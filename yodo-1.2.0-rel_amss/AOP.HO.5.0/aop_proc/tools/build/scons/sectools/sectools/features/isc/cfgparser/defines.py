...
MRC_2_0_CHIPSETS = (
    ...
    'lahaina', 'kamorta', 'bitra', 'qcn90xx', 'agatti', 'chitwan', 'makena', 'ipq5018'
)
...
SECBOOT_3_0_DOUBLE_SIGN_CHIPSETS = (
    ...
    'rennell', 'ipq6018', 'lahaina', 'kamorta', 'bitra', 'agatti', 'moselle', 'chitwan', 'makena'
)
...
ECDSA_CHIPSETS = (
    ...
    'lahaina', 'bitra', 'agatti', 'chitwan', 'makena'
)
