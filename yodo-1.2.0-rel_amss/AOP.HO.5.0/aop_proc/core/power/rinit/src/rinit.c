...
{
#if defined(LANAI_TARGET_CONFIG) || defined(KAPITI_TARGET_CONFIG) || defined(PINNACLE_TARGET_CONFIG) || defined(HAMOA_TARGET_CONFIG) //kapiti_todo
  return 1;
#else
      ...
      case EXT_GET_ARC_ID:
       ...
       case EXT_GET_RPID:
        ...
        case EXT_GET_WLAN_VOLT:
          ...
          {
            RINIT_INTS_TO_STR (buffer, args, args+1);
#if !defined(bitra_STUBS) && !defined(Olympic_STUBS) && !defined(WAIPIO_TARGET_CONFIG) && !defined(NETRANI_TARGET_CONFIG) && !defined(LANAI_TARGET_CONFIG) && !defined(HAMOA_TARGET_CONFIG)  &&!defined(PINNACLE_TARGET_CONFIG) && !defined(KUNO_TARGET_CONFIG) 
