  ...
  if loaded:
    ...
    try:
        ...
        if hansei_target in ['24','55']:
            ...
            cmd_db_size = 0x2000
        elif hansei_target in ['8250','Saipan', 'lahaina','cedros','waipio','fillmore']:
            cmd_db_addr = 0x80860000
            cmd_db_load_addr = 0x60860000
            cmd_db_size = 0x2000
        elif hansei_target in ['kailua',]:
...
for file in os.listdir(os.path.dirname(os.path.abspath(__file__))+'/dumpers'):
