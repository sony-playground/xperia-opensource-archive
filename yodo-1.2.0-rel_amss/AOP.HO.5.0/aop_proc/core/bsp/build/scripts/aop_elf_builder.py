...
def aop_elf_builder (target, source, env):
   ...
   elif env['MSM_ID'] in ['waipio','fillmore','kailua','aurora','lassen','netrani','kapiti','hamoa', 'pinnacle']:
      re = AopElfBuilder (env, source_str, target_str, [
            ('segment.paddr', '+0x0B000000', '0,1'),
            ('segment.vaddr', '+0x0B000000', '0,1'),
   ...
   elif env['MSM_ID'] in ['kuno']: #kuno_todo: once AOPSS_SYSDBG_DUMMY_4K segement is picked (stub in sysdbg_main.c)
      re = AopElfBuilder (env, source_str, target_str, [
            ('segment.paddr', '+0x0B000000', '0,1'),
            ('segment.vaddr', '+0x0B000000', '0,1'),
            ('segment.paddr', '-0x60000000', '5'),
            ('segment.vaddr', '-0x60000000', '5'),
            ('entry_point', '+0x0B000000', '')
            ])
