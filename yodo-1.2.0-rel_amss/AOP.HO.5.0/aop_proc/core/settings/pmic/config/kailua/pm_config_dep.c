...
$Header: //components/rel/aop.ho/5.0/aop_proc/core/settings/pmic/config/kailua/pm_config_dep.c#4 $ 
...
smps6_g_child_dep[] =
{
   ...
   &ldo_b[12],
   &ldo_b[15],
   /* SONY_BEGIN (Display: pmic config dependency) */
   &ldo_d[3],
   /* SONY_END (Display: pmic config dependency) */
   &ldo_k[6],
   &ldo_l[6],
   /* SONY_BEGIN (HW Configuration: pmic config dependency) */
   //&ldo_m[5],
