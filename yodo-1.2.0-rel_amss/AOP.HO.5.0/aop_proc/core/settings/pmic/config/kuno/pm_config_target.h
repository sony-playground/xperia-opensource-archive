...
$Header: //components/dev/aop.ho/5.0/cvelempa.aop.ho.5.0.Pinnacle_02_04_2022/aop_proc/core/settings/pmic/config/kailua/pm_config_target.h#1 $
...
#define PM_DRV_HYP    (0x1 << RSC_DRV_GLOBAL_HYP) //kuno_todo: NO HYP :pmic poc to remove 
