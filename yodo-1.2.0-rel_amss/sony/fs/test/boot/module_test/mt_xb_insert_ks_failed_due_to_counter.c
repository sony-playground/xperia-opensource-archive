		...
		const char *match)
{
	...
	case MT_XB_EXECUTE:
		...
		/*
		 * Set backup keystore. The KS counter is 5. This keystore
		 * is not XCS. The hash is the same as in the normal setup.
		 */
		...
		/*
		 * Set primary keystore. The KS counter is lower than the
		 * KS counter in RPBM. This is not allowed.
		 */
