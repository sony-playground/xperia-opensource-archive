		...
		unsigned int value_len)
{
	...
	if ((context != NULL) &&
		...
		(context->functions->set_property != NULL)) {
		...
		unsigned int id)
{
	...
	if ((context != NULL) &&
		(context->functions != NULL) &&
		(context->functions->clear_property != NULL)) {
		...
		unsigned int value_len)
{
	...
	if ((context != NULL) &&
		(context->functions != NULL) &&
		(context->functions->is_equal_property != NULL)) {
		...
		struct integration_hwstate *state)
{
	...
	if ((context != NULL) &&
		(context->functions != NULL) &&
		(context->functions->prepare_hwstate != NULL)) {
