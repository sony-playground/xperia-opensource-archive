...
/*===========================================================================
  MACRO DECLARATIONS
===========================================================================*/
/** @defgroup efi_pmic_lpg_protocol EFI_PMIC_LPG_PROTOCOL
 *  @ingroup PMIC 
 */
 /** @defgroup  efi_pmic_lpg_protocol_prot PROTOCOL
 *  @ingroup efi_pmic_lpg_protocol 
 */ 
 /** @defgroup  efi_pmic_lpg_protocol_apis APIs
 *  @ingroup efi_pmic_lpg_protocol 
 */ 

/** @defgroup  efi_pmic_lpg_protocol_data DATA_STRUCTURES
 *  @ingroup efi_pmic_lpg_protocol 
 */

/** @ingroup efi_pmic_lpg_protocol_data 
  Protocol version.
*/
 ...
 * @ingroup efi_pmic_lpg_protocol_apis
  @par Summary
  Configures the LPG.
 ...
 * @ingroup efi_pmic_lpg_protocol_prot
  @par Summary
