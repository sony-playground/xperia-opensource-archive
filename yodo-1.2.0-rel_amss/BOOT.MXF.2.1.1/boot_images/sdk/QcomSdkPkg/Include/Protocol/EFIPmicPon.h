...
/** @defgroup efi_pmic_pon_protocol EFI_PMIC_PON_PROTOCOL
 *  @ingroup PMIC 
 */
 /** @defgroup  efi_pmic_pon_protocol_prot PROTOCOL
 *  @ingroup efi_pmic_pon_protocol 
 */ 
 /** @defgroup  efi_pmic_pon_protocol_apis APIs
 *  @ingroup efi_pmic_pon_protocol 
 */ 

/** @defgroup  efi_pmic_pon_protocol_data DATA_STRUCTURES
 *  @ingroup efi_pmic_pon_protocol 
 */
