...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 04/21/20   xp      Adding BlinkLed API
...
/** @defgroup efi_pmic_rgb_led_protocol EFI_PMIC_RGB_LED_PROTOCOL
 *  @ingroup PMIC 
 */
 /** @defgroup  efi_pmic_rgb_led_protocol_prot PROTOCOL
 *  @ingroup efi_pmic_rgb_led_protocol 
 */ 
 /** @defgroup  efi_pmic_rgb_led_protocol_apis APIs
 *  @ingroup efi_pmic_rgb_led_protocol 
 */ 

/** @defgroup  efi_pmic_rgb_led_protocol_data DATA_STRUCTURES
 *  @ingroup efi_pmic_rgb_led_protocol 
 */
/** @ingroup efi_pmic_rgb_led_protocol_data
  Protocol version.
*/
#define PMIC_RGB_LED_REVISION 0x0000000000010003
...
/** @} */ /* end_ingroup efi_pmic_rgb_led_protocol_data */
 ...
 * @ingroup efi_pmic_rgb_led_protocol_apis
  @par Summary
 ...
 * @ingroup efi_pmic_rgb_led_protocol_apis
  @par Summary
  Blink LED(s) with given dim level
...
*/
typedef
EFI_STATUS (EFIAPI *EFI_PMIC_BLINK_LED)(
  IN  UINT32                          RbgMask,
  IN  UINT32                          DimLevel
);
...
===========================================================================*/
/** @ingroup efi_pmicRgbLed_protocol
 * @ingroup efi_pmic_rgb_led_protocol_prot
  @par Summary
