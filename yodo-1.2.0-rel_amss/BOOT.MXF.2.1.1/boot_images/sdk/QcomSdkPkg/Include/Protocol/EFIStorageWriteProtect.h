...
/** @defgroup EFI_STORAGE_WP_PROTOCOL  EFI_STORAGE_WP_PROTOCOL 
 *  @ingroup PERIPHERALS 
 */
 /** @defgroup  EFI_STORAGE_WP_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_STORAGE_WP_PROTOCOL 
 */ 
 /** @defgroup  EFI_STORAGE_WP_PROTOCOL_apis APIs
 *  @ingroup EFI_STORAGE_WP_PROTOCOL 
 */ 

/** @defgroup  EFI_STORAGE_WP_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_STORAGE_WP_PROTOCOL 
 */
...
/** @ingroup EFI_STORAGE_WP_PROTOCOL_data
  Protocol version.
*/
...
/** @ingroup EFI_STORAGE_WP_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_STORAGE_WP_PROTOCOL_prot
  @par Summary
