...
/** @defgroup efi_clock_protocol EFI_CLOCK_PROTOCOL
 *  @ingroup SOCINFRA 
 */
 /** @defgroup  efi_clock_protocol_prot PROTOCOL
 *  @ingroup efi_clock_protocol 
 */ 
 /** @defgroup  efi_clock_protocol_apis APIs
 *  @ingroup efi_clock_protocol 
 */ 

/** @defgroup  efi_clock_protocol_data DATA_STRUCTURES
 *  @ingroup efi_clock_protocol 
 */ 

/** @ingroup efi_clock_protocol_data 
  Protocol version.
*/
#define EFI_CLOCK_PROTOCOL_VERSION_1000A 0x000000000001000A

#define EFI_CLOCK_PROTOCOL_VERSION EFI_CLOCK_PROTOCOL_VERSION_1000A
...
/** @ingroup efi_clock_protocol_data
  @par Summary
  EFI_CLOCK_FREQ_PLAN_TYPE struct
...
===========================================================================*/
/* EFI_CLOCK_GET_ID */
/** @ingroup efi_clock_protocol_apis
  @par Summary
...
typedef
EFI_STATUS
(EFIAPI *EFI_CLOCK_LOGCLOCKSSTATE)(
  IN  EFI_CLOCK_PROTOCOL *This,
  IN  UINT32                   nLogMask
);

/* EFI_CLOCK_DUMPCLOCKSSTATE */
/** @ingroup efi_clock_protocol_apis
  @par Summary
  This API is called via EFI Test protocol.
  Read BDSClockLogState in BDS menu. Based on the current BDSClockLogState setting, whether or not
...
typedef
EFI_STATUS
(EFIAPI *EFI_CLOCK_DUMPCLOCKSSTATE)(
  IN  EFI_CLOCK_PROTOCOL *This,
  IN  UINT32                   nLogMask
);
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup efi_clock_protocol_prot
  @par Summary
...
struct _EFI_CLOCK_PROTOCOL {
   ...
   EFI_GET_ID                       GetID;
   EFI_CLOCK_LOGCLOCKSSTATE         LogClocksState;      /* Added in EFI_CLOCK_PROTOCOL_VERSION_REVISION_1000A */
   EFI_CLOCK_DUMPCLOCKSSTATE        DumpClocksState;     /* Added in EFI_CLOCK_PROTOCOL_VERSION_REVISION_1000A */
};
