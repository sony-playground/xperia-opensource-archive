...
/** @defgroup EFI_EMMC_WP_PROTOCOL  EFI_EMMC_WP_PROTOCOL 
 *  @ingroup PERIPHERALS 
 */
 /** @defgroup  EFI_EMMC_WP_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_EMMC_WP_PROTOCOL 
 */ 
 /** @defgroup  EFI_EMMC_WP_PROTOCOL_apis APIs
 *  @ingroup EFI_EMMC_WP_PROTOCOL 
 */ 

/** @defgroup  EFI_EMMC_WP_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_EMMC_WP_PROTOCOL 
 */
...
/** @ingroup EFI_EMMC_WP_PROTOCOL_data
  Protocol version.
*/
...
/** @addtogroup EFI_EMMC_WP_PROTOCOL_data 
@{ */
/**
...
/** @} */ /* end_addtogroup EFI_EMMC_WP_PROTOCOL_data */

/*===========================================================================
  FUNCTION DEFINITIONS
===========================================================================*/
/* EFI_EMMC_WP_GET_DEVICE_CAPABILITIES */
/** @ingroup EFI_EMMC_WP_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_EMMC_WP_PROTOCOL_prot
  @par Summary
