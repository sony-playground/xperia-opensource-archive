...
/*==============================================================================
  Copyright (c) 2011-2017,2019-2021 Qualcomm Technologies, Inc.
           All Rights Reserved.
...
$Header: //components/rel/core.boot_sdk/1.1/QcomSdkPkg/Include/Protocol/prot_inc/smem_type.h#4 $
...
typedef enum 
{
  ...
  SMEM_NUM_HOSTS    =  19,                    /**< Max number of host in target */
