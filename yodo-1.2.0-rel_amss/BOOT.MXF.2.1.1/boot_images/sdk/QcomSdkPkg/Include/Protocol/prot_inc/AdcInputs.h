...
============================================================================*/
/** @defgroup efi_adc_protocol EFI_ADC_PROTOCOL
 *  @ingroup PMIC 
 */
 
  /** @defgroup  efi_adc_protocol_prot PROTOCOL
 *  @ingroup efi_adc_protocol 
 */ 
 /** @defgroup  efi_adc_protocol_apis APIs
 *  @ingroup efi_adc_protocol 
 */ 

/** @defgroup  efi_adc_protocol_data DATA_STRUCTURES
 *  @ingroup efi_adc_protocol 
 */
...
/** VBATT_2S - nPhysical units are in millivolts          */
