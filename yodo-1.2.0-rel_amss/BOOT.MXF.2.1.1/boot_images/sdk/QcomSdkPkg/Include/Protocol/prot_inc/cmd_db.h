...
/** @defgroup efi_cmd_db_protocol EFI_CMD_DB_PROTOCOL
 *  @ingroup POWER 
 */
 /** @defgroup  efi_cmd_db_protocol_prot PROTOCOL
 *  @ingroup efi_cmd_db_protocol 
 */ 
 /** @defgroup  efi_cmd_db_protocol_apis APIs
 *  @ingroup efi_cmd_db_protocol 
 */ 

/** @defgroup  efi_cmd_db_protocol_data DATA_STRUCTURES
 *  @ingroup efi_cmd_db_protocol 
 */ 
//---------------------------------------------------------------------------
// Constant / Define Declarations
//---------------------------------------------------------------------------
/** @ingroup efi_cmd_db_protocol_data
@{ */

#define CMD_DB_MAX_RES_ID_LEN 8
#define CMD_DB_DRV_ID_PRIORITY_SZ  2

/** @} */ /* end_ingroup efi_cmd_db_protocol_data */
...
/** @ingroup efi_cmd_db_protocol_apis
 * <!-- cmd_db_query -->
 *
