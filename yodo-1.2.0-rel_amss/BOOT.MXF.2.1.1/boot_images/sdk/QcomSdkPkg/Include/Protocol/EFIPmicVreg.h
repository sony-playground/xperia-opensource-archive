...
/*===========================================================================
  INCLUDE FILES
===========================================================================*/
/** @defgroup EFI_QCOM_PMIC_VREG_PROTOCOL 
 *  @ingroup PMIC 
 */
 /** @defgroup  EFI_QCOM_PMIC_VREG_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_QCOM_PMIC_VREG_PROTOCOL 
 */ 
 /** @defgroup  EFI_QCOM_PMIC_VREG_PROTOCOL_apis APIs
 *  @ingroup EFI_QCOM_PMIC_VREG_PROTOCOL 
 */ 

/** @defgroup  EFI_QCOM_PMIC_VREG_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_QCOM_PMIC_VREG_PROTOCOL 
 */ 
/*===========================================================================
  MACRO DECLARATIONS
===========================================================================*/
/** @addtogroup EFI_QCOM_PMIC_VREG_PROTOCOL_data 
@{ */
/**
  Protocol version.
*/
#define PMIC_VREG_REVISION 0x0000000000010005
/** @} */ /* end_addtogroup EFI_QCOM_PMIC_VREG_PROTOCOL_data */
...
/** @ingroup EFI_QCOM_PMIC_VREG_PROTOCOL_data 
@{ */
/**
  VREG resource ID.
*/
...
===========================================================================*/
/* EFI_PM_VREG_CONTROL */ 
/** @ingroup EFI_QCOM_PMIC_VREG_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_QCOM_PMIC_VREG_PROTOCOL_prot
  @par Summary
