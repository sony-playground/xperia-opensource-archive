...
/** @ingroup efi_glink_protocol_apis
 @par Summary
 ...
 * @sideeffects  None
 */
typedef EFI_STATUS (EFIAPI* EFI_GLINK_LINK_STATE_POLL)
(
  glink_link_handle_type handle,
 ...
 * @sideeffects  None
 */
typedef EFI_STATUS (EFIAPI* EFI_GLINK_RX_POLL)
(
  glink_handle_type handle,
  glink_err_type    *ret  
);

typedef EFI_STATUS (EFIAPI* EFI_GLINK_SSR)
(
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup efi_glink_protocol_prot
  @par Summary
...
typedef struct _EFI_GLINK_PROTOCOL {
  ...
  EFI_GLINK_LINK_STATE_POLL           GlinkLinkStatePoll;
  EFI_GLINK_RX_POLL                   GlinkRxPoll;
  EFI_GLINK_SSR                       GlinkSsr;
}EFI_GLINK_PROTOCOL;
