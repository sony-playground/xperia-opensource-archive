...
/** @defgroup efi_cipher_protocol EFI_CIPHER_PROTOCOL
 *  @ingroup SECURITY 
 */
 /** @defgroup  efi_cipher_protocol_prot PROTOCOL
 *  @ingroup efi_cipher_protocol 
 */ 
 /** @defgroup  efi_cipher_protocol_apis APIs
 *  @ingroup efi_cipher_protocol 
 */ 

/** @defgroup  efi_cipher_protocol_data DATA_STRUCTURES
 *  @ingroup efi_cipher_protocol 
 */ 

/** @ingroup efi_cipher_protocol_data
@{ */
...
#define EFI_CIPHER_ALGORITHM_SM4_GUID \
  { \
    0xaf7de0b3, 0x7b85, 0x4161, {0x9e, 0x53, 0x05, 0x45, 0x0d, 0xf9, 0x36, 0x6b } \
  }
...
/** @} */ /* end_ingroup efi_cipher_protocol_data */

typedef struct _EFI_CIPHER_PROTOCOL EFI_CIPHER_PROTOCOL;

/** @ingroup efi_cipher_protocol_apis
...
/** @ingroup efi_resetReason_protocol_prot
  @par Summary
...
extern EFI_GUID gEfiCipherAlgorithmSM4Guid;
