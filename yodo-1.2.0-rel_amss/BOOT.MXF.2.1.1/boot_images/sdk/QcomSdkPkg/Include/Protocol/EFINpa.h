...
#include <npa_remote_resource_common.h>
 ...
 *
 *   V 1.3
 *      Adding Batch request API's.
 *
 * */
#define EFI_NPA_PROTOCOL_VER_LEGACY                              0x0000000000010001
#define EFI_NPA_PROTOCOL_VER_WITH_DEINIT_SUPPORT                 0x0000000000010002
#define EFI_NPA_PROTOCOL_VER_WITH_BATCH_REQUEST_SUPPORT          0x0000000000010003

/** @ingroup efi_npa_protocol_data
  Protocol version.
*/
#define EFI_NPA_PROTOCOL_REVISION EFI_NPA_PROTOCOL_VER_WITH_DEINIT_SUPPORT
...
/* EFI_NPA_BATCH_SCALAR_REQUEST */
/** @ingroup efi_npa_batch_scalar_request
 * @ingroup efi_npa_protocol_apis
  @par Summary
  Add the client scalar request to the specified batch.
  @par
  The request must be of scalar work model

  @param[in]  handle  Handle to batch being used
  @param[in]  client  Handle to the client in use.
  @param[in]  state   Requested resource state.
  ...
  EFI_NPA_INIT() must have already been called.
 */
typedef EFI_STATUS (EFIAPI* EFI_NPA_BATCH_SCALAR_REQUEST)(
    npa_batch_request_handle *handle,
    npa_client_handle         client, 
    npa_resource_state        state
);


/* EFI_NPA_BATCH_VECTOR_REQUEST */
/** @ingroup efi_npa_batch_vector_request
 * @ingroup efi_npa_protocol_apis
  @par Summary
  Add the client vector request to the specified batch.
  @par
  ...
  EFI_NPA_INIT() must have already been called.
 */
typedef EFI_STATUS (EFIAPI* EFI_NPA_BATCH_VECTOR_REQUEST)(
  npa_batch_request_handle *handle,
  npa_client_handle         client,
...
/* EFI_NPA_ISSUE_BATCH_REQUEST */
/** @ingroup efi_npa_issue_batch_request
 * @ingroup efi_npa_protocol_apis
  @par Summary
  Issues a Batch client work request.
  @par
  The resource state must be updated to account for the new request.
  ...
  EFI_NPA_INIT() must have already been called.
 */
typedef EFI_STATUS (EFIAPI* EFI_NPA_ISSUE_BATCH_REQUEST)( 
    npa_batch_request_handle   client
);
...
/** @endcond */
  ...
  EFI_NPA_ISSUE_BATCH_REQUEST       IssueBatchRequest;
  EFI_NPA_BATCH_SCALAR_REQUEST      BatchScalarRequest;
  EFI_NPA_BATCH_VECTOR_REQUEST      BatchVectorRequest;
 }EFI_NPA_PROTOCOL;
