...
*/
/*=============================================================================
  Copyright (c) 2011-2012, 2018 Qualcomm Technologies, Incorporated.
  All rights reserved.
...
/** @defgroup EFI_SMEM_PROTOCOL  EFI_SMEM_PROTOCOL 
 *  @ingroup PERIPHERALS 
 */
 /** @defgroup  EFI_SMEM_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_SMEM_PROTOCOL 
 */ 
 /** @defgroup  EFI_SMEM_PROTOCOL_apis APIs
 *  @ingroup EFI_SMEM_PROTOCOL 
 */ 

/** @defgroup  EFI_SMEM_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_SMEM_PROTOCOL 
 */
/*===========================================================================
  MACRO DECLARATIONS
===========================================================================*/
/** @addtogroup EFI_SMEM_PROTOCOL_prot 
@{ */
/**
  Protocol version.
*/
...
/** @ingroup EFI_SMEM_PROTOCOL_prot */
...
===========================================================================*/
/* EFI_SMEM_ALLOC */ 
/** @ingroup EFI_SMEM_PROTOCOL_apis
  @par Summary
...
/** @ingroup EFI_SMEM_PROTOCOL_apis
  ...
  @return
  EFI_SUCCESS        -- Function completed successfully. \n
  EFI_XXXX           -- Error occurred during the operation.
*/
typedef EFI_STATUS (EFIAPI *EFI_SMEM_ALLOC_EX)(
...
/** @ingroup EFI_SMEM_PROTOCOL_apis
  ...
  EFI_XXXX           -- Error occurred during the operation.
*/
typedef EFI_STATUS (EFIAPI *EFI_SMEM_GET_ADDR_EX)(
  smem_alloc_params_type *params
  );
...
typedef struct _EFI_SMEM_PROTOCOL {
  ...
  EFI_SMEM_ALLOC_EX     SmemAllocEx;
  EFI_SMEM_GET_ADDR_EX  SmemGetAddrEx;
