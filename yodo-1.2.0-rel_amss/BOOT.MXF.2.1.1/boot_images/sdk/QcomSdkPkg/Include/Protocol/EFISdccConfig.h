...
/** @defgroup EFI_SDCC_CONFIG_PROTOCOL  EFI_SDCC_CONFIG_PROTOCOL 
 *  @ingroup PERIPHERALS 
 */
 /** @defgroup  EFI_SDCC_CONFIG_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_SDCC_CONFIG_PROTOCOL 
 */ 
 /** @defgroup  EFI_SDCC_CONFIG_PROTOCOL_apis APIs
 *  @ingroup EFI_SDCC_CONFIG_PROTOCOL 
 */ 

/** @defgroup  EFI_SDCC_CONFIG_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_SDCC_CONFIG_PROTOCOL 
 */
...
/** @ingroup EFI_SDCC_CONFIG_PROTOCOL_data
  Protocol version.
*/
...
/** @ingroup EFI_SDCC_CONFIG_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_SDCC_CONFIG_PROTOCOL_prot
  @par Summary
