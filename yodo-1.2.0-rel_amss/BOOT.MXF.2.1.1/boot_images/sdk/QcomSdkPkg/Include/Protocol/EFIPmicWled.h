...
/** @defgroup EFI_QCOM_PMIC_WLED_PROTOCOL 
 *  @ingroup PMIC 
 */
 /** @defgroup  EFI_QCOM_PMIC_WLED_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_QCOM_PMIC_WLED_PROTOCOL 
 */ 
 /** @defgroup  EFI_QCOM_PMIC_WLED_PROTOCOL_apis APIs
 *  @ingroup EFI_QCOM_PMIC_WLED_PROTOCOL 
 */ 

/** @defgroup  EFI_QCOM_PMIC_WLED_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_QCOM_PMIC_WLED_PROTOCOL 
 */ 

/** @ingroup EFI_QCOM_PMIC_WLED_PROTOCOL_data */
/** Protocol version. */
...
/** @ingroup EFI_QCOM_PMIC_WLED_PROTOCOL_apis
  @par Summary
...
/**@ingroup EFI_QCOM_PMIC_WLED_PROTOCOL_prot
  @brief
