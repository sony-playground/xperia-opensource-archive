...
*/
typedef 
void (EFIAPI *EFI_DALSYS_PROTOCOL_INIT)(
...
*/
typedef 
void (EFIAPI *EFI_DALSYS_PROTOCOL_DEINIT)(
   IN    DALREG_DriverInfoList      *pModDriverList,
   IN    DALProps                   *pDALStringDevInfoList
);
#if 0
EFI_DALSYS_EventCreate(uint32 dwEvtAttrib, DALSYSEventHandle *phEvent,
									DALSYSEventObj *pEventObj)
	
typedef
EFI_STATUS
(EFIAPI *EFI_DALSYS_PROTOCOL_EVENTCREATE)(
IN	uint32 dwEvtAttrib, 
OUT	DALSYSEventHandle *phEvent,
OUT	DALSYSEventObj *pEventObj
);
#endif	
