...
/** @defgroup efi_limits_protocol EFI_LIMITS_PROTOCOL
 *  @ingroup UEFI_CORE 
 */
 /** @defgroup  efi_limits_protocol_prot PROTOCOL
 *  @ingroup efi_limits_protocol 
 */ 
 /** @defgroup  efi_limits_protocol_apis APIs
 *  @ingroup efi_limits_protocol 
 */ 

/** @defgroup  efi_limits_protocol_data DATA_STRUCTURES
 *  @ingroup efi_limits_protocol 
 */
/** @ingroup efi_limits_protocol_data
  Protocol version.
*/
 ...
 * @ingroup efi_limits_protocol_apis
  @par Summary
...
===========================================================================*/
/** @ingroup efi_limits_protocol
 * @ingroup efi_limits_protocol_prot
  @par Summary
