...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 10/16/17  c_samrab SCM call for deleting secure boot variables 
...
/** @defgroup EFI_VARIABLESERVICES_PROTOCOL  EFI_VARIABLESERVICES_PROTOCOL 
 *  @ingroup UEFI_CORE 
 */
 /** @defgroup  EFI_VARIABLESERVICES_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_VARIABLESERVICES_PROTOCOL 
 */ 
 /** @defgroup  EFI_VARIABLESERVICES_PROTOCOL_apis APIs
 *  @ingroup EFI_VARIABLESERVICES_PROTOCOL 
 */ 

/** @defgroup  EFI_VARIABLESERVICES_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_VARIABLESERVICES_PROTOCOL 
 */
...
/** @ingroup EFI_VARIABLESERVICES_PROTOCOL_data */
...
===========================================================================*/
/* EFI_FLUSHVARIABLENV */
/** @ingroup EFI_VARIABLESERVICES_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_VARIABLESERVICES_PROTOCOL_prot
  @par Summary
