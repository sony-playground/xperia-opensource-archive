...
/** @defgroup EFI_RESETREASON_PROTOCOL  EFI_RESETREASON_PROTOCOL
 *  @ingroup UEFI_CORE 
 */
 /** @defgroup  EFI_RESETREASON_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_RESETREASON_PROTOCOL 
 */ 
 /** @defgroup  EFI_RESETREASON_PROTOCOL_apis APIs
 *  @ingroup EFI_RESETREASON_PROTOCOL 
 */ 

/** @defgroup  EFI_RESETREASON_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_RESETREASON_PROTOCOL 
 */
/** @cond */
...
/** @addtogroup EFI_RESETREASON_PROTOCOL_data
@{ */
/**
  Protocol version.
*/
...
/** @ingroup EFI_RESETREASON_PROTOCOL_data */
...
** ============================================================================
*/
/** @ingroup EFI_RESETREASON_PROTOCOL_apis
  @par Summary
