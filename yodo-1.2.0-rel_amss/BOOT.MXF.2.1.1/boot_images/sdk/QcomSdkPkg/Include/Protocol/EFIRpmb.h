...
/** @defgroup EFI_SDCC_RPMB_PROTOCOL  EFI_SDCC_RPMB_PROTOCOL 
 *  @ingroup PERIPHERALS 
 */
 /** @defgroup  EFI_SDCC_RPMB_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_SDCC_RPMB_PROTOCOL 
 */ 
 /** @defgroup  EFI_SDCC_RPMB_PROTOCOL_apis APIs
 *  @ingroup EFI_SDCC_RPMB_PROTOCOL 
 */ 

/** @defgroup  EFI_SDCC_RPMB_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_SDCC_RPMB_PROTOCOL 
 */

/* RPMB Error Codes */
/** @addtogroup EFI_SDCC_RPMB_PROTOCOL_data 
@{ */
...
/** @} */ /* end_addtogroup EFI_SDCC_RPMB_PROTOCOL_data */

/** @cond */
typedef struct _EFI_SDCC_RPMB_PROTOCOL   EFI_SDCC_RPMB_PROTOCOL;
/** @endcond */

/** @ingroup EFI_SDCC_RPMB_PROTOCOL_data
  Protocol version.
*/
...
/** @ingroup EFI_SDCC_RPMB_PROTOCOL_apis
  @par Summary 
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_SDCC_RPMB_PROTOCOL_prot
  @par Summary
