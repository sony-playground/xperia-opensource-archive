...
*/
/*=============================================================================
    Copyright (c) 2011-2014, 2019 Qualcomm Technologies, Inc.
    All Rights Reserved
...
/*===========================================================================
  MACRO DECLARATIONS
===========================================================================*/
/** @defgroup efi_display_pwr_ctrl_protocol EFI_DISPLAY_PWR_CTRL_PROTOCOL
 *  @ingroup MULTIMEDIA
 */
 /** @defgroup  efi_display_pwr_ctrl_protocol_prot PROTOCOL
 *  @ingroup efi_display_pwr_ctrl_protocol 
 */ 
 /** @defgroup  efi_display_pwr_ctrl_protocol_apis APIs
 *  @ingroup efi_display_pwr_ctrl_protocol 
 */ 

/** @defgroup  efi_display_pwr_ctrl_protocol_data DATA_STRUCTURES
 *  @ingroup efi_display_pwr_ctrl_protocol 
 */ 

/** @ingroup efi_display_pwr_ctrl_protocol_data
@{ */
/**
  Protocol version.
*/
...
// {3c795f46-c9dc-4fc4-895f-5f416658af21}
#define EFI_DISPLAY_INIT_EVENT_GUID \
    { 0x3c795f46, 0xc9dc, 0x4fc4, { 0x89, 0x5f, 0x5f, 0x41, 0x66, 0x58, 0xaf, 0x21 } };

/** @} */ /* end_ingroup efi_display_pwr_ctrl_protocol_data */
/** @cond */
/*===========================================================================
  EXTERNAL VARIABLES
===========================================================================*/
...
typedef enum
{
  ...
  EFI_DISPLAY_TYPE_ALL,            /**< All displays : primary / secondary / external display */
  EFI_DISPLAY_TYPE_SECONDARY,      /**< Secondary display  */  
  EFI_DISPLAY_TYPE_INTERNAL_ALL,   /**< All internal displays : primary / secondary display   */
  EFI_DISPLAY_TYPE_EXTERNAL2,      /**< 2nd external display */
  EFI_DISPLAY_TYPE_EXTERNAL3,      /**< 3rd external display */
  EFI_DISPLAY_TYPE_EXTERNAL4,      /**< 4th external display */
  EFI_DISPLAY_TYPE_EXTERNAL5,      /**< 5th external display */
  EFI_DISPLAY_TYPE_EXTERNAL6,      /**< 6th external display */
...
/** @ingroup efi_display_pwr_ctrl_protocol_data
  List of displays to be disabled.
*/
typedef struct
{
  EFI_DISPLAY_TYPE   aDisabledDisplays[EFI_DISPLAY_TYPE_MAX];
  UINT32             uNumOfDisplays;
} EFI_DISABLED_DISPLAYS_TYPE;
...
/** @ingroup efi_display_pwr_ctrl_protocol_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup efi_display_pwr_ctrl_protocol_prot
  @par Summary
