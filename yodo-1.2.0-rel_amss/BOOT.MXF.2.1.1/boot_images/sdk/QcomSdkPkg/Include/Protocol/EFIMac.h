...
/** @defgroup efi_mac_protocol EFI_MAC_PROTOCOL
 *  @ingroup SECURITY 
 */
 /** @defgroup  efi_mac_protocol_prot PROTOCOL
 *  @ingroup efi_mac_protocol 
 */ 
 /** @defgroup  efi_mac_protocol_apis APIs
 *  @ingroup efi_mac_protocol 
 */ 

/** @defgroup  efi_mac_protocol_data DATA_STRUCTURES
 *  @ingroup efi_mac_protocol 
 */

/** @ingroup efi_mac_protocol_data
@{ */
...
/** @} */ /* end_ingroup efi_mac_protocol_data */

typedef struct _EFI_MAC_PROTOCOL EFI_MAC_PROTOCOL;

/** @ingroup efi_mac_protocol_apis
