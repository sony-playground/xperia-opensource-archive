...
/** @defgroup EFI_USB_DEVICE_PROTOCOL  EFI_USB_DEVICE_PROTOCOL 
 *  @ingroup INTERFACES 
 */
 /** @defgroup  EFI_USB_DEVICE_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_USB_DEVICE_PROTOCOL 
 */ 
 /** @defgroup  EFI_USB_DEVICE_PROTOCOL_apis APIs
 *  @ingroup EFI_USB_DEVICE_PROTOCOL 
 */ 

/** @defgroup  EFI_USB_DEVICE_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_USB_DEVICE_PROTOCOL 
 */

/*  Protocol GUID definition */
/** @ingroup EFI_USB_DEVICE_PROTOCOL_data */
extern EFI_GUID gEfiUsbDeviceProtocolGuid;


/** @addtogroup EFI_USB_DEVICE_PROTOCOL_data
@{ */
/** Protocol version. */
...
/**@ingroup EFI_USB_DEVICE_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_USB_DEVICE_PROTOCOL_prot
  @par Summary
