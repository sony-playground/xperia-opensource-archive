...
*/
/*=============================================================================
  Copyright (c) 2011-2014, 2016-2017, 2019 Qualcomm Technologies, Inc.
  All rights reserved.
...
/*=============================================================================
  ...
  --------   ---     -----------------------------------------------------------
  03/01/19   KS      Added enum for CHG TEMP
...
#define EFI_ADC_INPUT_CHG_TEMP         ADC_INPUT_CHG_TEMP
...
/** @ingroup efi_adc_protocol_data 
  @par Summary
  EfiAdcDeviceChannelType struct.
...
/** @ingroup efi_adc_protocol_data 
  @par Summary
  EfiAdcRecalibrateChannelResultType struct.
...
/** @ingroup efi_adc_protocol_data 
  @par Summary
  EfiAdcFuelGaugeThresholdType enum.
