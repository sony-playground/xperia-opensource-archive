...
/** @defgroup EFI_USB_INIT_PROTOCOL  EFI_USB_INIT_PROTOCOL 
 *  @ingroup INTERFACES 
 */
 /** @defgroup  EFI_USB_INIT_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_USB_INIT_PROTOCOL 
 */ 
 /** @defgroup  EFI_USB_INIT_PROTOCOL_apis APIs
 *  @ingroup EFI_USB_INIT_PROTOCOL 
 */ 

/** @defgroup  EFI_USB_INIT_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_USB_INIT_PROTOCOL 
 * 
 */
...
#define EFI_USB_INIT_PROTOCOL_REVISION   EFI_USB_INIT_PROTOCOL_REVISION_1
#define EFI_USB_INIT_PROTOCOL_REVISION_1 0x0000000000010000
...
/** @ingroup EFI_USB_INIT_PROTOCOL_data
...
/** @ingroup EFI_USB_INIT_PROTOCOL_apis
@par Summary
...
PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_USB_INIT_PROTOCOL_prot
@par Summary
