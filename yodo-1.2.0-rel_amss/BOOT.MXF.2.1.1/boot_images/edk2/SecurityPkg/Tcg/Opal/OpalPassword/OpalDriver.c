  ...
  )
{
  ...
  // Skip BuildOpalDeviceInfo. This function will save the Opal Device Info
  // into a lockbox. The lockbox is saved in SMM (System Management Mode)
  // and used for S3. Qcom does not implement S3.
#else
  BuildOpalDeviceInfo ();
#endif
  //
...
**/
#if defined (QCOM_EDK2_PATCH)
#define OPAL_TEST_PASSWORD_VARIABLE_NAME     L"OpalTestPassword"
#endif
CHAR8 *
  ...
  )
{
  ...
  *PressEsc = FALSE;
...
#if defined (QCOM_EDK2_PATCH)
  {
    ...
    EFI_STATUS  Status;
    Status = GetVariable2 (
      OPAL_TEST_PASSWORD_VARIABLE_NAME,
