...
#
#
#  Copyright (c) 2014, 2018, 2020, 2022 Qualcomm Technologies, Inc.  All Rights Reserved.
...
def oem_version_builder(target,
   ...
   if XmlImageTreeOemVersion is not None:
      ...
      if GlobalenVersionInfo is not None:
         oem_version_str = "".join([ "const char OEM_IMAGE_VERSION_STRING_AUTO_UPDATED[256]=\"OEM_IMAGE_VERSION_STRING=", GlobalenVersionInfo, "\";\n"])
      else:
         oem_version_str = "".join([ "const char OEM_IMAGE_VERSION_STRING_AUTO_UPDATED[256]=\"OEM_IMAGE_VERSION_STRING=", oem_environ, "\";\n"])
   
   if XmlImageTreeOemVersion is None :
      if oem_environ == "NULL":
         oem_ver = get_oem_version_string()
         oem_version_str = "".join([ "const char OEM_IMAGE_VERSION_STRING_AUTO_UPDATED[256]=\"OEM_IMAGE_VERSION_STRING=", oem_ver, "\";\n"])
      else :
         oem_version_str = "".join([ "const char OEM_IMAGE_VERSION_STRING_AUTO_UPDATED[256]=\"OEM_IMAGE_VERSION_STRING=", oem_environ, "\";\n"])
