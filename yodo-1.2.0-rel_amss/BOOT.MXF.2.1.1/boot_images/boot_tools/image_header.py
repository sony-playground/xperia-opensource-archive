...
#
# Copyright 2010, 2013-2014, 2016, 2020 by Qualcomm Technologies Incorporated.
# All Rights Reserved.
...
# --------   ---       ------------------------------------------------------
# 09/24/20   yps       Support to generate non hash segment header.
...
if len(sys.argv) < 5:
   print("Incorrect Usage: image_header.py <source file> <target file> <image_destination> <mbn type> <opt: elf_type> <diable hash>")
   print("Example: image_header.py ..\..\Build\Msm8660\DEBUG_RVCT31\FV\MSM8660_EFI.fd appsboot.mbn 0x40100000 bin")
   print("Example: image_header.py ..\..\Build\Msm8660\DEBUG_RVCT31\FV\MSM8660_EFI.fd appsboot.mbn 0x40100000 elf 64 nohash")
...
# MBN is generated in ELF format 
    ...
    if no_hash_seg == False:
      ...
      mbn_tools.concat_files (source_elf, files_to_cat_in_order)
      rv = mbn_tools.pboot_gen_elf([], source_elf, None, 
