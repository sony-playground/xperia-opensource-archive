 ...
 *
 * Copyright (C) 2010,2016, 2018, 2020, 2022 Qualcomm Technologies, Inc. All rights reserved.
...
int main (int argc, char *argv[])
{
    ...
    const char *const short_options = "hp:v:c:mis:g:w:r:lt:j:b:ku:xa:o:U:en:";  // possible cmd line short options
