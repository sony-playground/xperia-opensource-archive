...
#------------------------------------------------------------------------------
CLANG_TOOL_NAME = 'CLANG'
#------------------------------------------------------------------------------

FAKE_TOOLCHAIN_PATH = None
REAL_TOOLCHAIN_PATH = ''
BUILDEX_find_tool_config = None
...
def CALLFLOWGRAPH_find_tool_dirt(tools_dirt,tool_name):
  ...
  if CLANG_TOOL_NAME in tool_name:
  ...
  return BUILDEX_find_tool_config(tools_dirt,tool_name)
...
def main():
  ...
  global BUILDEX_find_tool_config
  ...
  BUILDEX_find_tool_config = buildex.find_tool_config
  buildex.find_tool_config = CALLFLOWGRAPH_find_tool_dirt
