...
def main():
  ...
  parser.add_option("-k", "--rpcheck-dir",
                    action="store",
                    type="string",
  ...
  parser.add_option("-r", "--relative-path-check",
                    action="store_true",
  ...
  if (options.relative_path_check):
    ...
    if (file_nums == 0):
      ...
      print("ERROR. Input threshold value is %d. There are %d files to modify." \
           % (options.relative_path_check_threshold, file_nums), end=' ')
      print("Please go through reletive_path_check.txt")
      sys.exit(RELETIVE_PATH_CHECK_ERROR_CODE)
      
      
  #Check the buildoption -O0
  if options.O0_check_enable and options.O0_check_dir and \
     options.O0_check_threshold:
    try:
      print ("Executing the buildoption -O0 check" + ("." * 5), end = '')
      file_num = O0_check.buildoption_O0_check(options.O0_check_dir,
                                               options.O0_check_threshold)
    except Exception as error:
      print(error)
    ...
    if (file_num == 0):
      ...
      print("WARNING. Input threshold value is %d. There are %d files to modify." \
           % (options.O0_check_threshold, file_num))
      print("Please go through O0_check_output.txt under boot_images/boot folder.")
