 ...
 * 22/06/22     gml     Updated PROG Buffer size for Pinnacles
...
/* Increased Buffer size to 768KB since xbl
   Image is greater than 700 KB */
#define FLASH_PROG_BUFFER_SIZE 0xC0000
