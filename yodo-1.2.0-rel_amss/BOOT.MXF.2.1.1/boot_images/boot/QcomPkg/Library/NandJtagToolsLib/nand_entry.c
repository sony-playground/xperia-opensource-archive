 ...
 *
 * Copyright (c) 2008-2012, 2014, 2020, 2022 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
...
void nand_init_dtb(void)
{
	...
	retValue = fdt_set_blob_handle(fdt_load_handle, DEFAULT_BLOB_ID);
	if (retValue != 0)
	{
		return;
	}
