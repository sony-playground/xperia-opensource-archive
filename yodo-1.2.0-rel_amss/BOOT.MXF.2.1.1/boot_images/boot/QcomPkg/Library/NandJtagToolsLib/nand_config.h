 ...
 *
 * Copyright (c) 2009-2011, 2020 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *   $Header: //components/dev/core.boot/5.1.1/glosch.core.boot.5.1.1.nand_cfg_olympic/QcomPkg/Library/NandJtagToolsLib/nand_config.h#1 $ 
...
#if !defined(BOOT_WATCHDOG_DISABLED) && !defined(FLASH_WATCHDOG_DISABLED)
