 ...
 *
 * Coldplug
 * Copyright (C) 2015,2018-2019,2021,2022 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/ColdplugLib/src/coldplug_bdev_spi_nor.c#2 $ $DateTime: 2022/09/15 10:32:02 $ $Author: pwbldsvc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2022-09-14   ss    Add coldplug_bdev_nor_get_boot_info
		...
		uint32 slot_no, uint32 lun_no)
{
	...
	nor_res = spinor_open((spinor_handle_t *)&nor_hdl->flash_hdl);
...
static int coldplug_bdev_nor_get_boot_info(void *bdev_hdl,struct coldplug_device_info *device_info)
{
...
static struct coldplug_bdev_ops coldplug_bdev_nor_ops = {
	...
	coldplug_bdev_nor_get_boot_info
};
