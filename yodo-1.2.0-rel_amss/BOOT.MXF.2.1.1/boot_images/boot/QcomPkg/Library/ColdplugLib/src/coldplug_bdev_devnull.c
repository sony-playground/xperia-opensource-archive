...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/ColdplugLib/src/coldplug_bdev_devnull.c#2 $ $DateTime: 2022/09/15 10:32:02 $ $Author: pwbldsvc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2022-09-14   rn    Add coldplug_bdev_devnull_ops_get_boot_info
...
static int coldplug_bdev_devnull_ops_get_boot_info(void *bdev_hdl,struct coldplug_device_info *device_info)
{
...
static struct coldplug_bdev_ops coldplug_bdev_devnull_ops =
{
	...
	coldplug_bdev_devnull_ops_get_boot_info
};
