 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_write(uint32 address, uint32 byte_count, uint8 *buffer);
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_read(uint32 address, uint32 byte_count, uint8 *buffer);
