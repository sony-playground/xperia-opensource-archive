...
static SPINOR_STATUS vendor_error_check (uint8 operation_type);
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_read_device_id (void *device_id, uint8 device_id_len)
{
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_erase (uint32 start_block, uint32 block_count)
{
  uint32 address = 0;
  uint8 qspi_status = 0;
  ...
  while (block_count)
  {
    ...
    if (SPINOR_DEVICE_DONE != spial_transfer(command_mode, address, NULL, 0,0))
    {
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_write (uint32 address,
                                      uint32 byte_count, uint8 *buffer)
{
  ...
  while (byte_count)
  {
    ...
    /* Command | data addr | data buffer | length | opcode */
      ...
      if (SPINOR_DEVICE_DONE != spial_transfer(command_mode, address, buffer, transfer_size,0))
    {
      status = SPINOR_DEVICE_FAIL;
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_read (uint32 address,
                                     uint32 byte_count, uint8 *buffer)
{
  SPINOR_STATUS status = SPINOR_DEVICE_DONE;
  ...
  while (byte_count > 0)
  {
    ...
    /* Command | data addr | data buffer | length | opcode */
      ...
      if (SPINOR_DEVICE_DONE != spial_transfer(command_mode, address, temp_buffer,transfer_size, 0))
    {
      status = SPINOR_DEVICE_FAIL;
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_core_erase_bulk(uint32 start_block, uint32 block_count)
{
  uint32 address = 0;
  uint8 qspi_status = 0;
  SPINOR_STATUS status = SPINOR_DEVICE_FAIL;
 ...
 *
 **********************************************************/
SPINOR_STATUS write_enable (uint8 *result)
{
  SPINOR_STATUS status = SPINOR_DEVICE_FAIL;
  uint32 timeout = 0;
  SPI_COMMAND_TYPE command_mode = qspi_write_enable_mode;
    ...
    if (SPINOR_DEVICE_DONE != spial_transfer(command_mode, 0, NULL, 0,0))
  {
    status = SPINOR_DEVICE_FAIL;
 ...
 *
 **********************************************************/
SPINOR_STATUS enable_quad_mode (uint8 qer_mode)
{
  SPINOR_STATUS status = SPINOR_DEVICE_DONE;
 ...
 *
 **********************************************************/
SPINOR_STATUS set_4byte_address_mode(void)
{
  SPINOR_STATUS status = SPINOR_DEVICE_DONE;
  uint8 temp = 0;
 ...
 *
 **********************************************************/
SPINOR_STATUS check_operation_status (uint8 *result)
{
  int32 timeout = 0;
  SPINOR_STATUS status = SPINOR_DEVICE_FAIL;
 ...
 *
 **********************************************************/
SPINOR_STATUS spinor_controller_init (void)
{
  SPINOR_STATUS status = SPINOR_DEVICE_DONE;
  bool qspi_init_status = FALSE;
