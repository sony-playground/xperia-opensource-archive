...
#endif /* !defined(FEATURE_DEVICEPROGRAMMER_SOMC) || !defined(FEATURE_SOMC_SKIP_SECBOOT_CHECK) */
...
int64 devprg_rx_blocking(void *data, size_t size)
{
  ...
  {
#if defined(FEATURE_DEVICEPROGRAMMER_SOMC) && defined(FEATURE_SOMC_SKIP_SECBOOT_CHECK)
    devprg_transport_rx_blocking(data, size, &ret_size);
#else /* !(defined(FEATURE_DEVICEPROGRAMMER_SOMC) && defined(FEATURE_SOMC_SKIP_SECBOOT_CHECK)) */
