...
void HAL_DSI_PhyFxnsInit(void)
{
    ...
    if ((0x02 == sDSIVersionInfo.uMajorVersion) &&
        (0x07 == sDSIVersionInfo.uMinorVersion))
    {
      /* Kailua 2.7.0 */
      gDsiPhyFxnTbl.HAL_DSI_PhyPllInitialize      = HAL_DSI_2_7_0_PhyPllInitialize;
      gDsiPhyFxnTbl.HAL_DSI_PhyDisable            = HAL_DSI_2_7_0_PhyDisable;
      gDsiPhyFxnTbl.HAL_DSI_Phy_PllEnable         = HAL_DSI_2_7_0_PhyPllEnable;
      gDsiPhyFxnTbl.HAL_DSI_PhyPllPowerCtrl       = HAL_DSI_2_7_0_PhyPllPowerCtrl;
      gDsiPhyFxnTbl.HAL_DSI_PhyPllSetup           = HAL_DSI_2_7_0_PhyPllSetup;
      gDsiPhyFxnTbl.HAL_DSI_PhyPllReConfigure     = HAL_DSI_2_7_0_PhyPllReConfigure;
      gDsiPhyFxnTbl.HAL_DSI_PhySetup              = HAL_DSI_2_7_0_PhySetup;
      gDsiPhyFxnTbl.HAL_DSI_PhySetupTimingParams  = HAL_DSI_2_7_0_PhySetupTimingParams;
      gDsiPhyFxnTbl.HAL_DSI_PhySetProperty        = HAL_DSI_2_7_0_PhySetProperty;
      gDsiPhyFxnTbl.HAL_DSI_PhyGetProperty        = HAL_DSI_2_7_0_PhyGetProperty;
      gDsiPhyFxnTbl.HAL_DSI_PhyGetPllCodes        = HAL_DSI_2_7_0_PhyGetPllCodes;
    }
    else
    {
