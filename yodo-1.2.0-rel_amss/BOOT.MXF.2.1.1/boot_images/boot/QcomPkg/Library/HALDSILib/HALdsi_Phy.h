...
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyPllPowerCtrl(DSI_Device_IDType eDeviceId, bool32 bPllPowerUp);
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhySetup(DSI_Device_IDType eDeviceId, HAL_DSI_PhyConfigType* psDsiPhyConfig);
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyPllSetup(HAL_DSI_PhyConfigType* psDsiPhyConfig, HAL_DSI_PhyConfigInfoType* psDsiPhyConfigInfo);
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhySetupTimingParams(HAL_DSI_TimingSettingType* pTimingParameters);
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyPllReConfigure(HAL_DSI_PhyConfigType* psDsiPhyConfig, HAL_DSI_PhyConfigInfoType* psDsiPhyPLLConfigInfo);
