...
*    
*  &copy; Copyright 2017-2020 QUALCOMM Technologies Incorporated, All Rights Reserved
*/
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/PmicLib/app/haptics/src/pm_app_haptics.c#1 $
$Author: pwbldsvc $
