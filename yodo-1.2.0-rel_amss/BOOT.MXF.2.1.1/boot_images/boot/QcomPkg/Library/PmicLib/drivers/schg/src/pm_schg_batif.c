...
*  &copy; Copyright 2016-2021 QUALCOMM Technologies, Inc All Rights Reserved
*/
...
pm_err_flag_type pm_schg_batif_enable_shipmode(uint32 pmic_index)
{
...
pm_err_flag_type pm_schg_batif_irq_enable(uint32 pmic_index, pm_schg_batif_irq_type irq, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type pm_schg_batif_irq_clear(uint32 pmic_index, pm_schg_batif_irq_type irq)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 1 << irq;
...
pm_err_flag_type pm_schg_batif_irq_set_trigger(uint32 pmic_index, pm_schg_batif_irq_type irq, pm_irq_trigger_type trigger)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1 << irq;
...
pm_err_flag_type pm_schg_batif_irq_status(uint32 pmic_index, pm_schg_batif_irq_type irq, pm_irq_status_type type, boolean *status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type pm_schg_batif_set_low_batt_detect_threshold(uint32 pmic_index, pm_schg_batif_low_battery_threshold lbt_cfg)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(pmic_index);
...
pm_err_flag_type pm_schg_batt_missing_status(uint32 pmic_index, pm_schg_batif_bat_miss_status_type status_type, boolean *st)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data;
...
pm_err_flag_type
pm_schg_batif_enable_fake_bat_detect(uint32 pmic_index, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1;
  uint8 data = 0;
  ...
  else
  {
    ...
    data = enable ? 1 : 0;
    err_flag = pm_comm_write_byte_mask(SLAVE_ID, fake_batid_ch_en, mask, data);
  }
  return err_flag;
}
