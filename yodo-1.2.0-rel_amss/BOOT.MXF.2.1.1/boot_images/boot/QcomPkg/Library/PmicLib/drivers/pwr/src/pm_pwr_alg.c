...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/PmicLib/drivers/pwr/src/pm_pwr_alg.c#1 $
...
pm_err_flag_type pm_pwr_ocp_latched_status_clear_alg(pm_pwr_data_type *pwr_data, pm_comm_info_type *comm_ptr, uint8 peripheral_index, boolean broadcast_cfg, boolean *ocp_occured)
{
    pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
    uint8 periph_type = 0;
