...
===========================================================================*/
pm_err_flag_type pm_schg_usb_irq_enable(uint32 pmic_index, pm_schg_usb_irq_type irq, boolean enable)
{
...
pm_err_flag_type pm_schg_usb_irq_clear(uint32 pmic_index, pm_schg_usb_irq_type irq)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 1 << irq;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(pmic_index);
...
pm_err_flag_type pm_schg_usb_irq_set_trigger(uint32 pmic_index, pm_schg_usb_irq_type irq, pm_irq_trigger_type trigger)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1 << irq;
...
pm_err_flag_type pm_schg_usb_irq_status(uint32 pmic_index, pm_schg_usb_irq_type irq, pm_irq_status_type type, boolean *status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type pm_schg_usb_set_usbin_adptr_allowance(uint32 pmic_index, pm_schg_usb_usbin_adapter_allowance_type adptr_allowance)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type pm_schg_usb_get_usbin_adptr_allowance(uint32 pmic_index, pm_schg_usb_usbin_adapter_allowance_type *adptr_allowance)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(pmic_index);
...
pm_err_flag_type pm_schg_usb_rerun_apsd(uint32 pmic_index)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(pmic_index);
  ...
  else
  {
    ...
    err_flag |= pm_comm_write_byte_mask(SLAVE_ID, apsd_cfg_reg, 0x1, 0x1);
  }

  return err_flag;
}

pm_err_flag_type pm_schg_usb_set_usbin_option1_cfg(uint32 pmic_index, pm_schg_usb_usbin_options_1_cfg usbin_cfg, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type pm_schg_usb_get_usbin_option1_cfg(uint32 pmic_index, pm_schg_usb_usbin_options_1_cfg usbin_cfg, boolean *enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(pmic_index);
