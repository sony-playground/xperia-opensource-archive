...
*  \n
*  &copy; Copyright 2012-2022 by QUALCOMM Technologies Incorporated, All Rights Reserved
*/
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/PmicLib/drivers/ldo/src/pm_ldo.c#1 $ 
...
pm_ldo_ocp_latched_status_clear(uint8 pmic_chip, uint8 peripheral_index, boolean *ocp_occured)
{
   ...
   pm_get_peripheral_info(pmic_chip, &ldo_peripheral_info);
    ...
    else
    {
      ...
      err_flag = pm_pwr_ocp_latched_status_clear_alg(&(ldo_ptr->pm_pwr_data), ldo_ptr->comm_ptr, peripheral_index, is_broadcast_cfg_present, ocp_occured);
    }
