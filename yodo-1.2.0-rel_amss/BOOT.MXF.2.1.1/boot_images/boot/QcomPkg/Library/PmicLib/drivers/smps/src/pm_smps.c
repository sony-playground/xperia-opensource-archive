...
*  \n  
*  &copy; Copyright 2010-2019, 2021,2022 QUALCOMM Technologies Incorporated, All Rights Reserved
*/
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/PmicLib/drivers/smps/src/pm_smps.c#1 $
$Author: pwbldsvc $
...
pm_smps_ocp_latched_status_clear(uint8 pmic_chip, uint8 peripheral_index,  boolean *ocp_occured)
{
    ...
    else
    {
        ...
        err_flag |= pm_pwr_ocp_latched_status_clear_alg(&(smps_ptr->pm_pwr_data), smps_ptr->comm_ptr, peripheral_index, is_broadcast_cfg_present, ocp_occured);
    }
