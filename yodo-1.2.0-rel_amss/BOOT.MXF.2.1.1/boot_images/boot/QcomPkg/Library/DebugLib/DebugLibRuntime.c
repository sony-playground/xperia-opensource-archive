/** @file
  ...
  Copyright (c) 2011-2013, 2015,2019 Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 07/06/19   ps      Use PRODMODE macro instead PRODMODE_ENABLED
...
#else
    if((ErrorLevel & (EFI_D_ERROR | EFI_D_BM)) != 0)
  	  SerialPortWrite ((UINT8 *) Buffer, AsciiStrLen(Buffer));
#endif
  }
}
