/** @file DALSYSLoader.c
  ...
  Copyright (c) 2010-2011,2014, 2017-2018, 2020, 2022 Qualcomm Technologies, Inc. All rights reserved.
                  ...
                  DALSYSMemAddr *VirtualAddr,DALSYSMemAddr *PhysicalAddr)
{
         ...
         DALSYS_MEM_ADDR_NOT_SPECIFIED == *VirtualAddr )
    {
       if(dwAttribs & DALSYS_MEM_PROPS_UNCACHED)
         heap_type = DALHEAP_UNCACHED;          

       if(DAL_SUCCESS != DALSYS_MallocType(ADD_SIZE_FOR_PADDING(dwLen),&pMemRegion,heap_type))
       {             
          pMemRegion = NULL;
       }
