...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 06/14/22   gpavithr Add stub for GetCapsuleStorageType()
 02/01/19   rajb     Removed redundant code
...
/**
  Return the Capsule Storage type which will be one of:
    -EFIESP -- this is by default
    -capsule partition

  @retval the storage type for capsule update
**/
CapsuleStorageType GetCapsuleStorageType (
  VOID)
{
    return CAPSULE_STORAGE_TYPE_UNKNOWN;
}
