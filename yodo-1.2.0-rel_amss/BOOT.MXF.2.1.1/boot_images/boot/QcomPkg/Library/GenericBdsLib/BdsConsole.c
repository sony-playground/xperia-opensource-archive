...
Copyright (c) 2013, 2021 Qualcomm Technologies, Inc All rights reserved.<BR>
...
/*
 * This function will search every simpletext device in current system and updates all console variables
*/
VOID
EFIAPI
...
/**
  ...
  and make every simpletext device as potential console device.
