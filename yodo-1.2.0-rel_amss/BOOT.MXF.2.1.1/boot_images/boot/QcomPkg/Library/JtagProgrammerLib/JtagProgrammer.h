...
extern UINT32 jsdcc_mem_erase_bulk_spi(void);
extern UINT32 jsdcc_mem_unit_test_spi();

extern UINT32 do_probe_eeprom(void);
extern UINT32 jsdcc_mem_read_eeprom(void);
extern UINT32 jsdcc_mem_write_eeprom(void);
extern UINT32 jsdcc_mem_erase_eeprom(void);
extern UINT32 jsdcc_mem_compute_crc_eeprom(void);
extern UINT32 jsdcc_mem_print_info_eeprom(void);
extern UINT32 jsdcc_mem_program_eeprom(void);
extern UINT32 jsdcc_mem_chip_erase_eeprom(void);
extern UINT32 jsdcc_mem_erase_partition_eeprom(void);
extern UINT32 jsdcc_mem_set_active_boot_eeprom(void);
extern UINT32 jsdcc_mem_erase_bulk_eeprom(void);
extern UINT32 jsdcc_mem_unit_test_eeprom();
#endif
