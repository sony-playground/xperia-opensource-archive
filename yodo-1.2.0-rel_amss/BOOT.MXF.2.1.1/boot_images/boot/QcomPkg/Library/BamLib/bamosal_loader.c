...
--------   ---     ------------------------------------------------------------
07/26/22   VC      Added BAM device static initialize config functions (bam_osal_init & bam_osal_deinit)
...
===============================================================================
                   Copyright (c) 2011-2016,2019,2022  QUALCOMM Technologies Inc.
                          All Rights Reserved.
...
void bam_osal_init(void)
{
  ...
  //get the properties from the static instance as Device tree data base is not yet ready
  bam_tgt_config_ptr = bam_settings_get_properties();
}
