           ...
           uBlendOrderIndex++)
       {
           ...
           for (uI = 0; uI < HAL_MDP_MAX_SSPP_IN_DUALPIPE_MODE; uI++)
           {
               ...
               case HAL_MDP_SOURCE_PIPE_DMA_4:
                 uRegValueEx2 = HWIO_OUT_FLD(uRegValueEx4,   MDP_CTL_0_LAYER_0_EXT4, DMA_4_OUT, uBlendOrderIndex);
                 break;

               case HAL_MDP_SOURCE_PIPE_DMA_5:
                 uRegValueEx2 = HWIO_OUT_FLD(uRegValueEx4,   MDP_CTL_0_LAYER_0_EXT4, DMA_5_OUT, uBlendOrderIndex);
                 break;
               ...
               case HAL_MDP_SOURCE_PIPE_DMA_4_REC1:
                   uRegValueEx2 = HWIO_OUT_FLD(uRegValueEx2, MDP_CTL_0_LAYER_0_EXT4, DMA_4_REC1_OUT, uBlendOrderIndex);
                   break;
               
               case HAL_MDP_SOURCE_PIPE_DMA_5_REC1:
                   uRegValueEx2 = HWIO_OUT_FLD(uRegValueEx2, MDP_CTL_0_LAYER_0_EXT4, DMA_5_REC1_OUT, uBlendOrderIndex);
                   break;
