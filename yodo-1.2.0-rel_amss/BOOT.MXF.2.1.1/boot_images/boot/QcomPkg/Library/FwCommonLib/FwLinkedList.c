/** @file FwLinkedList.c
  ...
  Copyright (c) 2012-2015, 2022 Qualcomm Technologies, Inc.  All Rights Reserved.
  ...
  )
{
  ...
  List->Head = pNew;
  List->Count++;
  List->TotalFvEntrySize += ((QPAYLOAD_FW_ENTRY *)Data)->FwEntrySize;
  return EFI_SUCCESS;
  ...
  )
{
  ...
  List->TotalFvEntrySize = 0;
  List->UpdatedTotalFvEntrySize = 0;
  List->SyncedTotalFvEntrySize = 0;
