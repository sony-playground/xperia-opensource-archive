...
#define UFS_GPP_MAX_ENTRIES     64  // 56(UFS_LUN4) + 8 reserved for OEM expansion
#define SPINOR_BOOT_MAX_ENTRIES 58  // Few more entries added then actual partition number for OEM expansion
