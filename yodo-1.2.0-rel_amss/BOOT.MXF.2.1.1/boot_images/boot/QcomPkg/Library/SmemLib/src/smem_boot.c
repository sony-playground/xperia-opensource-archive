/*=============================================================================
 ...
 Copyright (c)  2011-2013, 2016-2017, 2022 Qualcomm Technologies, Inc. All Rights Reserved.
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/SmemLib/src/smem_boot.c#1 $
