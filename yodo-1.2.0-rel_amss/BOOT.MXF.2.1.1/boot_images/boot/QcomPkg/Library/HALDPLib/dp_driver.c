  ...
  else
  {
    ...
    else
    {
      ...
      if (NULL != pPanelInfo)
      {
        ...
        sDPProp.sPanelInfo.uVsyncPulseInLines       = pPanelInfo->sActiveTiming.uVsyncPulseWidthLines;
        sDPProp.sPanelInfo.uVsyncFrontPorchInLines  = pPanelInfo->sActiveTiming.uVsyncFrontPorchLines;
        sDPProp.sPanelInfo.uVsyncBackPorchInLines   = pPanelInfo->sActiveTiming.uVsyncBackPorchLines;
        ...
        sDPProp.sPanelInfo.uPclkFreq                = (uint32)((pPanelInfo->uDisplayWidth +
                                                      ...
                                                      (uint64) (pPanelInfo->uDisplayHeight +
                                                       pPanelInfo->sActiveTiming.uVsyncFrontPorchLines +
                                                       pPanelInfo->sActiveTiming.uVsyncBackPorchLines +
                                                       pPanelInfo->sActiveTiming.uVsyncPulseWidthLines) *
    ...
    //Query the mode
     if (DP_STATUS_SUCCESS == DP_Host_GetProperty(pDPConfig->hDPHandle, DP_GETPROPERTY_GET_MODE_INFO, &sDPProp))
     {
      ...
      else
      {
       ...
       pPanelInfo->sActiveTiming.uVsyncPulseWidthLines    = sDPProp.sPanelInfo.uVsyncPulseInLines;
       pPanelInfo->sActiveTiming.uVsyncFrontPorchLines    = sDPProp.sPanelInfo.uVsyncFrontPorchInLines;
       pPanelInfo->sActiveTiming.uVsyncBackPorchLines     = sDPProp.sPanelInfo.uVsyncBackPorchInLines;
