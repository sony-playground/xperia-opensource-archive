/** @file
  ...
  Copyright (c) 2010-2015,2018,2021 Qualcomm Technologies Inc. All rights
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 02/18/21   cm      UEFI_daylight change
 06/22/18   abh     Changes in RTCInfo struct to match it with the one used by PMIC driver.
...
UEFI Spec Ch 8.3: Daylight can be:
  0 - indicates that time is not affected by daylight savings
  1 (EFI_TIME_ADJUST_DAYLIGHT) -  indicates that time is affected by daylight savings,but the clock isn't currently in daylight savings.
  3 (EFI_TIME_ADJUST_DAYLIGHT | EFI_TIME_IN_DAYLIGHT) - indicates that time is affected by daylight savings and the clock is currently in daylight savings.
By default we may display  any value and during clock sync with OS the correct time will be set, including this field.
*/ 
  ...
  )
{
  ...
  if (Status != EFI_SUCCESS ||
    ...
    DEBUG((EFI_D_WARN, "RTC Power loss...!\r\n"));
