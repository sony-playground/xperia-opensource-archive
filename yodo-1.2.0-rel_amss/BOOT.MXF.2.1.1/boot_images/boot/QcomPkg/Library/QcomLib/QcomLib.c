                    ...
                    OUT     CHAR8** ChipVerStr       OPTIONAL)
{
  ...
  AsciiStrnCpyS (TempPtr, BufferSize, PlatformTypeStrings[PlatformInfo.platform], BufferSize);
    ...
    )
{
  EFI_STATUS Status = EFI_SUCCESS;
  EFI_PXE_BASE_CODE_PROTOCOL            *Pxe = NULL;
  EFI_PXE_BASE_CODE_TFTP_OPCODE         Operation = EFI_PXE_BASE_CODE_TFTP_GET_FILE_SIZE;
  BOOLEAN                               Overwrite = FALSE;
  VOID                                  *BufferPtr = NULL;
  UINTN                                 *BlockSize = NULL;
  UINT64                                BufferSize;
  EFI_IP_ADDRESS                        ServerIp;
  EFI_PXE_BASE_CODE_MTFTP_INFO          *Info = NULL;
  BOOLEAN                               DontUseBuffer = TRUE;
    ...
    )
{
  EFI_STATUS Status = EFI_SUCCESS;
  EFI_PXE_BASE_CODE_PROTOCOL            *Pxe = NULL;
  EFI_PXE_BASE_CODE_TFTP_OPCODE         Operation = EFI_PXE_BASE_CODE_TFTP_READ_FILE;
  BOOLEAN                               Overwrite = FALSE;
  UINTN                                 *BlockSize = NULL;
  EFI_IP_ADDRESS                        ServerIp;
  EFI_PXE_BASE_CODE_MTFTP_INFO          *Info = NULL;
