...
/*===========================================================================
 ...
 Copyright (c) 2014, 2020 by QUALCOMM Technologies, Incorporated.  All Rights
 Reserved.
===========================================================================*/
...
typedef Event* os_event_type;

typedef void ( *os_isr_cb_fn )( void *cb_data );

typedef struct {
  EFIIPCC_Client client;
  EFIIPCC_Signal signal;
} os_ipc_intr_type;
