 ...
 */
/*=============================================================================
     Copyright (c) 2014-2015, 2020 QUALCOMM Technologies Incorporated.
     All rights reserved.
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/GLinkLib/core/inc/glink_transport_if.h#1 $
