...
2018-07-13   jt      Move tuning functions to sdcc_util 
...
******************************************************************************/
SDCC_STATUS 
sdcc_config_mmc_modes_segment_decode (sdcc_dev_type *sdcc_pdev, 
                                      UINT8 *raw_ext_csd);
...
*
******************************************************************************/
SDCC_STATUS sdcc_get_ext_csd (sdcc_dev_type *sdcc_pdev, UINT8 *buff);
...
*
******************************************************************************/
BOOLEAN sdcc_decode_extCSD (const UINT8 *data, sdcc_ext_csd_type *ext_csd);
...
*
******************************************************************************/
BOOLEAN sdcc_decode_mmc_cid (const UINT32 *raw_cid, sdcc_dev_type *sdcc_pdev);
...
*
******************************************************************************/
SDCC_STATUS sdcc_mmc_get_phy_partition_info (struct sdcc_device *handle, 
...
*
******************************************************************************/
SDCC_STATUS sdcc_mmc_set_pwr_on_write_prot (struct sdcc_device *handle, 
                                            UINT32 data_address, 
...
*
******************************************************************************/
SDCC_STATUS sdcc_mmc_get_write_prot_type (struct sdcc_device *handle, 
                                          UINT32 data_address, 
