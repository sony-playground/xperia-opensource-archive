...
#define SDCC_S18A                   0x01000000 /* Switch to 1.8V accepted */

#define SDCC_BUSY_STATUS_DEF 0x01   /* 00h - bits 511:376 are defined */
                                    /* 01h - bits 511:272 are defined */

#define SDCC_ACCESS_MODE_DS     0x0001 /* access mode func supports default speed */
#define SDCC_ACCESS_MODE_HS     0x0002 /* access mode func supports high speed */
#define SDCC_ACCESS_MODE_SDR50  0x0004 /* access mode func supports SDR50 */
#define SDCC_ACCESS_MODE_SDR104 0x0008 /* access mode func supports SDR104 */
#define SDCC_ACCESS_MODE_DDR50  0x0010 /* access mode func supports DDR50 */

#define SDCC_CMD6_DS     0x0000 /* CMD6 arg for default speed */
#define SDCC_CMD6_HS     0x0001 /* CMD6 arg for high speed */
#define SDCC_CMD6_SDR50  0x0002 /* CMD6 arg for SDR50 */
#define SDCC_CMD6_SDR104 0x0003 /* CMD6 arg for SDR104 */
#define SDCC_CMD6_DDR50  0x0004 /* CMD6 arg for DDR50 */
...
#define SDCC_SET_MODE                     0x80000000 /* Enabling the mode */
...
/* Spec Version Defines */
#define SDCC_SD_VER_1_0_X       0x0100
#define SDCC_SD_VER_1_1_0       0x0110
#define SDCC_SD_VER_2_0_0       0x0200
#define SDCC_SD_VER_3_0_X       0x0300
#define SDCC_SD_VER_4_X_X       0x0400
...
typedef struct sdcc_scr
{
   ...
   UINT8  sd_spec3;              /* Spec. Version 3.00 or higher */
   UINT8  sd_spec4;              /* Spec. Version 4.00 or higher */
} sdcc_scr_type;
...
* Arguments:
*    sdcc_pdev      [IN/OUT] : pointer to device type
*    intended_speed [IN]     : (optional) speed mode desired
*
* Returns:
*    Returns error code
*
