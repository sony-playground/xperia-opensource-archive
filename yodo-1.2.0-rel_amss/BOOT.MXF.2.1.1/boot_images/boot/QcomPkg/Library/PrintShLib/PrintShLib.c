  ...
  )
{
  ...
  ASSERT (PrintShLibPtr->UnicodeValueToStringS != NULL);
  if (PrintShLibPtr->UnicodeValueToStringS == NULL)
    return 0;  
  Return = PrintShLibPtr->UnicodeValueToStringS(Buffer, BufferSize, Flags, Value, Width);
