...
/* ===============================================================================
 ...
 $Header: //components/rel/core.boot/6.1.1/QcomPkg/Library/ChipInfoLib/ChipInfoLoader.h#4 $
...
#define CHIPINFO_PARTNUM_SG_KAILUA              0x1F1
#define CHIPINFO_PARTNUM_SGP_KAILUA             0x1F2
#define CHIPINFO_PARTNUM_QCS_KAILUA             0x252
#define CHIPINFO_PARTNUM_QCM_KAILUA             0x24F
...
#define CHIPINFO_PARTNUM_SDX_PINNACLES_M        CHIPINFO_PARTNUM_UNKNOWN
...
typedef struct
{
  ...
  ChipInfoProductManagementDataType  *aProductManagementData;
  const uint32                        nNumFamiliesWithProductManagementData;
} ChipInfoBSPType;
