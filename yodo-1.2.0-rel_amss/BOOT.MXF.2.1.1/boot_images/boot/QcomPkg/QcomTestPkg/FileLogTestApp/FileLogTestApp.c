...
ULogResult FileLogTest_MakePathFromName(CONST CHAR8 *LogName, CHAR8 *FilePath)
{
  ...
  AsciiStrCpyS(PathStr, AsciiStrLen(sTestLogDirectory) + AsciiStrLen(LogName) + AsciiStrLen(ULOGFILE_EXTENSION) + 1, sTestLogDirectory);
  ...
  AsciiStrCatS(PathStr, AsciiStrLen(sTestLogDirectory) + AsciiStrLen(LogName) + AsciiStrLen(ULOGFILE_EXTENSION) + 1, LogName);
  if (AsciiStrLen(PathStr) < length) {
  ...
  AsciiStrCatS(PathStr, AsciiStrLen(sTestLogDirectory) + AsciiStrLen(LogName) + AsciiStrLen(ULOGFILE_EXTENSION) + 1, ULOGFILE_EXTENSION);
  if (AsciiStrLen(PathStr) < length) {
