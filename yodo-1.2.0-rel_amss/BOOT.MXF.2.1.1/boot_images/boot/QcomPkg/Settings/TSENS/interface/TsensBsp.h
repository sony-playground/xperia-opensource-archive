...
typedef struct
{
   ...
   uint32 uZeroCEnMask;        /* Bitmask of sensors to enable zero C thresholds */
   int16 nsZeroCSetDeciDegC;   /* Zero C set threshold */
   int16 nsZeroCResetDeciDegC; /* Zero C reset threshold */
   boolean bPSHoldResetEn;     /* Whether to enable PS_HOLD reset */
   boolean bAutoAdjustPeriod;  /* Whether to adjust period on sleep */
   boolean bStandAlone;        /* Whether this is a stand alone controller */
   boolean bPWMEn;             /* Whether to enable PWM */
   boolean bWatchdogEn;        /* Whether to enable the watchdog */
   boolean bWatchdogResetEn;   /* Whether or not watchdog can perform TSENS resets */
