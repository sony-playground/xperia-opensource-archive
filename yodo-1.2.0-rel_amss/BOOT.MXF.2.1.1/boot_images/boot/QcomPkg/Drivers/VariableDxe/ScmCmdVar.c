/** @file ScmCmdVar.c
  ...
  Copyright (c) 2011-2017,2019 Qualcomm Technologies, Inc.  All 
  ...
  )
{
  ...
  do
  {
    ...
    Request->DataSize = (UINT32)*DataSize;  // TODO Mamta: size wont be 64bit value so should be ok.
  ...
  )
{
  ...
  do
  {
    ...
    Request->VariableNameSize = (UINT32)*VariableNameSize;   //  TODO Mamta this typecasting is ok since it is related to size
