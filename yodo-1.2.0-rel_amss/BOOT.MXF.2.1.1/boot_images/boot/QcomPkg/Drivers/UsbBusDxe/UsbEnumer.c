  ...
  switch (DevState)
  {
    ...
    { // Perform rest of enumeration till the completion
      ...
      if (USB_BIT_IS_SET (PortState->PortStatus, USB_PORT_STAT_SUPER_SPEED_PLUS)) {
        DEBUG (( EFI_D_ERROR, "UsbEnumNewDevRootHub: device connect speed is SUPER_PLUS\n"));
      }
  ...
  )
{
  ...
  switch (DevState)
  {
    ...
    { // Perform rest of enumeration till the completion
      ...
      // Check Port/Device Speed
      if (USB_BIT_IS_SET (PortState->PortStatus, USB_PORT_STAT_SUPER_SPEED_PLUS)){
        DEBUG (( EFI_D_ERROR, "UsbEnumNewDevHub: device connect speed is SUPER_PLUS\n"));
      }
