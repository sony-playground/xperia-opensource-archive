...
--------   ---    ---------------------------------------------------------- 
08/01/18   ivy    Modified API to config HW JEITA
01/29/18   cs     modified APIs to get batt id and batt temp.
11/27/17   ra     Removing unsupported protocols
...
EFI_STATUS EFIAPI  EFI_PmicFgBasicIsBatteryPresent(IN UINT32 PmicDeviceIndex, OUT BOOLEAN *isBatteryPresent);

EFI_STATUS EFIAPI EFI_GetBatteryType(IN UINT32 PmicDeviceIndex, OUT EFI_PM_FG_BATT_TYPE* battery_type);

EFI_STATUS EFIAPI EFI_PmicFgGetPmicGaugeSDAMInfo(OUT UINT32 *SdamPmicIndex, OUT UINT32 *SdamIndex);
/*===========================================================================
