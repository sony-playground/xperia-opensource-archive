...
Copyright (c) 2012, 2017-2018, 2022 Qualcomm Technologies, Inc. All Rights Reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 01/02/19   rajb    Updated capsule image process API
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "CapsuleService.c UpdateCapsule capsule storage type is 0x%X\n", (UINTN) CapsuleStorage));
  ...
  )
{
  ...
  CapsuleStorage = GetCapsuleStorageType();
  DEBUG ((DEBUG_INFO, "CapsuleService.c QueryCapsuleCapabilities capsule storage type is 0x%X\n", (UINTN) CapsuleStorage));
