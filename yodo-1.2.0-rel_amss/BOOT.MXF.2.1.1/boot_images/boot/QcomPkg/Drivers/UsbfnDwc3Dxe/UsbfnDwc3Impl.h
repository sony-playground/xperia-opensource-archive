...
#define DWC_DEV_SPEED_SS_PLUS         (5)
#define DWC_DEV_SPEED_INVALID         (7)
#define DWC_DEV_SPEED_DEFAULT         DWC_DEV_SPEED_SS
  
// Requires minimum of 5 to pass USB CV Chapter 9 Tests
// When running USB CV, the client tries to Send data over BULK EP
// and it gets queued up on TRBs.   We need enough TRBs in the ring
// before it gets full and returns error to client which may 
// assert fatal error.
#define USBFN_DWC_TRB_DEFAULT_NUM     5
