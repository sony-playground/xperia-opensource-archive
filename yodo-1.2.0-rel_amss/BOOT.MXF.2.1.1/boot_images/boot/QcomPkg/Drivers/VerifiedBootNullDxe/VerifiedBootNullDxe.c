/** @file VerifiedBootDxeNull.c
  ...
  Copyright (c) 2016, 2022 Copyright Qualcomm Technologies, Inc.  All Rights Reserved.
...
/*=============================================================================
 ...
 --------   ---      ----------------------------------------------------------
 05/24/22   anv      Added API to check whether Keymaster is enabled.
...
*/
EFI_STATUS
QCOM_VB_Get_Boot_State(IN  QCOM_VERIFIEDBOOT_PROTOCOL *This,
...
*/ 
EFI_STATUS
QCOM_VB_Get_Cert_FingerPrint(IN  QCOM_VERIFIEDBOOT_PROTOCOL *This,
                             OUT UINT8 *buf, IN UINTN buf_len,
                             OUT UINTN *out_len)
{
  return EFI_SUCCESS;
}
...
STATIC QCOM_VERIFIEDBOOT_PROTOCOL QCOMVerifiedBootProtocol = {
    ...
    QCOM_VB_Get_Boot_State,
    QCOM_VB_Get_Cert_FingerPrint,
