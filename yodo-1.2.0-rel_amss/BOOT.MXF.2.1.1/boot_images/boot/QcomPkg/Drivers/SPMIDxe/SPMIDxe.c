...
Spmi_Result
EFISpmiIntrCtlr_InterruptClearAll
(
  EFI_QCOM_SPMI_PROTOCOL *SpmiProtocolHandle)
{
    Spmi_Result result;
    ...
    result = SpmiIntrCtlr_InterruptClearAll();
  ...
  UINT16 *channel)
{
    ...
    result = SpmiBus_GetChannel(busId, slaveId, periphId, channel);
