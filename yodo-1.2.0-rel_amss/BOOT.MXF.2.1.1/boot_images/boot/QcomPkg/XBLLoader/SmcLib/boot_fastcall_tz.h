...
Copyright 2010-2011,2013-2017, 2020 by Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
--------   ---      ------------------------------------
12/02/20   rama     Removed smc status APIs
06/11/20   ck       Added TZ_INIT_CMD from SBL 4.1
06/05/20   ck       boot_tzt_result_regs_t and boot_tz_indirect_arg_list_t to uintnt
...
/*
 Unlock the TZ regions for image loading
*/
