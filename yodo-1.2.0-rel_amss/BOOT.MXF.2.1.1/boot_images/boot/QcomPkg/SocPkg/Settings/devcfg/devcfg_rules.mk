...
DEVCFG_SCRIPTS = $(BOOTTOOLS)/devcfg/scripts
...
$(DEVCFG_DATA_O) : $(DEVCFG_C) $(STRUCTPTR_H) $(MAKE_FILE) $(COMMON_DEPS) $(GLOBAL_DEPS)
	"$(CC)" $(XB_FLAGS) $(CC_FLAGS) $(DEVCFG_C_DEFINES) -include $(STRUCTPTR_H) -o $(DEVCFG_DATA_O) $(INC) $(DEVCFG_DATA_C)

$(DEVCFG_O) : $(DEVCFG_C) $(STRUCTPTR_H) $(MAKE_FILE) $(COMMON_DEPS) $(GLOBAL_DEPS)
	"$(CC)" $(XB_FLAGS) $(CC_FLAGS) $(DEVCFG_C_DEFINES) -include $(STRUCTPTR_H) -o $(DEVCFG_O) $(INC) $(DEVCFG_C)
...
$(DEVCFG_BLOB_TABLE_O) : $(DEVCFG_BLOB_TABLE_C) $(GLOBAL_DEPS)
	"$(CC)" $(XB_FLAGS) $(CC_FLAGS) $(DEVCFG_C_DEFINES) -o $(DEVCFG_BLOB_TABLE_O) $(INC) $(DEVCFG_BLOB_TABLE_C)
...
$(DALMOD_O) : $(DALMOD_C) $(GLOBAL_DEPS)
	"$(CC)" $(XB_FLAGS) $(CC_FLAGS) $(DEVCFG_C_DEFINES) -o $(DALMOD_O) $(INC) $(DALMOD_C)
