/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Copyright 2013 - 2020 by Qualcomm Technologies, Inc.
 All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 --------   ---     --------------------------------------------------------
 06/11/20   vk      Set SPAN bit
 06/05/20   digant  configure cpacr_el1 and enable i-cache
...
#define I_BIT         0x1000    /* Instruction cache */
#define CTRL_SPAN_BIT 0x800000  /* SCTLR_El1 SPAN Bit [23] for PXN */
...
//============================================================================
el1_entry:
  // Preserve parameter from XBL_SC in x7 if it has
  MOV x7, x0
  MOV X0, #0
  MOV SP, X0
  ...
  // retrieve stack-base
  // -------------------------------
  LDR x0, = Image$$STACK_BASE$$Pointer
  ...
  // SET SPAN bit for PXN
  ORR X0,X0, #CTRL_SPAN_BIT
  MSR SCTLR_EL1, X0

  // Zero init stack region
  // -------------------------------    
  LDR x0, = Image$$STACK$$Base
  LDR x1, = Image$$STACK$$Length
