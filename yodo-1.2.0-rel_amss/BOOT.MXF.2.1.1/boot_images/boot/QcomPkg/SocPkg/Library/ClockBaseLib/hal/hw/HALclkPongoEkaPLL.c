 ...
 */
bool HAL_clk_xbl_PongoEkaPLLEnable           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceDisableModeType eMode, void *pData );
bool HAL_clk_xbl_PongoEkaPLLIsEnabled        ( HAL_clk_xbl_SourceDescType *pSource );
void HAL_clk_xbl_PongoEkaPLLConfig           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceConfigType eConfig );
bool HAL_clk_xbl_PongoEkaPLLConfigPLL        ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig, HAL_clk_xbl_SourceConfigMode eMode );
bool HAL_clk_xbl_PongoEkaPLLSetCalConfig     ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig );
void HAL_clk_xbl_PongoEkaPLLSetRegSettings   ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_xbl_PongoEkaPLLControl
 *
 * Control function array for the Pongo PLLs.
 */
HAL_clk_xbl_SourceControlType HAL_clk_xbl_PongoekaPLLControl =
{
  .Enable           = HAL_clk_xbl_PongoEkaPLLEnable,
  .IsEnabled        = HAL_clk_xbl_PongoEkaPLLIsEnabled,
  .Config           = HAL_clk_xbl_PongoEkaPLLConfig,
  .ConfigPLL        = HAL_clk_xbl_PongoEkaPLLConfigPLL,
  .SetCalConfig     = HAL_clk_xbl_PongoEkaPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_xbl_PongoEkaPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLPostDivToHW
**
** ======================================================================== */

uint32_t HAL_clk_xbl_PongoEkaPLLPostDivToHW (uint32_t nDivider)
{
  if (nDivider)
  {
    nDivider--;
...
} /* END HAL_clk_xbl_PongoEkaPLLPostDivToHW */


/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLPostDivFromHW
**
** ======================================================================== */

uint32_t HAL_clk_xbl_PongoEkaPLLPostDivFromHW (uint32_t nDivider)
{
  return nDivider + 1;

} /* END HAL_clk_xbl_PongoEkaPLLPostDivFromHW */



/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLEnable
**
** ======================================================================== */

bool HAL_clk_xbl_PongoEkaPLLEnable
(
...
)
{
   ...
   */
  if (HAL_clk_xbl_PongoEkaPLLIsEnabled(pSource))
  {
    return TRUE;
  }
...
} /* END HAL_clk_xbl_PongoEkaPLLEnable */


/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLIsEnabled
**
** ======================================================================== */

bool HAL_clk_xbl_PongoEkaPLLIsEnabled
(
  HAL_clk_xbl_SourceDescType *pSource
)
{
...
} /* END HAL_clk_xbl_PongoEkaPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLConfig
**
** ======================================================================== */

void HAL_clk_xbl_PongoEkaPLLConfig
(
  HAL_clk_xbl_SourceDescType   *pSource,
...
} /* END HAL_clk_xbl_PongoEkaPLLConfig */


/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLConfigPLLNormal
**
** ======================================================================== */

bool HAL_clk_xbl_PongoEkaPLLConfigPLLNormal
(
  HAL_clk_xbl_SourceDescType      *pSource,
...
)
{
  ...
  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_MAIN,
    HAL_clk_xbl_PongoEkaPLLPostDivToHW(pConfig->PostDivs.Pongoeka.nMain));

  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_EVEN,
    HAL_clk_xbl_PongoEkaPLLPostDivToHW(pConfig->PostDivs.Pongoeka.nEven));
...
} /* END HAL_clk_xbl_PongoEkaPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLConfigPLL
**
** ======================================================================== */

bool HAL_clk_xbl_PongoEkaPLLConfigPLL
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_xbl_PongoEkaPLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_xbl_PongoEkaPLLConfigPLL */


/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLSetCalConfig
**
** ======================================================================== */

bool HAL_clk_xbl_PongoEkaPLLSetCalConfig
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_xbl_PongoEkaPLLSetRegSettings
**
** ======================================================================== */

void HAL_clk_xbl_PongoEkaPLLSetRegSettings
(
  HAL_clk_xbl_SourceDescType              *pSource,
...
} /* END HAL_clk_xbl_PongoEkaPLLSetRegSettings */
