...
bool HAL_clk_xbl_ZondaEkaPLLEnable           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceDisableModeType eMode, void *pData );
bool HAL_clk_xbl_ZondaEkaPLLIsEnabled        ( HAL_clk_xbl_SourceDescType *pSource );
void HAL_clk_xbl_ZondaEkaPLLConfig           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceConfigType eConfig );
bool HAL_clk_xbl_ZondaEkaPLLConfigPLL        ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig, HAL_clk_xbl_SourceConfigMode eMode );
bool HAL_clk_xbl_ZondaEkaPLLSetCalConfig     ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig );
void HAL_clk_xbl_ZondaEkaPLLSetRegSettings   ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_xbl_ZondaEkaPLLControl
 *
 * Control function array for the Zonda PLLs.
 */
HAL_clk_xbl_SourceControlType HAL_clk_xbl_ZondaekaPLLControl =
{
  .Enable           = HAL_clk_xbl_ZondaEkaPLLEnable,
  .IsEnabled        = HAL_clk_xbl_ZondaEkaPLLIsEnabled,
  .Config           = HAL_clk_xbl_ZondaEkaPLLConfig,
  .ConfigPLL        = HAL_clk_xbl_ZondaEkaPLLConfigPLL,
  .SetCalConfig     = HAL_clk_xbl_ZondaEkaPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_xbl_ZondaEkaPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLPostDivToHW
**
** ======================================================================== */

uint32_t HAL_clk_xbl_ZondaEkaPLLPostDivToHW (uint32_t nDivider)
{
  switch (nDivider)
  {
    case 0:
...
} /* END HAL_clk_xbl_ZondaEkaPLLPostDivToHW */

 
/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLEnable
**
...
bool HAL_clk_xbl_ZondaEkaPLLEnable
(
...
)
{
   ...
   */
  if (HAL_clk_xbl_ZondaEkaPLLIsEnabled(pSource))
  {
    return TRUE;
  }
...
} /* END of HAL_clk_xbl_ZondaEkaPLLEnable */


/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLIsEnabled
**
** ======================================================================== */

bool HAL_clk_xbl_ZondaEkaPLLIsEnabled
(
  HAL_clk_xbl_SourceDescType *pSource
)
{
...
} /* END HAL_clk_xbl_ZondaEkaPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLConfig
**
** ======================================================================== */

void HAL_clk_xbl_ZondaEkaPLLConfig
(
  HAL_clk_xbl_SourceDescType   *pSource,
...
} /* END HAL_clk_xbl_ZondaEkaPLLConfig */


/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLConfigPLLNormal
**
** ======================================================================== */

bool HAL_clk_xbl_ZondaEkaPLLConfigPLLNormal
(
  HAL_clk_xbl_SourceDescType      *pSource,
...
)
{
  ...
  nUserUVal |= HWIO_FVAL(PLL_USER_CTL_U, POST_DIV_CONTROL,
    HAL_clk_xbl_ZondaEkaPLLPostDivToHW(pConfig->PostDivs.Zonda.nMain));
...
} /* END HAL_clk_xbl_ZondaEkaPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLConfigPLL
**
** ======================================================================== */

bool HAL_clk_xbl_ZondaEkaPLLConfigPLL
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_xbl_ZondaEkaPLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_xbl_ZondaEkaPLLConfigPLL */


/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLSetCalConfig
**
** ======================================================================== */

bool HAL_clk_xbl_ZondaEkaPLLSetCalConfig
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_xbl_ZondaEkaPLLSetRegSettings
**
** ======================================================================== */

void HAL_clk_xbl_ZondaEkaPLLSetRegSettings
(
  HAL_clk_xbl_SourceDescType              *pSource,
...
} /* END HAL_clk_xbl_ZondaEkaPLLSetRegSettings */
