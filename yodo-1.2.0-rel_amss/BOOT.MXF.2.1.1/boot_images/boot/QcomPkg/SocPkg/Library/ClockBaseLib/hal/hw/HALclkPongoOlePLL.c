...
/*
 * HAL_clk_xbl_PongoOlePLLControl
 *
 * Control function array for the Pongo PLLs.
 */
HAL_clk_xbl_SourceControlType HAL_clk_xbl_PongoolePLLControl =
{
  ...
  .SetRegSettings   = HAL_clk_xbl_PongoOlePLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLPostDivToHW
**
** ======================================================================== */

uint32_t HAL_clk_xbl_PongoOlePLLPostDivToHW (uint32_t nDivider)
{
  if (nDivider)
  {
    nDivider--;
...
} /* END HAL_clk_xbl_PongoOlePLLPostDivToHW */


/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLPostDivFromHW
**
** ======================================================================== */

uint32_t HAL_clk_xbl_PongoOlePLLPostDivFromHW (uint32_t nDivider)
{
  return nDivider + 1;

} /* END HAL_clk_xbl_PongoOlePLLPostDivFromHW */



/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLEnable
**
** ======================================================================== */

bool HAL_clk_xbl_PongoOlePLLEnable
(
...
)
{
   ...
   */
  if (HAL_clk_xbl_PongoOlePLLIsEnabled(pSource))
  {
    return TRUE;
  }
...
} /* END HAL_clk_xbl_PongoOlePLLEnable */


/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLIsEnabled
**
** ======================================================================== */

bool HAL_clk_xbl_PongoOlePLLIsEnabled
(
  HAL_clk_xbl_SourceDescType *pSource
)
{
...
} /* END HAL_clk_xbl_PongoOlePLLIsEnabled */


/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLConfig
**
** ======================================================================== */

void HAL_clk_xbl_PongoOlePLLConfig
(
  HAL_clk_xbl_SourceDescType   *pSource,
...
} /* END HAL_clk_xbl_PongoOlePLLConfig */


/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLConfigPLLNormal
**
** ======================================================================== */

bool HAL_clk_xbl_PongoOlePLLConfigPLLNormal
(
  HAL_clk_xbl_SourceDescType      *pSource,
...
)
{
  ...
  /*
   * Bypass the reference clock to the outputs when the PLL is in STANDBY.
   */
  HAL_CLK_PLL_HWIO_OUTF(PLL_USER_CTL_U, pSource, XO_CLK_AT_OUT, 1);
  ...
  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_MAIN,
    HAL_clk_xbl_PongoOlePLLPostDivToHW(pConfig->PostDivs.Pongoole.nMain));

  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_EVEN,
    HAL_clk_xbl_PongoOlePLLPostDivToHW(pConfig->PostDivs.Pongoole.nEven));
...
} /* END HAL_clk_xbl_PongoOlePLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLConfigPLL
**
** ======================================================================== */

bool HAL_clk_xbl_PongoOlePLLConfigPLL
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_xbl_PongoOlePLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_xbl_PongoOlePLLConfigPLL */


/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLSetCalConfig
**
** ======================================================================== */

bool HAL_clk_xbl_PongoOlePLLSetCalConfig
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_xbl_PongoOlePLLSetRegSettings
**
** ======================================================================== */

void HAL_clk_xbl_PongoOlePLLSetRegSettings
(
  HAL_clk_xbl_SourceDescType              *pSource,
...
} /* END HAL_clk_xbl_PongoOlePLLSetRegSettings */
