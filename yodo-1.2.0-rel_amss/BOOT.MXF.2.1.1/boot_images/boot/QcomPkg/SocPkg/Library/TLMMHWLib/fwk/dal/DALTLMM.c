...
===========================================================================
             Copyright (c) 2010 - 2015, 2022 QUALCOMM Technologies Incorporated.
                    All Rights Reserved.
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/SocPkg/Library/TLMMHWLib/fwk/dal/DALTLMM.c#2 $
