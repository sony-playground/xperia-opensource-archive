...
bl_error_boot_type ramdump_table_target_unrecoverable_error_handler (void)
{
  ...
  do
  {
    ...
    edk2_cache_if->WriteBackInvalidateDataCacheRange((void *)SCL_RAMDUMP_DLOAD_BUFFERS_BASE,
    ...
    DALSYS_DeInitMod();
    edk2_cache_if->WriteBackInvalidateDataCacheRange((void *)Image$$RAMDUMP_DATA_RW$$Base,
                                                     (uintnt)Image$$RAMDUMP_DATA_RW$$Length);

    edk2_cache_if->WriteBackInvalidateDataCacheRange((void *)Image$$STACK$$Base,
