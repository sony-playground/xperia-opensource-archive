...
/*============================================================================
  ...
  $Header: //components/dev/core.boot/6.1/hadigal.core.boot.6.1.kai_pmic_adc_boot/QcomPkg/SocPkg/Kailua/Settings/ADC/loader/VAdcSettings.c#1 $
