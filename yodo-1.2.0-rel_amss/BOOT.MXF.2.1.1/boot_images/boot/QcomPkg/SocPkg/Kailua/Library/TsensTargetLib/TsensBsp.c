/*============================================================================
  ...
  OVERVIEW:     Auto-generated TSENS BSP
                * Chip: SM8550, version: all
                * Config file: TSENS_Kailua.xlsm, version: 13.0
...
static const TsensControllerCfgType gaTsensControllerCfgs[] =
{
   ...
   /* Controller 2 */
   {
      ...
      .bPWMEn                = FALSE,
      .pucTsensSROTPhys      = (uint8 *)TSENS2_REG_BASE_PHYS,
      .uTsensSROTSize        = TSENS2_REG_BASE_SIZE,
      .pucTsensTMPhys        = (uint8 *)TSENS2_TM_REG_BASE_PHYS,
      .uTsensTMSize          = TSENS2_TM_REG_BASE_SIZE,
      .pauTbcbReqs           = NULL,
      .uNumTbcbClients       = 0,
      .bWatchdogEn           = TRUE,
      .bWatchdogResetEn      = TRUE,
