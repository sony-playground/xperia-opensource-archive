...
uint32 HAL_tsens_GetBase1(boolean bUseRedundant, uint32 uController)
{
   if (!bUseRedundant)
   {
      switch (uController)
      {
         ...
         case 2:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW38_LSB, TSENS2_BASE0_4_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW38_MSB, TSENS2_BASE0_9_5) << 5);
         default:
            break;
      }
   }
...
uint32 HAL_tsens_GetBase2(boolean bUseRedundant, uint32 uController)
{
   if (!bUseRedundant)
   {
      switch (uController)
      {
         ...
         case 1:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW24_LSB, TSENS1_BASE1_1_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW24_MSB, TSENS1_BASE1_9_2) << 2);
         case 2:
...
uint32 HAL_tsens_GetOffset(boolean bUseRedundant, uint32 uFuseIdx)
{
   if (!bUseRedundant)
   {
      switch (uFuseIdx)
      {
         ...
         case 4:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW24_MSB, TSENS4_OFFSET_3_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW25_LSB, TSENS4_OFFSET_4) << 4);
         case 5:
         ...
         case 11:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW25_LSB, TSENS11_OFFSET_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW25_MSB, TSENS11_OFFSET_4_1) << 1);
         case 12:
         ...
         case 17:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW25_MSB, TSENS17_OFFSET_2_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW26_LSB, TSENS17_OFFSET_4_3) << 3);
         case 18:
         ...
         case 30:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW26_MSB, TSENS30_OFFSET_1_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS30_OFFSET_4_2) << 2);
         case 31:
         ...
         case 35:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS35_OFFSET);
         case 36:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS36_OFFSET_0) | (HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_MSB, TSENS36_OFFSET_4_1) << 1);
         case 37:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_MSB, TSENS37_OFFSET);
         case 38:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_MSB, TSENS38_OFFSET);
         case 39:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_MSB, TSENS39_OFFSET);
         case 40:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_MSB, TSENS40_OFFSET);
         default:
            break;
      }
   }
