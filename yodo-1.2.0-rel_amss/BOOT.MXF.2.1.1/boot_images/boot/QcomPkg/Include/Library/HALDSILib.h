...
-------------------------------------------------------------------------- */
/*
 * Defines list of DSI driver command flag bits
 */
typedef enum
{
  DSI_DISPLAY_CMDFLAG_NORETRY          = 0x00000001,
  DSI_DISPLAY_CMDFLAG_DMA_INTERLEAVED  = 0x00000002,
  DSI_DISPLAY_CMDFLAG_ASYNC            = 0x00000004,
  DSI_DISPLAY_CMDFLAG_NONEMBEDDED      = 0x00000008,
  DSI_DISPLAY_CMDFLAG_MAXPACKETSIZE    = 0x00000010,
  DSI_DISPLAY_CMDFLAG_DMA_SCHEDULE     = 0X00000080,
  DSI_DISPLAY_CMDFLAG_FORCE_32BIT      = 0x7FFFFFFF
} DSIDisplay_CmdFlags;
...
**   pPayload     - Context for the DSI commands to send.
**   uPayloadSize - Size for the DSI commands to send.
**   pReadData    - Data for the DSI read back.
**   pReadSize    - Size for the DSI read back.
**   eFlags       - DSI read flags.
**
** DESCRIPTION:
...
**
** DESCRIPTION:
**   Force calibration and get PLL codes
**
** ---------------------------------------------------------------------- */
