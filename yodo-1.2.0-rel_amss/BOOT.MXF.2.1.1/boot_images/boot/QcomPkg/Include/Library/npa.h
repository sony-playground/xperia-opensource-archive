 ...
 * @param state : Requested resource state
 */
void npa_batch_scalar_request( npa_batch_request_handle *handle, 
 ...
 */
void npa_batch_vector_request( npa_batch_request_handle *handle, 
                               npa_client_handle         client,
 ...
 * @param handle : Handle to batch being used
 */
void npa_issue_batch_request( npa_batch_request_handle handle );
