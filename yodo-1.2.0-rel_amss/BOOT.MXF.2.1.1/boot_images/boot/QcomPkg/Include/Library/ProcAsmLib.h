/** @file ProcAsmLib.h
  ...
  Copyright (c) 2012 - 2013, 2015, 2019 Qualcomm Technologies, Inc. All rights reserved. 
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 09/12/169  bd      CycleCnt reg type UINT32 to UINT64
 ...
 * Read CCNT Register
 */
UINT64 ReadCycleCntReg(void);

/*
 * Write CCNT Register
 */
void WriteCycleCntReg(UINT64 Val);
