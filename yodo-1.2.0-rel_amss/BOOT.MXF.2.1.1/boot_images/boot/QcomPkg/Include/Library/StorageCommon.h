...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 06/10/22   jt      Add UFS flush mask 
 09/23/21   sa      Add SPINOR profiling support.
...
#define UFS_PROFILE_FLUSH_BIT_MASK       (1<<8)
#define NOR_PROFILE_INIT_BIT_MASK        (1<<9)
#define NOR_PROFILE_READ_BIT_MASK        (1<<10)
#define NOR_PROFILE_WRITE_BIT_MASK       (1<<11)
#define NAND_PROFILE_INIT_BIT_MASK       (1<<12)
#define NAND_PROFILE_READ_BIT_MASK       (1<<13)
#define NAND_PROFILE_WRITE_BIT_MASK      (1<<14)
#define STOR_PROFILE_BENCHMARK_BIT_MASK  (1<<15)
#define SPINOR_PROFILE_INIT_BIT_MASK     (1<<16)
#define SPINOR_PROFILE_ERASE_BIT_MASK    (1<<17)
#define SPINOR_PROFILE_WRITE_BIT_MASK    (1<<18)
#define SPINOR_PROFILE_READ_BIT_MASK     (1<<19)


#ifdef STOR_PROFILE_ENABLE

  /* Events that are enabled for profiling - Modify based on the need */
  // #define STOR_PROFILE_BIT_MASK    (UFS_PROFILE_FLUSH_BIT_MASK|UFS_PROFILE_INIT_BIT_MASK|UFS_PROFILE_READ_BIT_MASK|UFS_PROFILE_WRITE_BIT_MASK|UFS_PROFILE_ERASE_BIT_MASK)
  #define STOR_PROFILE_BIT_MASK    (SPINOR_PROFILE_READ_BIT_MASK|SPINOR_PROFILE_WRITE_BIT_MASK|SPINOR_PROFILE_ERASE_BIT_MASK|SPINOR_PROFILE_INIT_BIT_MASK)
