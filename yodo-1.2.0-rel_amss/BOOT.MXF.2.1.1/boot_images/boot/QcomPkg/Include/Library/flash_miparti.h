...
DESCRIPTION
  ...
  Copyright (c) 2004-2009, 2012-2013, 2019-2020 Qualcomm Technologies Incorporated. 
  All Rights Reserved.
...
$Header: //components/rel/core.boot/6.1.1/QcomPkg/Include/Library/flash_miparti.h#1 $ $DateTime: 2022/08/18 10:15:46 $ $Author: pwbldsvc $
...
/*  This define can be changed from the inf file.
  ...
  be set to '48'. Else the value of 'FLASH_NUM_PART_ENTRIES' will
  be taken from the inf files.
 */

#ifndef FLASH_NUM_PART_ENTRIES
#define FLASH_NUM_PART_ENTRIES  48
#endif
