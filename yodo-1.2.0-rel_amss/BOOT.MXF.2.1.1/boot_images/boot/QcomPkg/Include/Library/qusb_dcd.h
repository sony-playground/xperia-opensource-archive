...
struct qusb_dcd_dsc_device {
  ...
  */
  ...
  //for setup transfers
  /*__QUSB_DMA_ZI__*/ uint8           setup_status[QUSB_MAX_CTRL_PKT_SIZE];
  /*__QUSB_DMA_ZI__*/ uint8           setup_data[QUSB_MAX_CTRL_PKT_SIZE];
  ...
  uint32                              shutdown_loop_iteration;  
};
 ...
 */
uint32 qusb_dcd_init(struct qusb_dcd_dsc_device* device);
