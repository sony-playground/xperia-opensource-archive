...
Copyright (c) 2021 Qualcomm Technologies, Inc All rights reserved.<BR>
...
//
/*
 This function will search every simpletxt device in the current system and update all console variables 
*/
