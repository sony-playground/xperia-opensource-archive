...
typedef struct
{
    ...
    uint8 min_shub_cp[MAX_NUM_CLOCK_PLAN_IDX];
    DDR_REGIONS_STRUCT ddr_regions[MAX_NUM_DDR_REGIONS];
} DDR_AOP_PARAMS;
...
#define AOP_PARAMS_MINOR_VERSION 0x8
