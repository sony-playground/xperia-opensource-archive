 ...
 *
 * Coldplug module.
 * Copyright (C) 2017-2018,2021,2022 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.1.1/QcomPkg/Include/api/storage/coldplug_api.h#2 $ $DateTime: 2022/09/15 10:32:02 $ $Author: pwbldsvc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2022-04-26   rn    Added is_boot_lun_present variable in coldplug_device_info
