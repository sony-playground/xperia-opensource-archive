 ...
 */
pm_err_flag_type 
pm_pbs_client_enable(uint8 pmic_device_index, pm_pbs_core_type pbs_core, pm_pbs_client_type client, boolean enable);
 ...
 */
pm_err_flag_type 
pm_pbs_client_enable_status(uint8 pmic_device_index, pm_pbs_core_type pbs_core, pm_pbs_client_type client, boolean *status);
 ...
 */
pm_err_flag_type 
pm_pbs_client_sw_trigger(uint8 pmic_chip, pm_pbs_core_type pbs_core, pm_pbs_client_type client, pm_pbs_client_trigger trigger, 
 ...
 */
pm_err_flag_type
pm_pbs_client_hw_trigger_enable(uint8 pmic_chip, pm_pbs_core_type pbs_core_index, pm_pbs_client_type pbs_client_index, 
