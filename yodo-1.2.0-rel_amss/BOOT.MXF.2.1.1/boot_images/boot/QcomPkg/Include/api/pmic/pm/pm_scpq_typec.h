#ifndef __PM_SCPQ_TYPEC_H__
#define __PM_SCPQ_TYPEC_H__

/*! \file
 *  \n
 *  \brief  pm_scpq_typec.h PMIC-SCPQ MODULE RELATED DECLARATION
 ...
 *  \n &copy; Copyright 2020-2021 QUALCOMM Technologies Inc, All Rights Reserved
 */
...
typedef enum
{
  PM_SCPQ_USB_TYPEC_VCONN_CONTROL_BY_HW,
  PM_SCPQ_USB_TYPEC_VCONN_DISABLE_BY_SW,
  PM_SCPQ_USB_TYPEC_VCONN_ENABLE_BY_SW = 0x03,
  PM_SCPQ_USB_TYPEC_VCONN_INVALID
}pm_scpq_usb_typec_vconn_enable_type;
...
}pm_scpq_usb_typec_vconn_ilimit;
...
}pm_scpq_usb_typec_vconn_ss_pd_ima;

typedef enum
{
  PM_TYPEC_DAM_ICL_3A,
  PM_TYPEC_DAM_ICL_FMB
}pm_scpq_usb_typec_dam_icl_sel;
 ...
 *
 * @param[in] pmic_index:   The pmic_index of charger module.
 * @param[in] status_type:  VCONN source type. Refer #pm_scpq_usb_typec_vconn_enable_type for details.
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *          version of the PMIC.
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_typec_vconn_enable(uint32 pmic_index, pm_scpq_usb_typec_vconn_enable_type enable_type);
 ...
 *
 * @param[in] pmic_index: The pmic_index of charger module.
 * @param[in] port_role:  USB type c port role type. Refer #pm_chg_typec_port_role_type for details.
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *          version of the PMIC.
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_typec_set_port_role(uint32 pmic_index, pm_chg_typec_port_role_type port_role);
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_typec_disable(uint32 pmic_index, boolean disable);
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_typec_enable_try_sink_mode(uint32 pmic_index, boolean enable);

/**
 * @brief This function configures debug access sink mode
 *
 * @param[in] pmic_index:  The pmic_index of charger module.
 * @param[in] enable:      enable/disable debug access sink mode
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *          version of the PMIC.
 ...
 *
 */
pm_err_flag_type pm_scpq_typec_en_dbg_access_snk(uint32 pmic_index, boolean enable);

/**
 * @brief This function configures Factory Mode Boot(FMB) mode
 *
 * @param[in] pmic_index:  The pmic_index of charger module.
 * @param[in] enable:      enable/disable Factory Mode Boot(FMB) mode.
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *          version of the PMIC.
 ...
 *
 */
pm_err_flag_type pm_scpq_typec_en_fmb(uint32 pmic_index, boolean enable);
