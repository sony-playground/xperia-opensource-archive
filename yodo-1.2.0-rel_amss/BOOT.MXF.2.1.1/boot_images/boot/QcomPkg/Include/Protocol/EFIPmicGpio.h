...
*/
/*=============================================================================
  Copyright (c) 2011-2019, 2022 Qualcomm Technologies, Incorporated.
  All rights reserved.
...
/** @ingroup efi_pm_gpio_ext_pin_config
  ...
  @param[in]  Gpio                 Which GPIO; see # EFI_PM_GPIO_PERIPH_INDEX
                                   for details.
  @param[in]  Set_Pull_Sel        Select the current source pulls type. Refer #EFI_PM_GPIO_I_SRC_PULL_TYPE for more info
...
(
 IN  UINT32                             PmicDeviceIndex,
 IN  EFI_PM_GPIO_PERIPH_INDEX           Gpio,
 IN  EFI_PM_GPIO_I_SRC_PULL_TYPE        Set_Pull_Sel
);
#endif /* FEATURE_XBOOT */
