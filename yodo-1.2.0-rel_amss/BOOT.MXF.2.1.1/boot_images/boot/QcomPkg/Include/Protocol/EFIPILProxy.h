...
#define PIL_EVENT_PRE_SHUTDOWN			  0x00000008    /* Event sent before TZ_PIL_UNLOCK_XPU_ID */
#define PIL_EVENT_POST_SHUTDOWN           0x00000010	/* Event sent after TZ_PIL_UNLOCK_XPU_ID */
