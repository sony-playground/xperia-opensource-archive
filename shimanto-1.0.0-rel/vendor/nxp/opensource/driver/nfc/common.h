...
#define DTS_ESIMDATA_GPIO_STR	"qcom,sn-esimdata"
#define DTS_ESIMCLK_GPIO_STR	"qcom,sn-esimclk"
#define DTS_ESIMRST_GPIO_STR	"qcom,sn-esimrst"
...
struct platform_gpio {
	...
	unsigned int esimdata;
	unsigned int esimclk;
	unsigned int esimrst;
};
