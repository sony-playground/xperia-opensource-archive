...
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/cs35l45/sound/soc/codecs/cirrus_cs35l45.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
...
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/cs35l45/sound/soc/codecs/cirrus_wm_adsp.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
...
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/cs40l25/drivers/misc/cirrus_cs40l2x.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
...
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/cs40l25/sound/soc/codecs/cirrus_cs40l2x_codec.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
