...
//struct dsi_reset_seq *sequence_touch;
	...
	int flm_mode;
	int br_adjust_type;
	int br_adjust_tp;       // brightness_max * TransitionPoint
	int br_adjust_min_lvl;
	int br_adjust_max_lvl;  // Max OS brightness level (with all white image)
	int br_adjust_peak_lvl; // Peak brightness level
};
