...
#define MAX_OEM_NOTIFY_EXTRA_DATA_SIZE	4
...
struct glink_oem_notify_msg {
	struct pmic_glink_hdr	hdr;
	u32			notification;
	u32			extra_data[MAX_OEM_NOTIFY_EXTRA_DATA_SIZE];
};
...
enum {
	/* Wireless charge notifications */
	NOTI_WLS_CHG_NEGOTIATION_END = 0,
	NOTI_WLS_CHG_NEGOTIATION_START,
	NOTI_WLS_RVSCHG_END,
	NOTI_WLS_RVSCHG_START,
	NOTI_WLS_RVSCHG_STOP_REASON_UNKNOWN,
	NOTI_WLS_RVSCHG_STOP_REASON_BATTERY_STATUS_FULL,
	NOTI_WLS_RVSCHG_STOP_REASON_THERMAL_MITIGATION,
	NOTI_WLS_RVSCHG_STOP_REASON_EXT,
	NOTI_WLS_RVSCHG_STOP_REASON_ERROR,
	NOTI_WLS_RVSCHG_RESUME,
	NOTI_WLS_RVSCHG_SUSPEND,
	/* FELS notifications */
	NOTI_FELS_DETECT_INVALID_BATTERY = 1000,
	NOTI_FELS_DETECT_PD_HARD_RESET,
	NOTI_FELS_DETECT_SOC_FREEZE_WARNING,
	NOTI_FELS_DETECT_SOC_FREEZE_ERROR,
	NOTI_FELS_DETECT_WLC_FW_UPDATE,
	NOTI_FELS_DETECT_WLC_MANY_ISR,
};
#define IS_NOTI_WLS(noti)	((noti) >= 0 && (noti) < 1000)
#define IS_NOTI_FELS(noti)	((noti) >= 1000 && (noti) < 2000)
