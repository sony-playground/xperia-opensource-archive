...
wget -P ${DOWNLOAD_PATH} https://github.com/sony/nnabla/archive/refs/tags/v1.0.18.zip
unzip ${DOWNLOAD_PATH}v1.0.18.zip -d ${DOWNLOAD_PATH}

cd ${DOWNLOAD_PATH}nnabla-1.0.18
