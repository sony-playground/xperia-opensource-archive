...
# Copyright 2016 Sony Corporation.<BR>
...
# SONY_BEGIN (section flag arrangement)
if(os.getenv('USES_FEATURE_XBOOT', None) == 'yes'):
    import sys
    print(os.getcwd())
    sys.path.append('SomcPkg/Tools/Python')
    from SectionArranger import *
# SONY_END (section flag arrangement)
