...
# Do not build qsh_wifi_test for kalama64 and pineapple
# kalama64 and pineapple does not have support for protobuf C APIs, which is
# referred by qsh_wifi_test and thus donot build/compile till the migration happens
# to use protobuf C++ APIs.
ifneq ($(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX),$(filter $(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX), kalama64 pineapple))
