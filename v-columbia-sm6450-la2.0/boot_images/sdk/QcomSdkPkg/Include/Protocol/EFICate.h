...
/** @ingroup EFI_CATE_MODIFY_TEST_ATTRIB_IN_JOBLIST
  @par Summary
...
typedef EFI_STATUS (EFIAPI *EFI_CATE_CHECK_JOBLIST_RESULT)(
  IN 		CONST CHAR8* 					JobListName,
