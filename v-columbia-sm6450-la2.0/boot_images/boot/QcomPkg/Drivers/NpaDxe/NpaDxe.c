/** @file NpaDxe.c
  ...
  Copyright (c) 2013-2015,2021 Qualcomm Technologies, Inc. All rights 
  reserved. 
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 05/27/21   amr      Added Support for Handling Batch Requests.
 ...
 *
 * @brief Issue a batch client work request
 *
 * Resource state should be updated to account for new request. 
 *  
 * @param client : Handle to client being used
 ...
 *  @return       EFI_SUCCESS
 */
static EFI_STATUS EFI_npa_issue_batch_request( 
                              npa_batch_request_handle   client)
{
    npa_issue_batch_request( client );
 ...
 *  @return       EFI_SUCCESS
 */
static EFI_STATUS EFI_npa_batch_vector_request(
                              npa_batch_request_handle *handle,
                              npa_client_handle         client,
                              unsigned int              num_elems,
                              npa_resource_state       *vector )
{
    npa_batch_vector_request( handle, client, num_elems, vector );
 ...
 *  @return       EFI_SUCCESS
 */
static EFI_STATUS EFI_npa_batch_scalar_request( 
                              npa_batch_request_handle  *handle,
                              npa_client_handle         client,
                              npa_resource_state        state )
{
    npa_batch_scalar_request( handle, client, state );
