...
VOID CPRMapRegions(VOID)
{
    ...
    // Netrani doesn't have MMCX rail, so skip MMCX controller Map Region for it
    if(CHIPINFO_FAMILY_NETRANI != DalChipInfo_ChipFamily()){
        BaseAddr = 0x00630000;
