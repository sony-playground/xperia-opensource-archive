/** @file AcpiPlatformTestFunc.c
  ...
  Copyright (c) 2013-2015,2019 Qualcomm Technologies Inc. All rights
  reserved. 
**/ 
...
)
{
  ...
  EFI_QCOM_ACPIPLATFORM_PROTOCOL *pEfiAcpiPlatformProtocol = NULL;
	...
	/* When RETAIL is enabled, the compiler throws an error since rest of code won't ever run.
