/** @file
  ...
  Copyright (c) 2010, 2012-2016, 2021, 2022 Qualcomm Technologies, Inc. All rights reserved. 
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 11/02/21   cm      support more modes
...
typedef struct {
  UINTN Columns;
  UINTN Rows;
} SIMPLE_CONSOLE_MODE_DATA;

SIMPLE_CONSOLE_MODE_DATA mSimpleConsoleModeData[] = {
  //
  //This is a super set of all possibile mode expected to be supported by display
  //in MTP's CRD's
  {80, 25}, // 640x480 CRD
  {80, 50},
  {80, 18}, // 640x360
  ...
  {128, 40}, // 1024x768
  {144, 40}, // 1152x768
  {153,140}, // 1224x2664 - Need to be revisited
  {160, 40}, // 1280x768
  {160, 56}, // 1280x1080
  {160, 53}, // 1280x1024
  {170, 40}, // 1366x768 or 1360x768
  {180,134}, // 1440x2560
  {180,168}, // 1440x3200
  {200, 47}, // 1600x900
  {240, 56}, // 1920x1080
...
#define MAX_MODE                  sizeof(mSimpleConsoleModeData)/sizeof(mSimpleConsoleModeData[0])
  ...
  )
{
  ...
  *Columns = mSimpleConsoleModeData[ModeNumber].Columns;
  *Rows = mSimpleConsoleModeData[ModeNumber].Rows;
  return EFI_SUCCESS;
}
