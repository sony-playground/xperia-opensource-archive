...
/*
  ...
  Copyright (c) 2020, 2022 QUALCOMM Technologies Incorporated.  All Rights Reserved.
  QUALCOMM Proprietary and Confidential.

  ====================================================================

  $Header: //components/rel/core.boot/6.0/QcomPkg/Drivers/ClockDxe/ClockSources.c#3 $
  $DateTime: 2022/01/26 20:36:45 $
  $Author: pwbldsvc $
...
)
{
  ...
  /*
   * Request MOL (minimum operating level) for the rail
   * before accessing the source HW.
   */
