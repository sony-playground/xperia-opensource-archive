...
/*
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Drivers/ClockDxe/ClockDriverImage.h#3 $
...
** =========================================================================*/
/*
  Initate the sequence to put Image's Processor into low-power/sleep state.

  Parameters Description:

  @param hClient [in] - Handle to the client.
  @param eMode   [in] - Processor Sleep mode.
  @param nFlags  [in] - Flags for this client. 

  Return Value:

  @return
  CLOCK_SUCCESS -- sequence completed succesfully.
*/
...
** =========================================================================*/
/*
  Initate the sequence to bring back Image's Processor from low-power/sleep state.
