...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 09/10/21   am      Removed support for DDIClock Interface and DAL reated stuff.
...
EFI_STATUS EFI_GetClockDividerID(IN EFI_CLOCK_PROTOCOL *This,
...
/**
  Looks up a Clock Divider ID for a specified clock divider.

  This function takes the name of a clock divider and returns a handle that
  can be used for making requests on that divider. This function programs the 
  divider for a specified clock. This functionality only applies to a small subset 
  of clocks that have independent dividers off the main domain.

  @param[in]  This               Pointer to the EFI_CLOCK_PROTOCOL instance.
  @param[in]  ClockDividerName   String name of the divider
  @param[out] ClockDividerId     Pointer where to fill in the divider ID.
