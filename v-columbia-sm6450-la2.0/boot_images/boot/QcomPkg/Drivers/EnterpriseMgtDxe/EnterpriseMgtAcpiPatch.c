...
=============================================================================*/
/*=============================================================================
 $Header: //components/rel/core.boot/6.0/QcomPkg/Drivers/EnterpriseMgtDxe/EnterpriseMgtAcpiPatch.c#1 $
                              EDIT HISTORY
    ...
    )
{
        ...
        (pPolicy->NumberOfHlosDevices <= MAX_HLOS_MANAGED_DEVICES) )
    {
        ...
        for (i = 0; i < pPolicy->NumberOfHlosDevices; i++)
        {
            ...
            memcpy(ppDeviceNameList[i], pPolicy->HlosDeviceList[i].DeviceName, MAX_DEVICE_NAME_SIZE);
