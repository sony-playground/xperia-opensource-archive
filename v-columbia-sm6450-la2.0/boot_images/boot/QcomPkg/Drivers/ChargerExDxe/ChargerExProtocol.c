...
)
{
  ...
  if((EFI_PLATFORMINFO_TYPE_CDP == PlatformType) || (EFI_PLATFORMINFO_TYPE_CLS == PlatformType))
  {
    DEBUG(( EFI_D_WARN, "ChargerExProtocol:: %a CDP/CLS (%d) Platform detected. No Battery information available. \r\n", __FUNCTION__, PlatformType));
    return EFI_UNSUPPORTED;
  }
...
)
{
  ...
  {
    DEBUG(( EFI_D_WARN, "ChargerExProtocol:: %a CLS (%d) Platform detected. No Battery information available. \r\n", __FUNCTION__, PlatformType));
    return EFI_UNSUPPORTED;
  }
...
)
{
  ...
  *bOffModeCharging = FALSE;
  ...
  {
    DEBUG(( EFI_D_WARN, "ChargerExProtocol:: %a CDP (%d) Platform detected. No Battery information available. \r\n", __FUNCTION__, PlatformType));
    return EFI_UNSUPPORTED;
  }
