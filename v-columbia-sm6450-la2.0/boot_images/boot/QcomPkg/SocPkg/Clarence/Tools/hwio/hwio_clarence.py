...
#===========================================================================
#
#  @file hwio_clarence.py
#  @brief HWIO config file for the HWIO generation scripts for Clarence.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_clarence.py --flat=ARM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
if __name__ == "__main__":
  ...
  #hwio_path = r'\\hw-skondoju-hyd\Dropbox\tools\hwio\HWIOGen.py'
