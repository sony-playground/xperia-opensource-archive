...
/**
    ...
    Reference chip release:
        SM8450 (Clarence) [clarence_v1.0_p3q1r10.4_rtl_partition_F02]
...
/*
  ...
  $Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Include/gsihwio.h#1 $
