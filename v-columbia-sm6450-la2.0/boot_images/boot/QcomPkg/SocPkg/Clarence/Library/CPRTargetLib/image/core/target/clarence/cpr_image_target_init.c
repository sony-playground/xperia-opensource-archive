 ...
 * $Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Library/CPRTargetLib/image/core/target/clarence/cpr_image_target_init.c#1 $
 * $Change: 36920166 $
 */
#include <string.h>
#include "cpr_logs.h"
