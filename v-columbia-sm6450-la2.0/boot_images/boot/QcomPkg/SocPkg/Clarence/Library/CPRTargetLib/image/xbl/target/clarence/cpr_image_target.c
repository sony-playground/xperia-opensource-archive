 ...
 * $Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Library/CPRTargetLib/image/xbl/target/clarence/cpr_image_target.c#1 $
 * $Change: 36920166 $
 */
...
{
    extern const cpr_settings cpr_settings_clarence;
...
void cpr_externalize_state()
{
    ...
    cpr_smem_serialize_settings(cpr_utils_get_rail_state( CPR_RAIL_NAV_LDO),
            true );
    cpr_smem_serialize_config( cpr_utils_get_rail_state( CPR_RAIL_WLAN),
            true );
...
{
    uint8 device_vpId = (CPR_HWIO_IN(HWIO_QFPROM_CORR_QC_SPARE_0_LSB_ADDR) & HWIO_QFPROM_CORR_QC_SPARE_0_LSB_SW_SPT_GLOBAL_RAILS_VPID_BMSK) >> HWIO_QFPROM_CORR_QC_SPARE_0_LSB_SW_SPT_GLOBAL_RAILS_VPID_SHFT ;
