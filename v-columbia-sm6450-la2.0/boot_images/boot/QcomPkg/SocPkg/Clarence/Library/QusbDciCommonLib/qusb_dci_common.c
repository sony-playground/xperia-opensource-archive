...
static uint8 qusb_dci_eud_reg_addr[QUSB_EUD_TUNE_TABLE_SIZE] =
{
  ...
  USB2PHY_OFF( HWIO_USB2PHY_USB_PHY_PARAMETER_OVERRIDE_X0_ADDR         ),  // 0xE6,
  USB2PHY_OFF( HWIO_USB2PHY_USB_PHY_PARAMETER_OVERRIDE_X1_ADDR         ),  // 0x0B,
  USB2PHY_OFF( HWIO_USB2PHY_USB_PHY_PARAMETER_OVERRIDE_X2_ADDR         ),  // 0x17,
