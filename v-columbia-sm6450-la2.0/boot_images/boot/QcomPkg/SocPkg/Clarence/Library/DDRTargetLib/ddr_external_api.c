...
DESCRIPTION:  
  ...
  Copyright (c) 2014, 2017, 2020-2021 QUALCOMM Technologies Incorporated.  All Rights Reserved.  
...
/* ============================================================================
**  Function : ddr_external_system_reset_type
** ============================================================================
*/
/*!
*   @brief
*   This function is called by external library before calling DDRSS initialization sequence
*   
*   @details
*   This api will be called by SNS library to determine if the boot is post normal Cold Reset or WMM
*   
*   @param 
*   @param None
*   
...
*   
*   @retval  boolean
*   return TRUE if boot after Chromebook reset, else FALSE
*   
*   @sa None
*/ 
#ifdef QCLIB_IMAGE

boolean ddr_external_system_reset_type() 
  { 
 /* if (HWIO_INF(AOSS_CC_RESET_DEBUG_ENABLE, WMM_MODE_EN) == 1)  
    {
...
/* ===========================================================================
* FUNCTION ddr_external_Get_Frequency_Limit_info

* DESCRIPTION
*   @brief
*   This function is called to get the DDR Fmax supported SKU Type
*   
*   LPDDR5-
*   0 -> 3.2 GHz
*   1 -> 2.75 GHz
...
*   None
*
*   @retval  DDR Fmax SKU Type
*
*   @sa None
*
===========================================================================*/
boolean ddr_external_Get_Frequency_Limit_info(void)
{
  if(((ddr_shared_data->device_params.device_type == DDR_TYPE_LPDDR4X) && (HWIO_INF(QFPROM_CORR_FEATURE_CONFIG_ROW6_LSB , DDR4_FREQ_SEL) == 0x1)) ||
    ((ddr_shared_data->device_params.device_type == DDR_TYPE_LPDDR5) && (HWIO_INF(QFPROM_CORR_FEATURE_CONFIG_ROW6_LSB , DDR5_FREQ_SEL) == 0x1)))
  {
    return TRUE;
  }
  return FALSE;             
...
/* ===========================================================================
* FUNCTION ddr_external_Get_DDR_Accessibility_Limit_Info
* DESCRIPTION
*   @brief
*   This function is called to get the DDR addressibility supported SKU Type
*   LPDDR5-
*   0 -> No limt
*   1 -> 12GB
*
...
*   None
*
*   @retval  DDR addressibility SKU Type
*
*   @sa None
* ===========================================================================*/
boolean ddr_external_Get_DDR_Accessibility_Limit_Info(void)
{
  if(((ddr_shared_data->device_params.device_type == DDR_TYPE_LPDDR4X) && (HWIO_INF(QFPROM_CORR_FEATURE_CONFIG_ROW6_LSB, DDR4_ADDRESSIBLITY_LIMIT) == 0x1)) ||
    ((ddr_shared_data->device_params.device_type == DDR_TYPE_LPDDR5) && (HWIO_INF(QFPROM_CORR_FEATURE_CONFIG_ROW6_LSB, DDR5_ADDRESSIBLITY_LIMIT) == 0x1)))
  {
    return TRUE;
  }
  return FALSE;
...
/* ===========================================================================
* FUNCTION ddr_external_Get_Chromebook_Sku_Info
* DESCRIPTION
*   @brief
*   This function is called to get the Chromebook SKU Type
*
*   0 -> Default
*   1 -> Chromebook
*
...
*   None
*
*   @retval  DDR Chromebook SKU Type
*
*   @sa None
* ===========================================================================*/
boolean ddr_external_Get_Chromebook_Sku_Info(void)
{

//#ifndef RUMI
//Read Chromebook Fuse and update DDR_FW_PTR (It will be used inside DSF)
/*   if(HWIO_INF (FEATURE_CONFIG_M7, CHROME_SKU) == 0x1)
  {
    //pGlobal_Config->gConfig.ddr_cfg.ddr_cfg.cb_sku = 0x1;
    return TRUE;
  }
  return FALSE */;
//#else
  //HAL_EXT_CORE_SW_DDR_printf(DDR_BOOTLOG, "VVDRV_ddr_init WARNING: This is an UNFUSE part. Overriding Fuse based on cb_sku(see ddr_param.cmm)\n");
  /*if(pGlobal_Config->gConfig.ddr_cfg.ddr_cfg.cb_sku)
  {
    return TRUE;
  }*/
  //return FALSE;
...
/* ===========================================================================
* FUNCTION ddr_external_Get_Warm_Mission_Mode_Info
* DESCRIPTION
*   @brief
*   This function is called to get the WMMM enable/disable status
*
*   0 -> Default
*   1 -> Enabled
*
...
*   @sa None
* ===========================================================================*/
boolean ddr_external_Get_Warm_Mission_Mode_Info(void)
{
/*   if(HWIO_INF(AOSS_CC_RESET_DEBUG_ENABLE, WMM_MODE_EN) == 0x1)
  {
    return TRUE;
  } */
  return FALSE;
...
(
  ...
  uint32 ddi_data_offfset // START_IN_DDR + offset 
)
{
