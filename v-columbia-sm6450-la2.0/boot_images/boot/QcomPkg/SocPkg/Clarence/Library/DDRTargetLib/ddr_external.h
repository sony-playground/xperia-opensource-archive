 ...
 ******************************************************************************/
/*==============================================================================
$Header: //components/dev/core.boot/6.0/sdasaroj.core.boot.6.0.dev_dsf30/QcomPkg/SocPkg/Clarence/Library/DDRTargetLib/ddr_external.h#2 $
$DateTime: 2022/05/19 20:17:48 $
$Author: sdasaroj $
================================================================================*/
#include "HALcomdef.h"
...
#else
	static inline void ddr_external_Get_Frequency_Limit_info(void)
	{
		return;
	}
#endif 
...
#else
	static inline void ddr_external_Get_DDR_Accessibility_Limit_Info(void)
	{
		return;
	}
#endif 
...
#else
	static inline void ddr_external_Get_Chromebook_Sku_Info(void)
	{
		return;
	}
#endif
...
#else
	static inline void ddr_external_Get_Warm_Mission_Mode_Info(void)
	{
		return;
	}
#endif
...
#if defined DSF_WMM_SUPPORTED
//CHROMEBOOK RESET MODE CHANGE
/* ============================================================================
...
*   
*   @details
*   This api will be called by SNS library to determine if the boot is post normal Cold Reset or Chromebook Reset(WMM)
*   
*   @param 
*   @param None
*   
...
#else 
  static inline boolean ddr_external_system_reset_type() 
  { 
    return FALSE; 
  } 
#endif
