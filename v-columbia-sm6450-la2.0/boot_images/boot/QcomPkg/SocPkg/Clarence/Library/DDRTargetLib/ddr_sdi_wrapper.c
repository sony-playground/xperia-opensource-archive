...
$Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Library/DDRTargetLib/ddr_sdi_wrapper.c#1 $
...
================================================================================
                   Copyright 2018,2020 Qualcomm Technologies Incorporated
                              All Rights Reserved
...
{ 
  ...
  {    
	...
	if(!HWIO_DPCC_PHY_CFG_MCGDSCR_INM(HWIO_DPCC_PHY_CFG_MCGDSCR_PWR_ON_BMSK)) )
	{
    ...
    if (!freeze_io_status) 
    {
	  if (HWIO_INF(MC_BROADCAST_ORCABO_SHKE_SELF_REFRESH_STATUS , WDOG_SELF_REFRESH))
	  {
