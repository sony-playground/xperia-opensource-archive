...
/*==============================================================================
                                  MACROS
==============================================================================*/
#define SDI_REG_LOG_START_ADDR 0x146AA200
#define SDI_DDR_IMEM_START_ADDR 0x146AA190

#define SDI_COOKIES_STRUCT_BASE 0x146AA610
#define PASS1_ENTER_COOKIE      0x146AA634
#define PASS2_COOKIE            0x146AA638
#define PASS1_EXIT_COOKIE       0x146AA63C
/*==============================================================================
                                  DATA
==============================================================================*/
...
typedef enum
{
  ...
  DPCC_PHY_GDSCR_PWR_ON_SET = 0xCAB01111,
  DPCC_PHY_GDSCR_PWR_ON_NOT_SET = 0xCAB00000,
