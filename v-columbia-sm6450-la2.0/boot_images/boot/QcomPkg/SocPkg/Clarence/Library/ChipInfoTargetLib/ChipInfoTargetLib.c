...
================================================================================
  ...
  $Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Library/ChipInfoTargetLib/ChipInfoTargetLib.c#1 $
...
void ChipInfo_UpdateDisabledCPUsToDDRLocation(void)
{
   ...
   * storing the disabled CPUs info at 0x808F4000 which is used by cpucp and cpusys-vm
   ...
   */
  outpdw(0x808F4000, aCPUClusters[0]);
  
  WriteBackInvalidateDataCacheRange((void*)0x808F4000, 0x1000);
}
...
void ChipInfo_InitChipset(ChipInfoCtxtType *pChipInfoCtxt)
{
  ...
  if (DisabledBins & CHIPINFO_SUBBIN_GROUP('E'))
  {
