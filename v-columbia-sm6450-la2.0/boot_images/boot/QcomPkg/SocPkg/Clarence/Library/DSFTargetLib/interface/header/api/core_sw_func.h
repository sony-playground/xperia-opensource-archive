 ...
 ******************************************************************************/
/*==============================================================================
$Header: //components/dev/core.boot/6.0/sdasaroj.core.boot.6.0.dev_dsf30/QcomPkg/SocPkg/Clarence/Library/DSFTargetLib/interface/header/api/core_sw_func.h#2 $
...
boolean EXT_CORE_SW_Get_Frequency_Limit_info(void);
boolean EXT_CORE_SW_Get_DDR_Accessibility_Limit_Info(void);
