 ...
 ******************************************************************************/
/*==============================================================================
$Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Library/DSFTargetLib/interface/header/itf_ds/ddr_ioctl.h#1 $
...
typedef enum
{
    ...
    IOCTL_CMD_MTE_EN_DIS                            = 3,         /**< Cmd to enable disable MTE feature */
