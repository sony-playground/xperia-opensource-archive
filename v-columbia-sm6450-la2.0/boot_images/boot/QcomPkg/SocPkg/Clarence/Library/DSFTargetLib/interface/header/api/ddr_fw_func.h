 ...
 ******************************************************************************/
/*==============================================================================
$Header: //sve/convex/release/clarence/v1/convex_2022_05_27_ver_04.00/convex/drivers/ddr/platform/clarence/src/DDRSS_SNS_V4/interface/header/api/ddr_fw_func.h#1 $
...
int DDR_FW_eCDT_lp4_Get_Interface_Parameter_Values(uint8 clk_idx, uint32 *buffer_ptr, size_t size);
int DDR_FW_eCDT_lp5_Get_Interface_Parameter_Values(uint8 clk_idx, uint32 *buffer_ptr, size_t size);
int DDR_FW_eCDT_lp5_Get_AC_Timing_Values(uint32 *buffer_ptr, size_t size);
int DDR_FW_eCDT_lp4_Get_AC_Timing_Values(uint32 *buffer_ptr, size_t size);
...
int DDR_FW_eCDT_lp5_Get_Safe_Mode_Values(uint32 *buffer_ptr, size_t size);
int DDR_FW_eCDT_lp4_Get_Safe_Mode_Values(uint32 *buffer_ptr, size_t size);
