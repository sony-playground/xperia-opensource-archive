...
$Header: //sve/convex/release/clarence/v1/convex_2022_05_27_ver_04.00/convex/drivers/ddr/platform/clarence/src/DDRSS_SNS_V4/core_sw/src/core_sw.c#1 $
...
void CORE_SW_Set_PASR_DDR_INFO_TABLE(DDR_SHARED_STRUCT *ddr_shared_ptr)
{
    ...
    for(ch = 0; ch < MAX_IDX; ch++) //nagarwal - Cedros change
    {
