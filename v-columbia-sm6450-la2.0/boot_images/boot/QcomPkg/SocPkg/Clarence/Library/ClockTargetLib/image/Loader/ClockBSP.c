...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM4450v1 (clarence_1.0):
      PLL_HSR   : 3.0
      AOSS_CC   : clarence_aoss_cc_z_aoss_cc_5.7.1_p3q3r6.7_fp4 [clarence_aoss_cc.r2]
...
{
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 77   }, },
};

/*
 * ClockSourceBSP_APSSCC_APSSCCPLL1
 *
 * Used by:
 *   ClockSource_APSSCC_APSSCCPLL1
 */
static const ClockSourceFreqConfigType ClockSourceBSP_APSSCC_APSSCCPLL1[] =
{
...
{
  { { 0x0000C000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 43   }, },
};
...
{
  .nFlags                     = 0x0,
  .aBSP                       = ClockSourceBSP_APSSCC_APSSCCPLL1,
  .nBSPLen                    = SIZEOF_ARRAY(ClockSourceBSP_APSSCC_APSSCCPLL1),
  .nConfigMask                = 0x0,
  .nAddr                      = HWIO_ADDR(GOLD_APCS_CPU_PLL_MODE),
  .pmControl                  = &HAL_clk_xbl_ZondaevoV2PLLControl,
  .pCalibrationFreqConfig     = ClockSourceBSP_APSSCC_APSSCCPLL1,
  .nCalibrationFreqConfigLen  = SIZEOF_ARRAY(ClockSourceBSP_APSSCC_APSSCCPLL1),
  .pRegSettings               = ClockSourceRegSettings_APSSCC_APSSCCPLL0,
  .nRegSettingsLen            = SIZEOF_ARRAY(ClockSourceRegSettings_APSSCC_APSSCCPLL0),
};
...
{
  { 1209600000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 4 /* ClockSource_APSSCC_APSSCCPLL2 */        ,  0 /* 1209.0  Mhz */ ,  },   /* Mux[2] = APSS_CC_PLL2_OUT_EARLY */
};
...
{
  { 1478400000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 2 /* ClockSource_APSSCC_APSSCCPLL0 */        ,  0 /* 1478.0  Mhz */ ,  },   /* Mux[2] = APSS_CC_PLL0_OUT_EARLY */
};
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 15 /* ClockSource_XO */                      ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC1APPS[] =
{
  ...
  {  192000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 3,     4,     0,     0,     0xFF }, 7 /* ClockSource_GCC_GCCGPLL10 */            ,  0 /* 384.0   Mhz */ ,  },   /* Mux[3] = GCC_GPLL10_OUT_MAIN_PWRGRP0_CLKGEN_ACGC_CLK */
  {  384000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 3,     2,     0,     0,     0xFF }, 7 /* ClockSource_GCC_GCCGPLL10 */            ,  0 /* 384.0   Mhz */ ,  },   /* Mux[3] = GCC_GPLL10_OUT_MAIN_PWRGRP0_CLKGEN_ACGC_CLK */
};
...
{
  {  403000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     4,     0,     0,     0xFF }, 9 /* ClockSource_GCC_GCCGPLL4 */             ,  0 /* 806.0   Mhz */ ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN_PWRGRP1_CLKGEN_ACGC_CLK */
};
...
static uint32_t aBranchEnable[] =
{
  ...
  //HWIO_ADDR(GCC_AGGRE_CNOC_PERIPH_EAST_AHB_CBCR), /* Open clock */
  ...
  //HWIO_ADDR(GCC_AGGRE_NOC_AXI_CBCR), /* Open clock */
  // HWIO_ADDR(GCC_AGGRE_NOC_CENTER_AXI_CBCR), /* Defaults on. */
 // HWIO_ADDR(GCC_AGGRE_NOC_EAST_AXI_CBCR), /* Open clock */
  //HWIO_ADDR(GCC_AGGRE_NOC_EAST_TUNNEL_ASYNC_BRIDGE_CENTER_CBCR),/* Open Clock */
  //HWIO_ADDR(GCC_AGGRE_NOC_EAST_TUNNEL_CBCR), /* Open Clock */
  ...
  // HWIO_ADDR(GCC_AGGRE_NOC_SOUTH_CENTER_AXI_CBCR), /* Defaults on. */
  ...
  HWIO_ADDR(GCC_AGGRE_NOC_VIDEO_SF_AXI_CBCR),
  //HWIO_ADDR(GCC_AGGRE_NOC_WEST_TUNNEL_ASYNC_BRIDGE_CENTER_CBCR), /* Open Clock. */
  ...
  // HWIO_ADDR(GCC_CFG_NOC_AHB2PHY_NORTH_XO_CBCR), /* Defaults on. */
  ...
  //HWIO_ADDR(GCC_CFG_NOC_SOUTH_ASYNC_BRIDGE_CENTER_AHB_CBCR),  /* Open Clock. */
  ...
  //HWIO_ADDR(GCC_CNOC_PCIE_QX_CBCR), /* open clock */
  // HWIO_ADDR(GCC_CNOC_PERIPH_CBCR), /* Defaults on. */
  //HWIO_ADDR(GCC_CNOC_PERIPH_EAST_CBCR), /*Open Clock */
  ...
  //HWIO_ADDR(GCC_CNOC_SOUTH_CENTER_QX_CBCR),  /*Open Clock */
  // HWIO_ADDR(GCC_CNOC_SOUTH_QX_CBCR), /* Defaults on. */
  //HWIO_ADDR(GCC_CNOC_WLAN_AXI_CBCR), /*Open Clock */
  //HWIO_ADDR(GCC_CPUSS_CONFIG_NOC_SF_CBCR), /*Open Clock */
  HWIO_ADDR(GCC_DCC_AHB_CBCR),
  HWIO_ADDR(GCC_DDR_XO_CBCR),
  HWIO_ADDR(GCC_VIDEO_XO_CBCR),
  ...
  //HWIO_ADDR(GCC_NOC_EAST_DCD_XO_CBCR), /* Open Clock */
...
static HAL_clk_xbl_RegisterMaskType aBranchVote[] =
{
   ...
   * gcc_ddrss_wpss_axi_clk  Open Clock 
   * gcc_q6_noc_mss_q6_axi_clk  Open Clock
   * gcc_q6_noc_wpss_axi_clk
   */
   { HWIO_ADDR(GCC_BOOT_CLK_BRANCH_ENA_VOTE_2), 0x182000 },
};
