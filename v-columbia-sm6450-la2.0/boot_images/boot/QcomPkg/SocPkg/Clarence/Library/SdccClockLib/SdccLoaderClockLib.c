...
----------   ---     ----------------------------------------------------------- 
2022-04-14   ssb     Added sdcc2 clock info
2021-04-01   jt      Add delay before disabling clocks
...
sdcc_disable_mclk (UINT32 driveno)
{
   ...
   // Add 10ms delay before disabling the clocks, otherwise USB enumeration fails during ramdump
   // when SD card is not present
   sdcc_bsp_busy_wait(10000); 
