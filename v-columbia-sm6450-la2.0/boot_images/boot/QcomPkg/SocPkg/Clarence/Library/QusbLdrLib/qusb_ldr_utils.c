...
//============================================================================
/**
  Copyright (c) 2015-2019,2021,2022 Qualcomm Technologies, Inc. All rights reserved.
...
#define QUSB_DCI_PMI_INDEX                        (8)  /* For PMIC_I, Tioman PMIC is used for Clarence*/
...
static pm_chg_charger_port_type qusb_ldr_utils_get_chgr_type(void)
{
  ...
  if (pm_err != PM_ERR_FLAG_SUCCESS) {
  	qusb_uart_log("Get PMIC index failed, Hence using default PMIC index", 0);
