...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM4450v1 (clarence_1.0):
      PLL_HSR   : 3.0
      APSS_CC   : clarence_apss_cc_clarence_1.0_apss_p3q2r97_fp17 [clarence_apss_cc.r6]
      CAM_CC    : clarence_cam_cc_z_cam_cc_clarence_1.0_p3q3r25_fp8 [clarence_cam_cc.r2]
      DISP_CC   : clarence_disp_cc_z_disp_cc_clarence_1.0_p3q3r20_fp5 [clarence_disp_cc.r1]
      GCC       : clarence_gcc_z_clarence_clk_ctl_1.0_p3q3r39_fp13 [clarence_gcc.r11]
      GPU_CC    : clarence_gpu_cc_z_gpu_cc_clarence_1.0_p3q3r29_fp13 [clarence_gpu_cc.r1]
...
{'db_override': {'APSS_CC': {'cbc': {'apcs_silver_post_acd_clk': {'d_sw_owner': {'APCS': 'RW'}}}},
                 'GCC': {'cbc': {'gcc_eusb3_0_clkref_en': {'d_registers': {'cbcr_name': 'GCC_EUSB3_0_CLKREF_EN'},
                                                           'd_sw_owner': {'APCS': 'RW'},
                                                           'l_master': ['bi_tcxo']},
 ...
 'generators': [{'options': {'clock_flags': {'gcc_pcie_0_pipe_clk_src': ['DOMAIN_FORCE_SETTINGS']},
                 ...
                 'output_dir': 'clarence_output_dir',
                 'type': 'dalclock'}],
 'target': ['clarence']}
 ...
 */
extern HAL_clk_DebugMuxControlType        HAL_clk_DebugMuxControlAPSSCC_clarence;
extern HAL_clk_DebugMuxControlType        HAL_clk_DebugMuxControlCAMCC_clarence;
extern HAL_clk_DebugMuxControlType        HAL_clk_DebugMuxControlDISPCC_clarence;
extern HAL_clk_DebugMuxControlType        HAL_clk_DebugMuxControlGCC_clarence;
extern HAL_clk_DebugMuxControlType        HAL_clk_DebugMuxControlGPUCC_clarence;
...
static ClockDebugMuxType ClockDebugMux_GCC =
{
  ...
  .nDivider     = 2,
  .HALDebugMux  = {
    .pmControl  = &HAL_clk_DebugMuxControlGCC_clarence,
  },
};
...
static ClockDebugMuxType ClockDebugMux_APSSCC =
{
  ...
  .HALDebugMux  = {
    .pmControl  = &HAL_clk_DebugMuxControlAPSSCC_clarence,
  },
};
...
static ClockDebugMuxType ClockDebugMux_CAMCC =
{
  ...
  .nDivider     = 2,
  .HALDebugMux  = {
    .pmControl  = &HAL_clk_DebugMuxControlCAMCC_clarence,
  },
};
...
static ClockDebugMuxType ClockDebugMux_DISPCC =
{
  ...
  .nDivider     = 4,
  .HALDebugMux  = {
    .pmControl  = &HAL_clk_DebugMuxControlDISPCC_clarence,
  },
};
...
static ClockDebugMuxType ClockDebugMux_GPUCC =
{
  ...
  .nDivider     = 2,
  .HALDebugMux  = {
    .pmControl  = &HAL_clk_DebugMuxControlGPUCC_clarence,
  },
};
...
{
  {  680000000, &ClockSource_XO, { 0, 0, 1, 35,  0x00006AAA, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS,       },
  { 1000000000, &ClockSource_XO, { 0, 0, 1, 52,  0x00001555, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS,       },
  { 1210000000, &ClockSource_XO, { 0, 0, 1, 63,  0x00000555, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS_L1,    },
  { 1530000000, &ClockSource_XO, { 0, 0, 1, 79,  0x0000B000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_NOM,       },
  { 1700000000, &ClockSource_XO, { 0, 0, 1, 88,  0x00008AAA, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_NOM,       },
  { 1910000000, &ClockSource_XO, { 0, 0, 1, 99,  0x00007AAA, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_TUR,       },
  { 2020000000, &ClockSource_XO, { 0, 0, 1, 105, 0x00003555, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_TUR,       },
};
...
{
  {   19200000, &ClockSource_CAMCC_CAMCCPLL2,             { 4,     2,     1,     50,    0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[4] = CAM_CC_PLL2_OUT_MAIN */
  {   24000000, &ClockSource_CAMCC_CAMCCPLL2,             { 4,     20,    1,     4,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[4] = CAM_CC_PLL2_OUT_MAIN */
...
/*
 * ClockDomainBSP_GCC_GCCQUPV3WRAP0S1
 *
 * Note: These frequencies are used by domains possibly under DFS control. The
 *       DFS-enable state will be detected during init. If under DFS control,
 *       the domain will dynamically allocate its own BSP array and populate
 ...
 */
static ClockMuxConfigType ClockDomainBSP_GCC_GCCQUPV3WRAP0S1[] =
{
  {    7372800, &ClockSource_GCC_GCCGPLL0,                { 6,     2,     384,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP106_CLKGEN_ACGC_CLK */
  {   14745600, &ClockSource_GCC_GCCGPLL0,                { 6,     2,     768,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP106_CLKGEN_ACGC_CLK */
  {   19200000, &ClockSource_XO,                          { 0,     2,     0,     0,     0x00 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[0] = BI_TCXO */
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC1APPS[] =
{
  ...
  {  192000000, &ClockSource_GCC_GCCGPLL10,               { 3,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     },                                                            /* Mux[3] = GCC_GPLL10_OUT_MAIN_PWRGRP0_CLKGEN_ACGC_CLK */
  {  384000000, &ClockSource_GCC_GCCGPLL10,               { 3,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     },                                                            /* Mux[3] = GCC_GPLL10_OUT_MAIN_PWRGRP0_CLKGEN_ACGC_CLK */
};
...
{
  {  100000000, &ClockSource_GCC_GCCGPLL0,                { 1,     12,    0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[1] = GCC_GPLL0_OUT_MAIN_PWRGRP14_CLKGEN_ACGC_CLK */
  {  200000000, &ClockSource_GCC_GCCGPLL0,                { 1,     6,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[1] = GCC_GPLL0_OUT_MAIN_PWRGRP14_CLKGEN_ACGC_CLK */
  {  403000000, &ClockSource_GCC_GCCGPLL4,                { 5,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[5] = GCC_GPLL4_OUT_MAIN_PWRGRP1_CLKGEN_ACGC_CLK */
};
...
/*
 * ClockDomainBSP_GCC_GCCVIDEOVENUS
 *
 * Used by:
 *   ClockDomain_GCC_GCCVIDEOVENUS
 */
static ClockMuxConfigType ClockDomainBSP_GCC_GCCVIDEOVENUS[] =
{
  {  133333333, &ClockSource_GCC_GCCGPLL3,                { 5,     6,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[5] = GCC_GPLL3_OUT_MAIN_PWRGRP1_CLKGEN_ACGC_CLK */
  {  240000000, &ClockSource_GCC_GCCGPLL3,                { 5,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[5] = GCC_GPLL3_OUT_MAIN_PWRGRP1_CLKGEN_ACGC_CLK */
  {  365000000, &ClockSource_GCC_GCCGPLL3,                { 5,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     },                                                            /* Mux[5] = GCC_GPLL3_OUT_MAIN_PWRGRP1_CLKGEN_ACGC_CLK */
  {  384000000, &ClockSource_GCC_GCCGPLL3,                { 5,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[5] = GCC_GPLL3_OUT_MAIN_PWRGRP1_CLKGEN_ACGC_CLK */
};
...
{
  {  340000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 0] /* 680.0  */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
  {  500000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 1] /* 1000.0 */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
  {  605000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 2] /* 1210.0 */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
  {  765000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 3] /* 1530.0 */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
  {  850000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM_L1,     {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 4] /* 1700.0 */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
  {  955000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 5] /* 1910.0 */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
  { 1010000000, &ClockSource_GPUCC_GPUCCPLL0,             { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR_L1,     {{0}}, &ClockSourceBSP_GPUCC_GPUCCPLL0[ 6] /* 2020.0 */ },    /* Mux[1] = GPU_CC_PLL0_OUT_EVEN */
};
...
/*
 * ClockSourceMap_DISPCC_DISPCCMDSSVSYNC
 *
 * Used by:
 *   ClockDomain_DISPCC_DISPCCMDSSVSYNC
 *   ClockDomain_DISPCC_DISPCCXO
 */
static const ClockSourceMapType ClockSourceMap_DISPCC_DISPCCMDSSVSYNC[] =
{
  { 0,   19200000, &ClockSource_XO,                         },
  { 7,  400000000, NULL,                                    },
  { CLOCK_SOURCE_MAP_END }
...
/*
 * ClockSourceMap_GCC_GCCVIDEOVENUS
 *
 * Used by:
 *   ClockDomain_GCC_GCCVIDEOVENUS
 */
static const ClockSourceMapType ClockSourceMap_GCC_GCCVIDEOVENUS[] =
{
  { 0,   19200000, &ClockSource_XO,                         },
  { 1,  600000000, &ClockSource_GCC_GCCGPLL0,               },
  { 5,          0, &ClockSource_GCC_GCCGPLL3,               },
  { 7,  400000000, NULL,                                    },
  { CLOCK_SOURCE_MAP_END }
};
...
/*
 * ClockDomainFMax_DISPCC_DISPCCMDSSESC0
 *
 * Used by:
 *   ClockDomain_DISPCC_DISPCCMDSSESC0
 *   ClockDomain_DISPCC_DISPCCMDSSVSYNC
 *   ClockDomain_DISPCC_DISPCCXO
 */
static const ClockFMaxType ClockDomainFMax_DISPCC_DISPCCMDSSESC0[] =
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },
  {  0  }
};
...
/*
 * ClockDomainFMax_GCC_GCCQUPV3WRAP0S1
 *
 * Used by:
 *   ClockDomain_GCC_GCCQUPV3WRAP0S1
 *   ClockDomain_GCC_GCCQUPV3WRAP0S2
 ...
 *   ClockDomain_GCC_GCCQUPV3WRAP1S4
 */
static const ClockFMaxType ClockDomainFMax_GCC_GCCQUPV3WRAP0S1[] =
{
  {   75000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },
  {  100000000, RAIL_VOLTAGE_LEVEL_SVS,        },
  {  0  }
...
/*
 * ClockDomainFMax_GCC_GCCVIDEOVENUS
 *
 * Used by:
 *   ClockDomain_GCC_GCCVIDEOVENUS
 */
static const ClockFMaxType ClockDomainFMax_GCC_GCCVIDEOVENUS[] =
{
  {  133333333, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },
  {  240000000, RAIL_VOLTAGE_LEVEL_SVS,        },
  {  365000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     },
  {  384000000, RAIL_VOLTAGE_LEVEL_NOM,        },
  {  0  }
};
...
{
  {  340000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },
  {  500000000, RAIL_VOLTAGE_LEVEL_SVS,        },
  {  605000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     },
  {  765000000, RAIL_VOLTAGE_LEVEL_NOM,        },
  {  850000000, RAIL_VOLTAGE_LEVEL_NOM_L1,     },
  {  955000000, RAIL_VOLTAGE_LEVEL_TUR,        },
  { 1010000000, RAIL_VOLTAGE_LEVEL_TUR_L1,     },
  {  0  }
};
...
{
  {  570000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },
...
static ClockDomainNodeType ClockDomain_DISPCC_DISPCCMDSSESC0 =
{
  ...
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_DISPCC_DISPCCMDSSBYTE0),
  .nRailMask = RAIL_VDD_CX,
  .aFMax     = ClockDomainFMax_DISPCC_DISPCCMDSSESC0,
...
static ClockDomainNodeType ClockDomain_DISPCC_DISPCCMDSSVSYNC =
{
  ...
  .nRailMask = RAIL_VDD_CX,
  .aFMax     = ClockDomainFMax_DISPCC_DISPCCMDSSESC0,
  .aSourceMap = ClockSourceMap_DISPCC_DISPCCMDSSVSYNC,
  .pSource   = &ClockSource_XO,
  .nFlags    = 0x0,
  .HALDomain = {
...
{
  .aBSP      = ClockDomainBSP_GCC_GCCQUPV3WRAP0S1,
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_GCC_GCCQUPV3WRAP0S1),
  .nRailMask = RAIL_VDD_CX | RAIL_VDD_MXA,
  .aFMax     = ClockDomainFMax_GCC_GCCQUPV3WRAP0S1,
  .aSourceMap = ClockSourceMap_GCC_GCCQUPV3WRAP0S0,
  .pSource   = &ClockSource_XO,
  .nFlags    = 0x0,
  .HALDomain = {
...
static ClockDomainNodeType ClockDomain_GCC_GCCVIDEOVENUS =
{
  .aBSP      = ClockDomainBSP_GCC_GCCVIDEOVENUS,
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_GCC_GCCVIDEOVENUS),
  .nRailMask = RAIL_VDD_CX | RAIL_VDD_MXA,
  .aFMax     = ClockDomainFMax_GCC_GCCVIDEOVENUS,
  .aSourceMap = ClockSourceMap_GCC_GCCVIDEOVENUS,
  .pSource   = &ClockSource_XO,
  .nFlags    = 0x0,
  .HALDomain = {
    .nCGRAddr   = HWIO_PHYS(GCC_VIDEO_VENUS_CMD_RCGR),
    .pmControl  = &HAL_clk_GenericDomainControl,
  },
};
...
static ClockNodeType aClocks[] =
{
  ...
  {
    .szName    = "gcc_video_venus_bcr",
    .pDomain   = &ClockDomain_GCC_CLOCKDRIVERGENNOSOURCE,
    .pDebugMux = NULL,
    .nUniqueId = 0xEE3DB0C8,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { 0, HWIO_PHYS(GCC_VIDEO_VENUS_BCR), {0, 0} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = HAL_CLK_NO_DEBUG_MUX_SEL,
    },
  },
  ...
  {
    .szName    = "gcc_vcodec0_axi_clk",
    .pDomain   = &ClockDomain_GCC_GCCMMNOCSFQX,
    .pDebugMux = &ClockDebugMux_GCC,
    .nUniqueId = 0xACE220EA,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_PHYS(GCC_VCODEC0_AXI_CBCR), HWIO_PHYS(GCC_VIDEO_BCR), {0, 0} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 480,
    },
  },
  {
    .szName    = "gcc_venus_ctl_axi_clk",
    .pDomain   = &ClockDomain_GCC_GCCMMNOCSFQX,
    .pDebugMux = &ClockDebugMux_GCC,
    .nUniqueId = 0x83D88E36,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_PHYS(GCC_VENUS_CTL_AXI_CBCR), HWIO_PHYS(GCC_VIDEO_BCR), {0, 0} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 479,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    .szName    = "gcc_video_vcodec0_sys_clk",
    .pDomain   = &ClockDomain_GCC_GCCVIDEOVENUS,
    .pDebugMux = &ClockDebugMux_GCC,
    .nUniqueId = 0xA535945A,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_PHYS(GCC_VIDEO_VCODEC0_SYS_CBCR), HWIO_PHYS(GCC_VCODEC0_BCR), {0, 0} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 477,
    },
  },
  {
    .szName    = "gcc_video_venus_ctl_clk",
    .pDomain   = &ClockDomain_GCC_GCCVIDEOVENUS,
    .pDebugMux = &ClockDebugMux_GCC,
    .nUniqueId = 0xA873D58C,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_PHYS(GCC_VIDEO_VENUS_CTL_CBCR), HWIO_PHYS(GCC_VENUS_BCR), {0, 0} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 475,
    },
  },
...
static ClockPowerDomainNodeType aPowerDomains[] =
{
  ...
  {
    .szName         = "gcc_vcodec0_gdsc",
    .nRailMask      = RAIL_VDD_CX | RAIL_VDD_MXA,
    .nFlags         = 0x0,
    .HALPowerDomain = {
      .nGDSCRAddr     = HWIO_PHYS(GCC_VCODEC0_GDSCR),
      .pmControl      = &HAL_clk_GenericPowerDomainControl,
    },
  },
  {
    .szName         = "gcc_venus_gdsc",
    .nRailMask      = RAIL_VDD_CX | RAIL_VDD_MXA,
    .nFlags         = 0x0,
    .HALPowerDomain = {
      .nGDSCRAddr     = HWIO_PHYS(GCC_VENUS_GDSCR),
      .pmControl      = &HAL_clk_GenericPowerDomainControl,
    },
  },
  {
