...
/**
  ...
  BSP data for the Clarence apps clock driver.
*/
/*
  ====================================================================
  ...
  ====================================================================
  $Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/SocPkg/Clarence/Library/ClockLib/ClockAppsBSP.c#1 $
...
static ClockResult Clock_ReadEPSSLutData
(
...
static ClockResult Clock_SaveEPSSLutData
(
  ClockDrvCtxt     *pDrvCtxt,
  ClockAppsCPUType  eCPU
)
{
    ...
    default:
        ULOG_RT_PRINTF_0(pDrvCtxt->hClockLog,
            "Invalid clock domain detected by Clock_SaveEPSSLutData.");
