...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Clarence$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -DBOOT_PBL_H=\"pbl_sbl_shared.h\" -I$(WORKSPACE)/QcomPkg/SocPkg/Clarence/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Clarence/Library/EUDTargetLib/EUDTargetLib.inf

     # NAND libraries
     NandCommonLib|QcomPkg/Library/NullLibs/NandLibNull/NandLibNull.inf

     # Buttons libraries
     ButtonsBootLib|QcomPkg/SocPkg/Clarence/Library/ButtonsTargetLib/ButtonsBootLib.inf
     ...
     TLMMTargetLib|QcomPkg/SocPkg/Clarence/Library/TLMMTargetLib/TLMMTargetLib.inf
     ...
     PmicLoaderLib|QcomPkg/SocPkg/Clarence/Library/PmicLib/loader/PmicLoaderLib.inf
    ...
    PrePiHobListPointerLib|EmbeddedPkg/Library/PrePiHobListPointerLib/PrePiHobListPointerLib.inf
     ...
     SecTargetLib|SecPkg/Library/SecTargetLib/chipsets/Clarence/SecTargetLib.inf
     DbgInfoLib|SecPkg/Library/dbginfolib/build/DbgInfoLib.inf
     ACLib|SecPkg/Library/ACLib/ACLib.inf
     ACConfigDataLib|SecPkg/Library/ACConfigDataLib/clarence/ACConfigDataLib.inf
     ...
     BootSmemLib|QcomPkg/XBLLoader/BootSmem/BootSmem.inf
     SmemImageLib|QcomPkg/SocPkg/Clarence/Library/SmemImageLib/SmemImageLib.inf
