...
DESCRIPTION: driver for the Atheros-based QSPI (quad SPI)
                       ...
                       Copyright (c) 2015, 2017 - 2018, 2020 Qualcomm Technologies, Incorporated
                                        All Rights Reserved
...
#define QUAD_SPI_CLK        74
#define QUAD_SPI_CS_0       75
#define QUAD_SPI_DATA_0     76
#define QUAD_SPI_DATA_1     77
#define QUAD_SPI_DATA_2     78
#define QUAD_SPI_DATA_3     79
...
static bool configure_gpios(void)
{
  ...
  else
  {
    DALGpioSignalType gpio_group[] =
    {
       ...
       DAL_GPIO_CFG(QUAD_SPI_CS_0, 1, DAL_GPIO_INPUT, DAL_GPIO_NO_PULL, DAL_GPIO_4MA),
