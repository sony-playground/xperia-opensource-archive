...
boolean usb_al_check_for_fedl(uint32 core_id, boolean check_dp_high, uint32 check_dp_timeout_ms)
{
   return qusb_al_check_for_fedl(core_id, check_dp_high, check_dp_timeout_ms);
}
