...
typedef struct _mhi_ctx
{
  ...
  mhi_addr_t       *lChCtxBase_ptr;      /**< Local MHI channel context base pointer address*/
  ...
  mhi_addr_t         *lErCtxBase_ptr;    /**< Local MHI event context base pointer address*/
  ...
  mhi_addr_t         *lCrCtxBase_ptr;    /**< Local Command Ring Context pointer address*/
