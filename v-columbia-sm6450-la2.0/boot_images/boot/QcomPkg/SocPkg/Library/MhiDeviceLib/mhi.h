...
/** MHI Configuration */
typedef struct _mhi_cfg
{
   uint32 ver;          /**< MHI Protocol Version */
 ...
 * @brief      mhi_is_enumerated
 *
 *             Return if MHI Has been enumerated by the host
 *
 *
 *
 * @dependencies
 ...
 *
 * @param [in/out] MHI Configuration structure that will be populated
 *
 * @dependencies
 *             None
 *
 ...
 * @sideeffect None
 */
void mhi_get_config(mhi_cfg_t*);

/**
 * @brief      mhi_poll
 *
 *             Polls MHI for any pending operations.
 *             Only applicaple for boot environments.
 *
 * @return
 *             None
 *
