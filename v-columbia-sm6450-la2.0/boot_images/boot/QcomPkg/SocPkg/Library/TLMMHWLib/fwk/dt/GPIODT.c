...
/*
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Library/TLMMHWLib/fwk/dt/GPIODT.c#2 $
  $DateTime: 2021/08/05 11:53:27 $
  $Author: pwbldsvc $
...
)
{
  ...
  /* NOTE: fdt_get_blob_handle will return error in UEFI, need to ignore return value */
  fdt_get_blob_handle(&pBlob, DEFAULT_BLOB_ID);
