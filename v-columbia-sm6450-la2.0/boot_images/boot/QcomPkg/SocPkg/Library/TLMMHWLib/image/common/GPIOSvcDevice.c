...
/*========================================================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Library/TLMMHWLib/image/common/GPIOSvcDevice.c#3 $
...
)
{
  ...
  {
    if ( ganGpioAccess[nIdx].nInUse == 1 && ganGpioAccess[nIdx].nPin == nPin)
    {
      return TRUE;
    }
  }
