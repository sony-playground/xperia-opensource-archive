...
Copyright 2014 - 2021,2022 by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================*/
...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Library/XBLLoaderLib/boot_target.h#2 $
  $DateTime: 2022/04/26 05:58:00 $ 
  $Author: pwbldsvc $

when       who          what, where, why
--------   --------     ----------------------------------------------------------
04/17/22   nnaram       added SHRM DRAM region for netrani
...
#define MAX_CRASHDUMP_TABLE_ENTRIES 300
...
#ifndef SCL_SHRM_MEM_SHRM_BASE
#define MEMORY_REGION26 {SHRM_DMEM_SHRM_DRAM_BASE,SHRM_TOTAL_DUMP_MEM_SIZE, "SHRM DRAM region", "SHRMDMEM.BIN"}
#endif
...
#define MEMORY_REGION35 {AOSS_ISLAND_RAM_BASE, AOSS_ISLAND_RAM_SIZE, "ISLAND RAM region", "AOSS_ISL.BIN"}

#define MEMORY_REGION_LAST {0, 0, NULL, NULL}

#ifndef SCL_SHRM_MEM_SHRM_BASE
#define MEMORY_REGION_TABLE MEMORY_REGION1,MEMORY_REGION2,MEMORY_REGION3,MEMORY_REGION4,MEMORY_REGION5,MEMORY_REGION6,MEMORY_REGION7,MEMORY_REGION8,MEMORY_REGION9,MEMORY_REGION10,MEMORY_REGION11,MEMORY_REGION12,MEMORY_REGION13,MEMORY_REGION14,MEMORY_REGION15,MEMORY_REGION16,MEMORY_REGION17,MEMORY_REGION18,MEMORY_REGION19, MEMORY_REGION26,MEMORY_REGION27,MEMORY_REGION28,MEMORY_REGION29,MEMORY_REGION30,MEMORY_REGION31,MEMORY_REGION32,MEMORY_REGION33,MEMORY_REGION34,MEMORY_REGION35,MEMORY_REGION_LAST
#else
