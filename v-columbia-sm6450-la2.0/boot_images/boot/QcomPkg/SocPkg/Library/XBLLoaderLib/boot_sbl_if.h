...
Copyright 2007, 2009-2011, 2013-2015,2020 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
...
--------   ---     ----------------------------------------------------------
07/23/20   rama    change pbl_shared_data to void*
...
{ 
  ...
  /* set when ddr init steps are complete */
  boot_boolean is_ddr_initialized;
