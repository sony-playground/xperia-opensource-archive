...
static bool HAL_clk_xbl_LucidEvoPLLEnable           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceDisableModeType eMode, void *pData );
static bool HAL_clk_xbl_LucidEvoPLLIsEnabled        ( HAL_clk_xbl_SourceDescType *pSource );
static void HAL_clk_xbl_LucidEvoPLLConfig           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceConfigType eConfig );
static bool HAL_clk_xbl_LucidEvoPLLConfigPLL        ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig, HAL_clk_xbl_SourceConfigMode eMode );
static bool HAL_clk_xbl_LucidEvoPLLEnableVote       ( HAL_clk_xbl_SourceDescType *pSource );
static bool HAL_clk_xbl_LucidEvoPLLSetCalConfig     ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig );
static void HAL_clk_xbl_LucidEvoPLLSetRegSettings   ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_xbl_LucidEvoPLLControl
 *
 * Control function array for the LucidEvo PLLs.
 */
HAL_clk_xbl_SourceControlType HAL_clk_xbl_LucidevoPLLControl =
{
  .Enable           = HAL_clk_xbl_LucidEvoPLLEnable,
  .IsEnabled        = HAL_clk_xbl_LucidEvoPLLIsEnabled,
  .Config           = HAL_clk_xbl_LucidEvoPLLConfig,
  .ConfigPLL        = HAL_clk_xbl_LucidEvoPLLConfigPLL,
  .EnableVote       = HAL_clk_xbl_LucidEvoPLLEnableVote,
  .SetCalConfig     = HAL_clk_xbl_LucidEvoPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_xbl_LucidEvoPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLEnableVote
**
** ======================================================================== */

static bool HAL_clk_xbl_LucidEvoPLLEnableVote
(
...
} /* END HAL_clk_xbl_LucidEvoPLLEnableVote */


/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLEnable
**
...
static bool HAL_clk_xbl_LucidEvoPLLEnable
(
  HAL_clk_xbl_SourceDescType        *pSource,
...
} /* END of HAL_clk_xbl_LucidEvoPLLEnable */


/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLIsEnabled
**
** ======================================================================== */

static bool HAL_clk_xbl_LucidEvoPLLIsEnabled
(
  HAL_clk_xbl_SourceDescType *pSource
)
{
...
} /* END HAL_clk_xbl_LucidEvoPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLConfig
**
** ======================================================================== */

static void HAL_clk_xbl_LucidEvoPLLConfig
(
  HAL_clk_xbl_SourceDescType   *pSource,
...
} /* END HAL_clk_xbl_LucidEvoPLLConfig */


/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLConfigPLLNormal
**
**  Returns:
**    bool - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static bool HAL_clk_xbl_LucidEvoPLLConfigPLLNormal
(
  HAL_clk_xbl_SourceDescType      *pSource,
...
} /* END HAL_clk_xbl_LucidEvoPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLConfigPLL
**
**  Returns:
**    bool - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static bool HAL_clk_xbl_LucidEvoPLLConfigPLL
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_xbl_LucidEvoPLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_xbl_LucidEvoPLLConfigPLL */


/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLSetCalConfig
**
** ======================================================================== */

static bool HAL_clk_xbl_LucidEvoPLLSetCalConfig
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_xbl_LucidEvoPLLSetRegSettings
**
** ======================================================================== */

static void HAL_clk_xbl_LucidEvoPLLSetRegSettings
(
  HAL_clk_xbl_SourceDescType              *pSource,
...
} /* END HAL_clk_xbl_LucidEvoPLLSetRegSettings */
