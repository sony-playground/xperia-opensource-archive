...
static bool HAL_clk_xbl_ZondaOlePLLEnable           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceDisableModeType eMode, void *pData );
static bool HAL_clk_xbl_ZondaOlePLLIsEnabled        ( HAL_clk_xbl_SourceDescType *pSource );
static void HAL_clk_xbl_ZondaOlePLLConfig           ( HAL_clk_xbl_SourceDescType *pSource, HAL_clk_xbl_SourceConfigType eConfig );
static bool HAL_clk_xbl_ZondaOlePLLConfigPLL        ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig, HAL_clk_xbl_SourceConfigMode eMode );
static bool HAL_clk_xbl_ZondaOlePLLSetCalConfig     ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_PLLConfigType *pmConfig );
static void HAL_clk_xbl_ZondaOlePLLSetRegSettings   ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_SourceRegSettingsType *pmSettings );
...
static bool HAL_clk_xbl_ZondaOlePLLEnable
(
...
static bool HAL_clk_xbl_ZondaOlePLLIsEnabled
(
  HAL_clk_xbl_SourceDescType *pSource
)
{
...
static void HAL_clk_xbl_ZondaOlePLLConfig
(
  HAL_clk_xbl_SourceDescType   *pSource,
...
static bool HAL_clk_xbl_ZondaOlePLLConfigPLLNormal
(
  HAL_clk_xbl_SourceDescType      *pSource,
...
static bool HAL_clk_xbl_ZondaOlePLLConfigPLL
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig,
...
static bool HAL_clk_xbl_ZondaOlePLLSetCalConfig
(
  HAL_clk_xbl_SourceDescType      *pSource,
  const HAL_clk_xbl_PLLConfigType *pConfig
)
...
static void HAL_clk_xbl_ZondaOlePLLSetRegSettings
(
  HAL_clk_xbl_SourceDescType              *pSource,
