 ...
 *
 * $DateTime: 2022/09/18 02:51:17 $
 * $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Library/CPRTargetLib/image/xbl/target/netrani/cpr_image_target_init.c#2 $
 * $Change: 39778058 $
 */
#include <string.h>
#include "cpr_logs.h"
...
#define HWIO_TCSR_TCSR_BOOT_MISC_DETECT_ADDR          0x1FD3000
#define HWIO_TCSR_TCSR_BOOT_MISC_DETECT_INM(m)        in_dword_masked(HWIO_TCSR_TCSR_BOOT_MISC_DETECT_ADDR, m)
...
static cpr_cfg_funcs* init_closed_loop(cpr_rail* rail)
{
    ...
    dload_flag = HWIO_TCSR_TCSR_BOOT_MISC_DETECT_INM(0x10 | 0x20);
    if(!dload_flag)
