...
#define CDP_DISP_RESET_GPIO                98       // GPIO number for LCD0_RESET
#define CDP_DISP_TE_GPIO                   99      // GPIO number for TE
//#define CDP_DISP_LCD_REG_EN                64      // GPIO for LCD internal boost power
//#define CDP_DISP_LCD_BKLT_EN               65      // GPIO for backlight enable
...
static MDP_Status Panel_CDP_PowerUp(MDP_Display_IDType eDisplayId)
{
  ...
  else
  {
    ...
    /* LCD Bias */
    pm_gpio_cfg_mode(PMIC_E, PM_GPIO_4, PM_GPIO_DIG_OUT);
    pm_gpio_set_voltage_source(PMIC_E, PM_GPIO_4, PM_GPIO_VIN0);
    pm_gpio_set_out_src_cfg(PMIC_E, PM_GPIO_4, PM_GPIO_SRC_GND);
    pm_gpio_set_out_drv_str(PMIC_E, PM_GPIO_4, PM_GPIO_OUT_DRV_STR_HIGH);
    pm_gpio_set_output_level(PMIC_E, PM_GPIO_4, PM_GPIO_LEVEL_HIGH);
    pm_gpio_set_out_buf_cfg(PMIC_E, PM_GPIO_4, PM_GPIO_OUT_BUF_CFG_CMOS);
    
    /* LCD VDDIO PIN*/
    pm_gpio_cfg_mode(PMIC_E, PM_GPIO_9, PM_GPIO_DIG_OUT);
    pm_gpio_set_voltage_source(PMIC_E, PM_GPIO_9, PM_GPIO_VIN0);
    pm_gpio_set_out_src_cfg(PMIC_E, PM_GPIO_9, PM_GPIO_SRC_GND);
    pm_gpio_set_out_drv_str(PMIC_E, PM_GPIO_9, PM_GPIO_OUT_DRV_STR_HIGH);
    pm_gpio_set_output_level(PMIC_E, PM_GPIO_9, PM_GPIO_LEVEL_HIGH);
    pm_gpio_set_out_buf_cfg(PMIC_E, PM_GPIO_9, PM_GPIO_OUT_BUF_CFG_CMOS);
  ...
  if (MDP_PANEL_BACKLIGHTTYPE_PMIC == pBacklightConfig->eBacklightType)
  {
    ...
    switch (pBacklightConfig->uBacklightCntrl.eBacklightCtrl)
    {
      ...
      case MDP_PMIC_BACKLIGHT_CONTROLTYPE_PWM:
       {
        /* LCD PWM Enable Pin */
        pm_gpio_cfg_mode(PMIC_E, PM_GPIO_10, PM_GPIO_DIG_OUT);
        pm_gpio_set_voltage_source(PMIC_E, PM_GPIO_10, PM_GPIO_VIN0);
        pm_gpio_set_out_src_cfg(PMIC_E, PM_GPIO_10, PM_GPIO_SRC_GND);
        pm_gpio_set_out_drv_str(PMIC_E, PM_GPIO_10, PM_GPIO_OUT_DRV_STR_HIGH);
        pm_gpio_set_output_level(PMIC_E, PM_GPIO_10, PM_GPIO_LEVEL_HIGH);
        pm_gpio_set_out_buf_cfg(PMIC_E, PM_GPIO_10, PM_GPIO_OUT_BUF_CFG_CMOS);
