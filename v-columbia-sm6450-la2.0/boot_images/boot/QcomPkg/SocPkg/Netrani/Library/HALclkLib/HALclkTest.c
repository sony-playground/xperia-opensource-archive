...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Library/HALclkLib/HALclkTest.c#3 $
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlAPSSCC_netrani =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlCAMCC_netrani =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlDISPCC_netrani =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlGCC_netrani =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlGPUCC_netrani =
{
...
)
{
  ...
  HWIO_OUTF(VCODEC_VIDEO_CC_DEBUG_DIV_CDIVR, CLK_DIV, 1);
  HWIO_OUTF(VCODEC_VIDEO_CC_DEBUG_CBCR, CLK_ENABLE, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlVIDEOCC_netrani =
{
