...
#  @file HALclkHWIO.py
#
#  @brief HWIO config for the Netrani XBL Loader Clock HWIO generation.
#
...
#  ===========================================================================
#
#  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Library/HALclkLib/HALclkHWIO.py#2 $
