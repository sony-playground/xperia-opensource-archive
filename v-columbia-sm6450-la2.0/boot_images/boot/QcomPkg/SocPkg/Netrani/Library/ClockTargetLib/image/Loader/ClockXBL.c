...
uint32_t Clock_ODSC_Ctl_Cfg[] =
{
  ...
  //HWIO_ADDR(GCC_QUPV3_WRAP_0_S_AHB_CBCR),  //Avoid NOC errors and register access problems with QUP registers
  //HWIO_ADDR(GCC_QUPV3_WRAP_1_S_AHB_CBCR),  //Avoid NOC errors and register access problems with QUP registers
...
{
  HWIO_ADDR(GCC_AGGRE_CNOC_PERIPH_AHB_CBCR),
  HWIO_ADDR(GCC_AGGRE_NOC_AXI_CBCR),
  HWIO_ADDR(GCC_AGGRE_NOC_SOUTH_AXI_CBCR),
  HWIO_ADDR(GCC_CFG_NOC_LPASS_SOUTH_AHB_CBCR),
  HWIO_ADDR(GCC_CFG_NOC_SOUTH_ASYNC_BRIDGE_CENTER_AHB_CBCR),
  HWIO_ADDR(GCC_CNOC_PCIE_QX_CBCR),
  HWIO_ADDR(GCC_CPUSS_CONFIG_NOC_SF_CBCR),
};
...
static void Clock_ApplyWorkarounds(void)
{
  ...
  HWIO_OUTF(GCC_QUPV3_WRAP0_S5_DIV_CDIVR, CLK_DIV, 0);
  HWIO_OUTF(GCC_QUPV3_WRAP1_S5_DIV_CDIVR, CLK_DIV, 0);
