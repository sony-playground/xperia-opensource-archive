...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Library/ClockTargetLib/image/RamDump/ClockBSP.c#7 $
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 6 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
...
{
  {      32000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 6 /* ClockSource_XO */                       ,  0 /* 0.0     Mhz */ ,  },   /* Mux[0] = CHIP_SLEEP_CLK */
};
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0x00 }, 6 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
...
{
  {     144000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     32,    3,     25,    0xFF }, 6 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
  {     400000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     24,    1,     4,     0xFF }, 6 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
  ...
  {  192000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 3,     4,     0,     0,     0xFF }, 4 /* ClockSource_GCC_GCCGPLL10 */            ,  0 /* 384.0   Mhz */ ,  },   /* Mux[3] = GCC_GPLL10_OUT_MAIN */
  {  384000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 3,     2,     0,     0,     0xFF }, 4 /* ClockSource_GCC_GCCGPLL10 */            ,  0 /* 384.0   Mhz */ ,  },   /* Mux[3] = GCC_GPLL10_OUT_MAIN */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC2APPS[] =
{
  ...
  {  202000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 2,     8,     0,     0,     0xFF }, 5 /* ClockSource_GCC_GCCGPLL9 */             ,  0 /* 808.0   Mhz */ ,  },   /* Mux[2] = GCC_GPLL9_OUT_MAIN */
};
...
{
  {    9600000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     4,     0,     0,     0xFF }, 6 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 6 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
};
...
static ClockNodeType aClocks[] =
{
...

  {
    ...
    .nFlags      = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_QUPV3_WRAP0_QSPI0_CBCR),
    .mHWVotable  = {HWIO_ADDR(GCC_PROC_CLK_BRANCH_ENA_VOTE_2), 0x1000000},
  },
  {
...

  {
    ...
    .nFlags      = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_QUPV3_WRAP1_QSPI0_CBCR),
