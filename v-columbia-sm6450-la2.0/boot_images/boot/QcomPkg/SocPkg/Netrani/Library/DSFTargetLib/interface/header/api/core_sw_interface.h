...
extern boolean (*fptr_HAL_EXT_CORE_SW_Get_Frequency_Limit_info)(void);
extern boolean (*fptr_HAL_EXT_CORE_SW_Get_DDR_Accessibility_Limit_Info)(void);
...
/* ============================================================================
**  Function : HAL_EXT_CORE_SW_Get_Frequency_Limit_info
** ============================================================================
*/
/*!
*   @brief
*   This function obtains the frequency limit fuse information
*   
*   @param
*   None
*   
...
*   
*   @retval
*   Frequency limit fuse information 
*   
*   @sa None
*/
boolean HAL_EXT_CORE_SW_Get_Frequency_Limit_info(void);

/* ============================================================================
**  Function : HAL_EXT_CORE_SW_Get_DDR_Accessibility_Limit_Info
** ============================================================================
*/
/*!
*   @brief
*   This function obtains the DDR Accessibility limit fuse information
*   
*   @param
*   None
*   
...
*   
*   @retval
*   DDR Accessibility limit fuse information 
*   
*   @sa None
*/
boolean HAL_EXT_CORE_SW_Get_DDR_Accessibility_Limit_Info(void);
