...
/**
    ...
    @file ChipInfoHWIO_Netrani.h
    Reference chip release:
        SM6450 (Netrani) [netrani_v1.0_p3q3r45_MTO]
    ...
    'Include' filters applied: CHIP_UNIQUE_ID_.*[FUSE_CONTROLLER_SW_RANGE4] QFPROM_CORR_QC_SPARE_3_ROW0_LSB[QFPROM_CORR] QFPROM_CORR_QC_SPARE_3_ROW0_MSB[QFPROM_CORR] QFPROM_CORR_PTE_ROW1_MSB[QFPROM_CORR] QFPROM_CORR_PTE_ROW1_LSB[QFPROM_CORR] QFPROM_CORR_QC_CONFIG_ROW2_LSB[QFPROM_CORR] QFPROM_CORR_FEATURE_CONFIG_ROW5_MSB[QFPROM_CORR] QFPROM_CORR_QC_SPARE_3_ROW1_LSB[QFPROM_CORR] QFPROM_CORR_QC_SPARE_3_ROW1_MSB[QFPROM_CORR] QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB[QFPROM_CORR] QFPROM_CORR_FEATURE_CONFIG_ROW5_MSB[QFPROM_CORR] TCSR_SOC_HW_VERSION[TCSR_TCSR_REGS] TLMM_HW_REVISION_NUM.*[TLMM_REG] 

    Generation parameters: 
    { 'filename': 'ChipInfoHWIO_Netrani',
      ...
      'module-filter-include': { 'FUSE_CONTROLLER_SW_RANGE4': ['CHIP_UNIQUE_ID_.*'],
                                 'QFPROM_CORR': [ 'QFPROM_CORR_QC_SPARE_3_ROW0_LSB',
                                                  'QFPROM_CORR_QC_SPARE_3_ROW0_MSB',
                                                  'QFPROM_CORR_PTE_ROW1_MSB',
                                                  'QFPROM_CORR_PTE_ROW1_LSB',
                                                  'QFPROM_CORR_QC_CONFIG_ROW2_LSB',
                                                  'QFPROM_CORR_FEATURE_CONFIG_ROW5_MSB',
                                                  'QFPROM_CORR_QC_SPARE_3_ROW1_LSB',
                                                  'QFPROM_CORR_QC_SPARE_3_ROW1_MSB',
                                                  'QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB',
                                                  'QFPROM_CORR_FEATURE_CONFIG_ROW5_MSB'],
...
/*
    ...
    $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Include/ChipInfoHWIO.h#6 $
    $DateTime: 2023/07/27 00:11:02 $
    $Author: pwbldsvc $
...
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_IDDQ_MX_OFF_6_0_BMSK                                                          0xfe000000
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_IDDQ_MX_OFF_6_0_SHFT                                                                  25
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_IDDQ_MX_ACTIVE_BMSK                                                            0x1ff8000
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_IDDQ_MX_ACTIVE_SHFT                                                                   15
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_SUBBINB_BMSK                                                                      0x7c00
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_SUBBINB_SHFT                                                                          10
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_PTE_DATA_73_BMSK                                                                   0x200
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_PTE_DATA_73_SHFT                                                                       9
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_WAFER_ZONE_BMSK                                                                    0x1c0
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_WAFER_ZONE_SHFT                                                                        6
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_SUBBINA_BMSK                                                                        0x3e
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_SUBBINA_SHFT                                                                           1
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_PTE_DATA_64_BMSK                                                                     0x1
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_PTE_DATA_64_SHFT                                                                       0
...
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_WS_RT_BMSK                                                                 0x80000000
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_WS_RT_SHFT                                                                         31
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_WS_HT_BMSK                                                                 0x40000000
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_WS_HT_SHFT                                                                         30
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_FT_RT_BMSK                                                                 0x20000000
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_FT_RT_SHFT                                                                         29
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_FT_HT_BMSK                                                                 0x10000000
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_MR_FT_HT_SHFT                                                                         28
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_IDDQ_GFX_ACTIVE_BMSK                                                           0xffc0000
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_IDDQ_GFX_ACTIVE_SHFT                                                                  18
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_IDDQ_APC0_ACTIVE_BMSK                                                            0x3ff00
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_IDDQ_APC0_ACTIVE_SHFT                                                                  8
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_DOU_BINNING_BMSK                                                                    0xf0
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_DOU_BINNING_SHFT                                                                       4
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_BIN_V_IDENTIFIER_BMSK                                                                0xc
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_BIN_V_IDENTIFIER_SHFT                                                                  2
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_TSENS_REV_CTRL_BMSK                                                                  0x2
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_TSENS_REV_CTRL_SHFT                                                                    1
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_IDDQ_MX_OFF_7_BMSK                                                                   0x1
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_IDDQ_MX_OFF_7_SHFT                                                                     0
...
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW0_LSB_SUBBINB_BMSK                                                               0x7c00
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW0_LSB_SUBBINB_SHFT                                                                   10
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW0_LSB_SUBBINA_BMSK                                                                0x3e0
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW0_LSB_SUBBINA_SHFT                                                                    5
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW0_LSB_PARTIAL_BIN_BMSK                                                             0x1f
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW0_LSB_PARTIAL_BIN_SHFT                                                                0
...
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW1_MSB_QC_SPARE_3_105_82_BMSK                                                 0xffffff00
#define HWIO_QFPROM_CORR_QC_SPARE_3_ROW1_MSB_QC_SPARE_3_105_82_SHFT                                                          8
...
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_IRIS_DISABLE_10BIT_ENCODE_BMSK                                     0x80000000
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_IRIS_DISABLE_10BIT_ENCODE_SHFT                                             31
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_IRIS_DISABLE_10BIT_DECODE_BMSK                                     0x40000000
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_IRIS_DISABLE_10BIT_DECODE_SHFT                                             30
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_FEATURE_CONFIG_349_344_BMSK                                        0x3f000000
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_FEATURE_CONFIG_349_344_SHFT                                                24
...
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_EFUSE_CAMERA_TFE_2_PIXEL_PIPE_DISABLE_BMSK                           0x400000
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_EFUSE_CAMERA_TFE_2_PIXEL_PIPE_DISABLE_SHFT                                 22
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_EFUSE_CAMERA_TFE_2_DISABLE_BMSK                                      0x200000
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_EFUSE_CAMERA_TFE_2_DISABLE_SHFT                                            21
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_EFUSE_CAMERA_PHY_3_DISABLE_BMSK                                      0x100000
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_EFUSE_CAMERA_PHY_3_DISABLE_SHFT                                            20
...
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_EFUSE_QDSP6_HVX_VTCMSHRINK_BMSK                                  0x180
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_EFUSE_QDSP6_HVX_VTCMSHRINK_SHFT                                      7
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_QDSP_HMX_FLTARRAYTHROTTLE_BMSK                                    0x60
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_QDSP_HMX_FLTARRAYTHROTTLE_SHFT                                       5
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_QDSP6_HMX_FXPARRAYTHROTTLE_BMSK                                   0x18
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_QDSP6_HMX_FXPARRAYTHROTTLE_SHFT                                      3
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_QDSP6_HVX_VTCMSIZE_BMSK                                            0x6
#define HWIO_QFPROM_CORR_FEATURE_CONFIG_ROW5_LSB_TURING_QDSP6_HVX_VTCMSIZE_SHFT                                              1
...
#define TLMM_REG_REG_BASE_USED                                                               0xb001c

#define HWIO_TLMM_HW_REVISION_NUMBER_0_ADDR                                                  (TLMM_REG_REG_BASE      + 0x8f010)
...
#define HWIO_TLMM_HW_REVISION_NUMBER_1_ADDR                                                  (TLMM_REG_REG_BASE      + 0x8f014)
...
#define HWIO_TLMM_HW_REVISION_NUMBER_2_ADDR                                                  (TLMM_REG_REG_BASE      + 0x8f018)
