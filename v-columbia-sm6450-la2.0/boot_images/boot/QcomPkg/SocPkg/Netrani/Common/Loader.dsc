...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Netrani$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -DBOOT_PBL_H=\"pbl_sbl_shared.h\" -I$(WORKSPACE)/QcomPkg/SocPkg/Netrani/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Netrani/Library/EUDTargetLib/EUDTargetLib.inf

     # NAND libraries
     NandCommonLib|QcomPkg/Library/NullLibs/NandLibNull/NandLibNull.inf

     # Buttons libraries
     ButtonsBootLib|QcomPkg/SocPkg/Netrani/Library/ButtonsTargetLib/ButtonsBootLib.inf
     ...
     TLMMTargetLib|QcomPkg/SocPkg/Netrani/Library/TLMMTargetLib/TLMMTargetLib.inf
     ...
     PmicLoaderLib|QcomPkg/SocPkg/Netrani/Library/PmicLib/loader/PmicLoaderLib.inf
     PmicPsiLib|QcomPkg/SocPkg/Netrani/Library/PmicLib/loader/PmicPsiLib.inf
...
#	 PmicLoaderLib|QcomPkg/Library/NullLibs/PmicLibNull/PmicLoaderLibNull.inf
    PrePiHobListPointerLib|EmbeddedPkg/Library/PrePiHobListPointerLib/PrePiHobListPointerLib.inf
     ...
     QusbLdrLib|QcomPkg/SocPkg/Netrani/Library/QusbLdrLib/QusbLdrLib.inf
     ...
     SecTargetLib|SecPkg/Library/SecTargetLib/chipsets/Netrani/SecTargetLib.inf
     DbgInfoLib|SecPkg/Library/dbginfolib/build/DbgInfoLib.inf
     ACLib|SecPkg/Library/ACLib/ACLib.inf
     ACConfigDataLib|SecPkg/Library/ACConfigDataLib/netrani/ACConfigDataLib.inf
     ...
     BootSmemLib|QcomPkg/XBLLoader/BootSmem/BootSmem.inf
     SmemImageLib|QcomPkg/SocPkg/Netrani/Library/SmemImageLib/SmemImageLib.inf
