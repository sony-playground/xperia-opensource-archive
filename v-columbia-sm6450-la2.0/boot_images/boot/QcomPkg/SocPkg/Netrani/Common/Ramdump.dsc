...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Netrani$(VAR)/RamDump
...
#
  QcomPkg/XBLRamDump/XBLRamDump.inf {
    <LibraryClasses>
      ...
      ClockTargetLib|QcomPkg/SocPkg/Netrani/Library/ClockTargetLib/ClockRamDumpLib.inf
      ...
      HALMDSSLib|QcomPkg/Library/HALMDSSLib/HALMDSS83x.inf
      LoggerLib|QcomPkg/LoaderFramework/Logger/Logger.inf
      MDPLibBoot|QcomPkg/Library/MDPLib/MDPLibBoot.inf
      MDPPlatformLibBoot|QcomPkg/SocPkg/Netrani/Library/MDPPlatformLibBoot/MDPPlatformLibBoot.inf
      PmicLib|QcomPkg/SocPkg/Netrani/Library/PmicLib/PmicLib.inf
      PmicLoaderLib|QcomPkg/SocPkg/Netrani/Library/PmicLib/loader/PmicRamDump.inf
