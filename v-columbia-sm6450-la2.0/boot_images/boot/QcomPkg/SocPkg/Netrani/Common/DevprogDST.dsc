...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Netrani$(VAR)/DevprogDST
...
[Components.common]
  QcomPkg/DevPrg/DevPrgDST.inf {
     <LibraryClasses>
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Netrani/Library/PmicLib/loader/PmicDevprogLib.inf   
