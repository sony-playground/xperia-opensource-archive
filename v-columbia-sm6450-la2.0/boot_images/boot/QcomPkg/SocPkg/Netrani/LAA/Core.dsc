...
[Defines]
  ...
  FLASH_DEFINITION               = QcomPkg/SocPkg/Netrani/LAA/Core.fdf

[Defines.ARM]
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Netrani$(VAR)/Core_32

[Defines.AARCH64]
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Netrani$(VAR)/Core

!include QcomPkg/SocPkg/Netrani/Common/Core.dsc.inc
...
[LibraryClasses]
  ...
  # XHwreset Library
  XHwresetLib|SomcPkg/Platform/SomcSm6450Pkg/Library/XHwresetLib/XHwresetLib.inf
  # XSDI Library
  ...
  # XVibratorLib
  XVibratorLib|SomcPkg/Platform/SomcSm6450Pkg/Library/XVibratorLib/XVibratorLib.inf
  # XHapticsLib
  XHapticsLib|SomcPkg/Platform/SomcQcomCmnPkg/Library/XHapticsLib/XHapticsLibNull.inf
  # XBootPALLib Library
  XBootPALLib|SomcPkg/Platform/SomcSm6450Pkg/Library/XBootPALLib/XBootPALLib.inf
  # RTCPrintLib
...
[Components]
  ...
  SomcPkg/Platform/SomcQcomCmnPkg/Drivers/XHwresetDxe/XHwresetDxe.inf {
    <LibraryClasses>
      PmicCoreLib|QcomPkg/SocPkg/Netrani/Library/PmicLib/core/la/PmicCoreLib.inf
