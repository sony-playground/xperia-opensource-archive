...
{
   // MAIN_PORT
   0x0098C000,    // uart_base
   0x009C0000,// qup_common_base
   0x2001c161,  // gpio_tx_config
   0x2000c171,  // gpio_rx_config
   0,           // gpio_cts_config
   0,           // gpio_rfr_config
   0,           // clock_id_index
   (void*)0,        // bus_clock_id
   (void*)"gcc_qupv3_wrap0_s3_clk",     // core_clock_id
...
{
    0x53, 0x45, 0x46, 0x57, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x30, 0x02, 0x00, 0x06, 0x04, 
