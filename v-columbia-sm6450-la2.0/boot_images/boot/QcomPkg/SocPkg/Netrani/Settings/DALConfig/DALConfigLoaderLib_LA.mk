...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/DALConfig/*.h \
...
XML_DEPS = $(WORKSPACE)/QcomPkg/SocPkg/Settings/BootTempCheck/boot_temp_check_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/TLMM/loader/TLMMChipset.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/UFS/ufs_config.xml \
           $(WORKSPACE)/QcomPkg/Settings/PlatformInfo/PlatformInfo.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/PMIC/pm_config_target_loader.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/ADC/internal/loader/adc_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/ADC/internal/loader/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/SMEM/smem_xbl_loader.xml \
           ...
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/ICB/loader/icbcfg_boot.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/TSENS/tsens_props.xml
...
IMAGE_CFG_XML = $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/DALConfig/image_cfg.xml
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SocPkg/Netrani/Settings/DALConfig/DALConfigLoaderLib_LA.mk
