...
----------   ---     ----------------------------------------------------------  
2021-09-20   cm      Add HS-G4 registers
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_table[] = {
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_LOCK_CMP_EN_OFFS,                   0x42},
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_LOCK_CMP2_MODE0_OFFS,               0x19}, 
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_LOCK_CMP1_MODE1_OFFS,               0x65}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_LOCK_CMP2_MODE1_OFFS,               0x1E}, 
   ...
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
           HWIO_UFS_MEM_QSERDES_TX0_LANE_MODE_1_OFFS,                   0xF5}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_TX0_LANE_MODE_3_OFFS,                   0x3F},
   { 0x00, HWIO_UFS_MEM_QSERDES_TX0_RES_CODE_LANE_OFFSET_TX_OFFS,       0x03},  
   { 0x00, HWIO_UFS_MEM_QSERDES_TX0_RES_CODE_LANE_OFFSET_RX_OFFS,       0x06},  
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL1_OFFS,         0x04},
   { CONDITIONAL_FLAG(0, HS_G4), 
           HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL2_OFFS,         0x00},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
           HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL2_OFFS,         0x06},
   { CONDITIONAL_FLAG(0, HS_G4), 
           HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL3_OFFS,         0x4A},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
           HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL3_OFFS,         0x04},
   { CONDITIONAL_FLAG(0, HS_G4), 
           HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL4_OFFS,         0x0A},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
           HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL4_OFFS,         0x1A},
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_RX_EQ_OFFSET_ADAPTOR_CNTRL1_OFFS,   0x17},
   ...
   { CONDITIONAL_FLAG(0, HS_G4), 
         HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_LOW_OFFS,                  0xBF},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
         HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_LOW_OFFS,                  0x6D},
   { CONDITIONAL_FLAG(0, HS_G4),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH_OFFS,                  0xBF}, 
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH_OFFS,                  0x6D}, 
   { CONDITIONAL_FLAG(0, HS_G4), 
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH2_OFFS,                 0x7F},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
   ...
   { CONDITIONAL_FLAG(0, HS_G4),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH4_OFFS,                 0x2D},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
   ...
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_01_HIGH4_OFFS,                 0xB7},
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_10_HIGH4_OFFS,              0xB7},
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_end_table[] = {
   ...
   { 0x00, HWIO_UFS_MEM_UFS_PHY_TX_LARGE_AMP_DRV_LVL_OFFS,         0x0A},
   ...
   { CONDITIONAL_FLAG(0, HS_G4),
           HWIO_UFS_MEM_UFS_PHY_TIMER_20US_CORECLK_STEPS_MSB_OFFS, 0x2D},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
           HWIO_UFS_MEM_UFS_PHY_TIMER_20US_CORECLK_STEPS_MSB_OFFS, 0x16}, 
   { CONDITIONAL_FLAG(0, HS_G4), 
           HWIO_UFS_MEM_UFS_PHY_TIMER_20US_CORECLK_STEPS_LSB_OFFS, 0xB0},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
           HWIO_UFS_MEM_UFS_PHY_TIMER_20US_CORECLK_STEPS_LSB_OFFS, 0xD8}, 
   { CONDITIONAL_FLAG(0, HS_G4), 
          HWIO_UFS_MEM_UFS_PHY_TX_PWM_GEAR_BAND_OFFS,              0xFF},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
          HWIO_UFS_MEM_UFS_PHY_TX_PWM_GEAR_BAND_OFFS,              0xAA},
   { CONDITIONAL_FLAG(0, HS_G4), 
          HWIO_UFS_MEM_UFS_PHY_TX_HS_GEAR_BAND_OFFS,               0x1B},	  
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
   ...
   { 0x00, HWIO_UFS_MEM_UFS_PHY_RX_SIGDET_CTRL1_OFFS,              0x0E},
...
static struct ufs_mphy_init_item ufs_bsp_mphy_2_lane_init_table[] = {
     ...
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
             HWIO_UFS_MEM_QSERDES_TX1_LANE_MODE_1_OFFS,                       0xF5},
     { 0x00, HWIO_UFS_MEM_QSERDES_TX1_LANE_MODE_3_OFFS,                       0x3F},
     { 0x00, HWIO_UFS_MEM_QSERDES_TX1_RES_CODE_LANE_OFFSET_TX_OFFS,           0x03},
     { 0x00, HWIO_UFS_MEM_QSERDES_TX1_RES_CODE_LANE_OFFSET_RX_OFFS,           0x06}, 
     ...
     { 0x00, HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL1_OFFS,             0x04},
     { CONDITIONAL_FLAG(0, HS_G4),
             HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL2_OFFS,             0x00},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
             HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL2_OFFS,             0x06},
     { CONDITIONAL_FLAG(0, HS_G4),
             HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL3_OFFS,             0x4A},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
             HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL3_OFFS,             0x04},
     { CONDITIONAL_FLAG(0, HS_G4),
             HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL4_OFFS,             0x0A},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
             HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL4_OFFS,             0x1A},
     { 0x00, HWIO_UFS_MEM_QSERDES_RX1_RX_EQ_OFFSET_ADAPTOR_CNTRL1_OFFS,       0x17},
     ...
     { CONDITIONAL_FLAG(0, HS_G4), 
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_LOW_OFFS,                    0xBF},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_LOW_OFFS,                    0x6D},
     { CONDITIONAL_FLAG(0, HS_G4),
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH_OFFS,                   0xBF}, 
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH_OFFS,                   0x6D}, 
     { CONDITIONAL_FLAG(0, HS_G4), 
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH2_OFFS,                  0x7F},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
     ...
     { CONDITIONAL_FLAG(0, HS_G4),
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH4_OFFS,                  0x2D},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR),
     ...
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR), 
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_01_HIGH4_OFFS,                  0xB7},
     ...
     { 0x00, HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_10_HIGH4_OFFS,                  0xB7},
