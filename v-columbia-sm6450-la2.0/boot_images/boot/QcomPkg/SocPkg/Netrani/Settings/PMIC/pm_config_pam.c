 ...
 *  
 *    Platform: Netrani.XX.1.0
 *    Revision: NO REVISIONS (Working Set)
 *    Template Version: 
 *    $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Settings/PMIC/pm_config_pam.c#4 $ 
 *    $DateTime: 2022/05/11 05:30:30 $  $Author: pwbldsvc $
 *  
...
{
    { (void*)pm_pam_emmc_vcc_b_ldo24, PM_PRM_RSRC_VRM_VREG },
}; 
...
{
    { (void*)pm_pam_sd_mmc_vdd_e_ldo9, PM_PRM_RSRC_VRM_VREG },
}; 
...
{
    { (void*)pm_pam_sd_mmc_vdd_px2_e_ldo6, PM_PRM_RSRC_VRM_VREG },
}; 

npa_node_dependency
pm_pam_deps_sd_mmc_vdd_px2 [] =
{
    PM_PRM_CLIENT_VREG_DEP ( e,  ldo, 6 ),
};

/*************************** UFS0_VCC Client ***************************/

const pm_prm_vreg_data_type
pm_pam_ufs0_vcc_b_ldo24 [] =
{
     /*     mode    voltage(mV)  enable*/ 
    { PM_PRM_VREG_MODE_LPM, 0, PM_PRM_DEV_DISABLE },  // GENERIC_OFF
...
{
    { (void*)pm_pam_ufs0_vcc_b_ldo24, PM_PRM_RSRC_VRM_VREG },
}; 
...
pm_prm_device_rsrc_data [] =
{
    ...
    PM_PRM_DEV_RSRC_VREG ( e, ldo, 6, PM_PRM_RSRC_LDO,  PM_PRM_RPMH, PM_LDO_6),
