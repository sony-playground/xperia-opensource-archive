...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Netrani/Settings/PMIC/pm_pvc_config.c#2 $
...
{
  {0x5, 0x2640}, /* S7E_CTRL_VSET_LB */
  {0x5, 0x2641}, /* S7E_CTRL_VSET_UB */
  {0x5, 0x2645}, /* S7E_CTRL_MODE_CTL */
  {0x5, 0x2646}  /* S7E_CTRL_EN_CTL */
};
...
{
  {0x5, 0x1D40}, /* S4E_CTRL_VSET_LB */
  {0x5, 0x1D41}, /* S4E_CTRL_VSET_UB */
  {0x5, 0x1D45}, /* S4E_CTRL_MODE_CTL */
  {0x5, 0x1D46}  /* S4E_CTRL_EN_CTL */
};
...
SpmiCfg_Ppid pm_pvc_mgpi_addr[] =
{
  ...
  {0x5, 0x4846}, /* MGPI4, SD card, default disabled unless for QRD L9E */
  {0x1, 0xDA46}, /* MGPI5, UICC0, L26B */
  {0x1, 0xC944}, /* MGPI6, AOP PDC TRIGGER, L9B RM/NPM control*/
