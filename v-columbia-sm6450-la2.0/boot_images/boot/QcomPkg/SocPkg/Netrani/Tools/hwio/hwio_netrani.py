...
#===========================================================================
#
#  @file hwio_fillmore.py
#  @brief HWIO config file for the HWIO generation scripts for fillmore.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_fillmore.py --flat=ARM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
HWIO_EXTRA_BASES = [
  ...
  ['BOOT_IMEM_SIZE',               0x00400000, 0x0],
  ['BOOT_IMEM_END',                0x14bfffff, 0x0],
]
