#ifndef __PALIMA_ROOT_PORT_CONFIG_H__
#define __PALIMA_ROOT_PORT_CONFIG_H__
/*
...
STATIC CONST pcie_reg_op_t palima_port_x2_lane_seq[] =
{
...
STATIC CONST pcie_reg_op_t palima_port_x1_lane_seq[] =
{
   {PCIE_REG_OP_RMW, HWIO_OFFS(PCIE_PORT_LINK_CTRL_OFF), HWIO_PCIE_PORT_LINK_CTRL_OFF_LINK_CAPABLE_BMSK,
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_op_t palima_post_phy_pwr_up_init_seq[] =
{
...
STATIC CONST pcie_reg_op_t palima_phy_delay_seq[] =
{
...
STATIC CONST pcie_reg_op_t palima_set_link_speed_gen_3[] =
{
    /* Link Speed */
...
STATIC CONST pcie_reg_op_t palima_set_link_speed_gen_4[] =
{
    /* Link Speed */
...
STATIC CONST pcie_reg_op_t palima_post_phy_pwr_up_dbi_init_seq[] =
{
    /* Fix NFTS */
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_init_cfg_t palima_port_0_phy_init_cfg[] =
{
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(palima_port_0_phy_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(palima_port_0_phy_start_seq),

  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(palima_phy_delay_seq),

  /* Check if the PHY PLL is locked */
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(palima_port_0_phy_poll_seq),

  /* Perform post power up sequence */
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_port_x1_lane_seq),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_pcie_0_post_phy_pwr_up_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(palima_post_phy_pwr_up_init_seq),

  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_set_link_speed_gen_3),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_post_phy_pwr_up_dbi_init_seq),
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_init_cfg_t palima_port_1_phy_init_cfg[] =
{
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(palima_port_1_phy_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(palima_port_1_phy_start_seq),

  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(palima_phy_delay_seq),

  /* Check if the PHY PLL is locked */
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(palima_port_1_phy_poll_seq),

  /* Perform post power up sequence */
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_port_x2_lane_seq),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_pcie_1_post_phy_pwr_up_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(palima_post_phy_pwr_up_init_seq),
     
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_set_link_speed_gen_4),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(palima_post_phy_pwr_up_dbi_init_seq),
 ...
 ******************************************************************************/
static pcie_port_config_t palima_port_0_cfg[] =
{
   {
      .hw_rp_index            = 0,
      .port_clk_cfg           = &palima_pcie_clk_rp0,
      .port_gpio_cfg          = palima_gpio_config_rp0,
      .port_mem_bases         = palima_port_0_mem_region,
      .port_phy_init_cfg      = palima_port_0_phy_init_cfg,
      .port_phy_deinit_cfg    = palima_port_0_phy_de_init_cfg,
      .loopback_cfg           = &palima_port_0_loopback_seq,
      .perst_pin              = PALIMA_RC_0_GPIO_PCIE_RESET,
      .iommu_cfg              = "PCIE0",
      .pmic_cfg               = &palima_port_0_pmic_cfg,
 ...
 ******************************************************************************/
static pcie_port_config_t palima_port_1_cfg[] =
{
   {
      .hw_rp_index            = 1,
      .port_clk_cfg           = &palima_pcie_clk_rp1,
      .port_gpio_cfg          = palima_gpio_config_rp1,
      .port_mem_bases         = palima_port_1_mem_region,
      .port_phy_init_cfg      = palima_port_1_phy_init_cfg,
      .port_phy_deinit_cfg    = palima_port_1_phy_de_init_cfg,
      .loopback_cfg           = &palima_port_1_loopback_seq,
      .perst_pin              = PALIMA_RC_1_GPIO_PCIE_RESET,
      .iommu_cfg              = "PCIE1",
      .pmic_cfg               = &palima_port_1_pmic_cfg,
      .aspm                   = aspm_l1_ena_l0s_ena,
   },
};

/*******************************************************************************
 *               Palima port configurations for public
 ******************************************************************************/
pcie_port_options_config_t palima_target_port_options[] = 
{
   {
      ...
      .ports_config_cnt = ARRAY_LENGTH(palima_port_0_cfg),
      .ports_config_list = palima_port_0_cfg,
   },

   {
      ...
      .default_enable = 1,   // No HW conditional, so enable it by default
      .config_select_condition = NULL,
      .ports_config_cnt = ARRAY_LENGTH(palima_port_1_cfg),
      .ports_config_list = palima_port_1_cfg,
   },
};

static mem_region_t palima_target_common_mem_regions[] =
{
  /* TCSR register space */
