#ifndef __FILLMORE_ROOT_PORT_0_CONFIG_H__
#define __FILLMORE_ROOT_PORT_0_CONFIG_H__
/*
...
static const pcie_pmic_config_t fillmore_port_0_pmic_cfg = 
{
 ...
 *    Register region map
 ******************************************************************************/
static const mem_region_t fillmore_port_0_mem_region[max_mem_reg] =
{
 ...
 ******************************************************************************/
STATIC CONST ICBArb_RequestType fillmore_pcie_0_icb_request[] =
{
  {
...
STATIC CONST ICBArb_MasterSlaveType fillmore_pcie_0_icb_mstr_slv_lst[] =
{
  {
...
STATIC pcieIcbClkBW_t fillmore_pcie_0_icb_bw[] =
{
  {
    .npa_client_name = "pcie_0",
    .ms_list = fillmore_pcie_0_icb_mstr_slv_lst,
    .ms_size = sizeof(fillmore_pcie_0_icb_mstr_slv_lst),
    .req_list = fillmore_pcie_0_icb_request,
    .req_size = sizeof(fillmore_pcie_0_icb_request)
  }
};
 ...
 ******************************************************************************/
STATIC CONST char * fillmore_pcie_reset_clks_rp0[] =
{
  "gcc_pcie_0_aux_clk",
  NULL
};

STATIC CONST char * fillmore_pcie_gcc_clks_rp0[] =
{
...
CONST pcie_clk_mux_cfg_t fillmore_pcie_0_clk_mux = 
{
...
CONST clk_freq_cfg_t fillmore_pcie_0_clk_settings[] =
{
...
STATIC CONST pcie_clocks_cfg_t fillmore_pcie_clk_rp0 =
{
   .clk_pwr    = "gcc_pcie_0_gdsc",
   .core_clks  = fillmore_pcie_gcc_clks_rp0,
   .clk_reset  = fillmore_pcie_reset_clks_rp0,
   .clk_mux    = &fillmore_pcie_0_clk_mux,
   .clk_freq   = fillmore_pcie_0_clk_settings,
   .icb_bw     = fillmore_pcie_0_icb_bw,
};

/*******************************************************************************
 *              PCIe port GPIO settings
 ******************************************************************************/
#define FILLMORE_RC_0_GPIO_PCIE_RESET      117
#define FILLMORE_RC_0_GPIO_CLK_REQ         118
#define FILLMORE_RC_0_GPIO_PCIE_WAKE       119

STATIC CONST pcie_gpio_cfg_t fillmore_gpio_config_rp0[] =
{
  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = FILLMORE_RC_0_GPIO_CLK_REQ,
    .tlmm.func_sel       = 1,
...

  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = FILLMORE_RC_0_GPIO_PCIE_RESET,
    .tlmm.func_sel       = 0,
...

  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = FILLMORE_RC_0_GPIO_PCIE_WAKE,
    .tlmm.func_sel       = 0,
    .tlmm.direction      = GPIO_INPUT,
    .tlmm.pull           = GPIO_PULL_UP,
    .tlmm.drive_strength = GPIO_2MA,
 ...
 *
 *******************************************************************************/
STATIC CONST pcie_reg_write_val_t fillmore_port_0_phy_init_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t fillmore_port_0_phy_start_seq[] =
{
...
STATIC CONST pcie_reg_op_t fillmore_port_0_phy_poll_seq[] =
{
...
STATIC CONST pcie_reg_op_t fillmore_pcie_0_post_phy_pwr_up_init_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t fillmore_port_0_phy_de_init_seq[] =
{
   {HWIO_OFFS(PCIE_USB3_UNI_PCS_POWER_DOWN_CONTROL),    0x00},
   {PCIE_REG_OP_STOP},
};

STATIC CONST pcie_reg_init_cfg_t fillmore_port_0_phy_de_init_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(fillmore_port_0_phy_de_init_seq),
  {PcieSeq_Stop},
};
...
STATIC CONST pcie_reg_write_val_t fillmore_port_0_phy_lpb_en_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t fillmore_port_0_phy_lpb_dis_seq[] =
{
...
STATIC CONST pcie_reg_init_cfg_t fillmore_port_0_phy_lpb_en_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(fillmore_port_0_phy_lpb_en_seq),
  {PcieSeq_Stop},
};

STATIC CONST pcie_reg_init_cfg_t fillmore_port_0_phy_lpb_dis_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(fillmore_port_0_phy_lpb_dis_seq),
  {PcieSeq_Stop},
};

STATIC CONST pcie_loopback_cfg_t fillmore_port_0_loopback_seq = 
{
   fillmore_port_0_phy_lpb_en_cfg,
   fillmore_port_0_phy_lpb_dis_cfg,
};

/*******************************************************************************
 * Register set reset sequences
 ******************************************************************************/
static const pcie_reg_op_t fillmore_port_0_reg_reset_seq[] = 
{
#if 0
