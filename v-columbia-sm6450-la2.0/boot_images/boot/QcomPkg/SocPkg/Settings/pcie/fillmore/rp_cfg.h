#ifndef __FILLMORE_ROOT_PORT_CONFIG_H__
#define __FILLMORE_ROOT_PORT_CONFIG_H__
/*
...
STATIC CONST pcie_reg_op_t fillmore_port_x1_lane_seq[] =
{
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_op_t fillmore_post_phy_pwr_up_init_seq[] =
{
...
STATIC CONST pcie_reg_op_t fillmore_phy_delay_seq[] =
{
...
STATIC CONST pcie_reg_op_t fillmore_set_link_speed_gen_3[] =
{
    /* Link Speed */
...
STATIC CONST pcie_reg_op_t fillmore_post_phy_pwr_up_dbi_init_seq[] =
{
    /* Fix NFTS */
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_init_cfg_t fillmore_port_0_phy_init_cfg[] =
{
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(fillmore_port_0_phy_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(fillmore_port_0_phy_start_seq),

  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(fillmore_phy_delay_seq),

  /* Check if the PHY PLL is locked */
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(fillmore_port_0_phy_poll_seq),

  /* Perform post power up sequence */
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(fillmore_port_x1_lane_seq),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(fillmore_pcie_0_post_phy_pwr_up_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(fillmore_post_phy_pwr_up_init_seq),

  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(fillmore_set_link_speed_gen_3),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(fillmore_post_phy_pwr_up_dbi_init_seq),
 ...
 ******************************************************************************/
static pcie_port_config_t fillmore_port_0_cfg[] =
{
   {
      .hw_rp_index            = 0,
      .port_clk_cfg           = &fillmore_pcie_clk_rp0,
      .port_gpio_cfg          = fillmore_gpio_config_rp0,
      .port_mem_bases         = fillmore_port_0_mem_region,
      .port_phy_init_cfg      = fillmore_port_0_phy_init_cfg,
      .port_phy_deinit_cfg    = fillmore_port_0_phy_de_init_cfg,
      .loopback_cfg           = &fillmore_port_0_loopback_seq,
      .perst_pin              = FILLMORE_RC_0_GPIO_PCIE_RESET,
      .iommu_cfg              = "PCIE0",
      .pmic_cfg               = &fillmore_port_0_pmic_cfg,
      .aspm                   = aspm_l1_ena_l0s_ena,
   },
};

/*******************************************************************************
 *               Fillmore port configurations for public
 ******************************************************************************/
pcie_port_options_config_t fillmore_target_port_options[] = 
{
   {
      ...
      .ports_config_cnt = ARRAY_LENGTH(fillmore_port_0_cfg),
      .ports_config_list = fillmore_port_0_cfg,
   },
};

static mem_region_t fillmore_target_common_mem_regions[] =
{
  /* TCSR register space */
