#ifndef __CLARENCE_ROOT_PORT_0_CONFIG_H__
#define __CLARENCE_ROOT_PORT_0_CONFIG_H__
/*
...
===============================================================================
   ...
   --------   ---     ---------------------------------------------------------
   08/31/23   ms      updated mem region
   04/20/23   ms      Created new for clarence
...
static const pcie_pmic_config_t clarence_port_0_pmic_cfg = 
{
 ...
 *    Register region map
 ******************************************************************************/
static const mem_region_t clarence_port_0_mem_region[max_mem_reg] =
{
  /* axi_reg: DBI register space */
  {.pa=PCIE_GEN3X1_PCIE_WRAPPER_AXI_X1_BASE, .sz=PCIE_GEN3X1_PCIE_WRAPPER_AXI_X1_BASE_SIZE},

  /* ahb_reg: PARF register space */
  {.pa=PCIE0_PCIE_WRAPPER_AHB_W_PHY_G3X1_BASE, .sz=PCIE0_PCIE_WRAPPER_AHB_W_PHY_G3X1_BASE_SIZE},
 ...
 ******************************************************************************/
STATIC CONST ICBArb_RequestType clarence_pcie_0_icb_request[] =
{
  {
...
STATIC CONST ICBArb_MasterSlaveType clarence_pcie_0_icb_mstr_slv_lst[] =
{
  {
...
STATIC pcieIcbClkBW_t clarence_pcie_0_icb_bw[] =
{
  {
    .npa_client_name = "pcie_0",
    .ms_list = clarence_pcie_0_icb_mstr_slv_lst,
    .ms_size = sizeof(clarence_pcie_0_icb_mstr_slv_lst),
    .req_list = clarence_pcie_0_icb_request,
    .req_size = sizeof(clarence_pcie_0_icb_request)
  }
};
 ...
 ******************************************************************************/
STATIC CONST char * clarence_pcie_reset_clks_rp0[] =
{
  "gcc_pcie_0_aux_clk",
  NULL
};

STATIC CONST char * clarence_pcie_gcc_clks_rp0[] =
{
...
CONST pcie_clk_mux_cfg_t clarence_pcie_0_clk_mux = 
{
...
CONST clk_freq_cfg_t clarence_pcie_0_clk_settings[] =
{
...
STATIC CONST pcie_clocks_cfg_t clarence_pcie_clk_rp0 =
{
   .clk_pwr    = "gcc_pcie_0_gdsc",
   .core_clks  = clarence_pcie_gcc_clks_rp0,
   .clk_reset  = clarence_pcie_reset_clks_rp0,
   .clk_mux    = &clarence_pcie_0_clk_mux,
   .clk_freq   = clarence_pcie_0_clk_settings,
   .icb_bw     = clarence_pcie_0_icb_bw,
};

/*******************************************************************************
 *              PCIe port GPIO settings
 ******************************************************************************/
#define CLARENCE_RC_0_GPIO_PCIE_RESET      32
#define CLARENCE_RC_0_GPIO_CLK_REQ         107
#define CLARENCE_RC_0_GPIO_PCIE_WAKE       31

STATIC CONST pcie_gpio_cfg_t clarence_gpio_config_rp0[] =
{
  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = CLARENCE_RC_0_GPIO_CLK_REQ,
    .tlmm.func_sel       = 1,
...

  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = CLARENCE_RC_0_GPIO_PCIE_RESET,
    .tlmm.func_sel       = 0,
...

  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = CLARENCE_RC_0_GPIO_PCIE_WAKE,
    .tlmm.func_sel       = 0,
    .tlmm.direction      = GPIO_INPUT,
    .tlmm.pull           = GPIO_PULL_UP,
    .tlmm.drive_strength = GPIO_2MA,
 ...
 *
 *******************************************************************************/
STATIC CONST pcie_reg_write_val_t clarence_port_0_phy_init_seq[] =
{
   ...
   {HWIO_OFFS(QSERDES_RX_VGA_CAL_CNTRL2),    0x07},
   {HWIO_OFFS(QSERDES_TX_RES_CODE_LANE_OFFSET_TX),    0x16},
   {HWIO_OFFS(QSERDES_TX_RES_CODE_LANE_OFFSET_RX),    0x04},
...
STATIC CONST pcie_reg_write_val_t clarence_port_0_phy_start_seq[] =
{
...
STATIC CONST pcie_reg_op_t clarence_port_0_phy_poll_seq[] =
{
...
STATIC CONST pcie_reg_op_t clarence_pcie_0_post_phy_pwr_up_init_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t clarence_port_0_phy_de_init_seq[] =
{
   {HWIO_OFFS(PCIE_USB3_UNI_PCS_POWER_DOWN_CONTROL),    0x00},
   {PCIE_REG_OP_STOP},
};

STATIC CONST pcie_reg_init_cfg_t clarence_port_0_phy_de_init_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(clarence_port_0_phy_de_init_seq),
  {PcieSeq_Stop},
};
...
STATIC CONST pcie_reg_write_val_t clarence_port_0_phy_lpb_en_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t clarence_port_0_phy_lpb_dis_seq[] =
{
...
STATIC CONST pcie_reg_init_cfg_t clarence_port_0_phy_lpb_en_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(clarence_port_0_phy_lpb_en_seq),
  {PcieSeq_Stop},
};

STATIC CONST pcie_reg_init_cfg_t clarence_port_0_phy_lpb_dis_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(clarence_port_0_phy_lpb_dis_seq),
  {PcieSeq_Stop},
};

STATIC CONST pcie_loopback_cfg_t clarence_port_0_loopback_seq = 
{
   clarence_port_0_phy_lpb_en_cfg,
   clarence_port_0_phy_lpb_dis_cfg,
};

/*******************************************************************************
 * Register set reset sequences
 ******************************************************************************/
static const pcie_reg_op_t clarence_port_0_reg_reset_seq[] = 
{
#if 0
