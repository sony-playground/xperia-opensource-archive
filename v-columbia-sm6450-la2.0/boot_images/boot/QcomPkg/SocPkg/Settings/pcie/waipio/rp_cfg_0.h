#ifndef __WAIPIO_ROOT_PORT_0_CONFIG_H__
#define __WAIPIO_ROOT_PORT_0_CONFIG_H__
/*
...
static const pcie_pmic_config_t waipio_port_0_pmic_cfg = 
{
 ...
 *    Register region map
 ******************************************************************************/
static const mem_region_t waipio_port_0_mem_region[max_mem_reg] =
{
 ...
 ******************************************************************************/
STATIC CONST ICBArb_RequestType waipio_pcie_0_icb_request[] =
{
  {
...
STATIC CONST ICBArb_MasterSlaveType waipio_pcie_0_icb_mstr_slv_lst[] =
{
  {
...
STATIC pcieIcbClkBW_t waipio_pcie_0_icb_bw[] =
{
  {
    .npa_client_name = "pcie_0",
    .ms_list = waipio_pcie_0_icb_mstr_slv_lst,
    .ms_size = sizeof(waipio_pcie_0_icb_mstr_slv_lst),
    .req_list = waipio_pcie_0_icb_request,
    .req_size = sizeof(waipio_pcie_0_icb_request)
  }
};
 ...
 ******************************************************************************/
STATIC CONST char * waipio_pcie_reset_clks_rp0[] =
{
  "gcc_pcie_0_aux_clk",
  NULL
};

STATIC CONST char * waipio_pcie_gcc_clks_rp0[] =
{
...
CONST pcie_clk_mux_cfg_t waipio_pcie_0_clk_mux = 
{
...
CONST clk_freq_cfg_t waipio_pcie_0_clk_settings[] =
{
...
STATIC CONST pcie_clocks_cfg_t waipio_pcie_clk_rp0 =
{
   .clk_pwr    = "gcc_pcie_0_gdsc",
   .core_clks  = waipio_pcie_gcc_clks_rp0,
   .clk_reset  = waipio_pcie_reset_clks_rp0,
   .clk_mux    = &waipio_pcie_0_clk_mux,
   .clk_freq   = waipio_pcie_0_clk_settings,
   .icb_bw     = waipio_pcie_0_icb_bw,
};

/*******************************************************************************
 *              PCIe port GPIO settings
 ******************************************************************************/
#define WAIPIO_RC_0_GPIO_PCIE_RESET      94
#define WAIPIO_RC_0_GPIO_CLK_REQ         95
#define WAIPIO_RC_0_GPIO_PCIE_WAKE       96

STATIC CONST pcie_gpio_cfg_t waipio_gpio_config_rp0[] =
{
  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = WAIPIO_RC_0_GPIO_CLK_REQ,
    .tlmm.func_sel       = 1,
...

  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = WAIPIO_RC_0_GPIO_PCIE_RESET,
    .tlmm.func_sel       = 0,
...

  {
   .cfg_type = MSM_GPIO,
   {
    .tlmm.gpio_num       = WAIPIO_RC_0_GPIO_PCIE_WAKE,
    .tlmm.func_sel       = 0,
    .tlmm.direction      = GPIO_INPUT,
    .tlmm.pull           = GPIO_PULL_UP,
    .tlmm.drive_strength = GPIO_2MA,
 ...
 *
 *******************************************************************************/
STATIC CONST pcie_reg_write_val_t waipio_port_0_phy_init_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t waipio_port_0_phy_start_seq[] =
{
...
STATIC CONST pcie_reg_op_t waipio_port_0_phy_poll_seq[] =
{
...
STATIC CONST pcie_reg_op_t waipio_pcie_0_post_phy_pwr_up_init_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t waipio_port_0_phy_de_init_seq[] =
{
   {HWIO_OFFS(PCIE_USB3_UNI_PCS_POWER_DOWN_CONTROL),    0x00},
   {PCIE_REG_OP_STOP},
};

STATIC CONST pcie_reg_init_cfg_t waipio_port_0_phy_de_init_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(waipio_port_0_phy_de_init_seq),
  {PcieSeq_Stop},
};
...
STATIC CONST pcie_reg_write_val_t waipio_port_0_phy_lpb_en_seq[] =
{
...
STATIC CONST pcie_reg_write_val_t waipio_port_0_phy_lpb_dis_seq[] =
{
...
STATIC CONST pcie_reg_init_cfg_t waipio_port_0_phy_lpb_en_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(waipio_port_0_phy_lpb_en_seq),
  {PcieSeq_Stop},
};

STATIC CONST pcie_reg_init_cfg_t waipio_port_0_phy_lpb_dis_cfg[] =
{
  {PcieQcSoCVer_All,     ahb_reg,  REG_WRITE_TYPE(waipio_port_0_phy_lpb_dis_seq),
  {PcieSeq_Stop},
};

STATIC CONST pcie_loopback_cfg_t waipio_port_0_loopback_seq = 
{
   waipio_port_0_phy_lpb_en_cfg,
   waipio_port_0_phy_lpb_dis_cfg,
};

/*******************************************************************************
 * Register set reset sequences
 ******************************************************************************/
static const pcie_reg_op_t waipio_port_0_reg_reset_seq[] = 
{
#if 0
