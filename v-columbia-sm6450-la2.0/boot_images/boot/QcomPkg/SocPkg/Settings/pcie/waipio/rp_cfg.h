#ifndef __WAIPIO_ROOT_PORT_CONFIG_H__
#define __WAIPIO_ROOT_PORT_CONFIG_H__
/*
...
STATIC CONST pcie_reg_op_t waipio_port_x2_lane_seq[] =
{
...
STATIC CONST pcie_reg_op_t waipio_port_x1_lane_seq[] =
{
   {PCIE_REG_OP_RMW, HWIO_OFFS(PCIE_PORT_LINK_CTRL_OFF), HWIO_PCIE_PORT_LINK_CTRL_OFF_LINK_CAPABLE_BMSK,
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_op_t waipio_post_phy_pwr_up_init_seq[] =
{
...
STATIC CONST pcie_reg_op_t waipio_phy_delay_seq[] =
{
...
STATIC CONST pcie_reg_op_t waipio_set_link_speed_gen_3[] =
{
    /* Link Speed */
...
STATIC CONST pcie_reg_op_t waipio_set_link_speed_gen_4[] =
{
    /* Link Speed */
...
STATIC CONST pcie_reg_op_t waipio_post_phy_pwr_up_dbi_init_seq[] =
{
    /* Fix NFTS */
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_init_cfg_t waipio_port_0_phy_init_cfg[] =
{
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(waipio_port_0_phy_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(waipio_port_0_phy_start_seq),

  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(waipio_phy_delay_seq),

  /* Check if the PHY PLL is locked */
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(waipio_port_0_phy_poll_seq),

  /* Perform post power up sequence */
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_port_x1_lane_seq),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_pcie_0_post_phy_pwr_up_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(waipio_post_phy_pwr_up_init_seq),

  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_set_link_speed_gen_3),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_post_phy_pwr_up_dbi_init_seq),
 ...
 ******************************************************************************/
STATIC CONST pcie_reg_init_cfg_t waipio_port_1_phy_init_cfg[] =
{
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(waipio_port_1_phy_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_WRITE_TYPE(waipio_port_1_phy_start_seq),

  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(waipio_phy_delay_seq),

  /* Check if the PHY PLL is locked */
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(waipio_port_1_phy_poll_seq),

  /* Perform post power up sequence */
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_port_x2_lane_seq),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_pcie_1_post_phy_pwr_up_init_seq),
  {PcieQcSoCVer_All,    ahb_reg,  REG_OP_TYPE(waipio_post_phy_pwr_up_init_seq),
     
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_set_link_speed_gen_4),
  {PcieQcSoCVer_All,    axi_reg,  REG_OP_TYPE(waipio_post_phy_pwr_up_dbi_init_seq),
 ...
 ******************************************************************************/
static pcie_port_config_t waipio_port_0_cfg[] =
{
   {
      .hw_rp_index            = 0,
      .port_clk_cfg           = &waipio_pcie_clk_rp0,
      .port_gpio_cfg          = waipio_gpio_config_rp0,
      .port_mem_bases         = waipio_port_0_mem_region,
      .port_phy_init_cfg      = waipio_port_0_phy_init_cfg,
      .port_phy_deinit_cfg    = waipio_port_0_phy_de_init_cfg,
      .loopback_cfg           = &waipio_port_0_loopback_seq,
      .perst_pin              = WAIPIO_RC_0_GPIO_PCIE_RESET,
      .iommu_cfg              = "PCIE0",
      .pmic_cfg               = &waipio_port_0_pmic_cfg,
 ...
 ******************************************************************************/
static pcie_port_config_t waipio_port_1_cfg[] =
{
   {
      .hw_rp_index            = 1,
      .port_clk_cfg           = &waipio_pcie_clk_rp1,
      .port_gpio_cfg          = waipio_gpio_config_rp1,
      .port_mem_bases         = waipio_port_1_mem_region,
      .port_phy_init_cfg      = waipio_port_1_phy_init_cfg,
      .port_phy_deinit_cfg    = waipio_port_1_phy_de_init_cfg,
      .loopback_cfg           = &waipio_port_1_loopback_seq,
      .perst_pin              = WAIPIO_RC_1_GPIO_PCIE_RESET,
      .iommu_cfg              = "PCIE1",
      .pmic_cfg               = &waipio_port_1_pmic_cfg,
      .aspm                   = aspm_l1_ena_l0s_ena,
   },
};

/*******************************************************************************
 *               Waipio port configurations for public
 ******************************************************************************/
pcie_port_options_config_t waipio_target_port_options[] = 
{
   {
      ...
      .ports_config_cnt = ARRAY_LENGTH(waipio_port_0_cfg),
      .ports_config_list = waipio_port_0_cfg,
   },

   {
      ...
      .default_enable = 1,   // No HW conditional, so enable it by default
      .config_select_condition = NULL,
      .ports_config_cnt = ARRAY_LENGTH(waipio_port_1_cfg),
      .ports_config_list = waipio_port_1_cfg,
   },
};

static mem_region_t waipio_target_common_mem_regions[] =
{
  /* TCSR register space */
