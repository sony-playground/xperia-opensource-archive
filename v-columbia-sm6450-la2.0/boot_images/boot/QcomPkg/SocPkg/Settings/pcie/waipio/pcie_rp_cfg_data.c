...
===============================================================================
   ...
   --------   ---     ---------------------------------------------------------
   03/07/22   Ps      Waipio specific cfg data separated from other tgt
...
pcie_target_config_t waipio_pcie_tgt_config_data = 
{ 
    .config_data_version = PCIE_CONFIG_DATA_VERSION,
    .target_chip_id = PCIE_TARGET_CHIP_ID_IGNORE,
    .target_chip_family = EFICHIPINFO_FAMILY_WAIPIO,
    .target_platform_type = 0, // EFI_PLATFORMINFO_TYPE_CDP,  //   CDP

    .target_port_option_cnt = ARRAY_LENGTH(waipio_target_port_options),
    .target_port_option_list = waipio_target_port_options,
    .entp_mgmt_addr = 0,
