 ...
 *  
 *    Platform: Waipio.XX.1.0
 *    Revision: NO REVISIONS (Working Set)
 *    Template Version: 
 *    $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Settings/PMIC/pm_config_pam.c#5 $ 
 *    $DateTime: 2021/08/16 10:38:10 $  $Author: pwbldsvc $
 *  
...
pm_pam_pcie1_rails_info [] = 
{
    ...
    { (void*)pm_pam_pcie1_b_ldo6, PM_PRM_RSRC_VRM_VREG },
