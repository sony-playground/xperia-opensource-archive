...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Settings/ICB/loader/icbcfg_data.c#11 $
$DateTime: 2022/04/18 15:02:39 $
$Author: pwbldsvc $
$Change: 36651068 $
...
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_qm_cfg_data_waipio_v1[] =
{
  /* Enable QM core cgc */
...
icbcfg_prop_seg_type icbcfg_qm_cfg_seg_waipio_v1 = 
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_qm_cfg_data_waipio_v1),
  /* Pointer to config data array */ 
  icbcfg_qm_cfg_data_waipio_v1                                    
};

/*---------------------------------------------------------------------------*/
/* Init Config Segment list                                                  */
/*---------------------------------------------------------------------------*/
icbcfg_prop_seg_type *icbcfg_boot_segs_waipio_v1[] =
{
  &icbcfg_qm_cfg_seg_waipio_v1,
};

icbcfg_prop_type icbcfg_boot_prop_waipio_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_boot_segs_waipio_v1),
  /* Pointer to config data array */
  icbcfg_boot_segs_waipio_v1
};
...
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_gemnoc_cfg_data_waipio_v1[] =
{
  /* Modem Victim mode */
...
icbcfg_prop_seg_type icbcfg_gemnoc_cfg_seg_waipio_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_gemnoc_cfg_data_waipio_v1),
  /* Pointer to config data array */
  icbcfg_gemnoc_cfg_data_waipio_v1
};

/*---------------------------------------------------------------------------*/
/* LLCC Config Segment                                                       */
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_llcc_cfg_data_waipio_v1[] =
{
...
icbcfg_prop_seg_type icbcfg_llcc_cfg_seg_waipio_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_llcc_cfg_data_waipio_v1),
  /* Pointer to config data array */
  icbcfg_llcc_cfg_data_waipio_v1
};

/*---------------------------------------------------------------------------*/
/* LLCC Config Segment                                                       */
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_wa_data_waipio_v1[] =
{
  /* QCTDD07436397: Disable ECO for GPU. */
  ICBCFG_HWIO_DW(GEM_NOC_SW_CGC_DISABLE_SBM_FLAGOUTSET0_LOW, 0x1),
};

icbcfg_prop_seg_type icbcfg_wa_seg_waipio_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_wa_data_waipio_v1),
  /* Pointer to config data array */
  icbcfg_wa_data_waipio_v1
};

/*---------------------------------------------------------------------------*/
/* PostInit Config Segment list                                              */
/*---------------------------------------------------------------------------*/
icbcfg_prop_seg_type *icbcfg_post_boot_segs_waipio_v1[] =
{
  &icbcfg_gemnoc_cfg_seg_waipio_v1,
  &icbcfg_llcc_cfg_seg_waipio_v1,
  &icbcfg_wa_seg_waipio_v1,
};

icbcfg_prop_type icbcfg_post_prop_waipio_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_post_boot_segs_waipio_v1),
  /* Pointer to config data array */
  icbcfg_post_boot_segs_waipio_v1
};

icbcfg_mem_region_type map_ddr_regions_waipio_v1[] =
{
...
icbcfg_device_config_type waipio_v1 =
{
  /* Chip version information for this device data. */
  CHIPINFO_FAMILY_WAIPIO,      /**< Chip family */
  false,                       /**< Exact match for version? */
  0,                           /**< Chip version */

  /* Device information. */
  ARRAY_SIZE(map_ddr_regions_waipio_v1), /**< Number of regions in the DDR map */
  map_ddr_regions_waipio_v1,             /**< Array of mappable DDR regions */
  6,                                     /**< Number of mapping segments. */
  4,                                     /**< Number of channels. */
  36,                                    /**< Address width in bits. */
  ICBCFG_ADDR_TRANS_LLCC,                /**< Address translator hardware type. */
  trans_bases_waipio_v1,                 /**< Translation block base addresses. */

  /* Prop lists. */
  &icbcfg_boot_prop_waipio_v1,           /**< Init time prop list. */
  &icbcfg_post_prop_waipio_v1,           /**< Post-init time prop list. */
};
...
/* GEMNOC Config Segment                                                     */
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_gemnoc_cfg_data_waipio_v2[] =
{
  /* Modem Victim mode */
  ICBCFG_HWIO_DW(LLCC_BROADCAST_ORLLCC_FEAC_TCM0_CFG,          0x0007C000),
  ICBCFG_HWIO_DW(LLCC_BROADCAST_ORLLCC_FEAC_TCM0_MASK_CFG,     0x00001F80),
...
icbcfg_prop_seg_type icbcfg_gemnoc_cfg_seg_waipio_v2 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_gemnoc_cfg_data_waipio_v2),
  /* Pointer to config data array */
  icbcfg_gemnoc_cfg_data_waipio_v2
};

/*---------------------------------------------------------------------------*/
/* PostInit Config Segment list                                              */
/*---------------------------------------------------------------------------*/
icbcfg_prop_seg_type *icbcfg_post_boot_segs_waipio_v2[] =
{
  &icbcfg_gemnoc_cfg_seg_waipio_v2,
  &icbcfg_llcc_cfg_seg_waipio_v1,
  &icbcfg_wa_seg_waipio_v1,
};

icbcfg_prop_type icbcfg_post_prop_waipio_v2 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_post_boot_segs_waipio_v2),
  /* Pointer to config data array */
  icbcfg_post_boot_segs_waipio_v2
};

icbcfg_device_config_type waipio_v2 =
{
  /* Chip version information for this device data. */
  CHIPINFO_FAMILY_WAIPIO,      /**< Chip family */
  false,                       /**< Exact match for version? */
  ...
  /* Prop lists. */
  &icbcfg_boot_prop_waipio_v1,           /**< Init time prop list. */
  &icbcfg_post_prop_waipio_v2,           /**< Post-init time prop list. */
};

/*---------------------------------------------------------------------------*/
/* TARGET LIST                                                               */
/*---------------------------------------------------------------------------*/
icbcfg_device_config_type *configs_waipio[] =
{
  &waipio_v2,
  &waipio_v1,
};
