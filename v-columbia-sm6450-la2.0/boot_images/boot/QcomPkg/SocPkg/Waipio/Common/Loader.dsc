...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Waipio$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -DBOOT_PBL_H=\"pbl_sbl_shared.h\" -I$(WORKSPACE)/QcomPkg/SocPkg/Waipio/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Waipio/Library/EUDTargetLib/EUDTargetLib.inf

     # NAND libraries
     NandCommonLib|QcomPkg/Library/NullLibs/NandLibNull/NandLibNull.inf

     # Buttons libraries
     ButtonsBootLib|QcomPkg/SocPkg/Waipio/Library/ButtonsTargetLib/ButtonsBootLib.inf
     ...
     ClockTargetLib|QcomPkg/SocPkg/Waipio/Library/ClockTargetLib/ClockTargetLib.inf
     TLMMTargetLib|QcomPkg/SocPkg/Waipio/Library/TLMMTargetLib/TLMMTargetLib.inf
     ...
     PmicLoaderLib|QcomPkg/SocPkg/Waipio/Library/PmicLib/loader/PmicLoaderLib.inf
     ...
     BootSmemLib|QcomPkg/XBLLoader/BootSmem/BootSmem.inf
     SmemImageLib|QcomPkg/SocPkg/Waipio/Library/SmemImageLib/SmemImageLib.inf
