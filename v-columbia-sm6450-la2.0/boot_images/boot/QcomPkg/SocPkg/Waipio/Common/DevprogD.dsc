...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Waipio$(VAR)/DevprogD
...
[Components.common]
  QcomPkg/DevPrg/DevPrgD.inf {
     <LibraryClasses>
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Waipio/Library/PmicLib/loader/PmicDevprogLib.inf
