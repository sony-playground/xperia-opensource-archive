...
/*
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Include/msmhwiobase.h#6 $
  $DateTime: 2021/08/10 20:11:22 $
  $Author: pwbldsvc $
...
#define QUPV3_2_QUPV3_ID_0_BASE                                     0x00800000
#define QUPV3_2_QUPV3_ID_0_BASE_SIZE                                0x00100000
#define QUPV3_2_QUPV3_ID_0_BASE_PHYS                                0x00800000

/*----------------------------------------------------------------------------
 * BASE: QUPV3_0_QUPV3_ID_1
 *--------------------------------------------------------------------------*/

#define QUPV3_0_QUPV3_ID_1_BASE                                     0x00900000
#define QUPV3_0_QUPV3_ID_1_BASE_SIZE                                0x00100000
#define QUPV3_0_QUPV3_ID_1_BASE_PHYS                                0x00900000

/*----------------------------------------------------------------------------
 * BASE: QUPV3_1_QUPV3_ID_0
 *--------------------------------------------------------------------------*/

#define QUPV3_1_QUPV3_ID_0_BASE                                     0x00a00000
#define QUPV3_1_QUPV3_ID_0_BASE_SIZE                                0x00100000
#define QUPV3_1_QUPV3_ID_0_BASE_PHYS                                0x00a00000
...
#define PCIE0_PCIE_WRAPPER_AHB_W_PHY_G3X1_EDMA_BASE                 0x01c00000
#define PCIE0_PCIE_WRAPPER_AHB_W_PHY_G3X1_EDMA_BASE_SIZE            0x00008000
#define PCIE0_PCIE_WRAPPER_AHB_W_PHY_G3X1_EDMA_BASE_PHYS            0x01c00000
...
#define PCIE1_PCIE_WRAPPER_AHB_W_PHY_G4X2_EDMA_BASE_PHYS            0x01c08000
...
#define SSC_QDSP6_TCM_BASE                                          0x02000000
#define SSC_QDSP6_TCM_BASE_SIZE                                     0x00000000
#define SSC_QDSP6_TCM_BASE_PHYS                                     0x02000000

/*----------------------------------------------------------------------------
 * BASE: SSC
 *--------------------------------------------------------------------------*/

#define SSC_BASE                                                    0x02000000
...
#define SSC_QDSP6_TCM_END_BASE                                      0x023fffff
#define SSC_QDSP6_TCM_END_BASE_SIZE                                 0x00000000
#define SSC_QDSP6_TCM_END_BASE_PHYS                                 0x023fffff

/*----------------------------------------------------------------------------
 * BASE: SSC_SDC_CODE_RAM_START_ADDRESS
 *--------------------------------------------------------------------------*/

#define SSC_SDC_CODE_RAM_START_ADDRESS_BASE                         0x02800000
#define SSC_SDC_CODE_RAM_START_ADDRESS_BASE_SIZE                    0x00000000
#define SSC_SDC_CODE_RAM_START_ADDRESS_BASE_PHYS                    0x02800000

/*----------------------------------------------------------------------------
 * BASE: SSC_SDC_CODE_RAM_END_ADDRESS
 *--------------------------------------------------------------------------*/

#define SSC_SDC_CODE_RAM_END_ADDRESS_BASE                           0x02817fff
#define SSC_SDC_CODE_RAM_END_ADDRESS_BASE_SIZE                      0x00000000
#define SSC_SDC_CODE_RAM_END_ADDRESS_BASE_PHYS                      0x02817fff

/*----------------------------------------------------------------------------
 * BASE: SSC_SDC_DATA_RAM_START_ADDRESS
 *--------------------------------------------------------------------------*/

#define SSC_SDC_DATA_RAM_START_ADDRESS_BASE                         0x028e0000
#define SSC_SDC_DATA_RAM_START_ADDRESS_BASE_SIZE                    0x00000000
#define SSC_SDC_DATA_RAM_START_ADDRESS_BASE_PHYS                    0x028e0000

/*----------------------------------------------------------------------------
 * BASE: SSC_SDC_DATA_RAM_END_ADDRESS
 *--------------------------------------------------------------------------*/

#define SSC_SDC_DATA_RAM_END_ADDRESS_BASE                           0x028effff
#define SSC_SDC_DATA_RAM_END_ADDRESS_BASE_SIZE                      0x00000000
#define SSC_SDC_DATA_RAM_END_ADDRESS_BASE_PHYS                      0x028effff

/*----------------------------------------------------------------------------
 * BASE: SSC_RAM_START_ADDRESS
 *--------------------------------------------------------------------------*/

#define SSC_RAM_START_ADDRESS_BASE                                  0x02ba0000
#define SSC_RAM_START_ADDRESS_BASE_SIZE                             0x00000000
#define SSC_RAM_START_ADDRESS_BASE_PHYS                             0x02ba0000

/*----------------------------------------------------------------------------
 * BASE: SSC_RAM_END_ADDRESS
 *--------------------------------------------------------------------------*/

#define SSC_RAM_END_ADDRESS_BASE                                    0x02bad7ff
#define SSC_RAM_END_ADDRESS_BASE_SIZE                               0x00000000
#define SSC_RAM_END_ADDRESS_BASE_PHYS                               0x02bad7ff
...
#define PCIE_GEN4X2_PCIE_WRAPPER_AXI_X2_WITH_EDMA_BASE              0x40000000
#define PCIE_GEN4X2_PCIE_WRAPPER_AXI_X2_WITH_EDMA_BASE_SIZE         0x02000000
#define PCIE_GEN4X2_PCIE_WRAPPER_AXI_X2_WITH_EDMA_BASE_PHYS         0x40000000
...
#define PCIE_GEN3X1_PCIE_WRAPPER_AXI_X1_WITH_EDMA_BASE              0x60000000
#define PCIE_GEN3X1_PCIE_WRAPPER_AXI_X1_WITH_EDMA_BASE_SIZE         0x02000000
#define PCIE_GEN3X1_PCIE_WRAPPER_AXI_X1_WITH_EDMA_BASE_PHYS         0x60000000
