 ...
 *                   command mode DSC                             *
 ******************************************************************/
const static int8 r66451_60hz_fhd_plus_dsc_cmd_xmldata[] =
...
"<?xml version=\"1.0\" encoding=\"utf - 8\"?>"
"<PanelName>R66451 Visionox</PanelName>"
"<PanelDescription>R66451 Visionox Single DSI DSC Command Mode Amoled Panel for secondary panel (1440x2560 24bpp)</PanelDescription>"
"<Group id=\"Active Timing\">"
  "<HorizontalActive>1080</HorizontalActive>"
  "<HorizontalFrontPorch>95</HorizontalFrontPorch>"
  "<HorizontalBackPorch>40</HorizontalBackPorch>"
...
static MDP_Status Panel_CDP_PowerUp(MDP_Display_IDType eDisplayId)
{
  ...
  else
  {
    ...
    if (PM_ERR_FLAG_SUCCESS != pm_ldo_sw_mode(PMIC_D, PM_LDO_1, PM_SW_MODE_NPM))
    {
      MDP_Log_Message(MDP_LOGLEVEL_ERROR, "DisplayDxe: Error configuring LDO1D to NPM mode\n");
    }

    if (PM_ERR_FLAG_SUCCESS != pm_ldo_volt_level(PMIC_D, PM_LDO_1, 1200000, TRUE))
    {
      MDP_Log_Message(MDP_LOGLEVEL_ERROR, "DisplayDxe: Error configuring LDO1D to 1.2V\n");
    }
    ...
    {
      MDP_Log_Message(MDP_LOGLEVEL_ERROR, "DisplayDxe: Error enabling LDO1D\n");
    }
  ...
  case MDPPLATFORM_CONFIG_GETPANELCONFIG:
    {
      ...
      case MDP_DISPLAY_PRIMARY:
        ...
        default:
          pPlatformParams->sPlatformPanel.pPanelXMLConfig = (int8*)r66451_60hz_fhd_plus_dsc_cmd_xmldata;
          pPlatformParams->sPlatformPanel.uConfigSize     = sizeof(r66451_60hz_fhd_plus_dsc_cmd_xmldata);
          break;
