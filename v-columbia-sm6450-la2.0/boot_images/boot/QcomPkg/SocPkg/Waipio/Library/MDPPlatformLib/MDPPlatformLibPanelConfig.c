...
/*===========================================================================
                        Defines
===========================================================================*/
#define HDK_DISP_DSI_STATUS_GPIO	64         /* GPIO LOW: DSI panel, HIGH: HDMI */
...
static MDPPlatformHardwareConfig sHwConfig[] =
{
  ...
  MDP_PLATFORM_CREATE_PANEL_HW_CONFIG_POWER(Panel_HDK_PowerUp, Panel_HDK_PowerDown)                              /*HW_CONFIG_DEFAULT_BRIGHT_PWM_CON_GPIO*/
};
...
static PhysicalPanelConfigType sPhysicalPanelConfigTable[] =
{
  ...
  {"r66451_sec_120hz_fhd_dsc_vid",             "Panel_secondary_r66451_120hz_fhd_plus_dsc_vid.xml",       "qcom,mdss_dsi_visionox_r66451_fhd_plus_video:",               &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
  ...
  {"nt36672c_90hz_fhd_vid_cphy",               "Panel_nt36672c_fhd_plus_90hz_video_cphy.xml",             "qcom,mdss_dsi_nt36672c_fhd_plus_90hz_video:",                 &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_HDK_POWER]},
  ...
  {"r66451_144hz_dsc_cmd_cphy_demura_spr", "Panel_r66451_144hz_fhd_plus_dsc_cmd_cphy_demura_SPR.xml", "qcom,mdss_dsi_r66451_fhd_plus_144hz_cphy_cmd:",               &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
};
...
static PlatformDSIDetectParams uefiDphyPanelList[] = {
    // Panel #0 - R66451 fhd single dsc Command Mode Panel (1080x2340 24bpp)
    {
      "r66451_120hz_fhd_dsc_cmd",
      0x06,                                                  // uCmdType
      0x05,                                                  // total number of retry on failures
      {
        {{0x68, 0x00},                                       // address to read ID1
        {0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}     // expected readback
        },
      },
    ...
    else
    {
      ...
      case EFI_PLATFORMINFO_TYPE_MTP:
      {
        if (((0x10000 == pPlatformInfo->sEFIPlatformType.version) ||
             (0x10001 == pPlatformInfo->sEFIPlatformType.version))&& 
             (1       == pPlatformInfo->sEFIPlatformType.subtype))
        {
          // Fusion device with rm69299 visionox panel
          MDPPlatformSetPanelName(pPlatformPanel->szName, "rm69299_amoled_fhd_plus_video");
        }
        ...
        {
          // r66451 visionox CPhy panel
          MDPPlatformSetPanelName(pPlatformPanel->szName, "r66451_120hz_fhd_dsc_cmd_cphy");
        }
		else if ((0x10000 == pPlatformInfo->sEFIPlatformType.version) &&
                 (5       == pPlatformInfo->sEFIPlatformType.subtype))
        {
          // vtdr6130 visionox cmd mode panel
      ...
      case EFI_PLATFORMINFO_TYPE_HDK:
      {
        ...
        {
          MDPPlatformSetPanelName(pPlatformPanel->szName, "nt36672c_90hz_fhd_vid_cphy");
        }
        else
        {
          MDPPlatformClearPanelName(pPlatformPanel->szName);
