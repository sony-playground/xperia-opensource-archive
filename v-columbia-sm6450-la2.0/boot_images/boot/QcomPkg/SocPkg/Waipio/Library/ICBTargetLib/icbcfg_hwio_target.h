...
/*
    ...
    $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Library/ICBTargetLib/icbcfg_hwio_target.h#2 $
    $DateTime: 2020/07/27 16:13:19 $
    $Author: pwbldsvc $
...
#define LLCC2_LLCC_BEAC0_REG_BASE                                                                       (DDR_SS_BASE            + 0x00360000)
#define LLCC2_LLCC_BEAC0_REG_BASE_SIZE                                                                  0xa000
#define LLCC2_LLCC_BEAC0_REG_BASE_USED                                                                  0x806c
...
#define LLCC1_LLCC_BEAC0_REG_BASE                                                                       (DDR_SS_BASE            + 0x00660000)
...
#define LLCC3_LLCC_BEAC0_REG_BASE                                                                       (DDR_SS_BASE            + 0x00760000)
#define LLCC3_LLCC_BEAC0_REG_BASE_SIZE                                                                  0xa000
#define LLCC3_LLCC_BEAC0_REG_BASE_USED                                                                  0x806c
