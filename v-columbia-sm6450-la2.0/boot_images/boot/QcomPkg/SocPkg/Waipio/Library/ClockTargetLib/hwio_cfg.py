...
#  ===========================================================================
#
#  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Library/ClockTargetLib/hwio_cfg.py#2 $
#  $DateTime: 2021/11/30 21:49:07 $
#  $Author: pwbldsvc $
#
#  ===========================================================================
...
_header = """
#include <HALhwio.h>
#include <Waipio/Include/msmhwiobase.h>
...
_clock_mods = [
  ...
  'PHY_REFGEN_2_NORTH_CM_PHY_REFGEN_NXGEN',
