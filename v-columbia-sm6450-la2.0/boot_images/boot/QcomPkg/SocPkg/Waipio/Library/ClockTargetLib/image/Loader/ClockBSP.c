...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM8450v1 (waipio_1.0):
      ...
      APSS_CC   : waipio_apss_cc_waipio_apss_1.0_p3q3r544_fp50 [palima_apss_cc.r1]
      GCC       : waipio_gcc_z_waipio_clk_ctl_p3q3r9.5_fp26 [waipio_gcc.r36]
      GPU_CC    : waipio_gpu_cc_z_gpu_cc_5.1_p3q2r10.03.9292_fp24 [waipio_gpu_cc.r6]

    SM8450v2 (waipio_2.0):
      PLL_HSR   : 2.0
      AOSS_CC   : waipio_aoss_cc_z_aoss_cc_5.0_p3q3r8.5_fp12 [waipio_aoss_cc.r6]
      APSS_CC   : waipio_apss_cc_waipio_apss_2.0_p3q3r71_fp59 [waipio_2.0_apss_cc.r1]
      GCC       : waipio_gcc_z_waipio_clk_ctl_p3q3r100.5_fp27 [waipio_gcc.r36]
      GPU_CC    : waipio_gpu_cc_z_gpu_cc_5.1_p3q2r10.03.9292_fp25 [waipio_v2_gpu_cc.r3]
...
{'db_override': {'GCC': {'cbc': {'gcc_aggre_ufs_phy_axi_clk': {'func_group': 'ufs_phy'},
 ...
 'generators': [{'options': {'clock_flags': {'gcc_gpll0': ['DO_NOT_DISABLE'],
                             ...
                             'hal_ctl_structs': {'aoss_cc_pll1': 'HAL_clk_xbl_PongoevoWaipioPLLControl',
...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Library/ClockTargetLib/image/Loader/ClockBSP.c#10 $
...
extern HAL_clk_xbl_SourceControlType      HAL_clk_xbl_TaycanevoPLLControl;
extern HAL_clk_xbl_SourceControlType      HAL_clk_xbl_ZondaevoPLLControl;

/*
 * Custom control structures.
 */
extern HAL_clk_xbl_SourceControlType      HAL_clk_xbl_PongoevoWaipioPLLControl;
...
{
  {
    ...
    .HWVersion = {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO},
  },
  {
    .HALSettings = {
      .nConfigCtl   = 0x08200800,
    ...
    .HWVersion = {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO},
  },
};

static const ClockSourceRegSettingsType ClockSourceRegSettings_GCC_GCCGPLL3[] =
{
  {
    .HALSettings = {
      .nConfigCtl   = 0x00000000,
      .nConfigCtl1  = 0x000001C0,
      .nTestCtl     = 0x00000000,
      .nTestCtl1    = 0x00000000,
      .nUserCtl     = 0x00000000,
      .nUserCtl1    = 0x00000002,
    },
  },
};
...
{
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 71   }, {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO}},
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 74   }, {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO}},
};
...
{
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 86   }, {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO}},
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 91   }, {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO}},
};
...
{
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 63   }, {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO}},
  { { 0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 66   }, {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO}},
};
...
{
  { { 0x00004555, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 44   }, {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO}},
  { { 0x000092AA, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 45   }, {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO}},
};
...
ClockSourceNodeType ClockSource_AOSSCC_AOSSCCPLL1 =
{
  ...
  .pmControl                  = &HAL_clk_xbl_PongoevoWaipioPLLControl,
...
ClockSourceNodeType ClockSource_GCC_GCCGPLL3 =
{
  ...
  .pmControl                  = &HAL_clk_xbl_TaycanevoPLLControl,
  .pCalibrationFreqConfig     = ClockSourceBSP_GCC_GCCGPLL3,
  .nCalibrationFreqConfigLen  = SIZEOF_ARRAY(ClockSourceBSP_GCC_GCCGPLL3),
  .pRegSettings               = ClockSourceRegSettings_GCC_GCCGPLL3,
  .nRegSettingsLen            = SIZEOF_ARRAY(ClockSourceRegSettings_GCC_GCCGPLL3),
};
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 16 /* ClockSource_XO */                      ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = APSS_CC_XO_PRE_DFD_BR_CLK_SRC */
  {  600000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 1,     2,     0,     0,     0xFF }, 6 /* ClockSource_GCC_GCCGPLL0 */             ,  0 /* 600.0   Mhz */ ,  },   /* Mux[1] = GCC_GPLL0_DIV */
  { 1363200000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 2 /* ClockSource_APSSCC_APSSCCGOLDPLL */     ,  0 /* 1363.0  Mhz */ , {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO} },   /* Mux[2] = APSS_CC_GOLD_PLL_OUT_MAIN */
  { 1420800000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 2 /* ClockSource_APSSCC_APSSCCGOLDPLL */     ,  1 /* 1420.0  Mhz */ , {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO} },   /* Mux[2] = APSS_CC_GOLD_PLL_OUT_MAIN */
};

/*
 * ClockDomainBSP_APSSCC_APSSCCGOLDPLUSMUX
 *
 * Used by:
 *   ClockDomain_APSSCC_APSSCCGOLDPLUSMUX
 */
static ClockMuxConfigType ClockDomainBSP_APSSCC_APSSCCGOLDPLUSMUX[] =
{
  {  600000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 1,     2,     0,     0,     0xFF }, 6 /* ClockSource_GCC_GCCGPLL0 */             ,  0 /* 600.0   Mhz */ ,  },   /* Mux[1] = GCC_GPLL0_DIV */
};
...
{
  { 1209600000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 4 /* ClockSource_APSSCC_APSSCCL3PLL */       ,  0 /* 1209.0  Mhz */ , {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO} },   /* Mux[2] = APSS_CC_L3_PLL_OUT_MAIN */
  { 1267200000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 4 /* ClockSource_APSSCC_APSSCCL3PLL */       ,  1 /* 1267.0  Mhz */ , {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO} },   /* Mux[2] = APSS_CC_L3_PLL_OUT_MAIN */
};
...
{
  { 1363200000, RAIL_VOLTAGE_LEVEL_NOM,        { 2,     2,     0,     0,     0xFF }, 5 /* ClockSource_APSSCC_APSSCCSILVERPLL */   ,  0 /* 1363.0  Mhz */ ,  },   /* Mux[2] = APSS_CC_SILVER_PLL_OUT_MAIN */
};
...
{
  {  533000000, RAIL_VOLTAGE_LEVEL_NOM,        { 4,     4,     0,     0,     0x05 }, 7 /* ClockSource_GCC_GCCGPLL1 */             ,  0 /* 1066.0  Mhz */ , {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_WAIPIO} },   /* Mux[4] = GCC_GPLL1_OUT_MAIN */
  {  600000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     2,     0,     0,     0x05 }, 6 /* ClockSource_GCC_GCCGPLL0 */             ,  0 /* 600.0   Mhz */ , {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_WAIPIO} },   /* Mux[1] = GCC_GPLL0_OUT_MAIN_PWRGRP3_CLKGEN_ACGC_CLK */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC2APPS[] =
{
  ...
  {   50000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     12,    0,     0,     0xFF }, 6 /* ClockSource_GCC_GCCGPLL0 */             ,  0 /* 300.0   Mhz */ ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP18_CLKGEN_ACGC_CLK */
  ...
  {  202000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 2,     8,     0,     0,     0xFF }, 15 /* ClockSource_GCC_GCCGPLL9 */            ,  0 /* 808.0   Mhz */ ,  },   /* Mux[2] = GCC_GPLL9_OUT_MAIN */
};
...
{
  .aBSP      = ClockDomainBSP_APSSCC_APSSCCGOLDPLUSMUX,
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_APSSCC_APSSCCGOLDPLUSMUX),
  .eMaster   = CLOCK_MASTER_DEFAULT,
