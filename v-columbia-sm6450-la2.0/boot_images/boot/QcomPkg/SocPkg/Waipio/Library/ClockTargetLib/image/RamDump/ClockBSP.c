...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM8450v1 (waipio_1.0):
      ...
      GCC       : waipio_gcc_z_waipio_clk_ctl_p3q3r9.5_fp26 [waipio_gcc.r31]

    SM8450v2 (waipio_2.0):
      PLL_HSR   : 2.0
      DISP_CC   : waipio_disp_cc_z_disp_cc_5.0_p3q2r7.13_fp22 [waipio_disp_cc.r6]
      GCC       : waipio_gcc_z_waipio_clk_ctl_p3q3r100.5_fp27 [waipio_gcc.r31]
...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Waipio/Library/ClockTargetLib/image/RamDump/ClockBSP.c#5 $
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 5 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
...
{
  {      32000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 5 /* ClockSource_XO */                       ,  0 /* 0.0     Mhz */ ,  },   /* Mux[0] = CHIP_SLEEP_CLK */
};
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0x00 }, 5 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
...
{
  {     400000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     24,    1,     4,     0xFF }, 5 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
  ...
  {   50000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     12,    0,     0,     0xFF }, 2 /* ClockSource_GCC_GCCGPLL0 */             ,  0 /* 300.0   Mhz */ ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP18_CLKGEN_ACGC_CLK */
  ...
  {  202000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 2,     8,     0,     0,     0xFF }, 4 /* ClockSource_GCC_GCCGPLL9 */             ,  0 /* 808.0   Mhz */ ,  },   /* Mux[2] = GCC_GPLL9_OUT_MAIN */
};
...
{
  {    9600000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     4,     0,     0,     0xFF }, 5 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0xFF }, 5 /* ClockSource_XO */                       ,  0 /* 19.0    Mhz */ ,  },   /* Mux[0] = BI_TCXO */
};
