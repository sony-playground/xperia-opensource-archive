...
#  @file HALclkHWIO.py
#
#  @brief HWIO config for the Palima XBL Loader Clock HWIO generation.
#
...
#  ===========================================================================
#
#  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Palima/Library/HALclkLib/HALclkHWIO.py#2 $
