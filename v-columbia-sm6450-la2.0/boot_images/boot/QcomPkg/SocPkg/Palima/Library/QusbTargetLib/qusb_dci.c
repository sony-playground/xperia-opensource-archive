 ...
 * @ref         
 *
 *              Copyright (c) 2013-2015,2018-2020 Qualcomm Technologies Incorporated.
 *              All Rights Reserved.
...
void qusb_dci_read_enum_cookie(uint32 *cookie)
{
  *cookie = (*(uint32 *)(QUSB_SINGLE_BOOT_ENUM_ADDR));
  // TODO: Palima PBL did not write cookie, will fix in v2, and can be remove
