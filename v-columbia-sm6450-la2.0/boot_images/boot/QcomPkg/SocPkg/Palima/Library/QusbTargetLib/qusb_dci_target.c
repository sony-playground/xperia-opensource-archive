...
//============================================================================
/**
  Copyright (c) 2013-2015, 2017-2020 Qualcomm Technologies, Inc. All rights reserved.
...
boolean qusb_ss_phy_init(void)
{
  ...
  boolean retimer_result = usb_shared_redriver_set_usb_mode(0, USB4_MODE_TYPE_USB3, qusb_dci_ss_lane);
  if (retimer_result==FALSE)
  {
    usb_shared_uart_log_error("qusb_ss_phy_init, redriver failed ", 0);
  }
  //usb_shared_uart_log_error("qusb_ss_phy_init, retimer pass ", 0);
