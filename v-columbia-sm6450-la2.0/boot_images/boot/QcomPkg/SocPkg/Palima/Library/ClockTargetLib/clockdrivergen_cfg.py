...
HAL_CONTROL = {
  'aoss_cc_pll1':          'HAL_clk_xbl_PongoolePalimaPLLControl',
  ...
  'generators': [
    {
      ...
      'options': {
        ...
        'include_only_freqs': {'.*qup.*wrap._s.*': [7372800, 14745600, 19200000, 48000000], '.*ufs.*': [300000000]},
        ...
        'include_only_clocknames': ['.*qup.*_s.*', 'gcc_memnoc_clk', 'gcc_shrm_clk'],
