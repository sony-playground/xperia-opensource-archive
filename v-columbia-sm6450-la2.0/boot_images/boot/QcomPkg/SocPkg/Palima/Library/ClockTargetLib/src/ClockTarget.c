...
HAL_clk_xbl_SourceControlType HAL_clk_xbl_ZondaOleWAPLLControl;
...
ClockResult Clock_InitTarget(rail_voltage_level eBootCorner)
{
   ...
   */
  HAL_clk_xbl_ZondaOleWAPLLControl =
  (HAL_clk_xbl_SourceControlType) {
    .Enable         = HAL_clk_xbl_ZondaolePLLControl.Enable,
    .IsEnabled      = HAL_clk_xbl_ZondaolePLLControl.IsEnabled,
    .Config         = HAL_clk_xbl_ZondaolePLLControl.Config,
    .ConfigPLL      = HAL_clk_xbl_ZondaOleWAPLLConfigPLL,
    .EnableVote     = HAL_clk_xbl_ZondaolePLLControl.EnableVote,
    .IsVoteEnabled  = HAL_clk_xbl_ZondaolePLLControl.IsVoteEnabled,
    .SetCalConfig   = HAL_clk_xbl_ZondaolePLLControl.SetCalConfig,
    .SetRegSettings = HAL_clk_xbl_ZondaolePLLControl.SetRegSettings,
  };
