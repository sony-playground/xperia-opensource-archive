...
*/
/**
    @file llcc_trp_palima_and.h
    @brief Auto-generated HWIO interface include file.

    Reference chip release:
        SM8450 (Palima) [palima_v1.0_p3q3r17.2_MTO_POST_SI]
    ...
    { 'explicit-addressing': True,
      'filename': 'llcc_trp_palima_and.h',
...
/*
    ...
    $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Palima/Library/SystemCacheTargetLib/llcc_trp_reg_or.h#1 $
