...
----------   ---     -------------------------------------------------------------- 
2022-04-28   ssb     Updated DLL_CONFIG_2_DEFAULT_VAL for SDR104
2022-04-22   ssb     Updated Speed mode values as per DT 
2022-02-07   cm      Move default values to Target Files
2021-11-09   cm      DDR50 mode removal from cap reg
...
/******************************************************************************
                           S D C C    B S P
******************************************************************************/
#define SDCC_BSP_DLL_CONFIG_DEFAULT_VAL                      0x7442C
#define SDCC_BSP_DLL_CONFIG_2_DEFAULT_VAL     				0x87C00
#define SDCC_BSP_DLL_CONFIG_3_DEFAULT_VAL    				0x08
#define SDCC_BSP_DDR_CONFIG_DEFAULT_VAL          			0x80040868
#define SDCC_BSP_DLL_USER_CTRL_DEFAULT_VAL                 0x090106C0
#define SDCC_BSP_DLL_TEST_CTRL_DEFAULT_VAL                  0x1800000
#define SDCC_BSP_DLL_CONFIG_2_DEFAULT_SDR50_VAL		0x5400

#define SDCC_BSP_DEFAULT_DRIVE_STRENGTH                      0x1FB6
#define SDCC_BSP_DEFAULT_DRIVE_STRENGTH_CTL0            0x1FB6
