...
Copyright 2018-2021 by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================*/
...
07/28/20   ds           palima updates for whitelist and mem regions
07/17/20   ds           palima updates for memmap and rumi validation
06/24/20   ds           palima update for memmap and hwio
...
#define SCL_IMEM_UNUSED_REGION_SIZE      SIZE_84KB
...
#define AOSS_ISLAND_RAM_SIZE             SIZE_16KB
...
#define SCL_SHRM_MEM_SHRM_BASE    0x19060000
#define SCL_SHRM_MEM_SHRM_SIZE    SIZE_64KB

// Clock Group Name
#define CLK_FREQ_GRP_NAME "core"
