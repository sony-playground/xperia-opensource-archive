...
----------   ---     ----------------------------------------------------------
2022-06-22   vm      Update Post Si Palima PHY version 8.0
2022-03-18   vm      Update Post Si Palima PHY.
2022-03-09   cm      Update Post Si Palima PHY.
2021-10-08   cm      Update latest for Palima PHY.
2021-10-08   cm      Update for Palima PHY.
2021-05-04   jt      Update for PHY version 26.0 
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_table[] = {
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_CP_CTRL_MODE1_OFFS,                 0x14}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_PLL_RCTRL_MODE1_OFFS,               0x18}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_PLL_CCTRL_MODE1_OFFS,               0x18}, 
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_TX0_TX_FR_DCC_CTRL_OFFS,   				0x4C},
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_end_table[] = {
   ...
   { 0x00, HWIO_UFS_MEM_UFS_PHY_PLL_CNTL_OFFS,                     0x0B},
...
static struct ufs_mphy_init_item ufs_bsp_mphy_2_lane_init_table[] = {
	 ...
	 { 0x00, HWIO_UFS_MEM_QSERDES_TX1_TX_FR_DCC_CTRL_OFFS,				  0x4C},
