...
XML_DEPS = $(WORKSPACE)/QcomPkg/SocPkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/PMIC/pm_config_target_core.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/ADC/internal/core/adc_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/ADC/internal/core/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/Settings/PlatformInfo/PlatformInfo.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/ICB/core/icbcfg_arb.xml \
		   $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/GPI/core/gpi_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/HWIO/$(MACRO_NAME)/DalHWIO.xml \
...
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/DALConfig/DALConfigCoreLib_LA.mk
# \
