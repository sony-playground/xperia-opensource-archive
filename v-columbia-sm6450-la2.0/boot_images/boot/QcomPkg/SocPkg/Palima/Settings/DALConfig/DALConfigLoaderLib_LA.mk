...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/DALConfig/*.h \
...
XML_DEPS = $(WORKSPACE)/QcomPkg/SocPkg/Settings/BootTempCheck/boot_temp_check_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/TLMM/loader/TLMMChipset.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/UFS/ufs_config.xml \
           $(WORKSPACE)/QcomPkg/Settings/PlatformInfo/PlatformInfo.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/PMIC/pm_config_target_loader.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/ADC/internal/loader/adc_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/ADC/internal/loader/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/SMEM/smem_xbl_loader.xml \
           ...
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/ICB/loader/icbcfg_boot.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/TSENS/tsens_props.xml
...
IMAGE_CFG_XML = $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/DALConfig/image_cfg.xml
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SocPkg/Palima/Settings/DALConfig/DALConfigLoaderLib_LA.mk
