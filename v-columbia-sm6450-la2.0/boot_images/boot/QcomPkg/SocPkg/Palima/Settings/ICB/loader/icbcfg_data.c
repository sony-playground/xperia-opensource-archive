...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Palima/Settings/ICB/loader/icbcfg_data.c#2 $
$DateTime: 2021/10/21 22:46:49 $
$Author: pwbldsvc $
$Change: 33594944 $
...
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_qm_cfg_data_palima_v1[] =
{
  /* Enable QM core cgc */
...
icbcfg_prop_seg_type icbcfg_qm_cfg_seg_palima_v1 = 
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_qm_cfg_data_palima_v1),
  /* Pointer to config data array */ 
  icbcfg_qm_cfg_data_palima_v1                                    
};

/*---------------------------------------------------------------------------*/
/* Init Config Segment list                                                  */
/*---------------------------------------------------------------------------*/
icbcfg_prop_seg_type *icbcfg_boot_segs_palima_v1[] =
{
  &icbcfg_qm_cfg_seg_palima_v1,
};

icbcfg_prop_type icbcfg_boot_prop_palima_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_boot_segs_palima_v1),
  /* Pointer to config data array */
  icbcfg_boot_segs_palima_v1
};
...
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_gemnoc_cfg_data_palima_v1[] =
{
  /* Modem Victim mode */
...
icbcfg_prop_seg_type icbcfg_gemnoc_cfg_seg_palima_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_gemnoc_cfg_data_palima_v1),
  /* Pointer to config data array */
  icbcfg_gemnoc_cfg_data_palima_v1
};

/*---------------------------------------------------------------------------*/
/* LLCC Config Segment                                                       */
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_llcc_cfg_data_palima_v1[] =
{
...
icbcfg_prop_seg_type icbcfg_llcc_cfg_seg_palima_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_llcc_cfg_data_palima_v1),
  /* Pointer to config data array */
  icbcfg_llcc_cfg_data_palima_v1
};

/*---------------------------------------------------------------------------*/
/* LLCC Config Segment                                                       */
/*---------------------------------------------------------------------------*/
icbcfg_data_type icbcfg_wa_data_palima_v1[] =
{
  /* QCTDD07436397: Disable ECO for GPU. */
  ICBCFG_HWIO_DW(GEM_NOC_SW_CGC_DISABLE_SBM_FLAGOUTSET0_LOW, 0x1),
};

icbcfg_prop_seg_type icbcfg_wa_seg_palima_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_wa_data_palima_v1),
  /* Pointer to config data array */
  icbcfg_wa_data_palima_v1
};

/*---------------------------------------------------------------------------*/
/* PostInit Config Segment list                                              */
/*---------------------------------------------------------------------------*/
icbcfg_prop_seg_type *icbcfg_post_boot_segs_palima_v1[] =
{
  &icbcfg_gemnoc_cfg_seg_palima_v1,
  &icbcfg_llcc_cfg_seg_palima_v1,
  &icbcfg_wa_seg_palima_v1,
};

icbcfg_prop_type icbcfg_post_prop_palima_v1 =
{
  /* Length of the config  data array */
  ARRAY_SIZE(icbcfg_post_boot_segs_palima_v1),
  /* Pointer to config data array */
  icbcfg_post_boot_segs_palima_v1
};

icbcfg_mem_region_type map_ddr_regions_palima_v1[] =
{
...
icbcfg_device_config_type palima_v1 =
{
  /* Chip version information for this device data. */
  CHIPINFO_FAMILY_PALIMA,      /**< Chip family */
  false,                       /**< Exact match for version? */
  0,                           /**< Chip version */

  /* Device information. */
  ARRAY_SIZE(map_ddr_regions_palima_v1), /**< Number of regions in the DDR map */
  map_ddr_regions_palima_v1,             /**< Array of mappable DDR regions */
  6,                                     /**< Number of mapping segments. */
  4,                                     /**< Number of channels. */
  36,                                    /**< Address width in bits. */
  ICBCFG_ADDR_TRANS_LLCC,                /**< Address translator hardware type. */
  trans_bases_palima_v1,                 /**< Translation block base addresses. */

  /* Prop lists. */
  &icbcfg_boot_prop_palima_v1,           /**< Init time prop list. */
  &icbcfg_post_prop_palima_v1,           /**< Post-init time prop list. */
};

/*---------------------------------------------------------------------------*/
/* TARGET LIST                                                               */
/*---------------------------------------------------------------------------*/
icbcfg_device_config_type *configs_palima[] =
{
  &palima_v1,
};
