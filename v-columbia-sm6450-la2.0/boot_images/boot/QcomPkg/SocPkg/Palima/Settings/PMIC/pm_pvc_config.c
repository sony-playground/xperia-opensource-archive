...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Palima/Settings/PMIC/pm_pvc_config.c#2 $
...
{
  {0x7, 0x9B40}, /* S1H_CTRL_VSET_LB */
  {0x7, 0x9B41}, /* S1H_CTRL_VSET_UB */
  {0x7, 0x9B45}, /* S1H_CTRL_MODE_CTL */
  {0x7, 0x9B46}  /* S1H_CTRL_EN_CTL */
};
...
{
  {0x1, 0x9B40}, /* S1B_CTRL_VSET_LB */
  {0x1, 0x9B41}, /* S1B_CTRL_VSET_UB */
  {0x1, 0x9B45}, /* S1B_CTRL_MODE_CTL */
  {0x1, 0x9B46}  /* S1B_CTRL_EN_CTL */
};
...
{
  {0x2, 0xC546}, /* MGPI0, UICC1, L5C */
  {0x0, 0x5A49}, /* MGPI1, NFC, LNBBCLK2 */
  {0x0, 0x0},    /* MGPI2, Spare */
  {0x0, 0x0},    /* MGPI3, HST_SW_CTRL, used by WLAN to be configured by MGPI module */
  {0x2, 0xC946}, /* MGPI4, SD card, default disabled unless for QRD */
  {0x2, 0xC446}, /* MGPI5, UICC0, L4C */
  {0x7, 0xC144}, /* MGPI6, AOP PDC TRIGGER, L1H RM/NPM control*/
