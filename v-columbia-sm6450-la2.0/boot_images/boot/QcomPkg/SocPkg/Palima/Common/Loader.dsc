...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Palima$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -DBOOT_PBL_H=\"pbl_sbl_shared.h\" -I$(WORKSPACE)/QcomPkg/SocPkg/Palima/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Palima/Library/EUDTargetLib/EUDTargetLib.inf

     # NAND libraries
     NandCommonLib|QcomPkg/Library/NullLibs/NandLibNull/NandLibNull.inf

     # Buttons libraries
     ButtonsBootLib|QcomPkg/SocPkg/Palima/Library/ButtonsTargetLib/ButtonsBootLib.inf
     ...
     TLMMTargetLib|QcomPkg/SocPkg/Palima/Library/TLMMTargetLib/TLMMTargetLib.inf
     ...
     PmicLoaderLib|QcomPkg/SocPkg/Palima/Library/PmicLib/loader/PmicLoaderLib.inf
     PmicPsiLib|QcomPkg/SocPkg/Palima/Library/PmicLib/loader/PmicPsiLib.inf
     ...
     SecTargetLib|SecPkg/Library/SecTargetLib/chipsets/Waipio/SecTargetLib.inf
     DbgInfoLib|SecPkg/Library/dbginfolib/build/DbgInfoLib.inf
     ACLib|SecPkg/Library/ACLib/ACLib.inf
     ACConfigDataLib|SecPkg/Library/ACConfigDataLib/waipio/ACConfigDataLib.inf
     ...
     BootSmemLib|QcomPkg/XBLLoader/BootSmem/BootSmem.inf
     SmemImageLib|QcomPkg/SocPkg/Palima/Library/SmemImageLib/SmemImageLib.inf
