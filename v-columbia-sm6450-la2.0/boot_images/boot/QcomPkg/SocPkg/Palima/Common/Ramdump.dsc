...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Palima$(VAR)/RamDump
...
#
  QcomPkg/XBLRamDump/XBLRamDump.inf {
    <LibraryClasses>
      ...
      ClockTargetLib|QcomPkg/SocPkg/Palima/Library/ClockTargetLib/ClockRamDumpLib.inf
      ...
      MDPPlatformLibBoot|QcomPkg/SocPkg/Palima/Library/MDPPlatformLibBoot/MDPPlatformLibBoot.inf
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Palima/Library/PmicLib/loader/PmicRamDump.inf
      ...
      UsbSharedLib|QcomPkg/SocPkg/Palima/Library/UsbSharedLib/UsbSharedLibRamdump.inf
