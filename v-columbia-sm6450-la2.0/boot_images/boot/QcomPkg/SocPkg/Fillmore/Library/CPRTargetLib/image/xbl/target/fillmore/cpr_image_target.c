 ...
 *
 * $DateTime: 2022/01/23 23:22:01 $
 * $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Library/CPRTargetLib/image/xbl/target/fillmore/cpr_image_target.c#9 $
 * $Change: 35060725 $
 */
...
{
    extern const cpr_settings cpr_settings_fillmore;

    return &cpr_settings_fillmore;
}
...
{
    //ToDo: After Fuse updated in IPCAT 
    //uint8 device_vpId = (CPR_HWIO_IN(0x221C2428) & 0xF0) >> 4;
	uint8 device_vpId = (CPR_HWIO_IN(HWIO_QFPROM_CORR_QC_SPARE_0_ROW0_LSB_ADDR) & HWIO_QFPROM_CORR_QC_SPARE_0_ROW0_LSB_SW_SPT_GLOBAL_RAILS_VPID_BMSK) >> HWIO_QFPROM_CORR_QC_SPARE_0_ROW0_LSB_SW_SPT_GLOBAL_RAILS_VPID_SHFT ;
