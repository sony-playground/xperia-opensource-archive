...
void HAL_clk_xbl_PongoEvoPLLFillmoreSetRegSettings ( HAL_clk_xbl_SourceDescType *pSource, const HAL_clk_xbl_SourceRegSettingsType *pmSettings);

/* ============================================================================
**    Data Declarations
** ==========================================================================*/

HAL_clk_xbl_SourceControlType HAL_clk_xbl_PongoevoFillmorePLLControl =
{
  ...
  .SetRegSettings   = HAL_clk_xbl_PongoEvoPLLFillmoreSetRegSettings,
};
...
)
{
   ...
   * outside the PLL.
   * HW Cr: CR#QCTDD07083928, checked with Shin Moe Wang and its applicable for Fillmore
   */
...
void HAL_clk_xbl_PongoEvoPLLFillmoreSetRegSettings
(
  HAL_clk_xbl_SourceDescType              *pSource,
