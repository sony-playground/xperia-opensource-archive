...
uint64 Clock_DCD_Cfg[] =
{
   ...
   HWIO_ADDR(GCC_CNOC_PCIE_QX_DCD_CDIV_DCDR),
   ...
   HWIO_ADDR(GCC_CONFIG_NOC_PCIE_DCD_CDIV_DCDR),
...
uint32_t Clock_ODSC_Ctl_Cfg[] =
{
  ...
  //HWIO_ADDR(GCC_QUPV3_WRAP_0_S_AHB_CBCR), /* Disabling due to multi EE issue. QCTDD10835649 */
  //HWIO_ADDR(GCC_QUPV3_WRAP_1_S_AHB_CBCR), /* Disabling due to multi EE issue. QCTDD10835649 */
...
uint32_t Clock_DCG_Ctl_Cfg[] =
{
   ...
   //HWIO_ADDR(GCC_LPASS_CFG_NOC_SWAY_CBCR), //HW CR: QCTDD09482166
   HWIO_ADDR(GCC_VDDCX_VS_CBCR),
   HWIO_ADDR(GCC_VDDMX_VS_CBCR),
   HWIO_ADDR(GCC_VS_CTRL_CBCR),
   HWIO_ADDR(GCC_APC_VS_CBCR),
   HWIO_ADDR(GCC_MDSS_VS_0_CBCR),
   HWIO_ADDR(GCC_MSS_SNOC_AXI_CBCR),
   HWIO_ADDR(GCC_GPU_MEMNOC_GFX_CBCR),
   HWIO_ADDR(GCC_CPUSS_CONFIG_NOC_SF_CBCR),
   //HWIO_ADDR(GCC_MMU_TCU_CBCR),
   //HWIO_ADDR(GCC_LPASS_CORE_AXIM_CBCR), //HW CR: QCTDD09482166
   //HWIO_ADDR(GCC_WPSS_AXI_CBCR), //bootup crash
...
*/
  ...
  /*
   * To address QCTDD07073315/QCTDD07513189, we need to set the following bits
  ...
  /*
   * Clocks below are unused post boot or open clocks.
   */
  HWIO_OUTF(GCC_AGGRE_NOC_AXI_CBCR, CLK_ENABLE, 0);
  HWIO_OUTF(GCC_MEMRED_P2S_CBCR , CLK_ENABLE, 0);

  HWIO_OUTF(GCC_DDRSS_TURING_Q6_AXI_CBCR, CLK_ENABLE, 1);
  HWIO_OUTF(GCC_QMIP_TURING_NSP_AHB_CBCR , CLK_ENABLE, 1);
  HWIO_OUTF(GCC_TURING_MMNOC_SF_CBCR, CLK_ENABLE, 1);
...
ClockResult Clock_ExitBoot(void)
{
  ...
  //Enabling ODSC after ICB_Config_Init is done, otherwise bootup crash is seen
