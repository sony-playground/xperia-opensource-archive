...
#define MC_VOTE_ADDR                    BCM_VOTETABLE_DRVr_NDd(8,0)   //bcm_phy_node_idx:-0
#define SHUB_VOTE_ADDR                  BCM_VOTETABLE_DRVr_NDd(8,1)   //bcm_phy_node_idx:-1
#define SYS_NOC_VOTE_ADDR               BCM_VOTETABLE_DRVr_NDd(8,4)   //bcm_phy_node_idx:-4
#define MMNOC_VOTE_ADDR                 BCM_VOTETABLE_DRVr_NDd(8,12)  //bcm_phy_node_idx:-12
#define CNOC_VOTE_ADDR                  BCM_VOTETABLE_DRVr_NDd(8,14)  //bcm_phy_node_idx:-14
#define CE_VOTE_ADDR                    BCM_VOTETABLE_DRVr_NDd(8,15)  //bcm_phy_node_idx:-15
#define IPA_VOTE_ADDR                   BCM_VOTETABLE_DRVr_NDd(8,16)  //bcm_phy_node_idx:-16
#define QUPV3_CORE_2X_VOTE_ADDR         BCM_VOTETABLE_DRVr_NDd(8,17)  //bcm_phy_node_idx:-17
#define CDSPNOC_VOTE_ADDR               BCM_VOTETABLE_DRVr_NDd(8,20)  //bcm_phy_node_idx:-20
#define HWKM_VOTE_ADDR               BCM_VOTETABLE_DRVr_NDd(8,x)  //bcm_phy_node_idx: not supported
#define PKA_VOTE_ADDR               BCM_VOTETABLE_DRVr_NDd(8,x)  //bcm_phy_node_idx: not supported
