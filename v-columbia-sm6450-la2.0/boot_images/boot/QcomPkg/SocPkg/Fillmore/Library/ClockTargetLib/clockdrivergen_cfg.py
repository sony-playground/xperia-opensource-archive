...
HAL_CONTROL = {
  ...
  'aoss_cc_pll1':          'HAL_clk_xbl_PongoevoFillmorePLLControl',
}
  ...
  'generators': [
    {
      ...
      'options': {
        ...
        'include_only_clocknames': ['.*qup.*wrap._s.*', 'gcc_memnoc_clk', 'gcc_shrm_clk'],
    ...
    },
    {
      ...
      'options': {
        ...
        'source_freq_config_format': source_freq_format,
        'domain_freq_config_format': domain_freq_format,
        'include_only_freqs': {'.*qup.*wrap._s.*': [7372800, 14745600, 19200000]},
...
if __name__ == "__main__":
  ...
  clockdrivergen_path = r'C:\Dropbox\Tools\clockdrivergen-func_groups\clockdrivergen-func_groups\bin\clockdrivergen.py'
