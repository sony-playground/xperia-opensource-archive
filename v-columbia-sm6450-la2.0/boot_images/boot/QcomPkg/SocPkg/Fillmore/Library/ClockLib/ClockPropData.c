...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Library/ClockLib/ClockPropData.c#5 $
...
ClockNameListType ClockDCDEnableDependencies[] =
{
  { "gcc_camera_xo_clk"   },
  { "gcc_camera_ahb_clk"  },
  { "cam_cc_core_ahb_clk" },// Needs to be enabled to trigger gcc_camera clocks
  { NULL },
};
