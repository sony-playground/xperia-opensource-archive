...
/*
  ...
  ====================================================================
  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Library/ClockLib/ClockAppsBSP.c#4 $
...
)
{
  ...
  {
    if (Clock_ReadEPSSLutData(pDrvCtxt, eCPU) != CLOCK_SUCCESS)
    {
      return CLOCK_ERROR;
    }
    if (Clock_SaveEPSSLutData(pDrvCtxt, eCPU) != CLOCK_SUCCESS)
    {
      return CLOCK_ERROR;
    }
  }
