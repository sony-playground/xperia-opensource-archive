...
/*
  ...
  ====================================================================
  $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Library/ClockLib/ClockAppsBSP.h#4 $
...
/**
  ...
  @param *pDrvCtxt [in] -- Handle to the Clock driver context.

  @return
  CLOCK_SUCCESS -- BSP initialized successfully.
  CLOCK_ERROR -- BSP initialization failed.
