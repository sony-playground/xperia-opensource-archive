...
static MDPPlatformPanelGpioType sSecondaryGpioConfig =
{
  ...
  81,  /* Display te gpio */
  2,   /* Display te gpio function select */
};
...
static PhysicalPanelConfigType sPhysicalPanelConfigTable[] =
{
  ...
  {"r66451_sec_60hz_fhd_dsc_vid",          "Panel_secondary_r66451_60hz_fhd_plus_dsc_vid.xml",    "qcom,mdss_dsi_visionox_r66451_fhd_plus_60hz_video:",          &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
  {"r66451_sec_60hz_fhd_dsc_cmd",          "Panel_secondary_r66451_60hz_fhd_plus_dsc_cmd.xml",    "qcom,mdss_dsi_visionox_r66451_fhd_plus_60hz_cmd:",            &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
  {"r66451_pri_60hz_fhd_dsc_vid",          "Panel_primary_r66451_60hz_fhd_plus_dsc_vid.xml",      "qcom,mdss_dsi_visionox_r66451_fhd_plus_60hz_video:",          &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
  {"r66451_pri_60hz_fhd_dsc_cmd",          "Panel_primary_r66451_60hz_fhd_plus_dsc_cmd.xml",      "qcom,mdss_dsi_visionox_r66451_fhd_plus_60hz_cmd:",            &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
  {"r66451_144hz_fhd_dsc_cmd_cphy_demura", "Panel_r66451_144hz_fhd_plus_dsc_cmd_cphy_demura.xml", "qcom,mdss_dsi_r66451_fhd_plus_144hz_cphy_cmd:",               &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
};
...
static PlatformDSIDetectParams uefiDphyPanelList[] = {
    // Panel #0 - NT36672e fhd plus 120 Video Mode Panel (1440x2880 24bpp)
    {
      "nt36672e_120hz_fhd_plus_vid",
      0x06,                                                  // uCmdType
...
*
* DESCRIPTION:
* The function returns the pointer and array size of uefiPanelList
*
***********************************************************************************************/
  ...
  else
  {
    ...
    else
    {
      ...
      case EFI_PLATFORMINFO_TYPE_ATP:
        MDPPlatformSetPanelName(pPlatformPanel->szName, DISPLAY_PANEL_ATP);
        break;
      case EFI_PLATFORMINFO_TYPE_IDP:
        if ((0x3 == pPlatformInfo->sEFIPlatformType.subtype))
        {
          MDPPlatformSetPanelName(pPlatformPanel->szName, DISPLAY_PANEL_IDPS);
          break;
        }
