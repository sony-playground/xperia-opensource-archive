...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Fillmore$(VAR)/DevprogD
...
[Components.common]
  QcomPkg/DevPrg/DevPrgD.inf {
     <LibraryClasses>
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Fillmore/Library/PmicLib/loader/PmicDevprogLib.inf
