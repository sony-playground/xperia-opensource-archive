...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Fillmore$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -DBOOT_PBL_H=\"pbl_sbl_shared.h\" -I$(WORKSPACE)/QcomPkg/SocPkg/Fillmore/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Fillmore/Library/EUDTargetLib/EUDTargetLib.inf

     # NAND libraries
     NandCommonLib|QcomPkg/Library/NullLibs/NandLibNull/NandLibNull.inf

     # Buttons libraries
     ButtonsBootLib|QcomPkg/SocPkg/Fillmore/Library/ButtonsTargetLib/ButtonsBootLib.inf
     ...
     TLMMTargetLib|QcomPkg/SocPkg/Fillmore/Library/TLMMTargetLib/TLMMTargetLib.inf
...
#   PmicLib|QcomPkg/Library/NullLibs/PmicLibNull/PmicLibNull.inf
     ...
     PmicLoaderLib|QcomPkg/SocPkg/Fillmore/Library/PmicLib/loader/PmicLoaderLib.inf
     PmicPsiLib|QcomPkg/SocPkg/Fillmore/Library/PmicLib/loader/PmicPsiLib.inf
     ...
     QusbLdrLib|QcomPkg/SocPkg/Fillmore/Library/QusbLdrLib/QusbLdrLib.inf
     ...
     MinidumpLib|QcomPkg/Library/MinidumpLib/MinidumpLoaderLib.inf 
     ...
     CryptoLoaderILib|QcomPkg/Library/CryptoInterfaceLib/CryptoLoaderILib.inf
     ...
     SecTargetLib|SecPkg/Library/SecTargetLib/chipsets/Fillmore/SecTargetLib.inf
     ACLib|SecPkg/Library/ACLib/ACLib.inf
     ACConfigDataLib|SecPkg/Library/ACConfigDataLib/fillmore/ACConfigDataLib.inf
     ...
     SmemImageLib|QcomPkg/SocPkg/Fillmore/Library/SmemImageLib/SmemImageLib.inf
