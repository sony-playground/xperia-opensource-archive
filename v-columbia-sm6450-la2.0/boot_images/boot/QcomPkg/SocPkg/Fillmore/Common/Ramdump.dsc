...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Fillmore$(VAR)/RamDump
...
#
  QcomPkg/XBLRamDump/XBLRamDump.inf {
    <LibraryClasses>
      ...
      ClockTargetLib|QcomPkg/SocPkg/Fillmore/Library/ClockTargetLib/ClockRamDumpLib.inf
      ...
      HALMDSSLib|QcomPkg/Library/HALMDSSLib/HALMDSS82x.inf
      LoggerLib|QcomPkg/LoaderFramework/Logger/Logger.inf
      MDPLibBoot|QcomPkg/Library/MDPLib/MDPLibBoot.inf
      MDPPlatformLibBoot|QcomPkg/SocPkg/Fillmore/Library/MDPPlatformLibBoot/MDPPlatformLibBoot.inf
...
#	PmicLoaderLib|QcomPkg/Library/NullLibs/PmicLibNull/PmicLoaderLibNull.inf
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Fillmore/Library/PmicLib/loader/PmicRamDump.inf
