...
uint8  __attribute__ ((aligned (4))) qup_v3_8_spi_fw[] =
{
    0x53, 0x45, 0x46, 0x57, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x30, 0x01, 0x00, 0x02, 0x0b, 
...
{
   if (version == 0x30080000)
   {
      *base_ptr = qup_v3_8_spi_fw;
   }
   else
   {
