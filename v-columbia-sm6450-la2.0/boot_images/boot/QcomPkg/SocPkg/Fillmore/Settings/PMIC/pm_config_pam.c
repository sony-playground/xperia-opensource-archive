 ...
 *  
 *    Platform: Fillmore.XX.1.0
 *    Revision: NO REVISIONS (Working Set)
 *    Template Version: 
 *    $Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Settings/PMIC/pm_config_pam.c#7 $ 
 *    $DateTime: 2021/12/02 12:15:33 $  $Author: pwbldsvc $
 *  
 *  &copy; Copyright Sept. 16, 2021 Qualcomm Technologies Incorporated, All Rights Reserved
 */
...
{
    { (void*)pm_pam_disp_ext_dp_b_ldo6, PM_PRM_RSRC_VRM_VREG },
...
{
    { (void*)pm_pam_pcie0_b_ldo6, PM_PRM_RSRC_VRM_VREG },
...
pm_pam_sd_mmc_vdd_px2_c_ldo6 [] =
{
    ...
    { PM_PRM_VREG_MODE_LPM, 1800, PM_PRM_DEV_ENABLE },  // GENERIC_STANDBY
    { PM_PRM_VREG_MODE_NPM, 1800, PM_PRM_DEV_ENABLE },  // GENERIC_ACTIVE
    { PM_PRM_VREG_MODE_LPM, 2960, PM_PRM_DEV_ENABLE },  // GENERIC_MV
    { PM_PRM_VREG_MODE_NPM, 2960, PM_PRM_DEV_ENABLE }  // GENERIC_HV
};
...
{
    { (void*)pm_pam_ufs0_vdda_b_ldo6, PM_PRM_RSRC_VRM_VREG },
}; 
...
{
    { (void*)pm_pam_ufs0_vdda_core_c_ldo10, PM_PRM_RSRC_VRM_VREG },
}; 
...
pm_pam_usb_hs1_rails_info [] = 
{
    ...
    { (void*)pm_pam_usb_hs1_b_ldo6, PM_PRM_RSRC_VRM_VREG },
    { (void*)pm_pam_usb_hs1_c_ldo1, PM_PRM_RSRC_VRM_VREG },
...
pm_pam_usb_ss1_rails_info [] = 
{
    ...
    { (void*)pm_pam_usb_ss1_b_ldo6, PM_PRM_RSRC_VRM_VREG },
