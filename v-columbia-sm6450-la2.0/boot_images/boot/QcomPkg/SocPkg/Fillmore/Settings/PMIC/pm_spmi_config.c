...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Settings/PMIC/pm_spmi_config.c#12 $
...
/*BID, SID, Periph ID, IRQ Owner, Periph Owner */ 
  ...
  {0, 2, 0x8A, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO03  */
  {0, 2, 0x8B, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO04  */
  {0, 2, 0x90, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* GPIO09 spare */
  ...
  {0, 3, 0x2E, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* SCPQ_P_OVP  */
  ...
  {0, 8, 0xB0, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* SDAM1 Charger */
  {0, 8, 0xB1, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* SDAM2 QG */
  ...
  {0, 1, 0x88, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO01 PA_THERM_1 */
  {0, 1, 0x8B, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO04 PA_THERM_2 */
  ...
  {0, 4, 0x88, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO01 PA1_THERM north thermistor */
  {0, 4, 0x89, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO02 PA2_THERM east therm */
  {0, 5, 0x04, SPMI_OWNER_AOP,    SPMI_OWNER_MSS},   /* BUS  */
  {0, 5, 0x88, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO01 spare */
  {0, 5, 0x89, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO02 spare */
  {0, 5, 0x8A, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO03 spare */
  ...
  {0, 1, 0x89, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO02 SDR mmwave thermistor */
  {0, 1, 0x8C, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO05 charger insertion PON trigger */
  {0, 1, 0x8D, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO06 volume+ */
  {0, 1, 0x8F, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO08  */
  {0, 1, 0x90, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO09  */
  ...
  {0, 2, 0x8D, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO06 SD_CARD_DET_N */
  {0, 2, 0x8E, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO07 LCD_BACKLIT_EN */
  {0, 2, 0x8F, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO08 LCD_BKLT_PWM */
  {0, 2, 0x90, SPMI_OWNER_ADSP,    SPMI_OWNER_APPS},   /* GPIO09 spare */
  ...
  {0, 3, 0x2E, SPMI_OWNER_ADSP,    SPMI_OWNER_APPS},   /* SCPQ_P_OVP  */
  ...
  {0, 3, 0xFD, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* OLEDB FOR Cortes_L  */
  {0, 4, 0x04, SPMI_OWNER_AOP,    SPMI_OWNER_APPS},   /* BUS  */
  {0, 4, 0x0A, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* TEMP_ALARM  */
  {0, 4, 0x8A, SPMI_OWNER_MSS,    SPMI_OWNER_MSS},   /* GPIO03 PA3_THERM west therm */
  ...
  {0, 6, 0x24, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* TEMP_ALARM  */
  {0, 7, 0x04, SPMI_OWNER_AOP,    SPMI_OWNER_APPS},   /* BUS  */
  {0, 7, 0x24, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* TEMP_ALARM  */
  ...
  {0, 8, 0xB0, SPMI_OWNER_ADSP,    SPMI_OWNER_APPS},   /* SDAM1 Charger */
  {0, 8, 0xB1, SPMI_OWNER_ADSP,    SPMI_OWNER_APPS},   /* SDAM2 QG */
  {0, 8, 0x5B, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* DIV_CLK1  */
  {0, 8, 0xB2, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* SDAM3  */
  {0, 8, 0xB3, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* SDAM4  */
  {0, 8, 0xC0, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO01 Spare */
  {0, 8, 0xC1, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO02 Spare */
  {0, 8, 0xC2, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO03 Spare */
  {0, 8, 0xC3, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO04 Spare */
  {0, 8, 0xC4, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO05 Spare */
  {0, 8, 0xC6, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO07 Spare */
  {0, 8, 0xC7, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO08 Spare */
  {0, 8, 0xC8, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO09 factory test boot_1 */
  {0, 8, 0xC9, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO10 factory test boot_2 */
  {0, 8, 0xCA, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO11 Spare */
  {0, 8, 0xCB, SPMI_OWNER_APPS,    SPMI_OWNER_APPS},   /* GPIO12 Spare */
  ...
  {0, 1, 0x8A, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO03  */
  {0, 1, 0x8C, SPMI_OWNER_APPS,    SPMI_OWNER_AOP},   /* GPIO05 charger insertion PON trigger */
  {0, 1, 0x8E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO07  */
  {0, 1, 0x91, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO10 option amberjack */
  ...
  {0, 1, 0xCB, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO11  */
  {0, 1, 0xCC, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO12  */
  {0, 1, 0xCD, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO13  */
  {0, 1, 0xCE, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO14  */
  {0, 1, 0xCF, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO15  */
  {0, 1, 0xD0, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO16  */
  {0, 1, 0xD1, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO17  */
  {0, 1, 0xD2, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO18  */
  {0, 1, 0xD3, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO19  */
  {0, 1, 0xE1, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* AHC_AGGR1  */
  {0, 1, 0xE2, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* AHC_AGGR2  */
  ...
  {0, 6, 0x07, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRIM  */
  {0, 6, 0x09, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC  */
  {0, 6, 0x2C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MBG  */
  {0, 6, 0x40, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO01  */
  {0, 6, 0x41, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO02  */
  {0, 6, 0x42, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO03  */
  {0, 6, 0x43, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO04  */
  {0, 6, 0x44, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO05  */
  {0, 6, 0x45, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO06  */
  {0, 6, 0x46, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO07  */
  {0, 6, 0x51, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* CLK_LEICA2  */
  {0, 6, 0xC0, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO01 switch between I2C and SPMI. When used in I2C mode then also captures I2C interrupts */
  {0, 6, 0xC1, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO02 PM8010 Reset */
  ...
  {0, 7, 0x07, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRIM  */
  {0, 7, 0x09, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC  */
  {0, 7, 0x2C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MBG  */
  {0, 7, 0x40, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO01  */
  {0, 7, 0x41, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO02  */
  {0, 7, 0x42, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO03  */
  {0, 7, 0x43, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO04  */
  {0, 7, 0x44, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO05  */
  {0, 7, 0x45, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO06  */
  {0, 7, 0x46, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* LDO07  */
  {0, 7, 0x51, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* CLK_LEICA2  */
  {0, 7, 0xC0, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO01 switch between I2C and SPMI. When used in I2C mode then also captures I2C interrupts */
  {0, 7, 0xC1, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO02 PM8010 Reset */
  ...
  {0, 10, 0x01, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* REVID  */
  {0, 10, 0x04, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BUS  */
  {0, 10, 0x05, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* INT  */
  {0, 10, 0x06, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* SPMI  */
  {0, 10, 0x08, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* PON_PBS  */
  {0, 10, 0x09, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC  */
  {0, 10, 0x0B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MBG1  */
  {0, 10, 0x0E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* VDDGEN  */
  {0, 10, 0x0F, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* SPMI_MONITOR  */
  {0, 10, 0x1C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC_PBS1  */
  {0, 10, 0x1D, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC_PBS2  */
  {0, 10, 0x36, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* ADC_CORE_PBS  */
  {0, 10, 0x39, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* ADC_CMN  */
  {0, 10, 0x51, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* CLK_DIST  */
  {0, 10, 0x5E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* DIV_CLK  */
  {0, 10, 0x8B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO04 OPTION1 */
  {0, 10, 0x99, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BCAL_VIRTUAL_SLAVE  */
  {0, 10, 0x9A, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BUCK_CMN_MOD  */
  {0, 10, 0x9B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_CTRL  */
  {0, 10, 0x9C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_PS  */
  {0, 10, 0x9D, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_FREQ  */
  {0, 10, 0xFE, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRST_MSTR  */
  {0, 10, 0xFF, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRIM  */
  {0, 11, 0x01, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* REVID  */
  {0, 11, 0x04, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BUS  */
  {0, 11, 0x05, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* INT  */
  {0, 11, 0x06, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* SPMI  */
  {0, 11, 0x08, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* PON_PBS  */
  {0, 11, 0x09, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC  */
  {0, 11, 0x0B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MBG1  */
  {0, 11, 0x0E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* VDDGEN  */
  {0, 11, 0x0F, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* SPMI_MONITOR  */
  {0, 11, 0x1C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC_PBS1  */
  {0, 11, 0x1D, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC_PBS2  */
  {0, 11, 0x36, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* ADC_CORE_PBS  */
  {0, 11, 0x39, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* ADC_CMN  */
  {0, 11, 0x51, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* CLK_DIST  */
  {0, 11, 0x5E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* DIV_CLK  */
  {0, 11, 0x8B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO04 OPTION1 */
  {0, 11, 0x99, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BCAL_VIRTUAL_SLAVE  */
  {0, 11, 0x9A, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BUCK_CMN_MOD  */
  {0, 11, 0x9B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_CTRL  */
  {0, 11, 0x9C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_PS  */
  {0, 11, 0x9D, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_FREQ  */
  {0, 11, 0xFE, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRST_MSTR  */
  {0, 11, 0xFF, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRIM  */
  ...
  {0, 12, 0x08, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* PON_PBS  */
  {0, 12, 0x09, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC  */
  {0, 12, 0x0B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MBG1  */
  {0, 12, 0x0E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* VDDGEN  */
  {0, 12, 0x0F, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* SPMI_MONITOR  */
  {0, 12, 0x1C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC_PBS1  */
  {0, 12, 0x1D, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* MISC_PBS2  */
  {0, 12, 0x36, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* ADC_CORE_PBS  */
  {0, 12, 0x39, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* ADC_CMN  */
  {0, 12, 0x51, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* CLK_DIST  */
  {0, 12, 0x5E, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* DIV_CLK  */
  {0, 12, 0x8B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* GPIO04 OPTION1 */
  {0, 12, 0x99, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BCAL_VIRTUAL_SLAVE  */
  {0, 12, 0x9A, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* BUCK_CMN_MOD  */
  {0, 12, 0x9B, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_CTRL  */
  {0, 12, 0x9C, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_PS  */
  {0, 12, 0x9D, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* S1_FREQ  */
  {0, 12, 0xFE, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRST_MSTR  */
  {0, 12, 0xFF, SPMI_OWNER_AOP,    SPMI_OWNER_AOP},   /* TRIM  */
  {1, 11, 0x01, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* REVID  */
  {1, 11, 0x05, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* INT  */
  {1, 11, 0x06, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* SPMI  */
  {1, 11, 0x09, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* MISC  */
  {1, 11, 0xFF, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* TRIM_CTRL  */
  {1, 12, 0x01, SPMI_OWNER_ADSP,    SPMI_OWNER_ADSP},   /* REVID  */
  {1, 12, 0x05, SPMI_OWNER_ADSP,    SPMI_OWNER_AOP},   /* INT  */
  {1, 12, 0x06, SPMI_OWNER_ADSP,    SPMI_OWNER_AOP},   /* SPMI  */
  {1, 12, 0x09, SPMI_OWNER_ADSP,    SPMI_OWNER_AOP},   /* MISC  */
  {1, 12, 0xFF, SPMI_OWNER_ADSP,    SPMI_OWNER_AOP},   /* TRIM_CTRL  */
