...
$Header: //components/rel/core.boot/6.0/QcomPkg/SocPkg/Fillmore/Settings/PMIC/pm_pvc_config.c#5 $
...
{
  {0x1, 0xA440}, /* S4B_CTRL_VSET_LB */
  {0x1, 0xA441}, /* S4B_CTRL_VSET_UB */
  {0x1, 0xA445}, /* S4B_CTRL_MODE_CTL */
  {0x1, 0xA446}  /* S4B_CTRL_EN_CTL */
};
...
const SpmiBusCfg_MgpiPortCfg pm_mgpi_port_6_cfg = 
{
  ...
  0x3,                 /* Positive edge data */
  TRUE,             /* Negative edge enable */
  6,                 /* Negative edge PVC port address index */
  0x7,                 /* Negative edge data */
  TRUE,             /* MUX Sel Valid Flag*/
  0                  /* MUX Sel Value */
};
