...
extern uintnt Image$$DEVPRG_DDR_ZI$$Base[];
extern uintnt Image$$DEVPRG_DDR_ZI$$Length[];
...
VOID devprg_img_entry (void)
{
  ...
  memset(Image$$DEVPRG_DDR_ZI$$Base, 0, (uint32)(uintptr_t)Image$$DEVPRG_DDR_ZI$$Length);
