...
Copyright 2010-2015,2020 by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================*/
...
--------   ---     ----------------------------------------------------------
08/24/20   rama    Removed bl_shared_data dependencies
...
*   None
*/
void boot_config_data_table_init(void);
...
*   None
*/
void boot_config_data_table_default_init(void);
