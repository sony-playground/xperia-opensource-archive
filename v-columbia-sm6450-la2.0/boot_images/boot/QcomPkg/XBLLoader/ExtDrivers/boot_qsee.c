...
Copyright 2014-2017,2020-2021 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
...
*/
bl_error_boot_type
boot_qsee_interface_get_param(secboot_sw_type image_id, boot_qsee_param_type parameter_id, uintnt * result)
{
  ...
  {
    return BL_ERROR_GROUP_QSEE|BL_ERR_INVALID_PARAMETER;
  }
  ...
  /* image was not found so return error */
  return BL_ERROR_GROUP_QSEE|BL_ERR_INVALID_PARAMETER;
}
...
* 
*/
bl_error_boot_type boot_qsee_interface_set_param(boot_qsee_param_type parameter_id, uintnt value)
{
  ...
  switch(parameter_id)
  {
	...
	default :
	{
	 status = BL_ERROR_GROUP_QSEE|BL_ERR_INVALID_PARAMETER;
	 break;
	}
  }
...
bl_error_boot_type boot_qsee_get_interface(boot_qsee_if_type *qsee_if)
{
	...
	do
	{
		if(qsee_if == NULL)
		{
			return_status = GET_ERROR_CODE(BL_ERROR_GROUP_QSEE, BL_ERR_INVALID_PARAMETER);
			break;
		}
	
		qsee_if->get_image_entry = boot_qsee_interface_get_image_entry;
		qsee_if->get_eident = boot_qsee_interface_get_eident;
		qsee_if->get_entry_point = boot_qsee_interface_get_entry_point;
