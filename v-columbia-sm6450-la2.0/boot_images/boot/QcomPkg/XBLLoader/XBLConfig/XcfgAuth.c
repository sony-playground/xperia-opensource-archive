...
{  
  ...
  #ifndef BOOT_RAMDUMP_ENABLE 
  xblconfig_img_whitelist[0].start_addr = (uint64 )boot_internal_heap_base;
  xblconfig_img_whitelist[0].size = boot_internal_heap_size;

  xblconfig_img_whitelist[1].start_addr = (uint64 )boot_external_heap_base;
  xblconfig_img_whitelist[1].size = boot_external_heap_size;
  ...
  #else
  xblconfig_img_whitelist[0].start_addr = (uint64 )boot_external_heap_base;
  xblconfig_img_whitelist[0].size = boot_external_heap_size;
