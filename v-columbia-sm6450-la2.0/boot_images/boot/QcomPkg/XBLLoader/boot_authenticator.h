...
Copyright 2010-2014,2016-2017,2020 by QUALCOMM Technologies Inc.  All Rights Reserved.
=============================================================================*/
...
--------   ---     ----------------------------------------------------------
09/11/20   rama    Removed bl_shared_data dependencies.
05/29/20   rama    Replace boot_extern_sec_img_interface.h with sec_img_auth.h
...
* 
*/
bl_error_boot_type boot_auth_image(uint32 image_type );
