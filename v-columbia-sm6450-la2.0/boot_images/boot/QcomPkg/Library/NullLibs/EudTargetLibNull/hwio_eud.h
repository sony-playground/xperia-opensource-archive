...
/*
    ...
    $Header: //components/rel/core.boot/6.0/QcomPkg/Library/NullLibs/EudTargetLibNull/hwio_eud.h#1 $
    $DateTime: 2021/03/05 19:32:22 $
    $Author: pwbldsvc $
...
#define MODE_MANAGER_REG_BASE                                                               (AHB2PHY_SOUTH_BASE            + 0x00001000)
#define MODE_MANAGER_REG_BASE_SIZE                                                          0x1000
#define MODE_MANAGER_REG_BASE_USED                                                          0x17c
#define MODE_MANAGER_REG_BASE_PHYS                                                          (AHB2PHY_SOUTH_BASE_PHYS + 0x00001000)
...
#define HWIO_EUSB2PHY_XTRA_TUNE_PARARM_EN_RMSK                                                     0x1
...
#define MODE_MANAGER2_REG_BASE                 (AHB2PHY_SOUTH_BASE            + 0x00002000)
#define MODE_MANAGER2_REG_BASE_SIZE            0x1000
#define MODE_MANAGER2_REG_BASE_USED            0x0
#define MODE_MANAGER2_REG_BASE_PHYS            (AHB2PHY_SOUTH_BASE_PHYS + 0x00002000)
...
#define ACORE_REG_BASE                                               (AHB2PHY_SOUTH_BASE            + 0x00000000)
#define ACORE_REG_BASE_SIZE                                          0x1000
#define ACORE_REG_BASE_USED                                          0x240
#define ACORE_REG_BASE_PHYS                                          (AHB2PHY_SOUTH_BASE_PHYS + 0x00000000)
...
#define EUD_EUD_REG_BASE     (AHB2PHY_SOUTH_BASE            + 0x00000000)
#define EUD_EUD_REG_BASE_SIZE 0x3000
#define EUD_EUD_REG_BASE_USED 0x0
#define EUD_EUD_REG_BASE_PHYS (AHB2PHY_SOUTH_BASE_PHYS + 0x00000000)
...
#define HWIO_CAPT_SEC_BOOT_GPIO_BOOT_CONFIG_GPIO_AP_AUTH_EN_BMSK                        0x800
#define HWIO_CAPT_SEC_BOOT_GPIO_BOOT_CONFIG_GPIO_AP_AUTH_EN_SHFT                           11
...
#define HWIO_ECC_CORRECTABLE_STATUS_RSVD_BMSK                                      0xffff8000
#define HWIO_ECC_CORRECTABLE_STATUS_RSVD_SHFT                                              15
...
#define HWIO_ECC_ERROR_STATUS_RSVD_BMSK                                            0xffff8000
#define HWIO_ECC_ERROR_STATUS_RSVD_SHFT                                                    15
