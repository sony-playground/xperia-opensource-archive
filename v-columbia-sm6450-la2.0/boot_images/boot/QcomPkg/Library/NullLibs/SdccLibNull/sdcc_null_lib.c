 ...
 *
 * Copyright (c) 2015-2017, 2021-2022 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
...
----------   ---     ----------------------------------------------------------- 
2022-04-09   ssb     Added sdcc_handle_partial_open() Null Lib
2021-05-25   jt      Update sdcc_hc_set_uhs_mode_select()
...
SDCC_STATUS sdcc_hc_set_uhs_mode_select (sdcc_dev_type *p_device, sdcc_bsp_speed_mode mode)
{
   return SDCC_NO_ERROR;
}
