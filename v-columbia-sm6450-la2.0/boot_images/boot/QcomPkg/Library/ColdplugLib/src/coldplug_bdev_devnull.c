...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/ColdplugLib/src/coldplug_bdev_devnull.c#4 $ $DateTime: 2022/09/15 05:50:22 $ $Author: pwbldsvc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2022-09-15   rn    Add coldplug_bdev_devnull_ops_get_boot_info
