 ...
 *
 * Coldplug
 * Copyright (C) 2015,2019,2021,2022,2023 QUALCOMM Technologies, Inc.
 *
 * Coldplug UFS Block Device.
 *
 ***********************************************************************/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/ColdplugLib/src/coldplug_bdev_ufs.c#5 $ $DateTime: 2023/02/28 07:46:17 $ $Author: pwbldsvc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2023-10-02   ss    Added Embedded info to be returned from Boot info API
...
static int coldplug_bdev_ufs_get_boot_info(void *bdev_hdl,struct coldplug_device_info *device_info)
{
    ...
    /*Update Embedded device to correct value info as it will initialize as 0 because of being a static variable*/
	device_info->is_embedded_device = 1;
	return COLDPLUG_RESULT_SUCCESS;
