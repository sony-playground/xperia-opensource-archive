...
----------   ---     -----------------------------------------------------------
 05/07/20    ck      Replaced boot_flash_type with boot_media_type 
...
*
******************************************************************************/
EFI_STATUS GetFlashDeviceType (boot_media_type *ImemBootFlashType, FlashDeviceType *UefiFlashDevice)
{
  ...
  *UefiFlashDevice = EFI_MAX_FLASH_TYPE;
  ...
  switch(*ImemBootFlashType)
  {
    ...
    case PCIE_FLASHLESS:    *UefiFlashDevice = EFI_PCIE_FLASH_TYPE;       break;        
    case UFS_FLASH:         *UefiFlashDevice = EFI_UFS_FLASH_TYPE;        break;        
    case NVME_FLASH:        *UefiFlashDevice = EFI_NVME_FLASH_TYPE;       break;
    case RESERVED_1_FLASH:  *UefiFlashDevice = EFI_RESERVED_1_FLASH_TYPE; break;
    case USB_FLASHLESS:     *UefiFlashDevice = EFI_USB_FLASH_TYPE;        break;        
    case MEDIA_TYPE_MAX:    *UefiFlashDevice = EFI_MAX_FLASH_TYPE;        break;        
...
EFI_STATUS GetSharedImemBootOption (FlashDeviceType *BootDeviceOption)
{
  ...
  boot_media_type Val = MEDIA_TYPE_MAX;
