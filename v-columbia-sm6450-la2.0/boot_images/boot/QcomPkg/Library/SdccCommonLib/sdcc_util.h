...
*
******************************************************************************/
SDCC_STATUS sdcc_select_card (sdcc_dev_type *sdcc_pdev, BOOLEAN select);
...
*
* Description:
*    This function executes the tuning sequence to find the best phase for
*    HS200/SDR104 operation and configure the selected phase.
*
* Arguments:
