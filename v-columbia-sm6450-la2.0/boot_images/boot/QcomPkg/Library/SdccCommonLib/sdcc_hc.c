...
----------  ---     --------------------------------------------------- 
2022-06-23  ssb     Reorganised target specific function call.
2022-02-25  gml     Add HCSelectInDisable for SD Card
                                         ...
                                         sdcc_bsp_speed_mode mode)
{
   ...
   case SDCC_SDR50_MODE:
      ...
      if (p_device->pslot->capabilities.HAL_sdhci_Reg_44_46 & HAL_SDHCI_CAPS_USE_TUNING_FOR_SDR50_BMSK)
      {
         p_device->tuning_needed = TRUE; 
		 select_in = HAL_SDCC_CLOCK_UHS_MCLK;
		 p_device->card_mode = SDCC_DATA_TRANSFER_SDR_LS_MODE;
      }
      break;
                                         ...
                                         UINT16 transfer_size)
{
   ...
   {
      if ((SDCC_DATA_TRANSFER_HS200_MODE == p_device->card_mode) || 
				(SDCC_DATA_TRANSFER_SDR_LS_MODE == p_device->card_mode))
      {
