...
----------   ---     ---------------------------------------------------
2022-04-26   ssb     Add LOW_FREQ_MODE changes
2022-01-21   cm		 Update dll_Init API
2021-11-09   cm      Add sdr50 tuning bitmask
2021-05-24   jt      Add device tree support
2020-06-04   jt      Remove unused functions
...
#define HAL_SDHCI_CAPS_USE_TUNING_FOR_SDR50_SHFT			  13							
...
/* FC_FE Register */
#define HWIO_HC_REG_FC_FE_HC_VENDOR_VERSION_NUM_BMSK          0xFF000000
#define HWIO_HC_REG_FC_FE_HC_VENDOR_VERSION_NUM_SHFT          0x18
...
#define HWIO_HC_REG_DLL_CONFIG_INIT_BMSK                      0xffff
...
#define HWIO_HC_VENDOR_SPECIFIC_FUNC_HC_IO_PAD_PWR_SWITCH_EN_BMSK  0x18000
...
#define HWIO_HC_REG_DLL_CONFIG_2_LOW_FREQ_MODE_SHFT                     0x13
#define HWIO_HC_REG_DLL_CONFIG_2_MCLK_FREQ_CALC_BMSK                    0x3fc00
#define HWIO_HC_REG_DLL_CONFIG_2_MCLK_FREQ_CALC_SHFT                    0xa
#define HWIO_HC_REG_DLL_CONFIG_2_DDR_CAL_EN_BMSK                        0x1

/* DLL Config 3 Register */
#define HWIO_HC_REG_DLL_CONFIG_3_SDC4_CONFIG_MSB_BMSK                   0xff
 ...
 *   SD controller number, as described in \ref nControllerId.
 * @bEnable
 *   flag indicating disable/enable DLL
 */
void 
 ...
 *   SD controller number, as described in \ref nControllerId.
 * @bEnable 
 *   flag indicating disable/enable DLL CK_OUT
 *  
 */
void 
...
/**
 * Register SDCC_HC_VENDOR_SPECIFIC_FUNC 
 * Set IO PAD PWR SWITCH 
 *
 * @param nControllerId
 *   SD controller number, as described in \ref nControllerId
 */
void HAL_sdhci_IoPadPwrSwitch (const UINT32 nControllerId);
