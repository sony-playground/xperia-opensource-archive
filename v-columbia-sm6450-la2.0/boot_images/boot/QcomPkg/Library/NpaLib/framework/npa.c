...
Copyright (c) 2009-2014,2021 QUALCOMM Technologies Incorporated.
All Rights Reserved.
...
void npa_init( void )
{
  ...
  if ( NULL == npa.log )           
  {
    ...
    npa_init_pool( &npa.batch_request_pool,
                   &npa_config_data->batch_request_allocation,
                   sizeof(npa_batch_request) );

    npa_init_pool( &npa.batch_resource_pool,
                   &npa_config_data->batch_resource_allocation,
                   sizeof(npa_batch_resource) );
