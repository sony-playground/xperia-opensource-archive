 ...
 *   order.
 *
 *  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/NandCommonLib/flash_bam_wrapper.h#1 $ $DateTime: 2020/06/18 10:10:50 $ $Author: pwbldsvc $
 *
 *
...
#define NAND_BAM_BASE_PHY_ADDR (QPIC_QPIC_XPU3_BASE + 0x4000)
#define NAND_BAM_BASE_ADDR (QPIC_QPIC_XPU3_BASE + 0x4000)
