 ...
 *   order.
 *
 *  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/NandCommonLib/flash_osal.h#1 $ $DateTime: 2020/06/18 10:10:50 $ $Author: pwbldsvc $
 *
 *
...
{
  DALSYSMemAddr  physical_addr;   /* Physical address of the memory */
  DALSYSMemAddr  virtual_addr;    /* Virtual address of the memory */
