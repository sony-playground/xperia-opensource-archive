...
Copyright 2013-2018,2020 by Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
* 
* @brief
*    Function which gets executed after after DDR init and training completed
* 
* @par Dependencies
*   None
*   
