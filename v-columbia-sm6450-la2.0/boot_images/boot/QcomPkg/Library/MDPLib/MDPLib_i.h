...
/*===========================================================================
                                Defines
===========================================================================*/
#define RES_MAX_FAMILY_MAJOR                                10
#define RES_MAX_FAMILY_MINOR                                7
...
typedef enum
{
  ...
  MDP_DISPLAY_CONNECT_EDP1,                              /**< 19 - Display is connected to Embedded Display Port interface 1 */
...
typedef enum
{
  ...
  MDSS_DEVICE_VERSION_08_02,       /**< Device 8.2.x */
  MDSS_DEVICE_VERSION_08_03,       /**< Device 8.3.x */
  MDSS_DEVICE_VERSION_08_04,       /**< Device 8.4.x */
  MDSS_DEVICE_VERSION_08_05,       /**< Device 8.5.x */
  MDSS_DEVICE_VERSION_08_06,       /**< Device 8.6.x */
...
typedef struct
{
  ...
  uint32                uDSCID[MDP_DUAL_NUM_PINGPONGS];      /**< Display Stream Compression module used by the panel */
...
typedef struct
{
  ...
  uint32                          uModeId;                                        /**< Current mode index */
...
extern MDP_DisplayCtrlPathMapType          gMDP_DisplayControlPathMap[MDP_DISPLAY_MAX][MDP_DUALPIPE_NUM_MIXERS];
...
#define MDP_GET_DISPLAYINFO_DSC_ID(_displayId_, _mixerId_)  (MDP_GET_DISPLAYINFO(_displayId_)->sDSCConfig.uDSCID[((_mixerId_)<MDP_DUALPIPE_NUM_MIXERS)?(_mixerId_):0])
