...
#define MDP_MAX_MINOR_VERSION            7
...
const HAL_MDP_PingPongId* PingPongSplitSlaveMapInfo_MDSS8xx[MDP_MAX_MINOR_VERSION] =
{
   ...
   &sMDSS810_PPSplitSlaveMap[0],   /* MDSS 8.2.0  */
   &sMDSS810_PPSplitSlaveMap[0],   /* MDSS 8.3.0  */
   NULL,                           /* MDSS 8.4.0  */
   &sMDSS810_PPSplitSlaveMap[0],   /* MDSS 8.5.0  */
   &sMDSS810_PPSplitSlaveMap[0],   /* MDSS 8.6.0  */
};
...
const MDP_DeviceCaps* DeviceCapInfo_MDSS8xx[MDP_MAX_MINOR_VERSION] =
{
  ...
  &sDeviceCaps_MDSS810,           /* MDSS 8.2.0  */
  &sDeviceCaps_MDSS810,           /* MDSS 8.3.0  */
  NULL,                           /* MDSS 8.4.0  */
  &sDeviceCaps_MDSS810,           /* MDSS 8.5.0  */
  &sDeviceCaps_MDSS810,           /* MDSS 8.6.0  */
};
