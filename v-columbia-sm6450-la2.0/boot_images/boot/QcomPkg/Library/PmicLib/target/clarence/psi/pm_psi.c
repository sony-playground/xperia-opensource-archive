...
$Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/Library/PmicLib/target/netrani/psi/pm_psi.c#1 $ 
...
pm_pbs_ram_data_type*     pm_pbs_seq[] = { pm_sbl_config_data.pm_pbs_seq_a, pm_sbl_config_data.pm_pbs_seq_b, 
	                                        pm_sbl_config_data.pm_pbs_seq_c, pm_sbl_config_data.pm_pbs_seq_d, pm_sbl_config_data.pm_pbs_seq_e, pm_sbl_config_data.pm_pbs_seq_f, pm_sbl_config_data.pm_pbs_seq_g};
