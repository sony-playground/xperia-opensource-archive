...
$Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/Library/PmicLib/target/netrani/system/src/pm_sbl_boot_target.h#1 $
$Author: aravapal $
...
===========================================================================*/
// Order in pm_pbs_seq_a / pm_pbs_seq_b / pm_pbs_seq_c
// Which is PBS2_RAM     / PBS1_RAM     / PBS3_RAM
#define PBS_CRC_CHECK_STATUS_ADDR   {0x72A6, 0x72A3, 0x72A9}
#define PBS_CRC_CHECK_VALUE_ADDR    {0x72A7, 0x72A4, 0x72AA}
...
pm_err_flag_type pm_set_oledb_default_config();
