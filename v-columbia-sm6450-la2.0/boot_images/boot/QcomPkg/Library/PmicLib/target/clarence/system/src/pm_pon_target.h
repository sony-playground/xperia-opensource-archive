...
$Header: //components/dev/core.boot/6.0/aravapal.core.boot.6.0.tip_dev/QcomPkg/Library/PmicLib/target/netrani/system/src/pm_pon_target.h#1 $
$Author: aravapal $
...
#define PON_EVENT_LOG_AREA_SIZE (127 - 11 + 1) // MEM_011 to MEM_127
...
#define PON_LOG_PUSH_PTR                 (SDAM05_BASE_ADDR + MEM_OFFSET_START + 6)
...
#define PON_PBS_SYS_OK_RSN             0x31C2
#define PON_PBS_SYS_OK_RSN_TIOMAN      0x8732
#define PON_PBS_SYS_OK_RSN_NEBULA      0x2763
//to-do: update OCP reasons- check with systems team.
//sid+MISC_PBS peripheral base addr+interrupt value
#define PON_PBS_BOMPOKA_OCP_RSN        0x11D0
#define PON_PBS_SECOJR1_OCP_RSN        0x61C6
#define PON_PBS_SECOJR2_OCP_RSN        0x71C6
#define PON_PBS_LEICA2_OCP_RSN         0x4094
