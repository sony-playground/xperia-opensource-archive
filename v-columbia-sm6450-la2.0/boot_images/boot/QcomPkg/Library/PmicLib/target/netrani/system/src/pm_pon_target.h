...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/target/netrani/system/src/pm_pon_target.h#7 $
$Author: pwbldsvc $
...
#define PON_PBS_MAKUAC_OCP_RSN         0x4734
#define PON_PBS_SECO_OCP_RSN           0x61D0
