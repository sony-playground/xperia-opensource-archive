...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/target/netrani/psi/pm_psi.c#3 $ 
$DateTime: 2023/03/06 07:47:59 $  $Author: pwbldsvc $
...
struct pm_sbl_config_buffer {
	...
	pm_pbs_ram_data_type      pm_pbs_seq_f[PM_PBS_RAM_F_SIZE+1];
	pm_pbs_ram_data_type      pm_pbs_seq_g[PM_PBS_RAM_G_SIZE+1];
...
struct pm_sbl_config_buffer pm_sbl_config_data = {
	...
	.pm_pbs_seq_f = PM_PBS_RAM_F_DATA,
	.pm_pbs_seq_g = PM_PBS_RAM_G_DATA,
...
pm_pbs_ram_data_type*     pm_pbs_seq[] = { pm_sbl_config_data.pm_pbs_seq_a, pm_sbl_config_data.pm_pbs_seq_b, 
	                                        pm_sbl_config_data.pm_pbs_seq_c, pm_sbl_config_data.pm_pbs_seq_d, pm_sbl_config_data.pm_pbs_seq_e,
                                                pm_sbl_config_data.pm_pbs_seq_f, pm_sbl_config_data.pm_pbs_seq_g};
