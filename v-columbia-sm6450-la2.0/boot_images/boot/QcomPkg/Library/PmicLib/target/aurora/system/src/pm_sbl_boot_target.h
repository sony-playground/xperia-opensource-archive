...
*  \n
*  \n &copy; Copyright 2016-2020 Qualcomm Technologies Inc, All Rights Reserved
*/
/* =======================================================================
Edit History
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/target/aurora/system/src/pm_sbl_boot_target.h#3 $
$Author: pwbldsvc $
