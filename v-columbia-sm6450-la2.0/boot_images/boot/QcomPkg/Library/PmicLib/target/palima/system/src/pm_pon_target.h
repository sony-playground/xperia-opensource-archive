...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/target/palima/system/src/pm_pon_target.h#6 $
$Author: pwbldsvc $
...
#define PON_PBS_PAPIO_OCP_RSN          0x11D0
...
typedef enum
{
  ...
  PM_PON_EVENT_HAPUNA_FAULT            = 0x16,
  PM_PON_EVENT_FAULT_PMIC_I            = 0x17,
  PM_PON_EVENT_LEICA2_1_FAULT          = 0x17,
  PM_PON_EVENT_FAULT_PMIC_J            = 0x18,
  PM_PON_EVENT_LEICA2_2_FAULT          = 0x18,
