...
#define PM_PBS_RAM_A_ACTIVE_CODE_SIZE 	0x0C62
...
#define PM_PBS_RAM_SIZE_TOTAL 	0x1170
#define PM_PBS_RAM_BUF_COUNT 	0x06		//No of PBS RAM 
#define PM_SBL_COND_SEQ_SIZE	0x35
#define PM_SBL_SEQ_SIZE			2787
