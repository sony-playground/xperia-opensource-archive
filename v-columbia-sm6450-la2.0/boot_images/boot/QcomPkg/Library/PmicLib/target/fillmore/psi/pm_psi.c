...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/target/fillmore/psi/pm_psi.c#7 $ 
$DateTime: 2023/06/09 07:39:54 $  $Author: pwbldsvc $
...
pm_pbs_ram_data_type*     pm_pbs_seq[] = { pm_sbl_config_data.pm_pbs_seq_a, pm_sbl_config_data.pm_pbs_seq_b, 
                                          ...
                                          pm_sbl_config_data.pm_pbs_seq_e, pm_sbl_config_data.pm_pbs_seq_f};
