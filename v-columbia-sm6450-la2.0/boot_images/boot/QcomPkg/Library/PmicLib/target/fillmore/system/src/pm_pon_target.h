...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/target/fillmore/system/src/pm_pon_target.h#8 $
$Author: pwbldsvc $
...
#define PON_PBS_AMBERJACK_OCP_RSN      0x11D0
#define PON_PBS_PALANI_OCP_RSN         0x21D0
#define PON_PBS_SECO_OCP_RSN           0x41D0
#define PON_PBS_NALO_OCP_RSN           0x51D0
...
typedef enum
{
  ...
  PM_PON_EVENT_PAPIO_FAULT             = 0x10,
  PM_PON_EVENT_FAULT_PMIC_C            = 0x11,
  PM_PON_EVENT_PALANI_FAULT            = 0x11,
  PM_PON_EVENT_FAULT_PMIC_D            = 0x12,
  PM_PON_EVENT_PUHI_FAULT              = 0x12,
  PM_PON_EVENT_FAULT_PMIC_E            = 0x13,
  PM_PON_EVENT_SECO_FAULT              = 0x13,
  PM_PON_EVENT_FAULT_PMIC_F            = 0x14,
  PM_PON_EVENT_NALO_FAULT              = 0x14,
  PM_PON_EVENT_FAULT_PMIC_G            = 0x15,
  PM_PON_EVENT_AMBERJACK_FAULT         = 0x15,
  ...
  PM_PON_EVENT_SECO_JR_FAULT           = 0x19,
