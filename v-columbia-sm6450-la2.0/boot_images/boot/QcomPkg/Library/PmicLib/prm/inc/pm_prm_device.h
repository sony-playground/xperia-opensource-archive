...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/prm/inc/pm_prm_device.h#2 $

$Author: pwbldsvc $
$DateTime: 2023/03/20 07:23:05 $
...
#define PMIC_NPA_CLIENT_NODE_SD_MMC_VDD_PSTM "node/pmic/client/sd_mmc_vdd_pstm"
#define PMIC_NPA_CLIENT_NODE_SD_MMC_VDD_PX2_PSTM "node/pmic/client/sd_mmc_vdd_px2_pstm"

/*===========================================================================

FUNCTION pm_pstm_node_init

DESCRIPTION
    This function initializes the pstm resources and nodes.
