...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/pmic_devices/common/src/hw_module_type.h#5 $
$Author: pwbldsvc $
$DateTime: 2023/05/18 03:23:20 $
...
typedef enum
{
    ...
    PM_HW_MODULE_CHARGER_SCPQ_H_CHGR = 0x90,
...
typedef enum
{
    ...
    PM_HW_MODULE_BMS_QGAUGE = 3, 
    PM_HW_MODULE_BMS_QGAUGE2 = 4, 
...
typedef enum
{
    ...
    PM_HW_MODULE_LPG_PWM_BOMPOKA = 12,
...
typedef enum
{
    ...
    PM_HW_MODULE_HAPTICS_VIB_LDO  = 0x7E,
