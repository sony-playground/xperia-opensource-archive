...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/app/rgb/src/pm_app_rgb.c#3 $
$Author: pwbldsvc $
$DateTime: 2022/11/17 05:20:46 $
...
static pm_err_flag_type pm_rgb_led_config_internal(pm_app_rgb_config_type rgb_config)
{
  ...
  pm_rgb_data_type *rgb_data_ptr = pm_rgb_get_data(cfg_ptr->rgb_pmic);
