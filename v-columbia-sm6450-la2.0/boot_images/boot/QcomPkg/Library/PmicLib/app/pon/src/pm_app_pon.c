...
$Date: 2021/01/12 $ 
$Change: 28191559 $
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/app/pon/src/pm_app_pon.c#2 $
$Author: pwbldsvc $
...
pm_app_pon_reset_init (void)
{
  ...
  uint32 s3_timer_ms = 16000; //16sec is HW default
  ...
  s3_timer_ms   = pon_param_ptr->s3_reset_timer_cfg.timer_value_ms;
  ...
  {
    err_flag |= pm_app_pon_s3_reset_timer_cfg(app_reset_source, s3_timer_ms);
  }
