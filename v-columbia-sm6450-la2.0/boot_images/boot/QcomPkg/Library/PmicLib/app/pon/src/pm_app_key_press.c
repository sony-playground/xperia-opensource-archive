...
$Date: 2021/04/23 $ 
$Change: 30292625 $
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/app/pon/src/pm_app_key_press.c#3 $
$Author: pwbldsvc $
$DateTime: 2021/04/23 20:12:38 $
...
static boolean pm_app_pwrkey_was_keypress_release_valid(pm_pwrkey_dbnc_chk_type  *dbnc_chk)
{
   ...
   {
      err_flag |= pm_pon_irq_status(pmic_index, PM_PON_IRQ_KPD_PWR_N_DEB, PM_IRQ_STATUS_RT, &key_press_rt_sts);
