...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/haptics/src/pm_haptics_cfg_driver.h#6 $
$Author: pwbldsvc $
...
typedef struct
{
  ...
  // - on haptics_pattern
  pm_register_address_type fifo_play_rate;      //0x122
