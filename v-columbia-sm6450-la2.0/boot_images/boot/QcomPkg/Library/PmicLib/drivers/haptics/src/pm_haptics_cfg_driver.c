...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/haptics/src/pm_haptics_cfg_driver.c#7 $
$Author: pwbldsvc $
...
#define PMIC_HAPTICS_MAX_HW_VER    0x20
