...
*  &copy; Copyright (c) 2012-2020 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/pwm/src/pm_pwm.c#2 $
$Author: pwbldsvc $
...
pwm_value = (pwm_value > (pwm_ptr->pwm_specific_data->max_pwm_value)) ? (pwm_ptr->pwm_specific_data->max_pwm_value) :  pwm_value;
