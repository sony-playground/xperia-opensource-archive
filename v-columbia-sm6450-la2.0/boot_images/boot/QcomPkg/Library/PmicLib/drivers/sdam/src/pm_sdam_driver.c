...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/sdam/src/pm_sdam_driver.c#5 $
...
pm_sdam_driver_self_init(void)
{
  ...
  if(sdam_base_address_list_ptr == NULL)
  {
     CORE_VERIFY(0);
  }
