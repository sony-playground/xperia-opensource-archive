...
*  PMIC chip set.
*  \n &copy;  Copyright (c) 2013-2020 Qualcomm Technologies, Inc.  All Rights Reserved.
*/
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/rtc/src/pm_rtc_driver.h#1 $
$Author: pwbldsvc $
...
**************************************/
void pm_rtc_driver_init(pm_comm_info_type * comm_ptr, peripheral_info_type * peripheral_info, uint32 pmic_index);

pm_rtc_data_type * pm_rtc_get_data(uint32 pmic_index);

uint8 pm_rtc_get_num_peripherals(uint32 pmic_index);
