...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/bmd/src/pm_bmd.c#3 $
$Author: pwbldsvc $
$DateTime: 2021/12/09 02:30:40 $
...
===========================================================================*/
pm_err_flag_type pm_bmd_src_ctl(uint32 pmic_index, pm_bmd_src_ctl_sel_type bmd_sel)
{
  pm_err_flag_type    err_flag    = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_get_src_type(uint32 pmic_index, pm_bmd_src_ctl_sel_type *bmd_sel)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr = pm_bmd_get_data(pmic_index);
  ...
  else
  {
    ...
    pm_register_data_type mask = 0x01;
    err_flag = pm_comm_read_byte_mask(SLAVE_ID, bmd_src_ctrl, mask, &data);
...
pm_err_flag_type pm_bmd_get_battery_missing_rt_status(uint32 pmic_index, pm_bmd_bat_miss_sts_type bat_miss_type, boolean *missing)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_get_state(uint32 pmic_index, pm_bmd_state_type *state)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_get_mode(uint32 pmic_index, pm_bmd_mode_type *mode)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_set_sleep_rate(uint32 pmic_index, pm_bmd_sample_rate_type rate)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_set_off_rate(uint32 pmic_index, pm_bmd_sample_rate_type rate)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_set_bat_gone_negative_edge_debounce(uint32 pmic_index, pm_bmd_debounce_type debounce)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_set_bat_gone_posative_edge_debounce(uint32 pmic_index, pm_bmd_debounce_type debounce)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_set_battery_removal_comparator_threshold(uint32 pmic_index, pm_bmd_comparator_threshold_type threshold)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_enable_bmd_in_adc_conv(uint32 pmic_index, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
...
pm_err_flag_type pm_bmd_enable(uint32 pmic_index, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_bmd_data_type *bmd_ptr  = pm_bmd_get_data(pmic_index);
