...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/qbg/src/pm_qbg_driver.c#4 $
$Author: pwbldsvc $
...
===========================================================================*/
#define PMIC_BMS_QBG_MAIN_MAX_HW_VER 0x00
...
{ 
    ...
    .last_burst_avg_acc0_data0     = 0x0A0,      
    .last_burst_avg_acc2_data0     = 0x0A4,      
};
