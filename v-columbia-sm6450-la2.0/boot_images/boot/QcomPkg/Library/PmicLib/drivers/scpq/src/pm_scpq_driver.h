...
typedef struct
{
  ...
  pm_register_address_type chg_en_status       ; //0x07
  pm_register_address_type vbat_status         ; //0x08
  pm_register_address_type vbat_status2        ; //0x09
  pm_register_address_type ibat_status         ; //0x0A
  pm_register_address_type vflt_status         ; //0x0B
  pm_register_address_type ichg_status         ; //0x0E
  ...
  pm_register_address_type bat_2s_charge_cfg   ; //0xA0
...
typedef struct
{
  ...
  pm_register_address_type wdog_status                ; //0x07
  ...
  pm_register_address_type wd_time_sel                ; //0x59
  pm_register_address_type bark_bite_wdog_pet         ; //0x5A
  ...
  pm_register_address_type eng_sdcdc_spare            ; //0xCF
