...
/*============================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/vadc/src/pm_vadc.c#3 $$DateTime: 2021/03/16 17:13:17 $$Author: pwbldsvc $
                  ...
                  uint32 uConvTime_us)
{
   ...
   pm_err_flag_type status = PM_ERR_FLAG_INVALID_PERIPHERAL;
   uint32 uTimeWaited_us;
   uint32 uReadTime_us;
   struct pm_vadc_reg_dump rd;
#ifndef ADC_BOOT_DRIVER
   DALResult result;
   uint32 uEventIdx;
#endif
