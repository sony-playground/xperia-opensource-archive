...
*  \n
*  &copy; Copyright 2012-2019, 2021 QUALCOMM Technologies Incorporated, All Rights Reserved
*/
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/ldo/src/pm_ldo.c#4 $ 

$Author: pwbldsvc $
$DateTime: 2021/08/04 00:33:46 $
...
pm_err_flag_type pm_ldo_ocp_enable(uint8 pmic_chip, uint8  ldo_peripheral_index, pm_on_off_type  on_off)
{
    pm_err_flag_type err_flag     = PM_ERR_FLAG_SUCCESS;
    pm_ldo_data_type *ldo_ptr     = pm_ldo_get_data(pmic_chip);
    ...
    {
        err_flag = pm_pwr_ocp_en_alg (&(ldo_ptr->pm_pwr_data), ldo_ptr->comm_ptr, ldo_peripheral_index, on_off);
    }
    return err_flag;
}
