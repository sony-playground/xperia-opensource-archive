...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/ldo/src/pm_ldo_driver.c#4 $
$Author: pwbldsvc $
$DateTime: 2021/09/16 03:38:10 $
...
#define PM_LDO_DRIVER_HW_MAX_VER_SUPPORTED 0x32 // 1st bit are dig_major, 0 bit dig_minor = 1.0 
