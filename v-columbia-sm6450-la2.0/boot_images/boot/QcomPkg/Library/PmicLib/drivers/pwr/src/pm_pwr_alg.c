...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/pwr/src/pm_pwr_alg.c#4 $

$Author: pwbldsvc $
$DateTime: 2022/03/09 00:11:12 $
...
pm_err_flag_type pm_pwr_ocp_en_alg(pm_pwr_data_type *pwr_data, pm_comm_info_type *comm_ptr, uint8 peripheral_index, pm_on_off_type on_off)
{
    pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
    pm_register_address_type ocp_reg = 0x0;
