...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/drivers/bob/src/pm_bob_driver.c#6 $

$Author: pwbldsvc $
$DateTime: 2022/10/20 23:54:05 $
...
static pm_pwr_register_info_type bob_reg =
{
   ...
   .PD_CTL            = 0x048,
   .ECM_EN_CTL        = 0x000, 
   .VOUT_EXT_CTRL1_LB = 0x04A, 
   .RGB_HR_VOUT_MAX   = 0x06E, 
};
