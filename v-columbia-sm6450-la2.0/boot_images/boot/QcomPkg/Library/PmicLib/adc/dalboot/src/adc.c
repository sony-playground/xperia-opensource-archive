...
/*============================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/adc/dalboot/src/adc.c#2 $$DateTime: 2022/08/17 01:29:25 $$Author: pwbldsvc $
 ...
 * -------------------------------------------------------------------------*/
extern DALResult VAdc_clean_references(void);
