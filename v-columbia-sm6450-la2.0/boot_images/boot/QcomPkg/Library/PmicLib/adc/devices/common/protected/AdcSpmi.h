...
============================================================================*/
/* $Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/adc/devices/common/protected/AdcSpmi.h#2 $ */
...
AdcSpmiRead(AdcSpmiCtxtType *pCtxt, uint32 uReg, uint8 *pucData, uint32 uLen, uint32 *puBytesRead)
{
   ...
   ret = SpmiBus_ReadLong(0, pCtxt->uSlaveId,
                          pCtxt->ePriority,
...
AdcSpmiWrite(AdcSpmiCtxtType *pCtxt, uint32 uReg, uint8 *pucData, uint32 uLen)
{
   ...
   ret = SpmiBus_WriteLong(0, pCtxt->uSlaveId,
                           pCtxt->ePriority,
                           ADC_SPMI_ADDR(pCtxt->uPeripheralId, uReg),
                           pucData,
                           uLen);
