/*============================================================================
  ...
  DEPENDENCIES: None
                ...
                Copyright (c) 2009-2016, 2018-2021 Qualcomm Technologies, Inc.
                All Rights Reserved.
...
/*============================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/adc/devices/vadc/src/DalVAdc.c#7 $$DateTime: 2021/07/27 03:21:22 $$Author: pwbldsvc $
...
VAdc_DeviceInit(VAdcClientCtxt *pCtxt)
{
   ...
   if (pDevCtxt->pBsp->pszDTPath != NULL) {
      if (pDevCtxt->pBsp->pszDTPath[0] != '\0') {
         ...
         if (0 == vadc_read_dt_device_root(pDevCtxt->pBsp->pszDTPath, DT_bsp)) {
