...
/*============================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/adc/devices/vadc/src/DalVAdcFwk.c#2 $$DateTime: 2022/08/17 01:29:25 $$Author: pwbldsvc $
...
DALResult VAdc_clean_references()
{
  int i = 0;
  gVAdcDrvCtxt.dwRefs = 0;
  for(i=0;i<VADC_MAX_NUM_DEVICES;++i)
  {
    gVAdcDrvCtxt.VAdcDevCtxt[i].dwRefs = 0;
  }
  return DAL_SUCCESS;
}
