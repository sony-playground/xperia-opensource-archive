 ...
 *
 *  &copy; Copyright 2021 Qualcomm Technologies Inc, All Rights Reserved
 */
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/framework/inc/pm_config_sbl_common.h#3 $
