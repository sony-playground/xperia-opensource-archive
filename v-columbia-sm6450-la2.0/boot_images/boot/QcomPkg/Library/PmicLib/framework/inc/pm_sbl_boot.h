...
*  \n
*  \n &copy; Copyright 2018, 2021-2022 QUALCOMM Technologies Incorporated, All Rights Reserved
*/
/* =======================================================================
Edit History
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/PmicLib/framework/inc/pm_sbl_boot.h#6 $
$Author: pwbldsvc $
$DateTime: 2022/03/24 22:18:36 $
...
/*
 * Check if we should apply charging related logic/configure.
 */
pm_err_flag_type 
