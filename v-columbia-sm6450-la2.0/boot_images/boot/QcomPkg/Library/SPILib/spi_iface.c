 ...
 */
/*=============================================================================
            Copyright (c) 2019-2020,2023 Qualcomm Technologies, Incorporated.
                              All rights reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 06/02/20   ANL     SPITEST app in UEFI crash issue, commented configuring QUPV3_SE_AHB_M_CFG
...
{	
    if(h_ctxt == NULL)
	{
	   SPI_LOG(LEVEL_ERROR,"bus_iface_deinit : invalid parameters ");
	   return SPI_ERROR_INVALID_PARAM;
	}
	spi_iface_disable_m_irqs(h_ctxt);
