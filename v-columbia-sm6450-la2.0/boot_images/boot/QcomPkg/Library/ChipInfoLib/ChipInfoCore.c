...
================================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/ChipInfoLib/ChipInfoCore.c#3 $
...
)
{
  ...
  {
    ChipInfoCtxt.eSKU = pSMem->eSKU;
    ChipInfoCtxt.nProductCode = pSMem->nProductCode;
  }
