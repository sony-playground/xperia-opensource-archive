...
2019/05/21   sds     Update commit prototypes to improve logging
2018/03/22   sds     Active set TCS optimization
2017/01/31   sds     Add slave/master hw update functions
...
/**
  @brief Configures any hardware related to a master that is modified on a bandwidth change.
         Usually the QoS Generator bandwidth for a master.
         Valid only when master QOS mode is either Limited, Regulator, or deferred.
...
/**
 ...
 @param[in] client   The requesting NPA client
