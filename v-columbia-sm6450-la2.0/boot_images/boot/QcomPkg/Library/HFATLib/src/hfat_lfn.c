 ...
 * Copyright (C) 2006-2012, 2021 QUALCOMM Technologies, Inc.
 *
                      ...
                      F_DIRENTRY *dep, F_POS *pos)
{
  ...
  (void) _memset (lf->path, 0, sizeof(lf->path));
  (void) _memset (lf->lname, 0, sizeof(lf->lname));
  w_char_safe_copy (lf->path, path, (FN_MAXPATH-1));
  w_char_safe_copy (lf->lname, name, (F_MAXLNAME-1));
  lf->pos = *pos;
