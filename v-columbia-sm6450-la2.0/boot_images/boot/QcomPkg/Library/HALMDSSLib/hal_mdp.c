 ...
 **/
static void HAL_MDP_ConfigUBWCSettings();
                                     ...
                                     HAL_MDP_Hw_Private_Info     *psMdpHwInfo)
{
  if (NULL != psVersionInfo)
  {
    ...
    {
      // Query MDSS 9.0.0 hardware capabilities
      HAL_MDP_ReadHardwareInfo_9_0_0(psHwInfo, psMdpHwInfo);
    }
    else if(8 == psVersionInfo->uMajorVersion)
    {
      if(1 == psVersionInfo->uMinorVersion)
      {
        // Query MDSS 8.1.0 hardware capabilities
        HAL_MDP_ReadHardwareInfo_8_1_0(psHwInfo, psMdpHwInfo);
      }   
      else if(2 == psVersionInfo->uMinorVersion)
      {
        // Query MDSS 8.2.0 hardware capabilities
        HAL_MDP_ReadHardwareInfo_8_2_0(psHwInfo, psMdpHwInfo);
      }
      else if(3 == psVersionInfo->uMinorVersion)
      {
        // Query MDSS 8.3.0 hardware capabilities
        HAL_MDP_ReadHardwareInfo_8_3_0(psHwInfo, psMdpHwInfo);
      }
      else if(5 == psVersionInfo->uMinorVersion)
      {
        // Query MDSS 8.5.0 hardware capabilities
        HAL_MDP_ReadHardwareInfo_8_5_0(psHwInfo, psMdpHwInfo);
      }
      else if(6 == psVersionInfo->uMinorVersion)
      {
        // Query MDSS 8.6.0 hardware capabilities
        HAL_MDP_ReadHardwareInfo_8_6_0(psHwInfo, psMdpHwInfo);
      }
    }
  }
}
...
static void HAL_MDP_ConfigUBWCSettings()
{
  ...
  // UBWC Version Setting - HW uses this to decide whether to use UBWC ver 2.0 (UBWC_VER = 0) or 3.0 (UBWC_VER = 1) or 4.0 (UBWC_VER = 2)
  uRegValue = 0;
  uRegValue = HWIO_OUT_FLD(uRegValue,
                           MDSS_HW_UBWC_CTRL_2,
                           UBWC_VER,
