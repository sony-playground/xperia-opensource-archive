...
typedef struct _HAL_MDP_UBWCConfigInfo
{
  ...
  uint32 uMajorRevision;             /* Select UBWC Revision */
...
typedef struct _HAL_MDP_Hw_Private_Info
{
   ...
   /** DSC reduced ob max buffer limit*/
   uint32                               uReducedObMaxBuffer;
...
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(8.0.0)
*
...
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(8.2.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information
*
...
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(8.3.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information
*
...
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(8.5.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information
*
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SSPP_SetQosConfig_8_1_0()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_MDP_SSPP_SetQosConfig_8_1_0 (HAL_MDP_SourcePipeId              eSourcePipe,
                                      HAL_MDP_TrafficCtrl_LatencyType   eLatency,
                                      HAL_MDP_Qos_ConfigType           *psQoSInfo,
                                      uint32                            uFlags);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SSPP_SetQosConfig_9_0_0()
*/
/*!
* \brief
*  Source pipe QoS configuration
...
*
****************************************************************************/
void HAL_MDP_SSPP_SetQosConfig_9_0_0(HAL_MDP_SourcePipeId              eSourcePipe,
                                     HAL_MDP_TrafficCtrl_LatencyType   eLatency,
                                     HAL_MDP_Qos_ConfigType           *psQoSInfo,
                                     uint32                            uFlags);
