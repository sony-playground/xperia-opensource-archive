...
#define  HAL_MDP_8_1_0_NUM_OF_RGB_LAYERS                       0          /** RGB Source Surface Pixel Processors       */
#define  HAL_MDP_8_1_0_NUM_OF_VIG_LAYERS                       4          /** VIG Source Surface Pixel Processors       */
#define  HAL_MDP_8_1_0_NUM_OF_DMA_LAYERS                       4          /** DMA Source Surface Pixel Processors       */
#define  HAL_MDP_8_1_0_NUM_OF_CURSOR_LAYERS                    0          /** CURSOR Source Surface Pixel Processors    */
#define  HAL_MDP_8_1_0_NUM_OF_LAYER_MIXERS                     6          /** Layer Mixers                              */
#define  HAL_MDP_8_1_0_NUM_OF_DSPP                             4          /** Destination Surface Pixel Processor       */
#define  HAL_MDP_8_1_0_NUM_OF_PHYSICAL_INTERFACES              9          /** INTF_x (x = 0, 1, 2, 3, 4, 5, 6, 7 and 8) */
#define  HAL_MDP_8_1_0_NUM_OF_WRITEBACK_INTERFACES             1          /** WB_0, WB_1 and WB_2                       */
#define  HAL_MDP_8_1_0_NUM_OF_CONTROL_PATHS                    6          /** MDP_CTL_x (x = 0, 1, 2, 3, 4 and 5)       */
#define  HAL_MDP_8_1_0_NUM_OF_DATA_PATHS                       1          /** MDP_WB_x (x = 0, 1, 2, 3, and 4)          */
#define  HAL_MDP_8_1_0_NUM_OF_PINGPONGS                        6          /** Pingpong blocks                           */
#define  HAL_MDP_8_1_0_NUM_OF_WATCHDOGS                        0          /** Watch Dogs                                */
#define  HAL_MDP_8_1_0_NUM_OF_AXI_PORTS                        2          /** Number of AXI ports                       */
#define  HAL_MDP_8_1_0_NUM_OF_VBIF_CLIENTS                     14         /** Number of VBIF clients                    */

#define  HAL_MDP_8_1_0_NUM_OF_CHROMA_BLOCKS                    1          /** Number of Chroma blocks                   */

/** RGB and VG and DMA IGC LUT Size */
#define  HAL_MDP_8_1_0_SSPP_IGC_LUT_SIZE                       256
#define  HAL_MDP_8_1_0_SSPP_IGC_NUM_OF_COLOR_COMPONENTS        3          /** Color 0, 1 and 2                          */

/** DSPP IGC LUT Size */
#define  HAL_MDP_8_1_0_DSPP_IGC_LUT_SIZE                       256
#define  HAL_MDP_8_1_0_DSPP_IGC_NUM_OF_COLOR_COMPONENTS        3          /** Color 0, 1 and 2                          */

/** QSEED */

/** LAYER MIXER */
#define  HAL_MDP_8_1_0_LAYER_MIXER_MAX_BLEND_STAGES            11         /** Blend Stage                               */

/** QOS */
#define HAL_MDP_8_1_0_MAX_MDPCORE_CLK_FREQ                     500000000  /** MDP core maximum working clock frequency in Hz */

#define HAL_MDP_8_1_0_QOS_REQPRI_WATERMARK_REGS_COUNT          3


/* QoS priority re-mapping for real time read clients; real time clients are ViG, RGB, and DMA in line mode;*/
#define HAL_MDP_8_1_0_QOS_REMAPPER_REALTIME_CLIENTS            HAL_MDP_QOS_REMAPPER_INFO(                \
...
#define HAL_MDP_8_1_0_QOS_REMAPPER_NONREALTIME_CLIENTS         HAL_MDP_QOS_REMAPPER_INFO(                \
...
#define HAL_MDP_8_1_0_VBIF_MAX_DDR_RD_BURST_SIZE               7
#define HAL_MDP_8_1_0_VBIF_MAX_DDR_WR_BURST_SIZE               7
#define HAL_MDP_8_1_0_VBIF_MAX_RD_OT_SIZE                      0    /* 0 to use default value */
#define HAL_MDP_8_1_0_VBIF_MAX_WR_OT_SIZE                      0    /* 0 to use default value */

#define HAL_MDP_8_1_0_VBIF_ROUND_ROBIN_QOS_ARB                 HWIO_VBIF_VBIF_ROUND_ROBIN_QOS_ARB_RR_QOS_EN_BMSK

/** Clock control */
#define HAL_MDP_8_1_0_HYSTERISIS_DEFAULT                       1

/** HSIC register range */
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_HUE                  (-768)   // -180 degree
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_HUE                  (-768)   // 180 degree
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_UNCHANGE_HUE          0       // value for unchange hue going to the min hue direction
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_UNCHANGE_HUE         (-1536)  // value for unchange hue going to the max hue direction
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_SATURATION           (-128)   
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_SATURATION            127
#define HAL_MDP_8_1_0_PICTURE_ADJUST_UNCHANGE_SATURATION       0
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_INTENSITY            (-128) 
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_INTENSITY             127 
#define HAL_MDP_8_1_0_PICTURE_ADJUST_UNCHANGE_INTENSITY        0
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_CONTRAST             (-128)
#define HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_CONTRAST              127
#define HAL_MDP_8_1_0_PICTURE_ADJUST_UNCHANGE_CONTRAST         0

/** Highest bank bit configuration */
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_HIGHEST_BANK_BIT          (HAL_MDP_UBWC_HIGHEST_BANK_BIT_15)
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_MAL_SIZE                  (HAL_MDP_UBWC_MAL_32_BYTES)
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_LVL1_SWIZZLING_MODE       (HAL_MDP_UBWC_SWIZZLING_MODE_DISABLE)
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_LVL2_SWIZZLING_MODE       (HAL_MDP_UBWC_SWIZZLING_MODE_ENABLE)
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_LVL3_SWIZZLING_MODE       (HAL_MDP_UBWC_SWIZZLING_MODE_ENABLE)
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_BANK_SPREAD_MODE          (HAL_MDP_UBWC_BANK_SPREAD_MODE_ENABLE)
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_REVISION                  4
#define  HAL_MDP_8_1_0_UBWC_DEFAULT_MAX_DDR_CHANNELS          8

/* Display flag to enable PFS feature */
#define  HAL_MDP_DISPLAY_FLAG_ENABLE_PFS                      0x10000000

/** Multirect parameters */
#define HAL_MDP_8_1_0_MULTIRECT_PARALLEL_MAX_WIDTH           (2560)
#define HAL_MDP_8_1_0_MULTIRECT_TIMEMULTIPLEX_MIN_LINES      (8)
...
static HAL_MDP_VBIFQOSRemappersType gSVBIFQOSRemap_8_1_0[HAL_MDP_VBIF_CLIENT_MAX] =
{
...
*/
const HAL_MDP_VbifId gsVbifClientToHwIdMap_8_1_0[HAL_MDP_VBIF_CLIENT_MAX] =
{
...
HAL_MDP_SSPPQoSInfo gsSSPPQoSInfo_8_1_0 =
{
    &gLinearQoSInfo,
    NULL,
    NULL
...
*
****************************************************************************/
static void HAL_MDP_SetHWBlockRegOffsets_8_1_0(void)
{
                                    ...
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo)
{
   ...
   HAL_MDP_SetHWBlockRegOffsets_8_1_0();

   if(NULL != psHwInfo)
   {
      psHwInfo->uNumOfRGBLayers                                                        = HAL_MDP_8_1_0_NUM_OF_RGB_LAYERS;
      psHwInfo->uNumOfVIGLayers                                                        = HAL_MDP_8_1_0_NUM_OF_VIG_LAYERS;
      psHwInfo->uNumOfDMALayers                                                        = HAL_MDP_8_1_0_NUM_OF_DMA_LAYERS;
      psHwInfo->uNumOfCursorLayers                                                     = HAL_MDP_8_1_0_NUM_OF_CURSOR_LAYERS;
      psHwInfo->uNumOfLayerMixers                                                      = HAL_MDP_8_1_0_NUM_OF_LAYER_MIXERS;
      psHwInfo->uNumOfDSPPs                                                            = HAL_MDP_8_1_0_NUM_OF_DSPP;
      psHwInfo->uNumOfBltEngines                                                       = HAL_MDP_8_1_0_NUM_OF_WRITEBACK_INTERFACES;
      psHwInfo->uNumOfControlPaths                                                     = HAL_MDP_8_1_0_NUM_OF_CONTROL_PATHS;
      psHwInfo->uNumOfDataPaths                                                        = HAL_MDP_8_1_0_NUM_OF_DATA_PATHS;
      psHwInfo->uNumOfLayerMixerBlendStages                                            = HAL_MDP_8_1_0_LAYER_MIXER_MAX_BLEND_STAGES;
      psHwInfo->uNumOfPhyInterfaces                                                    = HAL_MDP_8_1_0_NUM_OF_PHYSICAL_INTERFACES;
      psHwInfo->uNumOfPingPongs                                                        = HAL_MDP_8_1_0_NUM_OF_PINGPONGS;
      psHwInfo->uNumOfWatchDogs                                                        = HAL_MDP_8_1_0_NUM_OF_WATCHDOGS;
      psHwInfo->uNumOfAxiPorts                                                         = HAL_MDP_8_1_0_NUM_OF_AXI_PORTS;
      psHwInfo->uNumOfVbifClients                                                      = HAL_MDP_8_1_0_NUM_OF_VBIF_CLIENTS;       
      psHwInfo->eGamutType                                                             = HAL_MDP_GAMUT_8BITGAMUT_TYPE;
      psHwInfo->uNumOfChromaDownBlocks                                                 = HAL_MDP_8_1_0_NUM_OF_CHROMA_BLOCKS;
   ...
   if(NULL != psMdpHwInfo)
   {
      ...
      // QOS & VBIF
      psMdpHwInfo->uVBIFMaxDdrRdBurstSize                                              = HAL_MDP_8_1_0_VBIF_MAX_DDR_RD_BURST_SIZE;
      psMdpHwInfo->uVBIFMaxDdrWrBurstSize                                              = HAL_MDP_8_1_0_VBIF_MAX_DDR_WR_BURST_SIZE;
      psMdpHwInfo->uVBIFMaxRdOT                                                        = HAL_MDP_8_1_0_VBIF_MAX_RD_OT_SIZE;
      psMdpHwInfo->uVBIFMaxWrOT                                                        = HAL_MDP_8_1_0_VBIF_MAX_WR_OT_SIZE;      
      
      psMdpHwInfo->uVBIFRoundRobinQosArb                                               = HAL_MDP_8_1_0_VBIF_ROUND_ROBIN_QOS_ARB;
      psMdpHwInfo->pVBIFQOSRemappers                                                   = &gSVBIFQOSRemap_8_1_0[0];
      psMdpHwInfo->pVBIFClientToHWIDMap                                                = &gsVbifClientToHwIdMap_8_1_0[0];

      // SSPP QoS (Danger, Safe, CReq) setting
      psMdpHwInfo->psSSPPQoSInfo                                                       = &gsSSPPQoSInfo_8_1_0;
      psMdpHwInfo->sIpFxnTbl.SSPPQosConfig                                             = &HAL_MDP_SSPP_SetQosConfig_8_1_0;

      //Picture adjustment(HSIC) 
      psMdpHwInfo->sPictureAdjustInfo.iMinHue                                          = HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMaxHue                                          = HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMinUnchangeHue                                  = HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_UNCHANGE_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMaxUnchangeHue                                  = HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_UNCHANGE_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMinSaturation                                   = HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iMaxSaturation                                   = HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeSaturation                              = HAL_MDP_8_1_0_PICTURE_ADJUST_UNCHANGE_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iMinIntensity                                    = HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iMaxIntensity                                    = HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeIntensity                               = HAL_MDP_8_1_0_PICTURE_ADJUST_UNCHANGE_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iMinContrast                                     = HAL_MDP_8_1_0_PICTURE_ADJUST_MIN_CONTRAST;
      psMdpHwInfo->sPictureAdjustInfo.iMaxContrast                                     = HAL_MDP_8_1_0_PICTURE_ADJUST_MAX_CONTRAST;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeContrast                                = HAL_MDP_8_1_0_PICTURE_ADJUST_UNCHANGE_CONTRAST;

      psMdpHwInfo->uHysterisisValue                                                    = HAL_MDP_8_1_0_HYSTERISIS_DEFAULT;
      ...
      psMdpHwInfo->uMaxParallelModeWidth                                               = HAL_MDP_8_1_0_MULTIRECT_PARALLEL_MAX_WIDTH;
      psMdpHwInfo->uMinTimeMultiplexModeLines                                          = HAL_MDP_8_1_0_MULTIRECT_TIMEMULTIPLEX_MIN_LINES;

      // UBWC Config
      psMdpHwInfo->sUBWCConfig.uHighestBankBit                                         = HAL_MDP_8_1_0_UBWC_DEFAULT_HIGHEST_BANK_BIT;
      psMdpHwInfo->sUBWCConfig.uMALSize                                                = HAL_MDP_8_1_0_UBWC_DEFAULT_MAL_SIZE;
      psMdpHwInfo->sUBWCConfig.uLvl1BankSwizzling                                      = HAL_MDP_8_1_0_UBWC_DEFAULT_LVL1_SWIZZLING_MODE;
      psMdpHwInfo->sUBWCConfig.uLvl2BankSwizzling                                      = HAL_MDP_8_1_0_UBWC_DEFAULT_LVL2_SWIZZLING_MODE;
      psMdpHwInfo->sUBWCConfig.uLvl3BankSwizzling                                      = HAL_MDP_8_1_0_UBWC_DEFAULT_LVL3_SWIZZLING_MODE;
      psMdpHwInfo->sUBWCConfig.uBankSpread                                             = HAL_MDP_8_1_0_UBWC_DEFAULT_BANK_SPREAD_MODE;
      psMdpHwInfo->sUBWCConfig.uMajorRevision                                          = HAL_MDP_8_1_0_UBWC_DEFAULT_REVISION;
      psMdpHwInfo->sUBWCConfig.uMaxDDRChannels                                         = HAL_MDP_8_1_0_UBWC_DEFAULT_MAX_DDR_CHANNELS;
...
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(8.6.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information
*
