...
Copyright (c) 2013-2019, 2021 by Qualcomm Technologies Incorporated.
All Rights Reserved.
...
typedef struct {
	 uint32*                   regAddrsDebugFuse; 
	 uint32                    DebugFuseMask;
	 uint32                    DebugFuseValueEn;
	 uint32                    DebugFuseValueCurrent;
} SpmiDebugFuseInfo;
