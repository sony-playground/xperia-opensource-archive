 ...
 * @file:  PmicArb.c
 * 
 * Copyright (c) 2013-2017,2021 by Qualcomm Technologies Incorporated. All Rights Reserved.
 * 
 * $DateTime: 2021/07/21 16:13:26 $
 * $Header: //components/rel/core.boot/6.0/QcomPkg/Library/SPMILib/src/core/hal/hoya7/PmicArb.c#4 $
 * $Change: 31953838 $ 
 * 
 *                              Edit History
 * Date     Description
