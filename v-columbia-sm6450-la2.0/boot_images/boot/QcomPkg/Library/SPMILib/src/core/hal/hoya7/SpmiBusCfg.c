 ...
 * $Header: //components/rel/core.boot/6.0/QcomPkg/Library/SPMILib/src/core/hal/hoya7/SpmiBusCfg.c#6 $
 * $Change: 32216607 $ 
 * 
 *                              Edit History
 * Date     Description
...
Spmi_Result SpmiBusCfg_ConfigureVrmPort(uint8 busId, const SpmiBusCfg_VrmPortCfg* portCfg)
{
    ...
    SPMI_HWIO_OUT_FIELD( HWIO_PMIC_ARBm_VRM_S_PORT_CTL_ADDR( base_addr, busId), 
    ...
    // Enable the individual port
    SPMI_HWIO_OUT_SET( HWIO_PMIC_ARBm_VRM_S_PORT_CTL_ADDR( base_addr, busId ),
