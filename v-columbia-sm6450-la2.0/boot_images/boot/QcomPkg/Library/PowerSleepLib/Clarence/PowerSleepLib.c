...
//rpmh_command_set_t* rpmh_sleep_config = calloc(sizeof(rpmh_command_set_t),WAKE_TCS_START - SLEEP_TCS_START);  //sleep set
...
void rsc_config_tcs_contents(void)
{
  ...
  HWIO_OUTFI(APSS_RSC_RSCC_TCSm_DRV2_CONTROL, SLEEP2_TCS, AMC_MODE_TRIGGER, 0);  
  HWIO_OUTFI(APSS_RSC_RSCC_TCSm_DRV2_CONTROL, WAKE1_TCS, AMC_MODE_TRIGGER, 0);  
  HWIO_OUTFI(APSS_RSC_RSCC_TCSm_DRV2_CONTROL, WAKE2_TCS, AMC_MODE_TRIGGER, 0);  
  ...
  HWIO_OUTFI(APSS_RSC_RSCC_TCSm_DRV2_CONTROL, SLEEP2_TCS, AMC_MODE_EN, 0);  
  HWIO_OUTFI(APSS_RSC_RSCC_TCSm_DRV2_CONTROL, WAKE1_TCS, AMC_MODE_EN, 0);  
  HWIO_OUTFI(APSS_RSC_RSCC_TCSm_DRV2_CONTROL, WAKE2_TCS, AMC_MODE_EN, 0);  
