 ...
 * $Header: //components/rel/core.boot/6.0/QcomPkg/Library/CPRLib/image/xbl/src/cpr_image.c#4 $
 * $Change: 36851008 $
 */
#include <stdlib.h>
#include "cpr_image.h"
...
void cpr_image_open_remote_cfg(void** cfg, uint32* size)
{
	...
	uint32 *version_addr;
     ...
     version_addr = smem_get_addr(SMEM_IMAGE_VERSION_TABLE, &version_size);
	...
	msg_ram_set_smem_address((uint32)SMEM_IMAGE_VERSION_TABLE, (uint32)(uintptr_t)version_addr);
    }
