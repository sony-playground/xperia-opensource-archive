 ...
 *
 * $DateTime: 2022/04/25 05:07:08 $
 * $Header: //components/rel/core.boot/6.0/QcomPkg/Library/CPRLib/common/inc/cpr_voltage_plan.h#5 $
 * $Change: 36788928 $
 */
...
} cpr_quotient_cfg_rev;

typedef struct cpr_quotient_cfg cpr_quotient_cfg;
...
typedef struct
{
    ...
    struct cpr_voltage_data
    {
        ...
        uint32              freqDelta;
		#ifdef CPR_REV_BASED_QUOTS_KV
        cpr_quotient_cfg_rev*   quotients;
		#else
