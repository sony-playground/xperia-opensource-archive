 ...
 *
 * $DateTime: 2021/08/25 20:59:15 $
 * $Header: //components/rel/core.boot/6.0/QcomPkg/Library/CPRLib/common/hal/v3/src/cpr_hal.c#4 $
 * $Change: 32561642 $
 *
 */
#include "cpr_hal.h"
        ...
        uint32 quotient)
{
    ...
    CPR_HWIO_OUT_FIELD(
            (HWIO_CPR_TARGET0_0_m_ADDR( hdl->controller->base, mode ) +
                targetOffset),
            HWIO_CPR_TARGET0_0_m_MODE_GCNT0, CPR_DEFAULT_GCNT );
}
