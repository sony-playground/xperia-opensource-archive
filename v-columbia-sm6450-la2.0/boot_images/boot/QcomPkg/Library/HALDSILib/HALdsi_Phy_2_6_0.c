...
static void HAL_DSI_Phy_TriggerSleepB(DSI_Device_IDType eDeviceId, bool32 bTrigger)
{
  ...
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_4_ADDR, uCmnCtrl4); 
}
...
static HAL_MDSS_ErrorType HAL_DSI_Phy_WaitForRefgen(DSI_Device_IDType eDeviceId)
{
  ...
  /* Set Refgen Request */
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_DIGTOP_SPARE10_ADDR, 0x00000001);
                                ...
                                HAL_DSI_PHY_PhySettingsType  *pSettings)
{
  ...
  uint32             uMDSSMajorVersion = 0x00;
  uint32             uMDSSMinorVersion = 0x00;

  uVersionInfo        = HWIO_MDSS_HW_HW_VERSION_IN;
  uMDSSMajorVersion   = HWIO_GETVAL(MDSS_HW_HW_VERSION, uVersionInfo, MAJOR);
  uMDSSMinorVersion   = HWIO_GETVAL(MDSS_HW_HW_VERSION, uVersionInfo, MINOR);
  ...
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_4_ADDR,    0x4);

  if (TRUE == pSettings->bCPhyMode)
  {
    /* dsi_cmn_init start */
    /* PHY MODE */
    uint32 uRegVal = HWIO_OUT_FLD(0, DSI_0_PHY_DSIPHY_CMN_GLBL_CTRL, PHY_MODE, 1);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_CTRL_ADDR, uRegVal);

    /* VREG_CTRL */
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_0_ADDR, 0x00000050);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR, 0x00000055);

    if ((uMDSSMajorVersion == 8) && 
        (uMDSSMinorVersion == 5))
    {
      /* VREG_CTRL_0P4 */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_0_ADDR,                   0x00000045);

      /* VREG_CTRL_0P2 */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR,                   0x00000041);
    }
    else
    {
      /* VREG_CTRL_0P4 */
    ...
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_BOT_CTRL_ADDR,  0x00000000);
  ...
  else
  {
    ...
    if (pSettings->uDesiredBitClkFreq <= 1500000000)
    {
      uVRegCtrl0      = 0x53;
    ...
    { 
      /* VREG_CTRL_0P4 */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_0_ADDR,                   0x00000044);

      /* VREG_CTRL_0P2 */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR,                   0x00000019);
    }
    else
    { 
      /* VREG_CTRL_0P4 */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_0_ADDR,                   uVRegCtrl0);

      /* VREG_CTRL_0P2 */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR,                   0x0000005C);
    }

    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_TOP_CTRL_ADDR,  uRescodeTopCtrl);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_BOT_CTRL_ADDR,  uRescodeBotCtrl);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_3_ADDR,                        0x00000000);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_STR_SWI_CAL_SEL_CTRL_ADDR,     0x00000000);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_HSTX_STR_CTRL_0_ADDR,          0x00000088);
    ...
    if (TRUE == pSettings->bSplitLink) 
    {
      ...
      /* Remove PLL, DIG and all lanes from pwrdn */
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_0_ADDR,             0x000000FF);
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0_ADDR,     0x0000003F);
      DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_SL_DSI_LANE_CTRL1_ADDR,  0x03);
    }
    else 
    {
      /* Remove PLL, DIG and all lanes from pwrdn */
    ...
    /* DCTRL */
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_2_ADDR,         0x00000040);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CLK_CFG0_ADDR,       0x00000001);
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CLK_CFG0_ADDR,       0x00000001);
  }
}
...
static HAL_MDSS_ErrorType HAL_DSI_Phy_SetupLanePhy(DSI_Device_IDType eDeviceId, DSI_LaneIDType eLaneId, HAL_DSI_PHY_LaneConfigType *pConfig)
{
  ...
  if (DSI_LaneID_0 == eLaneId)
  {
    DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_CFG2_ADDR, 0);
  }
  else
  {
                                                ...
                                                HAL_DSI_PHY_PhySettingsType  *pSettings)
{
  ...
  if (HAL_MDSS_STATUS_SUCCESS == eStatus)
  {
    ...
    else
    {
      ...
      if (pSettings->bSplitLink)
      {
        HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_CLKSL, &pSettings->sLaneConfig);
      }
    }
  }
                                  ...
                                  HAL_DSI_PHY_PllConfigType   *pPllConfig)
{
  ...
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_LOCK_MIN_DELAY_ADDR,           0x00000000);
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_RST_CONTROLS_ADDR,             0x00000011);
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_FASTLOCK_CONTROL_ADDR,             0x0000003F);
  ...
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_INT_GAIN_IFILT_BAND_1_ADDR,    0x00000084);
  ...
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PFILT_ADDR,                        0x00000029);
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PFILT_ADDR,                        0x0000002F);
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_IFILT_ADDR,                        0x0000002A);
...
static void HAL_DSI_Phy_ResetPhy(DSI_Device_IDType eDeviceId)
{
  ...
  DSI_WR(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_1_ADDR, HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_1_DSIPHY_SW_RESET_BMSK);
                                                 ...
                                                 HAL_DSI_LanePropertyType   *psLaneProperty)
{
  ...
  else
  {
    ...
    DSI_Log_Message(DSI_LOGLEVEL_ERROR, "HAL_DSI_Phy_LaneConfig enter psLaneProperty->eClockLaneOp =%d\n",psLaneProperty->eClockLaneOp);
    /* Program clock lane */
    ...
    DSI_Log_Message(DSI_LOGLEVEL_ERROR, "HAL_DSI_Phy_LaneConfig enter psLaneProperty->eDataLaneOp =%d\n",psLaneProperty->eDataLaneOp);
    /* Program data lane */
...
*
****************************************************************************/
static float  HAL_DSI_Phy_yValue(HAL_DSI_PhyConfigType *psDsiPhyConfig)
{
  float yVal = 0.0f;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyDisable()
*/
/*!
* \brief
*     Disables DSI Phy.
...
*
****************************************************************************/
void HAL_DSI_2_6_0_PhyDisable(DSI_Device_IDType   eDeviceId)
{
  uintPtr uOffset = HAL_DSI_GetRegBaseOffset(eDeviceId);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyPllEnable()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_DSI_2_6_0_PhyPllEnable(DSI_Device_IDType eDeviceId, bool32 bEnable)
{
  uintPtr uOffset = HAL_DSI_GetRegBaseOffset(eDeviceId);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyPllPowerCtrl()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhyPllPowerCtrl(DSI_Device_IDType   eDeviceId,
                                                 bool32              bPllPowerUp)
{
  HAL_MDSS_ErrorType   eStatus     = HAL_MDSS_STATUS_SUCCESS;
  /*
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhySetup()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhySetup(DSI_Device_IDType          eDeviceId,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyPllSetup()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhyPllSetup(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
                                             HAL_DSI_PhyConfigInfoType   *psDsiPhyConfigInfo)
{
  HAL_MDSS_ErrorType        eStatus           = HAL_MDSS_STATUS_SUCCESS;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhySetupTimingParams()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhySetupTimingParams(HAL_DSI_TimingSettingType *pTimingParameters)
{
  HAL_MDSS_ErrorType           eStatus             = HAL_MDSS_STATUS_SUCCESS;
  HAL_DSI_PHY_TimingConfigType sTimingConfig;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyPllReConfigure()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhyPllReConfigure(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyPllInitialize()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_DSI_2_6_0_PhyPllInitialize(void)
{
  ...
  {
    HAL_DSI_2_6_0_PhyPllPowerCtrl((DSI_Device_IDType)uControllerIndex, TRUE);
  }
}

/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhySetProperty()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhySetProperty(DSI_Device_IDType              eDeviceId,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyGetProperty
*/
/*!
* \brief
...
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhyGetProperty(DSI_Device_IDType              eDeviceId,
                                                HAL_DSI_PhyPropertyType        eProperty,
                                                HAL_DSI_PhyPropertyParamsType *pPropertyData)
{
  HAL_MDSS_ErrorType eStatus = HAL_MDSS_STATUS_SUCCESS;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_6_0_PhyGetPllCodes
*/
/*!
* \brief
*   Get PLL codes
...
*                             
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_6_0_PhyGetPllCodes(DSI_Device_IDType               eDeviceId,
