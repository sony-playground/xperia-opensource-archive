...
=============================================================================*/
/*=============================================================================
 $Header: //components/rel/core.boot/6.0/QcomPkg/Library/EnterpriseMgtLib/EnterpriseMgtLib.c#1 $
                              EDIT HISTORY
    ...
    )
{
    ...
    if (pFeatureList != NULL && NumFeatures != 0)
    {
        ...
        {
            DEBUG((ENT_MGT_ERRO, "EnterpriseMgtLib : Failed to map features to bitmap.\n"));
            goto Exit;
        }
