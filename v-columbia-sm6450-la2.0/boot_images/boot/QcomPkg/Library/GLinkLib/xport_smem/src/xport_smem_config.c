...
=============================================================================
  ...
  Copyright (c) 2014 - 2015,2017-2021 Qualcomm Technologies, Inc.
  All rights reserved.
...
$Header: //components/rel/core.boot/6.0/QcomPkg/Library/GLinkLib/xport_smem/src/xport_smem_config.c#3 $
...
xport_smem_config_type xport_smem_config[] =
{
  ...
  /* Boot->Wpss */
  {
    "wpss",                /* Remote host name        */
    SMEM_WPSS,              /* Remote host ID          */
    16*1024,               /* Tx FIFO size            */
    4*1024,                /* Tx MTU size             */
    {EFI_IPCC_C_WPSS, 0},      /* Interrupt   */
    &xport_smem_qos_config,
    NULL,                  /* Use default Alloc FIFO */
    NULL                   /* Use default clear interrupt */
  },
