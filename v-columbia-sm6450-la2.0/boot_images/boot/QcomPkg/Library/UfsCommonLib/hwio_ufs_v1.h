...
/**********************************************************************
 *
 * Copyright (c) 2012-2016, 2020-22 Qualcomm Technologies Incorporated. All Rights Reserved.
...
/*======================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Library/UfsCommonLib/hwio_ufs_v1.h#3 $
  $DateTime: 2022/02/24 20:46:55 $ $Author: pwbldsvc $
...
#define UFSHCI_ICE_OFFSET_ADDR                           0x8000
...
#define HWIO_UFSHCI_UTRLCNR                              (0x0064 + UFSHCI_OFFSET_ADDR)
...
/* Below register not available and not used so commented */
...
#define HWIO_VENSPEC_TEST_BUS_CTRL_2                     (0x00F4 + UFSHCI_OFFSET_ADDR)  
...
#define HWIO_ICE_CONTROL                   				 (0x0000 + UFSHCI_ICE_OFFSET_ADDR)
/* Below register not available and not used so commented */
...
#define BMSK_CEFES                                       (0x01 << 18)

/* Bit field of UFSHCI_HCS register */
/*  Below register macro is not used and original value viz.
    (0x03 << 8) doesn't match with HWIO_UFS_MEM_HCS_UPMCRS_BMSK
    so commented it.
*/
//#define BMSK_UPMCRS                                      (0x07 << 8)
