...
2022-04-11   jt      Add function to change device mode 
...
/** \details
 * This function finishes the full configuration of the 
 ...
 *
 */
int32 ufs_finish_config ( struct ufs_handle *handle, ufs_config_mode mode );
...
/** \details
 * This function sets the UFS device mode 
 *  
 * @param[in] handle 
 *    a pointer to the UFS handle that was returnd from \ref ufs_open
 * @param[in] device_mode
 *    UFS device mode to switch to 
 * @return 0 on success. Error code otherwise
 *
 */
