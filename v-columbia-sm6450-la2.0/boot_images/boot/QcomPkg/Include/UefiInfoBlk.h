...
typedef struct {             /* Offsets:   32 bit    64 bit   */
  ...
  /* Ver 0x0001000F */                            
  UINTN        VBAR_EL1[8];            /*   0xF8      0x148    */
  UINTN        TPIDR_EL1[8];           /*   0x118     0x188    */
  UINTN        TTBR0_EL1[8];           /*   0x138     0x1C8    */
  UINTN        TCR_EL1[8];             /*   0x158     0x208    */
  UINTN        MAIR_EL1[8];            /*   0x178     0x248    */
  UINTN        CPACR_EL1[8];           /*   0x198     0x288    */
  UINTN        SCTLR_EL1[8];           /*   0x1B8     0x2C8    */
  UINTN        CntvTval[8];            /*   0x1D8     0x308    */
  UINTN        CntvCval[8];            /*   0x1F8     0x348    */
  UINTN        CntvCtl[8];             /*   0x218     0x388    */
  UINTN        ISR_EL1[8];             /*   0x238     0x3C8    */
  ...
  /* Ver 0x00010010 */ 
  UINT64       IframePtr[8];            /*   0x268     0x418    */
