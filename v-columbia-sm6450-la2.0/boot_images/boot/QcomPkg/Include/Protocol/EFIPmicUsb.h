...
/**@ingroup efi_pmic_get_charger_pmic_index
  @par Summary
  This API returns charger pmic index

  @param[out]  *ChargerPmicIndex
...
typedef
EFI_STATUS (EFIAPI *EFI_PMIC_GET_CHARGER_PMIC_INDEX)(
...
struct _EFI_QCOM_PMIC_USB_PROTOCOL {
  ...
  EFI_PMIC_GET_CHARGER_PMIC_INDEX	        GetChargerPmicIndex;
};
