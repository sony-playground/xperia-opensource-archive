...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 05/20/19   px      Remove ReadLongDebug and WriteLongDebug in SPMI protocol
...
/** @ingroup efi_spmi_constants
  Protocol version. 
*/
#define SPMI_DXE_REVISION 0x0000000000010003
...
typedef Spmi_Result (*SPMI_INTERRUPTCLEARALL) (
    EFI_QCOM_SPMI_PROTOCOL *SpmiProtocolHandle
    );


typedef Spmi_Result (*SPMI_GETCHANNEL) (
    EFI_QCOM_SPMI_PROTOCOL *SpmiProtocolHandle,
    UINT8 busId,
    UINT8 slaveId,
    UINT8 periphId,
...
struct _EFI_QCOM_SPMI_PROTOCOL {
  ...
  SPMI_INTERRUPTCLEARALL        InterruptClearAll;
  SPMI_GETCHANNEL               GetChannel;
};
