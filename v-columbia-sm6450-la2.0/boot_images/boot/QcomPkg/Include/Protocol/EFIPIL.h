/*===============================================================================
  ...
  --------   ---         --------------------------------------------------------
  04/11/22   sn         added api to return pil cfg struct, PilInitCfgByUnicodeName
...
typedef struct _EFI_PIL_PROTOCOL {
   ...
   EFI_PROCESS_PIL_SHUTDOWN                     ProcessPilShutdown;
   EFI_PROCESS_PIL_GET_LOADED_IMAGE_CFG_BY_ID   GetLoadedImageCfgCpyById;
   EFI_PROCESS_PIL_INIT_CFG_BY_UNI_CODE_NAME    PilInitCfgByUnicodeName;  /*EFI_PIL_PROTOCOL_VERSION_V3*/
