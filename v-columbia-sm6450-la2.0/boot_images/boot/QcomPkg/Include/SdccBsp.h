...
----------   ---    --------------------------------------------------------------
2022-04-09   ssb    Update path length for device tree
2022-04-09   ssb    Add support for sdcc bootup using Device Tree Config
2022-02-03   cm     Updates for Palima
...
#define SDCC_BSP_DT_PATH_LEN                                 0x20
