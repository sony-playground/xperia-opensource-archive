...
#define CHIPINFO_PRODUCT_CODE_UNKNOWN       0x0
...
typedef enum
{
  ...
  CHIPINFO_ID_SCP_NETRANI         = CHIPINFO_ID_SMP_NETRANI,
  CHIPINFO_ID_SCQ_NETRANI         = 631,
  CHIPINFO_ID_SM_PALAWAN7         = 632,
...
#define CHIPINFO_FIRST_GENERAL_SKU  CHIPINFO_SKU_AA
#define CHIPINFO_LAST_GENERAL_SKU   CHIPINFO_SKU_AF
#define CHIPINFO_FIRST_Y_SKU        CHIPINFO_SKU_Y0
#define CHIPINFO_LAST_Y_SKU         CHIPINFO_SKU_Y7

/**
 * SKU_ID and P_CODE information for the current device.
 * See ChipInfo_GetSKU for more details.
 */
typedef struct
{
  ChipInfoSKUIdType eSKU;
  uint32_t nProductCode;
} ChipInfoSKUInfoType;
