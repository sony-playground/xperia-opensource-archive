...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Include/api/storage/coldplug_config.h#3 $ $DateTime: 2023/02/28 07:46:17 $ $Author: pwbldsvc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2023-02-10   ss    Set the coldplug max partitions count to 512
...
*****************************************************************************/
  ...
  #define COLDPLUG_MAX_PARTITIONS (512)
#endif
