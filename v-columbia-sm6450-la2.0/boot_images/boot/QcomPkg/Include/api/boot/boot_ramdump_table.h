...
$Header: //components/rel/core.boot/6.0/QcomPkg/Include/api/boot/boot_ramdump_table.h#2 $
...
bl_error_boot_type ramdump_table_add_restricted_region ( boot_handle ramdump_table_handle, uint64 length, char *desc, char *filename, void *handler);
