...
Copyright 2010-2015, 2017-2018, 2020 Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
--------   ---     ----------------------------------------------------------
06/04/20   ck      Removed boot_mmu_copy_page_table_v7
02/20/20   ck      Added boot_mmu_copy_page_table_v7
02/20/20   ck      Replaced uint64 casts with uintnt
01/26/18   vk      Add DSB and DMB API
...
* 
* @brief
*   Copy the source page tables to destination in DDR.
...
*
* @par Dependencies
*   destination L1, L2, and possible L3 (AARCH64) page tables must be allocated and invalidated, 
*   destination L2, possible L3 (AARCH64) page tables must reside in contiguous memory
*
* @retval
*   True if successful, 
...
* 
* @brief
*   Creates a data synchronization barrier (DSB SY)
* 
* @par Dependencies
*   None
*
...
* 
* @brief
*   Creates a data memory barrier (DMB SY)
* 
* @par Dependencies
*   None
*
...
extern uintnt mmu_l1_pagetable[];
extern uintnt mmu_l2_pagetable[];
...
* 
*/
void mmu_set_dacr( uintnt dacr_value);
...
* 
* @brief
*  Set the page table base address in TTBR0_EL1.
* 
* @par Dependencies
*  None
* 
...
* 
*/
void mmu_set_page_table_base(uintnt addr);
