...
typedef enum
{
  PM_SCPQ_USB_AICL_COLLAPSE_GF_SEL = 0,
  PM_SCPQ_USB_AICL_STEP_TIMING_SEL = 2,
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_get_apsd_status(uint32 pmic_index, pm_scpq_usb_apsd_status_type apsd_status, boolean *result);
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_set_inov_cfg(uint32 pmic_device, pm_scpq_usb_inov_cfg_type inov_cfg, boolean enable,
 ...
 *
 */
pm_err_flag_type pm_scpq_usb_get_inov_cfg(uint32 pmic_device, pm_scpq_usb_inov_cfg_type inov_cfg, boolean *enable,
                                          pm_scpq_usb_inov_vadp_decr_timer_type *timer_sel);
