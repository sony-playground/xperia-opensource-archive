...
*/
pm_err_flag_type 
pm_schg_usb_get_typec_status(uint32 pmic_index, pm_chg_typec_status_type *typec_status);
 ...
 */
pm_err_flag_type 
pm_schg_usb_get_typec_vbus_status(uint32 pmic_index, boolean *vbus_status);
...
*/
pm_err_flag_type 
pm_schg_usb_typec_vconn_enable(uint32 pmic_index, pm_schg_usb_typec_vconn_enable_type enable_type);
...
*/
pm_err_flag_type 
pm_schg_usb_typec_get_port_role(uint32 pmic_index, pm_chg_typec_port_role_type *port_role);
...
*/
pm_err_flag_type 
pm_schg_usb_typec_set_port_role(uint32 pmic_index, pm_chg_typec_port_role_type port_role);
...
*/
pm_err_flag_type 
pm_schg_usb_typec_disable(uint32 pmic_index, boolean disable);
...
*/
pm_err_flag_type 
pm_schg_usb_typec_enable_try_sink_mode(uint32 pmic_index, boolean enable);
 ...
 */
pm_err_flag_type 
pm_schg_typec_en_dbg_access_snk(uint32 pmic_index, boolean EnDbgAccessSnk);


/**
 * @brief This function enable/disable charing when debug access sink mode is detected
 *
 * @param[in] pmic_index:     The pmic_index of charger module.
 * @param[in] enable:         Enable/disable charging on DAM cable sink mode
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *                                               version of the PMIC.
 ...
 */
pm_err_flag_type 
pm_schg_typec_en_chg_on_dam_snk(uint32 pmic_index, boolean enable);
 ...
 */
pm_err_flag_type 
pm_schg_typec_en_fmb(uint32 pmic_index, boolean EnFmb);
 ...
 */
pm_err_flag_type 
pm_schg_typec_get_dam_connect_sts(uint32 pmic_index, boolean *ConnectSts);
 ...
 */
pm_err_flag_type 
pm_schg_typec_set_dam_icl(uint32 pmic_index, pm_schg_usb_typec_dam_icl_sel icl_sel);

/**
 * @brief This function configures Debug Access Mode(dam) icl.
 *
 * @param[in] pmic_index:   The pmic_index of charger module.
 * @param[in] usb_connector: uUSB/Typec.
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *                                               version of the PMIC.
 ...
 */
pm_err_flag_type 
pm_schg_typec_get_usb_connector_type(uint32 device_index, pm_typec_connector_type *usb_connector);
