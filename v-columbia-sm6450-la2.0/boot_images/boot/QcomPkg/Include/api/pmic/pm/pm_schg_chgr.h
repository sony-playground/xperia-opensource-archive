 ...
 *
 */
pm_err_flag_type pm_schg_chgr_enable_src(uint32 pmic_index, boolean chg_en_src);
 ...
 *
 */
pm_err_flag_type pm_schg_chgr_set_chg_polarity_low(uint32 pmic_index, boolean chg_pol_low);
