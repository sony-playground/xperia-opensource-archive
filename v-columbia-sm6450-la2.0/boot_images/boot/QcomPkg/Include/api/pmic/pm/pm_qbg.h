...
*
* @param[in] pmic_index         On what PMIC Index, QBG resides.
* @param[in] is_1s_battery, option_2s to set if it is 1s or 2s, and vbatt_2s option.
*
* @return  pm_err_flag_type
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available.
*          PM_ERR_FLAG_INVALID_PARAMETER     = Invalid parameters.
...
*
* @param[in] pmic_index         On what PMIC Index, QBG resides.
* @param[in] support_20A to set if it support 20A or 10A ibatt.
*
* @return  pm_err_flag_type
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available.
*          PM_ERR_FLAG_INVALID_PARAMETER     = Invalid parameters.
...
*
* @param[in] pmic_index         On what PMIC Index, QBG resides.
* @param[out] p_is_1s_battery, p_2s_option
*
* @return  pm_err_flag_type
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available.
*          PM_ERR_FLAG_INVALID_PARAMETER     = Invalid parameters.
