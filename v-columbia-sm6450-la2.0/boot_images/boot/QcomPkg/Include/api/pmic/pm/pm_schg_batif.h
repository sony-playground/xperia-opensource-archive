...
*
*/
pm_err_flag_type pm_schg_batif_enable_fake_bat_detect(uint32 pmic_index, boolean enable);

/**
* @brief This function disables fake battery detection for a given pmic
*
* @details
*  This function allows to set internal pull up
*
* @param[in] pmic_index:         The pmic_index of charger module.
* @param[in] pull_up_type:       pull type
* @param[in] resistance:         The resistance of pullup.
* @return  pm_err_flag_type
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
*                                              version of the PMIC.
*          PM_ERR_FLAG_SUCCESS               = SUCCESS.
