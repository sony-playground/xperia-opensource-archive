...
typedef enum
{
  PM_PWM_DTEST1, /*DTEST 1*/
  PM_PWM_DTEST2, /*DTEST 2*/
  PM_PWM_DTEST_INVALID, /*INVALID*/
}pm_pwm_dtest;
...
/*===========================================================================
FUNCTION  pm_pwm_config_dtest

DESCRIPTION
   This function configures the PWM DTEST line
PARAMETERS
 * @param [in] pmic_chip: :
 *                 PmicDeviceIndex - For primary 0
 * @param [in] dtest:
 *                 DTEST line to configure. Refer #pm_pwm_dtest for more info
 * @param [in] set_value:
 *                 TRUE : sets DTEST to PWM_OUT
 *                 FALSE: Disable PWM DTEST
...
===========================================================================*/
pm_err_flag_type pm_pwm_config_dtest(uint32 pmic_chip,
                                     pm_pwm_resource_type pwm_rsrc,
                                     pm_pwm_dtest dtest,
                                     uint32   set_value
                                     );
