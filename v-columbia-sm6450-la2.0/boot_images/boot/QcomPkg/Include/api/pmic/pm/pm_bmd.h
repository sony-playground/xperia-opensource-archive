 ...
 *   the PMIC BMD module.
 *
 *  \n &copy; Copyright (c) 2017-2021 QUALCOMM Technologies Incorporated. All Rights Reserved.
 */
...
/*===========================================================================
  ...
  $Header: //components/rel/core.boot/6.0/QcomPkg/Include/api/pmic/pm/pm_bmd.h#3 $
...
/**
 * @brief This function retrieves the input for the battery removal comparator
 *
 * @param[in]  pmic_index:
 *               0 for primary pmic
 *               1 for secondary pmic
