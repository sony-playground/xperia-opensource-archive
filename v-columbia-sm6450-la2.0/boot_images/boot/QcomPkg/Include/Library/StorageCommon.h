...
#define SPINOR_PROFILE_INIT_BIT_MASK     (1<<15)
#define SPINOR_PROFILE_ERASE_BIT_MASK    (1<<16)
#define SPINOR_PROFILE_WRITE_BIT_MASK    (1<<17)
#define SPINOR_PROFILE_READ_BIT_MASK     (1<<18)
