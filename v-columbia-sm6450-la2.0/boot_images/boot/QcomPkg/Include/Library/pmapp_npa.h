...
$Header: //components/rel/core.boot/6.0/QcomPkg/Include/Library/pmapp_npa.h#5 $ 
$DateTime: 2023/03/20 07:23:05 $  $Author: pwbldsvc $

when       	who     	what, where, why
--------   	---     	---------------------------------------------------------- 
3/13/23		udumpala    added sd_mmc_vdd_pstm, sd_mmc_vdd_px2_pstm
===========================================================================*/
...
#define PMIC_NPA_GROUP_ID_SD_MMC_VDD_PSTM "/pmic/client/sd_mmc_vdd_pstm"
#define PMIC_NPA_GROUP_ID_SD_MMC_VDD_PX2_PSTM "/pmic/client/sd_mmc_vdd_px2_pstm"
