...
Copyright 2012-2015,2021 by Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
--------   ---     ----------------------------------------------------------
15/03/21   bpk      move function prototype and struct def to 
                   QcomSdkPkg, in order to build parserdxe
