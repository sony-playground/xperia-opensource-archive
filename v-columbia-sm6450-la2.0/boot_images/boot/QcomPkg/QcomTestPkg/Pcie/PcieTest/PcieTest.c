...
# ----------   ---     ----------------------------------------------------------
# 03/20/2023   ms      Added NVME EP Support for Clarence PCIe
# 08/12/2022   ap      Added NVME EP Support for Netrani PCIe 
# 04/04/2022   ps      Endpoint hardcoded values changed to macros
...
{ 
   ...
   {.vend_id = PCIE_VENDOR_ID_QCOM, .dev_id = PCIE_DEV_ID_MOSELLE, .reg_offset = 0x10, .size = 0x8, .type_of_data = reg_type_addr},	
   {.vend_id = PCIE_VENDOR_ID_QCOM, .dev_id = PCIE_DEV_ID_CHITWAN, .reg_offset = 0x10, .size = 0x8, .type_of_data = reg_type_addr},
   {.vend_id = PCIE_NVME_VENDOR_ID_KIOXIA, .dev_id = PCIE_NVME_DEV_ID_KIOXIA,  .reg_offset = 0x34, .size = 0x4 },  // Kioxia NVMe device
   {.vend_id = PCIE_NVME_VENDOR_ID_PHISON, .dev_id = PCIE_NVME_DEV_ID_PHISON, .reg_offset = 0x2C, .size = 0x4 },
};
...
PcieTestType PcieTests [] = 
{
   ...
   {0, "tpsel", "tpsel", TargetPlatSelectTest, TPSEL_TEST_HELP_STR},
