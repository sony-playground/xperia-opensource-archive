...
const UINT8 T26[]="abcdefghijklmnopqrstuvwxyz";
const UINT8 T26_Sha1Result[] = {
  0x32, 0xd1, 0x0c, 0x7b, 0x8c, 0xf9, 0x65, 0x70,
  0xca, 0x04, 0xce, 0x37, 0xf2, 0xa1, 0x9d, 0x84,
  0x24, 0x0d, 0x3a, 0x89
};

const UINT8 T26_Sha224Result[] = {
...
const UINT8 T64[] ="abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijkl";
const UINT8 T64_Sha1Result[] = {
  0x93, 0x24, 0x9d, 0x4c, 0x2f, 0x89, 0x03, 0xeb,
  0xf4, 0x1a, 0xc3, 0x58, 0x47, 0x31, 0x48, 0xae,
  0x6d, 0xdd, 0x70, 0x42
};

const UINT8 T64_Sha224Result[] = {
...
const UINT8 T128[]="abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijkl";
const UINT8 T128_Sha1Result[] = {
  0x62, 0xe2, 0xd1, 0xa6, 0x17, 0x20, 0xb0, 0xcd,
  0x63, 0xb5, 0x31, 0xaa, 0x59, 0xed, 0xc8, 0x9d,
  0x42, 0x76, 0xcf, 0x98
};

const UINT8 T128_Sha224Result[] = {
...
const UINT8 T1000000_Sha1Result[] = {
  0x34, 0xaa, 0x97, 0x3c, 0xd4, 0xc4, 0xda, 0xa4,
  0xf6, 0x1e, 0xeb, 0x2b, 0xdb, 0xad, 0x27, 0x31,
  0x65, 0x34, 0x01, 0x6f
};

const UINT8 T1000000_Sha224Result[] = {
...
const UINT8 T1000000_Sha256Result[] = {
...
const UINT8 T1000000_Sha384Result[] = {
...
const UINT8 T1000000_Sha512Result[] = {
...
/* The following SM3 hash Test Vectors and outputs were auto-generated
   from cryptography library v2.9 - https://pypi.org/project/cryptography/
*/
const UINT8 msg_0[] =
{
...
const UINT8 sm3_hash_2[] =
{
    0x9c, 0xf0, 0x5d, 0x91, 0xcc, 0xdb, 0xb5, 0x3f, 0x87, 0x65, 0x43, 0xfd, 0x86, 0x67, 0x0c, 0xfd,
    0x22, 0xe0, 0x4a, 0x14, 0x58, 0xbc, 0xf0, 0x94, 0x06, 0xef, 0x06, 0x17, 0xd8, 0xf8, 0xd3, 0x43
};

const UINT8 sm3_hash_4[] =
{
    0x54, 0xb9, 0xd3, 0xe3, 0x62, 0xd1, 0x9c, 0xc4, 0xb5, 0x5b, 0x6c, 0x26, 0x3c, 0xa7, 0x77, 0xaf,
    0xa4, 0xe6, 0xb9, 0x66, 0xdb, 0x34, 0x9d, 0xed, 0xa3, 0xa8, 0xed, 0x6c, 0x87, 0x25, 0x2b, 0x7c
};

const UINT8 sm3_hash_8[] =
{
    0xdd, 0x3e, 0x9f, 0x12, 0x13, 0xa3, 0xd7, 0x4f, 0x2e, 0xb3, 0xa2, 0x01, 0x38, 0x5b, 0x72, 0x9e,
    0x5c, 0xa1, 0xa2, 0xbf, 0x68, 0xad, 0xc2, 0x6c, 0xc3, 0x5e, 0x6f, 0xfc, 0x08, 0x44, 0xc9, 0xb9
};

const UINT8 sm3_hash_16[] =
{
    0x9a, 0x6f, 0x6a, 0x2d, 0x67, 0x51, 0x92, 0x4b, 0xaa, 0x04, 0xf6, 0x28, 0x66, 0xc3, 0xde, 0x58,
    0xe3, 0x9c, 0x37, 0xc4, 0x10, 0x70, 0x31, 0x41, 0x0e, 0xee, 0x61, 0x20, 0xa8, 0xb5, 0x11, 0x1e
};

const UINT8 sm3_hash_32[] =
{
    0x21, 0xd8, 0x85, 0x8f, 0xbf, 0x71, 0x1c, 0x38, 0xa4, 0x88, 0x00, 0x2f, 0x36, 0x15, 0x43, 0xbf,
    0x9f, 0xa3, 0xaa, 0x0c, 0x78, 0x2d, 0xa9, 0xab, 0x68, 0x79, 0x6b, 0x93, 0x94, 0x1e, 0xda, 0xcb
};

const UINT8 sm3_hash_64[] =
{
    0x1b, 0xae, 0x4e, 0xb5, 0x0a, 0xea, 0x2d, 0x90, 0x98, 0x9c, 0x6b, 0x78, 0x71, 0xe7, 0xad, 0x91,
    0xd6, 0xd6, 0xa9, 0xb1, 0xe8, 0xbd, 0xc5, 0xfd, 0x39, 0xa1, 0xbd, 0xb0, 0x91, 0x59, 0x85, 0xa6
};

const UINT8 sm3_hash_128[] =
{
    0x15, 0x29, 0x3e, 0xf5, 0xe0, 0x12, 0xae, 0x43, 0x9a, 0xb5, 0x4c, 0xd0, 0x6d, 0x33, 0x2a, 0x84,
    0x3e, 0xe4, 0x23, 0xe6, 0xe3, 0xbe, 0xf3, 0x63, 0x10, 0xfa, 0x4c, 0x2a, 0xc8, 0x29, 0x31, 0xea
};

const UINT8 sm3_hash_256[] =
{
    0xa8, 0x28, 0x2d, 0xba, 0x5c, 0x98, 0x84, 0xbc, 0xcf, 0x8c, 0x55, 0x69, 0x67, 0xfa, 0x3a, 0x8c,
    0xed, 0xd8, 0xca, 0xa4, 0x3e, 0x87, 0x72, 0xed, 0x97, 0x80, 0xf2, 0x01, 0xab, 0xa6, 0xf1, 0x7b
};
...
const uefi_hash_test_vector_type uefi_hash_test_vectors[] = {
  /* T26 */
  ...
  ,
  {&gEfiHashAlgorithmSM3_256Guid,
  msg_64, sizeof(msg_64),
  sm3_hash_64}
  ,
  {&gEfiHashAlgorithmSM3_256Guid,
  msg_128, sizeof(msg_128),
  sm3_hash_128}
  ,
  {&gEfiHashAlgorithmSM3_256Guid,
  msg_256, sizeof(msg_256),
  sm3_hash_256}
#endif //defined (QCOM_EDK2_PATCH)
};
...
const uefi_hash_large_test_vector_type uefi_hash_large_test_vectors[] = {
  /* T1000000 */
  {&gEfiHashAlgorithmSha1Guid,
  T1000000_Sha1Result}
  ,
