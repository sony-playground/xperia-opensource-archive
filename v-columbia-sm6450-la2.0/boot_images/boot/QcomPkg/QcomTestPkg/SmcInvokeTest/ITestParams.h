...
#define TestParams_OP_ioAllTA 3
...
static inline int32_t
TestParams_get(Object self, uint32_t *vo_ptr, void *bo_ptr, size_t bo_len, size_t *bo_lenout, Object *oo_ptr)
{
  ObjectArg a[3];
...
static inline int32_t
TestParams_set(Object self, uint32_t vi_val, const void *bi_ptr, size_t bi_len, Object oi_val)
{
  ObjectArg a[3];
...
static inline int32_t
TestParams_ioAllTA(Object self, const void *bi01_ptr, size_t bi01_len, const void *bi02_ptr, size_t bi02_len, const void *bi03_ptr, size_t bi03_len, const void *bi04_ptr, size_t bi04_len, Object oi01_val, Object oi02_val, Object oi03_val, Object oi04_val, void *bo01_ptr, size_t bo01_len, size_t *bo01_lenout, void *bo02_ptr, size_t bo02_len, size_t *bo02_lenout, void *bo03_ptr, size_t bo03_len, size_t *bo03_lenout, void *bo04_ptr, size_t bo04_len, size_t *bo04_lenout, Object *oo01_ptr, Object *oo02_ptr, Object *oo03_ptr, Object *oo04_ptr)
{
  ObjectArg a[16];
  a[0].bi = (ObjectBufIn) { bi01_ptr, bi01_len * 1 };
  a[1].bi = (ObjectBufIn) { bi02_ptr, bi02_len * 1 };
  ...
  a[10].o = oi03_val;
  a[11].o = oi04_val;
  a[4].b = (ObjectBuf) { bo01_ptr, bo01_len * 1 };
  a[5].b = (ObjectBuf) { bo02_ptr, bo02_len * 1 };
  a[6].b = (ObjectBuf) { bo03_ptr, bo03_len * 1 };
  a[7].b = (ObjectBuf) { bo04_ptr, bo04_len * 1 };

  int32_t result = Object_invoke(self, TestParams_OP_ioAllTA, a, ObjectCounts_pack(4, 4, 4, 4));

  *bo01_lenout = a[4].b.size / 1;
  *bo02_lenout = a[5].b.size / 1;
  *bo03_lenout = a[6].b.size / 1;
  *bo04_lenout = a[7].b.size / 1;
  *oo01_ptr = a[12].o;
  *oo02_ptr = a[13].o;
  *oo03_ptr = a[14].o;
  *oo04_ptr = a[15].o;
