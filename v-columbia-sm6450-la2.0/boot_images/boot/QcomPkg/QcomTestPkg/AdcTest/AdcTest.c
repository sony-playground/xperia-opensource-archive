/*============================================================================
  ...
  DEPENDENCIES: None
                ...
                Copyright (c) 2011-2016, 2018-2019 Qualcomm Technologies, Inc.
                All Rights Reserved.
...
static const CHAR8 *vAdcChannels[] =
{
   ...
   ADC_INPUT_BATT_THERM_PU_30K,
   ADC_INPUT_BATT_THERM_PU_400K,
   ADC_INPUT_BATT_ID_OHMS,
   ADC_INPUT_BATT_ID_OHMS_PU_30K,
   ADC_INPUT_BATT_ID_OHMS_PU_400K,
   ADC_INPUT_SKIN_THERM,
   ADC_INPUT_CHG_TEMP,
   ADC_INPUT_USB_IN,
   ADC_INPUT_USB_IN_I,
   ADC_INPUT_USB_IN_I_MV,
   ADC_INPUT_DC_IN,
   ADC_INPUT_DC_IN_I,
};
...
int AdcTestWrapper(void)
{
   ...
   AdcRecalibrationResultType recal = {0};
