...
/*=============================================================================
 $Header: //components/rel/core.boot/6.0/QcomPkg/QcomTestPkg/EnterpriseMgtApp/EnterpriseMgtApp.c#1 $
                              EDIT HISTORY
...
**/
EFI_STATUS EnterpriseMgtTamperVar()
{
...
/**
  ...
  @retval EFI_STATUS  Status of return code.
**/
EFI_STATUS EnterpriseMgtDumpUefiNvVar()
{
...
/**
  ...
  @retval EFI_STATUS  Status of return code.
**/
static EFI_STATUS EnterpriseMgtLockNowVar()
{
    EFI_STATUS status = EFI_DEVICE_ERROR;
    ...
    for (i = 0; i < Argc; ++i)
    {
        ...
        else if (AsciiStriCmp (Argv[i], "-FeatureType") == 0)
        {
            ...
            for(j = i+1; j < Argc; j++)
            {
                ...
                AsciiPrint("EnterpriseMgtApp : Disable FeatureType 0x%02x\n", pFeatureList[NumFeatures]);
                NumFeatures++;
            }
            break;
        }
