...
/**
    ...
    { 'filename': 'HalusbHWIO_settings.h',
      'modules': ['USB2PHY_CM_DWC_USB2', 'USB3_DP_PHY_USB3.*']}
*/
/*
    ===========================================================================
    ...
    $Header: //components/rel/core.boot/6.0/Settings/Fillmore/Include/HalusbHWIO_settings.h#1 $
    $DateTime: 2021/11/09 12:48:53 $
    $Author: pwbldsvc $
