...
class phy_table(object):
    def __init__ (self, input, output, prefix, postfix, table, index, comment):
        self.addr_table = []
        self.data_table = []
        self.except_table = []
        self.phy_table = []
...
if __name__ == "__main__":
    ...
    builder = phy_table(input=input_path, output=output_tag, prefix=prefix, postfix=postfix, table=table_name, index=index_flag, comment=comment_flag)
