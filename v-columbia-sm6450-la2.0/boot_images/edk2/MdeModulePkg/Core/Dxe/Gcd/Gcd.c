...
Copyright (c) 2014-2015,2018, 2020, 2021 Qualcomm Technologies, Inc. All rights reserved.
  ...
  )
{
  ...
  CpuArchAttributes = Attributes & EXCLUSIVE_MEMORY_ATTRIBUTES & NONEXCLUSIVE_MEMORY_ATTRIBUTES;
#else
  ...
  else if ( (Attributes & EFI_MEMORY_XP) == EFI_MEMORY_XP) {
    CpuArchAttributes |= EFI_MEMORY_XP;
  }
#endif
