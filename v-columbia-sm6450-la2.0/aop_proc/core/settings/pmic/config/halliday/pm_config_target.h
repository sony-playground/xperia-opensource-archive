...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/settings/pmic/config/halliday/pm_config_target.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/13/22   rajivr  Initial version
========================================================================== */
...
#define PM_DRV_L3            (0x1 << RSC_DRV_GLOBAL_L3)
...
#define PM_DRV_TME_HW        (0x1 << RSC_DRV_GLOBAL_TME_HW)
#define PM_DRV_TME_SW        (0x1 << RSC_DRV_GLOBAL_TME_SW)
#define PM_DRV_DIS_1         (0x1 << RSC_DRV_GLOBAL_DISPLAY_1)
...
#define PM_DRV_BCM           (0x1 << RSC_DRV_GLOBAL_BCM)
