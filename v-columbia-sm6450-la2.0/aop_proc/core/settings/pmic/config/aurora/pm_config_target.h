...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/settings/pmic/config/aurora/pm_config_target.h#3 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/05/17   kt      Created
12/04/22   bde		WLANBB removed, WPSS added in drv CR:3164733
22/07/22   bde		DRVs updated as per drv_mapping CR: 3250842
========================================================================== */
...
#define PM_DRV_TMEH   (0x1 << RSC_DRV_GLOBAL_TME_HW) 
#define PM_DRV_TMES   (0x1 << RSC_DRV_GLOBAL_TME_SW)  
