...
$Header: //components/dev/aop.ho/4.0/arua.aop.ho.4.0.ClarenceAopPmicInitialChanges/aop_proc/core/settings/pmic/config/netrani/pm_config_target.h#1 $
...
#define PM_DRV_WPSS   (0x1 << RSC_DRV_GLOBAL_WPSS)  //WPSS added for Fillmore
