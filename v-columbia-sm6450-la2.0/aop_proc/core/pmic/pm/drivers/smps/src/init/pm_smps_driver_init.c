...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/pmic/pm/drivers/smps/src/init/pm_smps_driver_init.c#3 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/09/22   rajivr  Updated suptype condition check for AHC update
07/22/22   rajivr  Added check for PM_HW_MODULE_FTS__FTS525_CTL subtype
