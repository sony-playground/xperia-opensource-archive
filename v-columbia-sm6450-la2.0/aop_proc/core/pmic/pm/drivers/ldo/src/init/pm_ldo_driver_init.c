...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/pmic/pm/drivers/ldo/src/init/pm_ldo_driver_init.c#2 $
...
08/05/23   arua    LEICA2 LDO Type Addition
========================================================================== */
/*===========================================================================
...
static pm_pwr_register_info_type ldo_reg = 
{
  ...
  0x03B, 0x03C, 0x088, 0x066, 0x039, 0x068, 0x0D0, 0x60,
  0x49,  0x3C
};
