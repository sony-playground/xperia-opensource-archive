...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/pmic/pm/drivers/bob/src/init/pm_bob_driver_init.c#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/22/22   rajivr  Added check for BOB520 subtype in pm_bob_driver_init
12/22/15   al      Created
...
{
    0x100, 0x008, 0x011, 0x012, 0x013, 0x014, 0x015, 
    0x016, 0x040, 0x041, 0x042, 0x043, 0x045, 0x046, 0x047, 
    0x03B, 0x03C, 0x088, 0x066, 0x039, 0x068, 0x0D0
};
