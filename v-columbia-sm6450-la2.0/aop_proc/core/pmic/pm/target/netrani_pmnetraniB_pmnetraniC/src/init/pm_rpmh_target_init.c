...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/pmic/pm/target/netrani_pmnetraniB_pmnetraniC/src/init/pm_rpmh_target_init.c#6 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/10/15    kt      Initial version.
25/03/22    arua    Netrani Platform variant detection
17/05/22    arua    Netrani PMIC stub correction
31/08/23    arua    Netrani Platform variant detection removal for Customer Customization
===========================================================================*/
/*===========================================================================
...
{
    /*Netrani Platform variant detection removal for Customer Customization*/
    pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type pm_rpmh_pmic_detect_err_init(void)
{
    ...
    num_rsrc = pm_target_information_get_periph_count_info(PM_PROP_BOB_NUM, 4);
    pm_vrm_vreg_register_resources(4, PM_VRM_PERIPH_BOB, num_rsrc);
