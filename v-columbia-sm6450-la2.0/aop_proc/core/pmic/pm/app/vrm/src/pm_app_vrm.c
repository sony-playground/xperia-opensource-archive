...
$Header: //components/rel/aop.ho/4.0/aop_proc/core/pmic/pm/app/vrm/src/pm_app_vrm.c#7 $
 
when        who     what, where, why
--------    ---     ----------------------------------------------------------
11/23/16    kt       Created
02/01/22    rr       Added PM_MIN_SETTLING_TIME_POLL_THR 1500 for Waipio
04/11/22    rr       Added PM_MIN_SETTLING_TIME_POLL_THR 1500 for Palima
========================================================================== */
/*===========================================================================
...
#if defined(WAIPIO_TARGET_CONFIG) || defined(PALIMA_TARGET_CONFIG)
    #define PM_MIN_SETTLING_TIME_POLL_THR     1500 //uS
#else
