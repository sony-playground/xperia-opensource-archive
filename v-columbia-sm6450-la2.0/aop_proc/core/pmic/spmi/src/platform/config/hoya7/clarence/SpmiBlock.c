 ...
 * 
 * $DateTime: 2022/05/20 03:54:55 $
 * $Header: //components/dev/aop.ho/4.0/tmajumde.aop.ho.4.0.05202022_clarence_build_support/aop_proc/core/pmic/spmi/src/platform/config/hoya7/netrani/SpmiBlock.c#1 $
 * $Change: 37318055 $ 
 * 
 *                              Edit History
 * Date     Description
