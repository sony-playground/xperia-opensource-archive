...
#define INIT_MAP_SIZE 15
#define NUM_OUTSTANDING_MSG 5
#define MAX_CLASS_VALUE_LEN 15
#define MAX_MSG_LEN         0x64

#if defined(AURORA_TARGET_CONFIG) || defined(CLARENCE_TARGET_CONFIG)
#define NUM_REMOTES 4
#elif defined(HALLIDAY_TARGET_CONFIG)
...
{
    _APPS=0,
#if !defined(AURORA_TARGET_CONFIG) && !defined(HALLIDAY_TARGET_CONFIG)
    _MPSS,
#endif
#if !defined (FILLMORE_TARGET_CONFIG) && !defined(AURORA_TARGET_CONFIG) && !defined(HALLIDAY_TARGET_CONFIG) && !defined(NETRANI_TARGET_CONFIG) && !defined(CLARENCE_TARGET_CONFIG)
    _SLPI,
#endif
#if !defined(CLARENCE_TARGET_CONFIG)
    _CDSP,
#endif
    _ADSP, 
#if defined (FILLMORE_TARGET_CONFIG) || defined(AURORA_TARGET_CONFIG) || defined(NETRANI_TARGET_CONFIG) || defined(CLARENCE_TARGET_CONFIG)
    _WPSS,
#endif
