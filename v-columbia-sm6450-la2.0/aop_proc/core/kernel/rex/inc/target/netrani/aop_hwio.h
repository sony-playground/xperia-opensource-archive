...
/**
    ...
    Reference chip release:
        SM6xxx (Netrani) [netrani_v1.0_p3q1r21]
...
/*
    ...
    $Header: //components/rel/aop.ho/4.0/aop_proc/core/kernel/rex/inc/target/netrani/aop_hwio.h#2 $
    $DateTime: 2021/10/20 10:47:58 $
    $Author: pwbldsvc $
...
#define AOP_DEC_REG_BASE_USED                                               0xc0
...
#define HWIO_AOP_WDOG_BARK_TIME_SYNC_STATUS_SHFT                                    20
...
#define HWIO_AOP_WDOG_BITE_TIME_SYNC_STATUS_SHFT                                    20
...
#define HWIO_AOP_WDOG_TEST_SYNC_STATUS_SHFT                                         20
...
#define HWIO_AOP_PAGE_SELECT_ADDR                                           (AOP_DEC_REG_BASE      + 0x70)
#define HWIO_AOP_PAGE_SELECT_PHYS                                           (AOP_DEC_REG_BASE_PHYS + 0x70)
#define HWIO_AOP_PAGE_SELECT_OFFS                                           (AOP_DEC_REG_BASE_OFFS + 0x70)
#define HWIO_AOP_PAGE_SELECT_RMSK                                                 0x3f
#define HWIO_AOP_PAGE_SELECT_IN                    \
                in_dword(HWIO_AOP_PAGE_SELECT_ADDR)
...
#define HWIO_AOP_PAGE_SELECT_PAGE_SELECT_SHFT                                        0

#define HWIO_AOP_BRIDGES_CLK_GATING_ADDR                                    (AOP_DEC_REG_BASE      + 0x74)
#define HWIO_AOP_BRIDGES_CLK_GATING_PHYS                                    (AOP_DEC_REG_BASE_PHYS + 0x74)
#define HWIO_AOP_BRIDGES_CLK_GATING_OFFS                                    (AOP_DEC_REG_BASE_OFFS + 0x74)
#define HWIO_AOP_BRIDGES_CLK_GATING_RMSK                                           0x3
#define HWIO_AOP_BRIDGES_CLK_GATING_IN                    \
                in_dword(HWIO_AOP_BRIDGES_CLK_GATING_ADDR)
...
#define HWIO_AOP_BRIDGES_CLK_GATING_AOP_BRIDGE_CLK_GATING_SHFT                       1
#define HWIO_AOP_BRIDGES_CLK_GATING_NOC_BRIDGE_CLK_GATING_BMSK                     0x1
#define HWIO_AOP_BRIDGES_CLK_GATING_NOC_BRIDGE_CLK_GATING_SHFT                       0

#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_ADDR                               (AOP_DEC_REG_BASE      + 0x78)
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_PHYS                               (AOP_DEC_REG_BASE_PHYS + 0x78)
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_OFFS                               (AOP_DEC_REG_BASE_OFFS + 0x78)
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_RMSK                               0x7fffffff
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_IN                    \
                in_dword(HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_ADDR)
...
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_AOP_BRIDGE_HYST_CNTR_SHFT                  16
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_NOC_BRDG_SYNC_STATUS_BMSK              0x8000
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_NOC_BRDG_SYNC_STATUS_SHFT                  15
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_NOC_BRIDGE_HYST_CNTR_BMSK              0x7fff
#define HWIO_AOP_BRIDGES_HYSTERESIS_CNTR_NOC_BRIDGE_HYST_CNTR_SHFT                   0

#define HWIO_AOP_MISC_ADDR                                                  (AOP_DEC_REG_BASE      + 0x7c)
#define HWIO_AOP_MISC_PHYS                                                  (AOP_DEC_REG_BASE_PHYS + 0x7c)
#define HWIO_AOP_MISC_OFFS                                                  (AOP_DEC_REG_BASE_OFFS + 0x7c)
#define HWIO_AOP_MISC_RMSK                                                         0x3
#define HWIO_AOP_MISC_IN                    \
                in_dword(HWIO_AOP_MISC_ADDR)
...
#define HWIO_AOP_MISC_AOP_BRIDGE_POST_EN_SHFT                                        1
#define HWIO_AOP_MISC_NOC_BRIDGE_POST_EN_BMSK                                      0x1
#define HWIO_AOP_MISC_NOC_BRIDGE_POST_EN_SHFT                                        0

#define HWIO_AOP_CODE_RAM_DENSITY_ADDR                                      (AOP_DEC_REG_BASE      + 0x80)
#define HWIO_AOP_CODE_RAM_DENSITY_PHYS                                      (AOP_DEC_REG_BASE_PHYS + 0x80)
#define HWIO_AOP_CODE_RAM_DENSITY_OFFS                                      (AOP_DEC_REG_BASE_OFFS + 0x80)
...
#define HWIO_AOP_DATA_RAM_DENSITY_ADDR                                      (AOP_DEC_REG_BASE      + 0x84)
#define HWIO_AOP_DATA_RAM_DENSITY_PHYS                                      (AOP_DEC_REG_BASE_PHYS + 0x84)
#define HWIO_AOP_DATA_RAM_DENSITY_OFFS                                      (AOP_DEC_REG_BASE_OFFS + 0x84)
...
#define HWIO_AOP_MSG_RAM_DENSITY_ADDR                                       (AOP_DEC_REG_BASE      + 0x88)
#define HWIO_AOP_MSG_RAM_DENSITY_PHYS                                       (AOP_DEC_REG_BASE_PHYS + 0x88)
#define HWIO_AOP_MSG_RAM_DENSITY_OFFS                                       (AOP_DEC_REG_BASE_OFFS + 0x88)
...
#define HWIO_AOP_INTR_POLARITY_2_ADDR                                       (AOP_DEC_REG_BASE      + 0x8c)
#define HWIO_AOP_INTR_POLARITY_2_PHYS                                       (AOP_DEC_REG_BASE_PHYS + 0x8c)
#define HWIO_AOP_INTR_POLARITY_2_OFFS                                       (AOP_DEC_REG_BASE_OFFS + 0x8c)
...
#define HWIO_AOP_INTR_POLARITY_3_ADDR                                       (AOP_DEC_REG_BASE      + 0x90)
#define HWIO_AOP_INTR_POLARITY_3_PHYS                                       (AOP_DEC_REG_BASE_PHYS + 0x90)
#define HWIO_AOP_INTR_POLARITY_3_OFFS                                       (AOP_DEC_REG_BASE_OFFS + 0x90)
...
#define HWIO_AOP_INTR_EDG_LVL_2_ADDR                                        (AOP_DEC_REG_BASE      + 0x94)
#define HWIO_AOP_INTR_EDG_LVL_2_PHYS                                        (AOP_DEC_REG_BASE_PHYS + 0x94)
#define HWIO_AOP_INTR_EDG_LVL_2_OFFS                                        (AOP_DEC_REG_BASE_OFFS + 0x94)
...
#define HWIO_AOP_INTR_EDG_LVL_3_ADDR                                        (AOP_DEC_REG_BASE      + 0x98)
#define HWIO_AOP_INTR_EDG_LVL_3_PHYS                                        (AOP_DEC_REG_BASE_PHYS + 0x98)
#define HWIO_AOP_INTR_EDG_LVL_3_OFFS                                        (AOP_DEC_REG_BASE_OFFS + 0x98)
...
#define HWIO_AOP_IPC_PULSEWIDTH_ADDR                                        (AOP_DEC_REG_BASE      + 0x9c)
#define HWIO_AOP_IPC_PULSEWIDTH_PHYS                                        (AOP_DEC_REG_BASE_PHYS + 0x9c)
#define HWIO_AOP_IPC_PULSEWIDTH_OFFS                                        (AOP_DEC_REG_BASE_OFFS + 0x9c)
...
#define HWIO_AOP_ALWAYS_ON_PWR_HOLD_ADDR                                    (AOP_DEC_REG_BASE      + 0xa0)
#define HWIO_AOP_ALWAYS_ON_PWR_HOLD_PHYS                                    (AOP_DEC_REG_BASE_PHYS + 0xa0)
#define HWIO_AOP_ALWAYS_ON_PWR_HOLD_OFFS                                    (AOP_DEC_REG_BASE_OFFS + 0xa0)
...
#define HWIO_AOP_MINI_MMU_0_ADDR                                            (AOP_DEC_REG_BASE      + 0xa4)
#define HWIO_AOP_MINI_MMU_0_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xa4)
#define HWIO_AOP_MINI_MMU_0_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xa4)
...
#define HWIO_AOP_MINI_MMU_1_ADDR                                            (AOP_DEC_REG_BASE      + 0xa8)
#define HWIO_AOP_MINI_MMU_1_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xa8)
#define HWIO_AOP_MINI_MMU_1_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xa8)
...
#define HWIO_AOP_MINI_MMU_2_ADDR                                            (AOP_DEC_REG_BASE      + 0xac)
#define HWIO_AOP_MINI_MMU_2_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xac)
#define HWIO_AOP_MINI_MMU_2_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xac)
...
#define HWIO_AOP_MINI_MMU_3_ADDR                                            (AOP_DEC_REG_BASE      + 0xb0)
#define HWIO_AOP_MINI_MMU_3_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xb0)
#define HWIO_AOP_MINI_MMU_3_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xb0)
...
#define HWIO_AOP_MINI_MMU_4_ADDR                                            (AOP_DEC_REG_BASE      + 0xb4)
#define HWIO_AOP_MINI_MMU_4_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xb4)
#define HWIO_AOP_MINI_MMU_4_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xb4)
...
#define HWIO_AOP_MINI_MMU_5_ADDR                                            (AOP_DEC_REG_BASE      + 0xb8)
#define HWIO_AOP_MINI_MMU_5_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xb8)
#define HWIO_AOP_MINI_MMU_5_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xb8)
...
#define HWIO_AOP_MINI_MMU_6_ADDR                                            (AOP_DEC_REG_BASE      + 0xbc)
#define HWIO_AOP_MINI_MMU_6_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xbc)
#define HWIO_AOP_MINI_MMU_6_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xbc)
...
#define HWIO_AOP_MINI_MMU_7_ADDR                                            (AOP_DEC_REG_BASE      + 0xc0)
#define HWIO_AOP_MINI_MMU_7_PHYS                                            (AOP_DEC_REG_BASE_PHYS + 0xc0)
#define HWIO_AOP_MINI_MMU_7_OFFS                                            (AOP_DEC_REG_BASE_OFFS + 0xc0)
