...
typedef enum
{
    AOP_MPU_RGN_CODE_RAM = 0,        /* to detect code region writes*/
    AOP_MPU_RGN_DATA_RAM = 1,        /* to detect data execution */
    AOP_MPU_RGN_CODE_WR_8K = 2,      /* exceptions for logs, heap, init stack */ 
    AOP_MPU_RGN_CODE_WR_16K   = 3,   /* exceptions for data in coderam */ 
    AOP_MPU_RESERVED_0   = 4,        /* Reserved */
    AOP_MPU_RGN_CODE_NULL_PTR = 5,   /* to detect null-pointer dereference, TODO: might not be needed */
    AOP_MPU_RGN_MSP_STACK_GUARD = 6, /* to detect MSP stack overflow. NOTE: Must be the highest priority */
    AOP_MPU_RGN_PSP_STACK_GUARD = 7, /* to detect PSP stack overflow. NOTE: Must be the highest priority */
    AOP_MPU_RGN_COUNT,
} aop_mpu_rgn_num_t;
