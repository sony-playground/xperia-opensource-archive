...
void notify_tz(void)
{
  ...
  #if defined(WAIPIO_TARGET_CONFIG) || defined(AURORA_TARGET_CONFIG) || defined(FILLMORE_TARGET_CONFIG) || defined(NETRANI_TARGET_CONFIG) || defined(HALLIDAY_TARGET_CONFIG) || defined(CLARENCE_TARGET_CONFIG)
    IPCC_Handle hIPCC2;
