...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/aop.ho/4.0/aop_proc/core/securemsm/cryptodrivers/prng/chipset/build/netrani.SConscript#1 $
...
# netrani interface redirection
CHIPSETREDIRECTION = 'netrani'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "netrani  [%s] does not exist"%script_sconfname
