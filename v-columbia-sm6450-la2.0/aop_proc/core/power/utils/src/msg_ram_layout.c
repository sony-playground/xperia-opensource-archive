...
#if defined(MAKENA_TARGET_CONFIG) || defined(HALLIDAY_TARGET_CONFIG)
 ...
 *
 */ 
#if !defined(SDX24_STUBS) && !defined(SDX55_STUBS) && !defined(Olympic_STUBS)
 ...
 */ 
 ...
 {
#if defined(AOP_PROF_ENABLED) || defined(DEBUG_LPM_VIOLATORS)
