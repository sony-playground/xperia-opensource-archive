...
typedef struct
{
  ...
  uint32 reserved_addrs[6];
} dict_t;


#if !defined(WAIPIO_TARGET_CONFIG) && !defined(KAILUA_TARGET_CONFIG) && !defined(FILLMORE_TARGET_CONFIG) && !defined(AURORA_TARGET_CONFIG) && !defined(NETRANI_TARGET_CONFIG) && !defined(HALLIDAY_TARGET_CONFIG) && !defined(CLARENCE_TARGET_CONFIG)
...
typedef struct ddr_residency_info
{
  ...
  uint32_t drv_mc0_vote[NUM_DRVS]; //To store DDR instant AB/IB vote
...
typedef struct
{
  ...
  uint32 reserved1[210-((sizeof(DDR_RESIDENCY_INFO_T)+
