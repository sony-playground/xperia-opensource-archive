...
typedef enum
{
    ...
    MSG_RAM_AOP_LOGGING = 0x7, //RSC_DRV_DEBUG,       //tier 1 reclaim 
    MSG_RAM_GPU         = 0x8, //RSC_DRV_GPU,         //tier 1 reclaim
    MSG_RAM_DISPLAY     = 0x9, //RSC_DRV_DISPLAY,     //tier 1 reclaim  
    MSG_RAM_MODEM_SW    = 0xA, //RSC_DRV_MODEM_SW,  
    MSG_RAM_DDR_STATS   = 0xB, //RSC_DRV_MODEM_HW,
    MSG_RAM_COMPUTE_DSP = 0xC, //RSC_DRV_COMPUTE_DSP, 
