...
mid_a_str = ("",   "Voltage", "Voltage", "Voltage", "Voltage", "LLC Collapse", "QActive", "NA",       "NA")
mid_b_str = ("",   "Cmds",    "Cmds",    "Cmds",    "Cmds",    "Cmds",    "",        "Aborted",  "NA")
...
def print_seqstats(data):
    ...
    names = ("SHUB", "MC", "PARALLEL", "RESTORE", "COLLAPSE", "LLC FLUSH", "FLUSH ABORT", "SW SEQUENCE")
    seq_idx = 0;
