...
/*
  ====================================================================
                ...
                Copyright 2013-2019, 2023 Qualcomm Technologies, Inc.

  ====================================================================

  $Header: //components/rel/aop.ho/4.0/aop_proc/core/api/systemdrivers/PlatformInfoDefs.h#5 $
...
typedef struct
{
  ...
  uint32                          eSKU;                 /**< SKU ID enum for this device */
  uint32                          nProductCode;         /**< Product code for this device */
  uint32                          nPartNameMapOffset;  /**< Offset of the part name
                                                             strings for the current chip, from the base of socinfo. */
