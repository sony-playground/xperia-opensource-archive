...
/*
  ...
  $Header: //components/rel/aop.ho/4.0/aop_proc/core/api/systemdrivers/clock/clock.h#1 $
...
/* =========================================================================
**  Function : Clock_SetDomainPerfLevel
** =========================================================================*/
/**
  Set performance level of a specific clock domain.
  @param
    eDomain - Clock Domain
    nLevel  - HWKM performance level
  @return
    CLOCK_SUCCESS - Set configuration success
    CLOCK_ERROR   - Set configuration fails
...
int32 Clock_SetDomainPerfLevel( ClockDomainType eDomain, uint32 nLevel );
...
** =========================================================================*/
/**
  This function is used for doing clock related changes when entering/exiting
   vdd_cx min

  @param
    boolean enter : true signifies entering low power state, false on exit
  @return
    None
  ...
  @dependencies
    None
*/
void Clock_ProcessorShutdown( boolean enter );
...
/* =========================================================================
**  Function : Clock_PreSHUBClockSwitch
** =========================================================================*/
/**
  This function performs any necessary logic prior to changing the SHUB
  frequency. This should be called by ddr_mgr after the new voltage has been
  voted and before the actual SHUB frequency switch has occured.

  @param
    nCP -- Clock plan number SHUB is being switched to.
  @return
    CLOCK_SUCCESS
    CLOCK_ERROR
  ...
  @dependencies
    None
*/
int32_t Clock_PreSHUBClockSwitch (uint32_t nCP);


/* =========================================================================
**  Function : Clock_PostSHUBClockSwitch
** =========================================================================*/
/**
  This function performs any necessary logic after changing the SHUB
  frequency. This should be called by ddr_mgr after the SHUB frequency
  switch has completed but before the old voltage request has been removed.

  @param
    nCP -- Clock plan number SHUB just switched to.
  @return
    CLOCK_SUCCESS
    CLOCK_ERROR
  ...
  @dependencies
    None
*/
int32_t Clock_PostSHUBClockSwitch (uint32_t nCP);
