 ...
 */
typedef void ( *rpmh_completion_cb )( uint32 req_id, void * cb_data);
 ...
 * @param cb_data : Opaque cb data for the client
 */ 
void rpmh_notify_completion_all (rpmh_client_handle client_handle, uint32 req_id, void * cb_data);
 ...
 * @param cb_data : Opaque cb data for the client
 */ 
void rpmh_notify_completion_single (rpmh_client_handle client_handle, uint32 req_id, void * cb_data);
