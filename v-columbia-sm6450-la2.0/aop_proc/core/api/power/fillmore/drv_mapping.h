...
typedef enum {
    ...
    RSC_DRV_GLOBAL_SECPROC       = 4,   //Reserved1
    RSC_DRV_GLOBAL_AUDIO         = 5,
    RSC_DRV_GLOBAL_SENSORS       = 6,   //Reserved2
    ...
    RSC_DRV_GLOBAL_TME_SW        = 13,
    RSC_DRV_GLOBAL_WPSS          = 14,   //New for Fillmore(WLAN_BB is removed)
    RSC_DRV_GLOBAL_MODEM_SW      = 15,
    RSC_DRV_GLOBAL_MODEM_HW      = 16,
    RSC_DRV_GLOBAL_WLAN_RF       = 17,
