...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/aop.ho/4.0/aop_proc/core/bsp/build/scripts/cmm_builder.py#2 $
#  $DateTime: 2023/05/02 05:14:17 $
#  $Author: pwbldsvc $
#  $Change: 46340352 $
...
def cmmbuilder_debug_output(env, type, msg):
	...
	if os.path.isfile(filename):
		...
		if (not fileprops & stat.S_IWRITE & stat.S_IREAD):
