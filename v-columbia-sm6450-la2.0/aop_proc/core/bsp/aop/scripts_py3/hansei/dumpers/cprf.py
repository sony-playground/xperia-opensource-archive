...
def dump_cprf_summary(dump_path, memory, target, debug_info, fill_char):
	...
	with open(cprf_file_name, 'w') as cprf_file:
		...
		for m in range(0,no_cprf):
			...
			print("\n\t~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", file=cprf_file)
			print("\t| OL |Enb_count| Vmax | Vmin | Vsafe | Current |Up_count|Down_count|", file=cprf_file)
			print("\t~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", file=cprf_file)
			#print("\n\t~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", file=cprf_file)
			...
			for  lvl in range(0,no_corners):
				...
				print("\t|{0:>4d}|{1:>9d}|{2:>6d}|{3:>6d}|{4:>7d}|{5:>9d}|{6:>8d}|{7:>10d}|" .format(lvl,ol_count,vmax,vmin,vsafe,last_vol,up_count,down_count),file=cprf_file)
			print("\t~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", file=cprf_file)
