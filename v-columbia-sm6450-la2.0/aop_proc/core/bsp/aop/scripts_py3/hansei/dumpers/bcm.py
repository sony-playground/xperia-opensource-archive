                    ...
                    if (x==0):
                        ...
                        if (ddr_mc_cp!=0x0):
                            ...
                            for y in data[key]["Clock Domains"]:
                                try :							
                                    print("\t|{0:3s}{1:>20s}|{2:>8s}|{3:>10s}|{4:>8s}|{5:>25s}|{6:30s}: {7:>17s}|" .format(v4,var_print,v1,v2,v3,v5,y["domain"], (str(y["freq"][int(ddr_mc_cp,16)]).split(":")[1]) ), file=bcm_file)
                                    var_print=""  
                                    v1=""
                                    v2=""
                                    v3=""
                        ...
                        if (ddr_shub_cp!=0x0):
                            ...
                            for y in data[key]["Clock Domains"]:
                              try:
                                print("\t|{0:3s}{1:>20s}|{2:>8s}|{3:>10s}|{4:>8s}|{5:>25s}|{6:30s}: {7:>17s}|" .format(v4,var_print,v1,v2,v3,v5,y["domain"],(str(y["freq"][int(ddr_shub_cp,16)]).split(":")[1])), file=bcm_file)
                                var_print=""  
                                v1=""
                                v2=""
                                v3=""
                        ...
                        if (agg_cp!=0):
                            ...
                            for y in data[key]["Clock Domains"]:
                              try:
                                print("\t|{0:3s}{1:>20s}|{2:>8s}|{3:>10s}|{4:>8s}|{5:>25s}|{6:30s}: {7:>17s}|" .format(v4,var_print,v1,v2,v3,v5,y["domain"],(str(y["freq"][agg_cp]).split(":")[1])), file=bcm_file)
                                var_print=""  
                                v1=""
                                v2=""
                                v3=""
