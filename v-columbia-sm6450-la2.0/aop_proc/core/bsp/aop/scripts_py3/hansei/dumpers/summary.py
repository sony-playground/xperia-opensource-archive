...
chips = {
    ...
    10 : {
		...
		#netrani , soc_hw_versions: 0xA005
        5 : {
	    'MSM_ID' : 'netrani',
            'num'    : 'netrani',
            'name'   : 'netrani',
	    },
		#clarence, soc_hw_versions: 0xA010
        16 : {
	    'MSM_ID' : 'clarence',
            'num'    : 'clarence',
            'name'   : 'clarence',
	    },
		#aurora , soc_hw_versions: 0xA006 0xA00A0100
        6 : {
	    'MSM_ID' : 'aurora',
            'num'    : 'aurora',
            'name'   : 'aurora',
	    },
        #halliday , soc_hw_versions: 0xA00A 
        10 : { 
	    'MSM_ID' : 'halliday',
            'num'    : 'halliday',
            'name'   : 'halliday',
	    },
		#palima , soc_hw_versions: 0xA008
        8 : {
	    'MSM_ID' : 'palima',
            'num'    : 'palima',
            'name'   : 'palima',
