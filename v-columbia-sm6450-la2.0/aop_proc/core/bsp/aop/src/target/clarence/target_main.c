...
Copyright (c) 2016-2019,2022 QUALCOMM Technologies, Inc. (QTI). All Rights Reserved.
...
extern void arc_vcomp_ol_init(void);
...
void init_phase_1(void)
{
  ...
  {
     system_debug_main(); //clarence_todo
  }
  /* Populate chip info*/
  ChipInfo_Init();
  PlatformInfo_Init();
