...
dump_file_types = [
    ...
    {   # Certain system data is stored in OCIMEM
        ...
        'data'          : {
                              'dumptable' : {
                                                ...
                                                'halliday'   : 0x146AA000 + 0x10,
												'netrani'   : 0x146AA000 + 0x10,
												'clarence'   : 0x146AA000 + 0x10,
                                            },
                          },
    },
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS2_2.BIN','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst','dram_cs2_0xa00000000--0xa7fffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS2_2', 'dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff', 'dram_cs2_0xa00000000--0xa7fffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
