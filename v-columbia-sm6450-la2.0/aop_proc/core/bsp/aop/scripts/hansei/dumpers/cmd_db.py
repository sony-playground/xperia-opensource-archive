...
def dump(debug_data): #dump_path, memory, debug_info, fill_char):
	...
	try:
		...
		elif target in ['8250','Saipan','lahaina','cedros','waipio','fillmore','aurora','palima','netrani','clarence']:
	...
	with open(cmddb_file_name, 'w') as cmd_db_file:
		...
		elif target in ['8250','Saipan', 'lahaina','cedros','waipio','fillmore','netrani','clarence','aurora','palima']:
