# 1 "/local/mnt/workspace/CRMBuilds/AOP.HO.4.0-00571-WAIPIO_E-1_20231026_070056/b/HY11_1/aop_proc/core/kernel/rex/target/clarence/aop.scl"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 355 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/local/mnt/workspace/CRMBuilds/AOP.HO.4.0-00571-WAIPIO_E-1_20231026_070056/b/HY11_1/aop_proc/core/kernel/rex/target/clarence/aop.scl" 2
# 56 "/local/mnt/workspace/CRMBuilds/AOP.HO.4.0-00571-WAIPIO_E-1_20231026_070056/b/HY11_1/aop_proc/core/kernel/rex/target/clarence/aop.scl"
ENTRY(Reset_Handler)
...
SECTIONS
{
  ...
  ASSERT(. <= (((0x0 + 0x18000) - 0x300 - 32) - 0x2F00) - 0x3E0 - 0x200 - 0x1800, "AOPSS_CODE oversized");

  __aop_cram_size_left = (((0x0 + 0x18000) - 0x300 - 32) - 0x2F00) - 0x3E0 - 0x200 - 0x1800 - .;
  ...
  AOP_DATA_IN_CRAM (((0x0 + 0x18000) - 0x300 - 32) - 0x2F00) - 0x3E0 - 0x200 - 0x1800:
  {
  ...
  ASSERT (. < (0x80814000), "RINIT DATA oversized");
  __aop_rinit_size_left = (0x80814000) - .;
  AOPSS_RINIT_ZI:
  {
  ...
  PMIC_DATA (0x80814000) :
  {
   ...
   ASSERT (. < (0x8081C000), "PMIC DATA oversized");

  __aop_pmic_size_left = (0x8081C000) - .;
  AOPSS_PMIC_ZI:
  {
  ...
  ASSERT (. < (0x80860000), "DDR CODE oversized");

  __aop_ddrcode_size_left = (0x80860000) - .;
  AOPSS_DDR_CODE_ZI:
  {
  ...
  __aop_devcfg_start = 0x80880000;
  __aop_devcfg_end = 0x808A0000;
