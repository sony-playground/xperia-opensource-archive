...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/aop.ho/4.0/aop_proc/core/bsp/aop/build/AOP.py#14 $
#  $DateTime: 2022/05/22 01:47:14 $
#  $Author: pwbldsvc $
#  $Change: 37337813 $
#
#===============================================================================
...
def generate(env):
  ...
  if do_local_files:
    ...
    elif env['MSM_ID'] == 'halliday':
      env.Append(CPPDEFINES = 'NO_STACK_CHECK')
      env.Append(CPPDEFINES = 'HALLIDAY_STUBS')
    ...
    elif env['MSM_ID'] == 'clarence':
      env.Append(CPPDEFINES = 'NO_STACK_CHECK')
      env.Append(CPPDEFINES = 'CLARENCE_STUBS')
      env.Append(CPPDEFINES = 'CLARENCE_TARGET_CONFIG')
      env.Append(CCFLAGS    = ' -mlong-calls')
      env.AddUsesFlags('USES_REMOTE_QTI_SIGN')      #CLARENCE_TODO
    else:
      env.Append(CPPDEFINES = 'NO_STACK_CHECK')
