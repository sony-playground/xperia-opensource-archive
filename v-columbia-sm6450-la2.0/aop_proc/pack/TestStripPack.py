...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/aop.ho/4.0/aop_proc/pack/TestStripPack.py#1 $
...
'''
   ...
   Parameters:
      ...
      -v
            ...
            (bascially just the Perforce $Header: //components/rel/aop.ho/4.0/aop_proc/pack/TestStripPack.py#1 $ line), and exit.
...
try:
   ...
   log("Version $Header: //components/rel/aop.ho/4.0/aop_proc/pack/TestStripPack.py#1 $")
   ...
   #                "--source", source,
   #                "--version", "$Header: //components/rel/aop.ho/4.0/aop_proc/pack/TestStripPack.py#1 $".split('#')[1].split()[0],
   #                "--path", path,]
   #      if options:
   #         cmd += ["--options", "'" + options + "'"]
   #      log_exec(cmd)
   ...
   Incremental     = False
   TestStripPackVersionInfo = "TestStripPack.py Version Info: $Header: //components/rel/aop.ho/4.0/aop_proc/pack/TestStripPack.py#1 $"
   err_info = ErrorInfo()
