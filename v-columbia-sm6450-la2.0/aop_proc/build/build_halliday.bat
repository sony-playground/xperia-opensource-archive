...
rem ==========================================================================
rem $Header: //components/rel/aop.ho/4.0/aop_proc/build/build_halliday.bat#1 $

SET BUILD_ASIC=halliday
SET MSM_ID=halliday
SET HAL_PLATFORM=halliday
SET TARGET_FAMILY=halliday
SET CHIPSET=halliday
