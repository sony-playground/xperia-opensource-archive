...
rem ==========================================================================
rem $Header: //components/rel/aop.ho/4.0/aop_proc/build/build_kodiak_cedros_lahaina.bat#1 $

SET BUILD_ASIC=kodiak
SET MSM_ID=kodiak
SET HAL_PLATFORM=kodiak
SET TARGET_FAMILY=kodiak
SET CHIPSET=kodiak
...
SET BUILD_ASIC=cedros
SET MSM_ID=cedros
SET HAL_PLATFORM=cedros
SET TARGET_FAMILY=cedros
SET CHIPSET=cedros
SET SECPOLICY=USES_SEC_POLICY_MULTIPLE_DEFAULT_SIGN
...
SET BUILD_ASIC=8350
SET MSM_ID=8350
SET HAL_PLATFORM=8350
SET TARGET_FAMILY=8350
SET CHIPSET=sm8350
SET SECPOLICY=USES_SEC_POLICY_MULTIPLE_DEFAULT_SIGN
