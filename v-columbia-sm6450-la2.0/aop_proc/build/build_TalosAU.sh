...
# ==========================================================================
# $Header: //components/rel/aop.ho/4.0/aop_proc/build/build_TalosAU.sh#1 $

export BUILD_ASIC=TalosAU
export MSM_ID=TalosAU
export HAL_PLATFORM=TalosAU
export TARGET_FAMILY=TalosAU
export CHIPSET=TalosAU
