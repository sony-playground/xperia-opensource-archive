...
rem ==========================================================================
rem $Header: //components/rel/aop.ho/4.0/aop_proc/build/build_fillmore_devcfg.bat#1 $

SET BUILD_ASIC=filmore
SET MSM_ID=filmore
SET HAL_PLATFORM=filmore
SET TARGET_FAMILY=filmore
SET CHIPSET=filmore
