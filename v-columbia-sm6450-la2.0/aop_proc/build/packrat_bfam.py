...
def check_elf_exists(msm):
  ...
  elif msm in ['6150','7150','cedros','8350', 'makena','kodiak','fillmore', 'waipio','aurora','palima','lassen','netrani','clarence','halliday']:
...
def match_whitelist(all_files, whitelist_files, msm):
  ...
  if msm == '670':
    ...
    execfile(packrat_path + '/whitelist_halliday.py', whitelist)
  elif msm == 'lassen':
    execfile(packrat_path + '/whitelist_lassen.py', whitelist)
  elif msm == 'netrani':
    execfile(packrat_path + '/whitelist_netrani.py', whitelist)
  elif msm == 'clarence':
    execfile(packrat_path + '/whitelist_clarence.py', whitelist)
  else:
...
def main(argv):
  ...
  if msm == '670':
    ...
    supported_targets = ['6150','7150']
  elif msm == '8350':
    supported_targets = ['kodiak','cedros','8350']
  elif msm == 'makena':
    supported_targets = ['makena']
  elif msm == 'makenaau':
    supported_targets = ['ivi','adas']
  elif msm == 'Olympic':
    supported_targets = ['Olympic']
  elif msm == 'waipio':
    supported_targets = ['waipio','palima','fillmore','netrani','clarence'] 
  elif msm == 'aurora':
    supported_targets = ['aurora']
  elif msm == 'halliday':
    supported_targets = ['halliday']
  elif msm == 'fillmore':
