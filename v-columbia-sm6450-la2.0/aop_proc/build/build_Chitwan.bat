...
rem
rem Copyright (c) 2019 Qualcomm Technologies, Inc.
rem All Rights Reserved.
rem QUALCOMM Proprietary/GTDR
rem ==========================================================================
rem $Header: //components/rel/aop.ho/4.0/aop_proc/build/build_Chitwan.bat#1 $

SET BUILD_ASIC=Chitwan
SET MSM_ID=Chitwan
SET HAL_PLATFORM=Chitwan
SET TARGET_FAMILY=Chitwan
SET CHIPSET=Chitwan
