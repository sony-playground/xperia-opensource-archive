...
# -------------------------------------------------------------------------
#
#  $Header: //components/rel/aop.ho/4.0/aop_proc/tools/build/scons/test/pack_results.py#2 $
#  $DateTime: 2021/05/05 14:31:43 $
#  $Change: 30504120 $
#
# =========================================================================
'''%prog [options]
...
if __name__ == "__main__":
    ...
    arg_parser = ArgumentParser(description=__doc__,
                                version="$Header: //components/rel/aop.ho/4.0/aop_proc/tools/build/scons/test/pack_results.py#2 $")
