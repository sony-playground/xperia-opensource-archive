...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/aop.ho/4.0/aop_proc/tools/build/scons/build/build.py#2 $
...
if __name__ == "__main__":
    ...
    try:
        ...
        LG.log("Running $Header: //components/rel/aop.ho/4.0/aop_proc/tools/build/scons/build/build.py#2 $")
