...
.. uml::
   ...
   package ABL {
      ...
      class "XDeviceTreeLib\n(platform/vendor/semc/s1/s1integration)" as XDeviceTreeLib {
         XVerifiedBootImage
      }
   ...
   TaApiLib --> TaDxe
   TaDxe --> TaLib
   XDeviceTreeLib --> VerifiedBootDxe
   XDeviceTreeLib --> XBootLib
