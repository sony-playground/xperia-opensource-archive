...
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/arc4.c
...
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/blowfish.c
...
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/md2.c
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/md4.c
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/md5.c
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/md_wrap.c
...
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/rsa_internal.c
...
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/xtea.c

SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/certs.c
SOURCES_MBEDTLS_LIB+=$(FCS_MAIN)/../mbedtls/library/pkcs11.c
