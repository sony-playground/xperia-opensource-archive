		...
		const char *match)
{
	...
	case MT_XB_EXECUTE:
		...
		/* Set backup keystore to be a valid one with devid binding */
		...
		/*
		 * The primary keystore should now have been replaced
		 * with the backup keystore.
		 */

		/* Check that primary keystore is correct */
		...
		/* Check that backup keystore is correct */
		...
		/* Keystore restored; DevID not wrong; boot normally */
